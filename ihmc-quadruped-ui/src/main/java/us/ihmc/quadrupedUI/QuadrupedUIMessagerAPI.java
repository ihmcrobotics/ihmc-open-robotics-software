...
public class QuadrupedUIMessagerAPI
{
   ...
   public static final Topic<PawPlannerParametersReadOnly> FootstepPlannerParametersTopic = Root.child(Parameters).child(FootstepPlanning).topic(FootstepPlannerParameters);
