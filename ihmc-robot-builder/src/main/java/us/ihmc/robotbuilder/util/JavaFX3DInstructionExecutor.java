...
/**
 * Converts a {@link us.ihmc.graphicsDescription.Graphics3DObject} to a {@link MeshView} which can
 * be used in a JavaFX Scene.
 */
public class JavaFX3DInstructionExecutor extends Graphics3DInstructionExecutor
{
   ...
   public JavaFX3DInstructionExecutor(List<Graphics3DPrimitiveInstruction> instructions)
   {
   ...
   protected void doRotateInstruction(Graphics3DRotateInstruction rot)
   {
      ...
      outputRotation = new Affine(new double[] {mat.getM00(), mat.getM01(), mat.getM02(), 0, mat.getM10(), mat.getM11(), mat.getM12(), 0, mat.getM20(),
