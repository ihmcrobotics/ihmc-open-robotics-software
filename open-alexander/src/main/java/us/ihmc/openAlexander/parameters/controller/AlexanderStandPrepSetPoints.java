...
public class AlexanderStandPrepSetPoints implements WholeBodySetpointParameters
{
   ...
   public AlexanderStandPrepSetPoints(AlexanderJointMap jointMap)
   {
      ...
      for (RobotSide robotSide : RobotSide.values)
      {
         ...
         setPoints.put(jointMap.getLegJointName(robotSide, LegJointName.KNEE_PITCH), 0.75);
         setPoints.put(jointMap.getLegJointName(robotSide, LegJointName.ANKLE_PITCH), -0.25);
