...
public class AlexanderAllocationTest
{
   ...
   private final AllocationProfiler allocationProfiler = new AllocationProfiler();
   ...
   @Test
   @Tag("allocation-slow")
   public void testForAllocationsStanding()
   {
      testInternal(() ->
      {
         try
   ...
   public void testForAllocationsWalking()
   {
   ...
   @Test
   @Tag("allocation-slow")
   public void testForAllocationsDuringPelvisMotion()
   {
   ...
   @Test
   @Tag("allocation-slow")
   public void testForAllocationsWithPelvisUserControl()
   {
   ...
   @Test
   @Tag("allocation-slow")
   public void testForAllocationsDuringArmMotion()
   {
      Random random = new Random(4281284L);
      double duration = 0.3;
   ...
   @Test
   @Tag("allocation-slow")
   public void testForAllocationsDuringChestMotion()
   {
      Random random = new Random(4281284L);
      double duration = 0.3;
   ...
   private void testInternal(Runnable whatToTestFor)
   {
      ...
      if (!allocations.isEmpty())
      {
         ...
         fail("Found allocations in the controller.");
      }
   }
