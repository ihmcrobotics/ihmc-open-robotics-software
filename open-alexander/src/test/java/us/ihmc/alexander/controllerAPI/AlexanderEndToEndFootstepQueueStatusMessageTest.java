...
import us.ihmc.avatar.controllerAPI.EndToEndFootstepQueueStatusMessageTest;
...
public class AlexanderEndToEndFootstepQueueStatusMessageTest extends EndToEndFootstepQueueStatusMessageTest
{
   ...
   {
      super.testTheFootstepQueueStatus();
   }
