...
public class AlexanderToeOffTest extends AvatarToeOffTest
{
   @Test
   @Override
   public void testShortSteps(TestInfo testInfo)
   {
    ...
    {
        OpenAlexanderRobotModel robotModel = new OpenAlexanderRobotModel(OpenAlexanderVersion.V0_LEGS_ROBOT, RobotTarget.SCS)
        {
            @Override
