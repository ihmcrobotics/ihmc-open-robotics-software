...
public class EuclidCoreMissingToolsTest
{
   ...
   public void testProjectRotationOnAxis()
   {
      ...
      for (int i = 0; i < 10000; i++)
      {
         ...
         us.ihmc.euclid.tools.EuclidCoreMissingTools.projectRotationOnAxis(fullRotation, axis, actualRotation);
   ...
   public void testRotationMatrix3DFromFirstToSecondVector3D()
   {
      ...
      for (int i = 0; i < 10000; i++)
      {
         ...
         EuclidGeometryMissingTools.rotationMatrix3DFromFirstToSecondVector3D(firstVector, secondVector, actualRotationMatrix);
   ...
   public void testDistanceBetweenTwoLineSegment2Ds()
   {
      ...
      for (int i = 0; i < iters; i++)
      {
         ...
         double actualMinimumDistance = EuclidGeometryMissingTools.distanceBetweenTwoLineSegment2Ds(lineSegmentStart1,
                                                                                                    lineSegmentEnd1,
                                                                                                    lineSegmentStart2,
                                                                                                    lineSegmentEnd2);
         ...
         actualMinimumDistance = EuclidGeometryMissingTools.distanceBetweenTwoLineSegment2Ds(lineSegmentStart1,
                                                                                             lineSegmentEnd1,
                                                                                             lineSegmentStart2,
                                                                                             lineSegmentEnd2);
         assertEquals(expectedMinimumDistance, actualMinimumDistance, EPSILON);
      ...
      for (int i = 0; i < iters; i++)
      {
         ...
         actualMinimumDistance = EuclidGeometryMissingTools.distanceBetweenTwoLineSegment2Ds(lineSegmentStart1,
                                                                                             ...
                                                                                             lineSegmentStart2);
         assertEquals(expectedMinimumDistance, actualMinimumDistance, EPSILON);
         actualMinimumDistance = EuclidGeometryMissingTools.distanceBetweenTwoLineSegment2Ds(lineSegmentEnd1,
                                                                                             lineSegmentStart1,
                                                                                             lineSegmentStart2,
                                                                                             lineSegmentEnd2);
         assertEquals(expectedMinimumDistance, actualMinimumDistance, EPSILON);
   ...
   public void testIntersectionBetweenRay2DAndLine2D()
   {
      ...
      assertTrue(EuclidGeometryMissingTools.intersectionBetweenRay2DAndLine2D(rayOrigin, rayDirection, lineStart, lineDirection, intersectionToPac));
   ...
   public void testDifferentiateOrientation()
   {
      ...
      for (int i = 0; i < iters; i++)
      {
         ...
         us.ihmc.euclid.tools.EuclidCoreMissingTools.differentiateOrientation(qStart, qEnd, duration, actualAngularVelocity);
   ...
   public void testNextPositiveDefiniteMatrix3D() throws Exception
   {
      ...
      for (int i = 0; i < iters; i++) { // Test nextPositiveDefiniteMatrix3D(Random random)
         Matrix3D matrix3D = EuclidCoreMissingRandomTools.nextPositiveDefiniteMatrix3D(random);
      ...
      for (int i = 0; i < iters; i++) { // Test nextPositiveDefiniteMatrix3D(Random random, double minMaxValue)
         ...
         Matrix3D matrix3D = EuclidCoreMissingRandomTools.nextPositiveDefiniteMatrix3D(random, minMaxValue);
      ...
      // Test exceptions:
      try {
         EuclidCoreMissingRandomTools.nextPositiveDefiniteMatrix3D(random, -0.1);
