...
public class AtlasJoystickBasedSteppingApplication extends Application
{
   ...
   public void start(Stage primaryStage) throws Exception
   {
      ...
      bdiBehaviorcommandPublisher = ROS2Tools.createPublisherTypeNamed(ros2Node, BDIBehaviorCommandPacket.class, ROS2Tools.getControllerInputTopicName(robotName));
