...
public class AtlasCollisionBoxProvider extends SDFCollisionBoxProvider
{
   ...
   public AtlasCollisionBoxProvider(JaxbSDFLoader loader, AtlasJointMap jointMap)
   {
      ...
      for (RobotSide robotSide : RobotSide.values)
      {
         ...
         mittenPose.getTranslation().set((double) 0, robotSide.negateIfRightSide(0.27), -0.005);
         ...
         kneePose.getTranslation().set(0.05, (double) 0, 0.03);
         ...
         elbowBoxTransform.getTranslation().set((double) 0, robotSide.negateIfLeftSide(0.1), -0.2);
      ...
      backPackTransform.getTranslation().set(-0.2, (double) 0, 0.2);
      ...
      haloTransform.getTranslation().set((double) 0, (double) 0, (double) 1);
