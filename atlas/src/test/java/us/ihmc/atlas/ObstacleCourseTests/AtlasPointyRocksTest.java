...
public class AtlasPointyRocksTest extends HumanoidPointyRocksTest
{
    ...
    */
   @Override
   @ContinuousIntegrationTest(estimatedDuration = 104.0)
   @Test(timeout = 520000)
    ...
    */
   @Override
   @ContinuousIntegrationTest(estimatedDuration = 163.5)
   @Test(timeout = 820000)
    ...
    */
   @Override
   @ContinuousIntegrationTest(estimatedDuration = 154.0)
   @Test(timeout = 770000)
    ...
    */
   @Override
   @ContinuousIntegrationTest(estimatedDuration = 52.9)
   @Test(timeout = 260000)
