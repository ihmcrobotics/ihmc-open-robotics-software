...
public class AtlasSimpleICPOptimizationPushRecoveryTestA extends AvatarICPOptimizationPushRecoveryTestA
{
   @Override
   ...
   {
      AtlasSimpleICPOptimizationPushRecoveryTestA test = new AtlasSimpleICPOptimizationPushRecoveryTestA();
      try
      {
