...
public class AtlasSimpleICPOptimizationPushRecoveryTestB extends AvatarICPOptimizationPushRecoveryTestB
{
   @Override
   ...
   {
      AtlasSimpleICPOptimizationPushRecoveryTestB test = new AtlasSimpleICPOptimizationPushRecoveryTestB();
      try
      {
