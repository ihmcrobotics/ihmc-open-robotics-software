...
public class WalkingControllerTest
{
   ...
   private final RequestMessageOutputManager requestOutputManager = new RequestMessageOutputManager(ControllerAPIDefinition.getControllerSupportedRequestableMessages());
