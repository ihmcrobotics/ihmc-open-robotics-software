...
import us.ihmc.commonWalkingControlModules.instantaneousCapturePoint.ICPPlannerWithAngularMomentumOffsetWrapper;
...
public abstract class AvatarAbsoluteStepTimingsTest implements MultiRobotTestInterface
{
   ...
   {
      YoDouble firstTransferTime = getDoubleYoVariable(scs, "icpPlannerTransferDuration0", ICPPlannerWithAngularMomentumOffsetWrapper.class.getSimpleName());
