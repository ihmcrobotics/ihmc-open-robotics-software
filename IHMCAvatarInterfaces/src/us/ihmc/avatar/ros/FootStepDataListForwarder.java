...
public class FootStepDataListForwarder extends AbstractRosTopicSubscriber<ihmc_msgs.FootstepDataListRosMessage>
{
   ...
   public void onNewMessage(FootstepDataListRosMessage message)
   {
      ...
      controllerCommunicator.send(new us.ihmc.humanoidRobotics.communication.packets.walking.FootstepDataListMessage(footStepDataArrayList,message.getDefaultSwingDuration(),message.getDefaultTransferDuration(),executionMode));
   }
}
