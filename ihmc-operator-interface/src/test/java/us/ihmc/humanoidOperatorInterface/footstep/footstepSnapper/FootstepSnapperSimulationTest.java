...
import us.ihmc.humanoidOperatorInterface.dataStructures.quadTree.QuadTreeHeightMapVisualizer;
import us.ihmc.humanoidOperatorInterface.pointClouds.combinationQuadTreeOctTree.QuadTreeForGroundHeightMap;
...
import us.ihmc.humanoidOperatorInterface.quadTree.QuadTreeForGroundParameters;
import us.ihmc.humanoidOperatorInterface.simulationToolkit.visualizers.FootstepVisualizer;
...
//       planePosition.set(planePosition.x, planePosition.y, planePosition.z - 0.01); adversary code, move foot plane down a little
         ...
         if (assertPointConditions)
         {
            ...
            assertTrue((planeNormal.getZ() >= 0.98) || pointsBelowPlane, "queryPoint = " + queryPoint + " yaw = " + soleYaw.getDoubleValue() + " planeNormal = " + planeNormal + ", pointsBelowPlane = "
                                                                         + pointsBelowPlane);
         }
