...
public class VisibilityGraphsGeometryToolsTest
{
   ...
   public void testDoRay2DAndLineSegment2DIntersect() throws Exception
   {
      ...
      for (int i = 0; i < ITERATIONS; i++)
      {
         ...
         assertTrue("Iteration: " + i, VisibilityGraphsGeometryTools.doRay2DAndLineSegment2DIntersect(rayOrigin, rayDirection, lineSegmentStart, lineSegmentEnd));
         assertTrue("Iteration: " + i, VisibilityGraphsGeometryTools.doRay2DAndLineSegment2DIntersect(rayOrigin, rayDirection, lineSegmentEnd, lineSegmentStart));
         ...
         lineSegmentStart.scaleAdd(alphaStart, lineSegmentDirection, pointOnRay);
         lineSegmentEnd.scaleAdd(alphaEnd, lineSegmentDirection, pointOnRay);
         assertFalse("Iteration: " + i, VisibilityGraphsGeometryTools.doRay2DAndLineSegment2DIntersect(rayOrigin, rayDirection, lineSegmentStart, lineSegmentEnd));
         assertFalse("Iteration: " + i, VisibilityGraphsGeometryTools.doRay2DAndLineSegment2DIntersect(rayOrigin, rayDirection, lineSegmentEnd, lineSegmentStart));
      }
                                                                                             ...
                                                                                             Point2D lineSegmentEnd)
   {
      ...
      success = VisibilityGraphsGeometryTools.intersectionBetweenRay2DAndLineSegment2D(rayOrigin, rayDirection, lineSegmentStart, lineSegmentEnd, new Point2D());
      ...
      success = VisibilityGraphsGeometryTools.intersectionBetweenRay2DAndLineSegment2D(rayOrigin, rayDirection, lineSegmentEnd, lineSegmentStart, new Point2D());
      assertTrue(success == intersectionExist);
