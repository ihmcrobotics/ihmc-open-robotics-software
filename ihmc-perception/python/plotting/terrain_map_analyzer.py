...
from height_map_analyzer import *
...
def plot_and_compute_stats(height_map, debug=True, display=True):
    # Compute mean and standard deviation for the full grid
    mean_height, stddev_height, psd_height, fft_height, mean_contact, stddev_contact = get_terrain_stats(height_map)
