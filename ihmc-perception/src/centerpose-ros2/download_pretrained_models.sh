...
# bottle
wget -nc --no-check-certificate 'https://docs.google.com/uc?export=download&id=1PaNVJgRkyQjnNAVxOwQ9Ho3REAsmgtzf' -O models/bottle_v1_sym_12_140.pth
# camera
wget -nc --no-check-certificate 'https://docs.google.com/uc?export=download&id=1PaNVJgRkyQjnNAVxOwQ9Ho3REAsmgtzf' -O models/camera_v1_140.pth
# cereal box
wget -nc --no-check-certificate 'https://docs.google.com/uc?export=download&id=1PaNVJgRkyQjnNAVxOwQ9Ho3REAsmgtzf' -O models/cereal_box_v1_140.pth
# chair
