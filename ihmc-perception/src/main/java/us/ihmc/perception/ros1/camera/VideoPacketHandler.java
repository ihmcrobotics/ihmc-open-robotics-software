...
public class VideoPacketHandler implements CompressedVideoHandler
{
   ...
   public VideoPacketHandler(ROS2Node ros2Node, ROS2QosProfile qosProfile)
   {
   ...
   public VideoPacketHandler(ROS2Node ros2Node, ROS2Topic<VideoPacket> topic, ROS2QosProfile qosProfile)
   {
