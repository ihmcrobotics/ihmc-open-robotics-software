...
public class DoorModelParameters
{
   ...
   /** We place the opener up from the bottom of the panel as measured on our lab door. */
   ...
   public static final double FRAME_ARUCO_MARKER_WIDTH = RigidBodySceneObjectDefinitions.LARGE_MARKER_WIDTH;
   public static final int PULL_FRAME_MARKER_ID = 0;
   public static final int PUSH_FRAME_MARKER_ID = 1;
   public static final int LEFT_KNOB_MARKER_ID = 10;
   public static final int RIGHT_KNOB_MARKER_ID = 11;
   public static final int LEFT_HANDLE_MARKER_ID = 12;
   public static final int RIGHT_HANDLE_MARKER_ID = 13;

   /**
    * It is actually important to measure the ArUco marker pose relative to the opener,
   ...
   public static final double LEFT_SIDE_ARUCO_MARKER_TO_OPENER_AXIS_Y = 0.127;
   public static final double LEFT_SIDE_ARUCO_MARKER_TO_LEVER_AXIS_Y = -0.0885 - FRAME_ARUCO_MARKER_WIDTH;
}
