 ...
 *
 * TODO: It should support detected objects abstractly, using our ArUco & other implementations.
 */
public class PerceptionSceneObjectsManager
{
   ...
   private final DoorPerceptionHeuristicManager pullDoorManager;
   private final DoorPerceptionHeuristicManager pushDoorManager;
   private final ArUcoMarkerObject box = new ArUcoMarkerObject(null, "Box");
   ...
   public PerceptionSceneObjectsManager(ROS2PublishSubscribeAPI ros2, ArUcoMarkerObjectsInfo objectsInfo, ReferenceFrame cameraFrame)
   {
      this.ros2 = ros2;
      ...
      {
         markers.add(new ArUcoMarkerObject(objectsInfo, objectNames.get(IDs.get(i)) + "Marker"));
      ...
      pullDoorManager = new DoorPerceptionHeuristicManager(DoorSceneObjects.PULL_DOOR_MARKER_ID, "Pull", cameraFrame);
      ...
      pushDoorManager = new DoorPerceptionHeuristicManager(DoorSceneObjects.PUSH_DOOR_MARKER_ID, "Push", cameraFrame);
...
//               detectedObjectPublisher.markDetected(arUcoMarkerPosesMessage.getMarkerId().get(i));
   ...
   public DoorPerceptionHeuristicManager getPushDoorManager()
   {
      return pushDoorManager;
   }

   public DoorPerceptionHeuristicManager getPullDoorManager()
   {
