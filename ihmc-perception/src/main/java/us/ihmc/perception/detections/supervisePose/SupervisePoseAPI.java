                                     ...
                                     ROS2Topic<FoundationPoseParameters> ihmcParameters)
   {
      public SupervisePoseTopics(ROS2Topic<?> foundationPoseBase, ROS2Topic<?> supervisePoseBase, ROS2Topic<ImageMessage> overlayedImage)
      {
         this(foundationPoseBase.appendedWith("pose_estimation/depth_image").withType(Image.class),
              ...
              supervisePoseBase.appendedWith("pose_estimation/output").withType(Detection3DArray.class).withQoS(ROS2QoSProfile.BEST_EFFORT),
              ...
              supervisePoseBase.appendedWith("tracking/output").withType(Detection3DArray.class).withQoS(ROS2QoSProfile.BEST_EFFORT),
