...
public class IsaacROSFoundationPoseCommunicator implements AutoCloseable
{
   ...
   public IsaacROSFoundationPoseCommunicator(IsaacROSFoundationPoseObject objectToTrack, CRDTInfo crdtInfo)
   {
      ...
      poseEstimationResultSubscription = ros2Node.createSubscriptionSampler(objectToTrack.topics.poseEstimationOutput(), this::updateLatestResult);
      trackingResultSubscription = ros2Node.createSubscriptionSampler(objectToTrack.topics.trackingOutput(), this::updateLatestResult);
