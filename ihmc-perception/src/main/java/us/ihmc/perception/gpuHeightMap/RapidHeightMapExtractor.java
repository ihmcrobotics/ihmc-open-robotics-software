...
public class RapidHeightMapExtractor
{
   ...
   private BytedecoImage heightMapInSensor;
   private BytedecoImage heightMapInWorld;
   ...
   public void create(OpenCLManager openCLManager,  BytedecoImage depthImage)
   {
      ...
      heightMapInSensor = new BytedecoImage(cellsPerAxis, cellsPerAxis, opencv_core.CV_16UC1);
      heightMapInSensor.createOpenCLImage(openCLManager, OpenCL.CL_MEM_READ_WRITE);

      heightMapInWorld = new BytedecoImage(cellsPerAxis, cellsPerAxis, opencv_core.CV_16UC1);
      heightMapInWorld.createOpenCLImage(openCLManager, OpenCL.CL_MEM_READ_WRITE);
   ...
   public void update(RigidBodyTransform sensorToWorldTransform, float planeHeight)
   {
      if (!processing)
      {
         ...
         openCLManager.setKernelArgument(heightMapUpdateKernel, 3, groundPlaneBuffer.getOpenCLBufferObject());
