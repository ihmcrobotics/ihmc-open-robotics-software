...
public class BasicSceneObjects
{
   ...
   {
      return new ArUcoDetectableObject("Box", BOX_MARKER_ID, BOX_MARKER_WIDTH, BOX_TRANSFORM_TO_MARKER);
   }
   ...
   {
      return new ArUcoDetectableObject("CanOfSoup", 4, MARKER_WIDTH, new RigidBodyTransform());
   }
}
