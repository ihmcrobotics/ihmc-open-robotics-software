...
public class RealtimeL515
{
   ...
   public RealtimeL515(String prefix, rs2_context context, rs2_device device, YoRegistry parentRegistry, YoGraphicsListRegistry graphicsListRegistry)
   {
      ...
      BytePointer serialNumberBytePointer = realsense2.rs2_get_device_info(device, realsense2.RS2_CAMERA_INFO_SERIAL_NUMBER, error);
      String serialNumber = serialNumberBytePointer.getString();
