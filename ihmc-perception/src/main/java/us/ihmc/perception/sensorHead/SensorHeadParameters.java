...
public class SensorHeadParameters
{
   ...
   static
   {
      ...
      EuclidCoreTools.setYawPitchRollDegrees(FISHEYE_LEFT_TO_OUSTER_TRANSFORM_ON_ROBOT.getRotation(), 0.000, -25.0, 0.000);
   }
   ...
   static
   {
      ...
      EuclidCoreTools.setYawPitchRollDegrees(FISHEYE_RIGHT_TO_OUSTER_TRANSFORM_ON_ROBOT.getRotation(), 0.000, -25.0, 0.000);
   }
