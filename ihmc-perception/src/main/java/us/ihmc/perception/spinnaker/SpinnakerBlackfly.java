...
public class SpinnakerBlackfly
{
   ...
   protected SpinnakerBlackfly(spinCamera spinCamera, String serialNumber)
   {
      ...
      checkError(Spinnaker_C.spinCameraGetTLDeviceNodeMap(spinCamera, transportLayerDeviceNodeMap), "Getting transport layer device node map");
      checkError(Spinnaker_C.spinCameraInit(spinCamera), "Initializing camera");
      checkError(Spinnaker_C.spinCameraGetNodeMap(spinCamera, cameraNodeMap), "Retrieving GenICam node map");
      checkError(Spinnaker_C.spinCameraGetTLStreamNodeMap(spinCamera, streamNodeMap), "Retrieving stream node map");
   }
   ...
   public void setBufferHandlingMode(Spinnaker_C.spinTLStreamBufferHandlingModeEnums bufferHandlingMode)
   {
      ...
      checkError(Spinnaker_C.spinNodeMapGetNode(streamNodeMap, new BytePointer("StreamBufferHandlingMode"), bufferHandlingModeNode),
      ...
      checkError(Spinnaker_C.spinEnumerationGetEntryByName(bufferHandlingModeNode, new BytePointer(selectorString), setBufferHandlingMode),
                    "Getting stream buffer handling mode entry by name: " + selectorString);
      LongPointer bufferHandlingModePointer = new LongPointer(1);
      checkError(Spinnaker_C.spinEnumerationEntryGetIntValue(setBufferHandlingMode, bufferHandlingModePointer),
                 "Getting stream buffer handling mode int value");
      checkError(Spinnaker_C.spinEnumerationSetIntValue(bufferHandlingModeNode, bufferHandlingModePointer.get()),
   ...
   public void setAcquisitionMode(Spinnaker_C.spinAcquisitionModeEnums acquisitionMode)
   {
      ...
      checkError(Spinnaker_C.spinNodeMapGetNode(cameraNodeMap, new BytePointer("AcquisitionMode"), acquisitionModeNode),
      ...
      checkError(Spinnaker_C.spinEnumerationGetEntryByName(acquisitionModeNode, new BytePointer(selectorString), setAcquisitionMode),
                    "Getting acquisition mode entry by name: " + selectorString);
      LongPointer acquisitionModePointer = new LongPointer(1);
      checkError(Spinnaker_C.spinEnumerationEntryGetIntValue(setAcquisitionMode, acquisitionModePointer), "Getting acquisition mode int value");
      checkError(Spinnaker_C.spinEnumerationSetIntValue(acquisitionModeNode, acquisitionModePointer.get()), "Setting acquisition mode int value");
   }
   ...
   public void setPixelFormat(Spinnaker_C.spinPixelFormatEnums pixelFormat)
   {
      ...
      checkError(Spinnaker_C.spinNodeMapGetNode(cameraNodeMap, new BytePointer("PixelFormat"), pixelFormatNode), "Getting pixel format node map node");
      ...
      checkError(Spinnaker_C.spinEnumerationGetEntryByName(pixelFormatNode, new BytePointer(selectorString), pixelFormatEntryNodeHandle),
                    "Getting pixel format entry by name: " + selectorString);
      LongPointer ptrPixelFormat = new LongPointer(1L);
      checkError(Spinnaker_C.spinEnumerationEntryGetIntValue(pixelFormatEntryNodeHandle, ptrPixelFormat), "Getting pixel format int value");
      checkError(Spinnaker_C.spinEnumerationSetIntValue(pixelFormatNode, ptrPixelFormat.get()), "Setting pixel format int value");
   }

   public void startAcquiringImages()
   {
      checkError(Spinnaker_C.spinCameraBeginAcquisition(spinCamera), "Beginning camera acquisition");
   }
   ...
   public int getHeight(spinImage spinImage)
   {
      ...
      checkError(Spinnaker_C.spinImageGetHeight(spinImage, heightPointer), "Getting image height");
   ...
   public int getWidth(spinImage spinImage)
   {
      ...
      checkError(Spinnaker_C.spinImageGetWidth(spinImage, widthPointer), "Getting image width");
   ...
   public void stopAcquiringImages()
   {
      ...
      checkError(Spinnaker_C.spinCameraEndAcquisition(spinCamera), "Ending camera acquisition");
   }
}
