            ...
            switch (name){
                ...
                case "SavePCD": {
                    if(isPressed){
                        ...
                        String path1 = Paths.get("./ihmc-open-robotics-software/ihmc-perception/src/main/java/us/ihmc/ihmcPerception/lineSegmentDetector/pointcloud1.pcd").toAbsolutePath().normalize().toString();
                        String path2 = Paths.get("./ihmc-open-robotics-software/ihmc-perception/src/main/java/us/ihmc/ihmcPerception/lineSegmentDetector/pointcloud2.pcd").toAbsolutePath().normalize().toString();
