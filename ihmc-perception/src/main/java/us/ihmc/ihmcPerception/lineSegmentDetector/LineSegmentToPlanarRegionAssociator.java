...
public class LineSegmentToPlanarRegionAssociator {
    ...
    public void setCamIntrinsics(CameraPinholeBrown camIntrinsics) { this.camIntrinsics = camIntrinsics; }

    public void setCameraOrientation(Quaternion cameraOrientation) { this.cameraOrientation = cameraOrientation;  }
