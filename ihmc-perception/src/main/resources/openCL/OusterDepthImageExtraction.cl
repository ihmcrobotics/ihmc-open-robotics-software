kernel void extractDepthImage(global float *parameters, global int *pixelShifts,
                              ...
                              read_write image2d_t depthImage16UC1)
{
   ...
   int bytesToColumnDataBlockStart =
       x * measurementBlockSize + headerBlockBytes + y * channelDataBlockBytes;
