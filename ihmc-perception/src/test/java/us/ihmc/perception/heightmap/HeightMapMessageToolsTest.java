...
//
//      Mat heightMapResult = new Mat(cellsPerAxis, cellsPerAxis, opencv_core.CV_32FC1);
//
//      for (int i = 0; i < iterations; i++)
//      {
//         HeightMapMessageTools.unpackMessageToMat(heightMapMessage, heightMapResult, heightMapParameters);
//      }
//
...
//      float expectedTimeTakenToPackHeightMapMessageFromAMat = 1.0f;
