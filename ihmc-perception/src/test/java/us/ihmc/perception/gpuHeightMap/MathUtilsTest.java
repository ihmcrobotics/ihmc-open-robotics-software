...
public class MathUtilsTest
{
   ...
   {
      URL programPath = getClass().getClassLoader().getResource("cuda/MathUtilsTest.cu");
      URL headerPath = getClass().getClassLoader().getResource("cuda/utils/MathUtils.cuh");
...
//      cudaMemcpyAsync(cpuResultPointer, gpuResultPointer, gpuResultPointer.sizeof() * (gpuResultPointer.limit() + 1), cudaMemcpyDefault, stream);
   ...
   void testClampCUDA() throws Exception
   {
      ...
      URL programFile = getClass().getClassLoader().getResource("cuda/MathUtilsTest.cu");
      URL headerFile = getClass().getClassLoader().getResource("cuda/utils/MathUtils.cuh");
