...
public class MathUtilsTest
{
   ...
   {
      URL programPath = getClass().getClassLoader().getResource("us/ihmc/perception/heightMap/MathUtilsTest.cu");
   ...
   void testClampCUDA() throws Exception
   {
      ...
      URL programFile = getClass().getClassLoader().getResource("us/ihmc/perception/heightMap/MathUtilsTest.cu");
