...
public class HeightMapUtilsTest
{
   ...
   {
      URL programPath = getClass().getClassLoader().getResource("cuda/HeightMapUtilsTest.cu");
      URL headerPath = getClass().getClassLoader().getResource("cuda/heightMap/HeightMapUtils.cuh");
