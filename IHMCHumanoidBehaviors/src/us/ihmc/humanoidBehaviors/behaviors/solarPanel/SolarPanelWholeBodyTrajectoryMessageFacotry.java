...
public class SolarPanelWholeBodyTrajectoryMessageFacotry
{
   ...
   public void setMessage(SolarPanelCleaningPose cleaningPose, double pelvisYaw, double pelvisHeight, double motionTime)
   {
      ...
      ChestTrajectoryMessage chestTrajectoryMessage = new ChestTrajectoryMessage(motionTime, desiredChestOrientation, ReferenceFrame.getWorldFrame());
   ...
   public void setMessage(ArrayList<RRTNode> rrtPath)
   {
      ...
      else
      {
         ...
         handTrajectoryMessage.getFrameInformation().setTrajectoryReferenceFrame(ReferenceFrame.getWorldFrame());
         ...
         chestTrajectoryMessage.getFrameInformation().setTrajectoryReferenceFrameId(CommonReferenceFrameIds.PELVIS_ZUP_FRAME.getHashId());
