...
//   private IHMCRealtimeROS2Publisher<WalkingControllerPreviewInputMessage> walkingPreviewRequestPublisher;
   ...
   private void registerPubSubs(RealtimeRos2Node ros2Node)
   {
      ...
      ROS2Tools.createCallbackSubscriptionWithType(ros2Node, PawStepPlanningRequestPacket.class,
      ...
      ROS2Tools.createCallbackSubscriptionWithType(ros2Node, BodyPathPlanMessage.class, PawStepPlannerCommunicationProperties.publisherTopicNameGenerator(robotName),
                                           s -> processBodyPathPlanMessage(s.takeNextData()));
      ROS2Tools.createCallbackSubscriptionWithType(ros2Node, FootstepPlannerStatusMessage.class,
      ...
      ROS2TopicName controllerPreviewOutputTopicNameGenerator = ROS2Tools.WALKING_PREVIEW_TOOLBOX.withRobot(robotName)
                                                                                                 .withOutput();
      ROS2Tools.createCallbackSubscriptionWithType(ros2Node, WalkingControllerPreviewOutputMessage.class, controllerPreviewOutputTopicNameGenerator, s -> messager.submitMessage(
            PawStepPlannerMessagerAPI.WalkingPreviewOutput, s.takeNextData()));

      // publishers
      plannerParametersPublisher = ROS2Tools
            .createPublisherWithType(ros2Node, PawStepPlannerParametersPacket.class, PawStepPlannerCommunicationProperties.subscriberTopicNameGenerator(robotName));
      visibilityGraphsParametersPublisher = ROS2Tools
            .createPublisherWithType(ros2Node, VisibilityGraphsParametersPacket.class, PawStepPlannerCommunicationProperties.subscriberTopicNameGenerator(robotName));
      toolboxStatePublisher = ROS2Tools.createPublisherWithType(ros2Node, ToolboxStateMessage.class,
                                                                PawStepPlannerCommunicationProperties.subscriberTopicNameGenerator(robotName));
      pawPlanningRequestPublisher = ROS2Tools
            .createPublisherWithType(ros2Node, PawStepPlanningRequestPacket.class, PawStepPlannerCommunicationProperties.subscriberTopicNameGenerator(robotName));
      footstepDataListPublisher = ROS2Tools.createPublisherWithType(ros2Node, QuadrupedTimedStepListMessage.class, ROS2Tools.getControllerInputTopicName(robotName));
