...
public enum PawStepPlannerNodeRejectionReason
{
...
//   STEP_NOT_WIDE_ENOUGH,
   STEP_IN_PLACE, STEP_ON_OTHER_PAW,
   COULD_NOT_SNAP,
...
//   OBSTACLE_HITTING_BODY;
   ...
   public static final PawStepPlannerNodeRejectionReason[] values = values();
   ...
   public static PawStepPlannerNodeRejectionReason fromByte(byte enumAsByte)
   {
      if (enumAsByte == -1)
         return null;
