...
public class PawPlannerMessagerAPI
{
   ...
   private static final TypedTopicTheme<PawPlannerType> FootstepPlannerType = apiFactory.createTypedTopicTheme("FootstepPlannerType");
   private static final TypedTopicTheme<PawPlanningResult> FootstepPlannerResult = apiFactory.createTypedTopicTheme("FootstepPlannerResult");
   private static final TypedTopicTheme<PawPlannerStatus> FootstepPlannerStatus = apiFactory.createTypedTopicTheme("FootstepPlannerStatus");
   private static final TypedTopicTheme<PawPlannerParametersReadOnly> FootstepPlannerParameters = apiFactory.createTypedTopicTheme("FootstepPlannerParameters");
   ...
   private static final TypedTopicTheme<QuadrupedPawPlannerNodeRejectionReason> RejectionReason = apiFactory.createTypedTopicTheme("RejectionReason");
   ...
   public static final Topic<PawPlan> FootstepPlanTopic = Root.child(FootstepPlan).topic(Data);
   ...
   public static final Topic<PawPlannerParametersReadOnly> PlannerParametersTopic = Root.child(Parameters).topic(FootstepPlannerParameters);
   ...
   public static final Topic<PawPlannerType> PlannerTypeTopic = Root.child(FootstepPlan).topic(FootstepPlannerType);
   public static final Topic<PawPlanningResult> PlanningResultTopic = Root.child(FootstepPlan).topic(FootstepPlannerResult);
   public static final Topic<PawPlannerStatus> PlannerStatusTopic = Root.child(FootstepPlan).topic(FootstepPlannerStatus);
   ...
   public static final Topic<PawPlannerTargetType> StartTargetTypeTopic = Root.child(FootstepPlan).child(Start).topic(FootstepPlannerTargetType);
   ...
   public static final Topic<HashMap<QuadrupedPawPlannerNodeRejectionReason, List<PawNode>>> NodesRejectedThisTickTopic = Root.child(PlannerData).child(NodeOccupancyMap).child(
   ...
   public static final Topic<QuadrupedPawPlannerNodeRejectionReason> RejectionReasonToShowTopic = Root.child(PlannerData).child(NodeOccupancyMap).child(NodesRejectedByReason).topic(RejectionReason);
