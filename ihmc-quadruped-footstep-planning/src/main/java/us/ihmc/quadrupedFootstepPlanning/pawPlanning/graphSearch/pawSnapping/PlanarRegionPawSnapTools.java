...
public class PlanarRegionPawSnapTools
{
   ...
   public static PlanarRegion findHighestRegion(Point2DReadOnly point, List<PlanarRegion> planarRegionList, PlanarRegionPawConstraintDataHolder constraintDataHolder,
   ...
   public static PlanarRegion findHighestRegion(double x, double y, List<PlanarRegion> planarRegionList, PlanarRegionPawConstraintDataHolder constraintDataHolder,
                                                PlanarRegionPawConstraintDataParameters parameters)
   {
      ConvexPolygon2D tempPolygon = new ConvexPolygon2D();
      tempPolygon.addVertex(0.5 * PawNode.gridSizeXY, 0.5 * PawNode.gridSizeXY);
      tempPolygon.addVertex(0.5 * PawNode.gridSizeXY, - 0.5 * PawNode.gridSizeXY);
      tempPolygon.addVertex(- 0.5 * PawNode.gridSizeXY, 0.5 * PawNode.gridSizeXY);
      tempPolygon.addVertex(- 0.5 * PawNode.gridSizeXY, - 0.5 * PawNode.gridSizeXY);
      tempPolygon.update();
   ...
   public static PlanarRegion findHighestRegionWithProjection(Point2DReadOnly point, Vector2D projectionTranslationToPack,
                                                              PlanarRegionPawConstraintDataHolder constraintDataHolder, List<PlanarRegion> planarRegionList,
                                                              PlanarRegionPawConstraintDataParameters parameters)
   {
   ...
   private static Vector3D projectPointIntoRegion(PlanarRegion region, double x, double y, PlanarRegionPawConstraintDataHolder constraintDataHolder,
                                           PlanarRegionPawConstraintDataParameters parameters)
   {
   ...
   private static boolean isTranslationInGrid(PlanarRegionPawConstraintDataParameters parameters, Vector3D projectionTranslation)
   {
      ...
      {
         double epsilon = 1e-8;
         double maximumTranslationOnAxis = 0.5 * PawNode.gridSizeXY + epsilon;
   ...
   public static RigidBodyTransform getSnapTransformToRegion(Point2DReadOnly pointToSnap, PlanarRegion planarRegionToSnapTo)
   {
      ...
      PlanarRegionPawSnapTools.setTranslationSettingZAndPreservingXAndY(point, snapTransform);
