...
public class YoPawNode
{
   ...
   public PawNode getEquivalentNode()
   {
      for (RobotQuadrant robotQuadrant : RobotQuadrant.values)
      {
      ...
      return new PawNode(movingQuadrant.getEnumValue(), nodePositions.get(RobotQuadrant.FRONT_LEFT), nodePositions.get(RobotQuadrant.FRONT_RIGHT),
