...
public class PawStepPlannerMessagerAPI
{
   ...
   private static final TypedTopicTheme<PawStepPlannerType> FootstepPlannerType = apiFactory.createTypedTopicTheme("FootstepPlannerType");
   private static final TypedTopicTheme<PawStepPlanningResult> FootstepPlannerResult = apiFactory.createTypedTopicTheme("FootstepPlannerResult");
   private static final TypedTopicTheme<PawStepPlannerStatus> FootstepPlannerStatus = apiFactory.createTypedTopicTheme("FootstepPlannerStatus");
   ...
   private static final TypedTopicTheme<PawStepPlannerNodeRejectionReason> RejectionReason = apiFactory.createTypedTopicTheme("RejectionReason");
   ...
   public static final Topic<PawStepPlan> FootstepPlanTopic = Root.child(FootstepPlan).topic(Data);
   ...
   public static final Topic<PawStepPlannerParametersReadOnly> PlannerParametersTopic = Root.child(Parameters).topic(FootstepPlannerParameters);
   ...
   public static final Topic<PawStepPlannerType> PlannerTypeTopic = Root.child(FootstepPlan).topic(FootstepPlannerType);
   public static final Topic<PawStepPlanningResult> PlanningResultTopic = Root.child(FootstepPlan).topic(FootstepPlannerResult);
   public static final Topic<PawStepPlannerStatus> PlannerStatusTopic = Root.child(FootstepPlan).topic(FootstepPlannerStatus);
   ...
   public static final Topic<PawStepPlannerTargetType> StartTargetTypeTopic = Root.child(FootstepPlan).child(Start).topic(FootstepPlannerTargetType);
   ...
   public static final Topic<HashMap<PawNode, Pair<List<PawNode>, List<PawNode>>>> NodesThisTickTopic = Root.child(PlannerData).child(NodeOccupancyMap).child(NodesThisTick).topic(Data);
   public static final Topic<HashMap<PawStepPlannerNodeRejectionReason, List<PawNode>>> NodesRejectedThisTickTopic = Root.child(PlannerData).child(NodeOccupancyMap).child(
   ...
   public static final Topic<PawStepPlannerNodeRejectionReason> RejectionReasonToShowTopic = Root.child(PlannerData).child(NodeOccupancyMap).child(NodesRejectedByReason).topic(RejectionReason);
