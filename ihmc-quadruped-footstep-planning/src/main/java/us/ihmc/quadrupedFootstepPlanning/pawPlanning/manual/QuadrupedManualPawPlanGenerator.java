package us.ihmc.quadrupedFootstepPlanning.pawPlanning.manual;
...
public class QuadrupedManualPawPlanGenerator
{
   public QuadrupedTimedStepListMessage generateSteps(boolean trot,
                                                      RobotQuadrant firstPaw,
                                                      double swingHeight,
                                                      double stepHeight,
                                                      double stepLength,
                                                      double stepWidth,
                                                      ...
                                                      CommonQuadrupedReferenceFrames referenceFrames)
   {
      if (trot)
      {
         return generateTrotSteps(firstPaw,
                                  swingHeight,
                                  stepHeight,
                                  stepLength,
                                  stepWidth,
      ...
      {
         return generateCrawlSteps(firstPaw,
                                   swingHeight,
                                   stepHeight,
                                   stepLength,
                                   stepWidth,
   ...
   public QuadrupedTimedStepListMessage generateTrotSteps(RobotQuadrant firstPaw,
                                                          double swingHeight,
                                                          double stepHeight,
                                                          double stepLength,
                                                          double stepWidth,
                                                          ...
                                                          CommonQuadrupedReferenceFrames referenceFrames)
   {
      ...
      for (int i = 0; i < numberOfSteps; i++)
      {
         ...
         RobotQuadrant frontQuadrant = firstPaw;
         RobotQuadrant rearQuadrant = firstPaw.getDiagonalOppositeQuadrant();
         ...
         firstPaw = firstPaw.getAcrossBodyQuadrant();
