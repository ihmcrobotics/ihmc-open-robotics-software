...
public enum PawPlanningResult
{
   ...
   public static final PawPlanningResult[] values = values();

   public static PawPlanningResult generateRandomResult(Random random)
   {
   ...
   public static PawPlanningResult getWorstResult(PawPlanningResult resultA, PawPlanningResult resultB)
   {
   ...
   public static PawPlanningResult fromByte(byte enumAsByte)
   {
