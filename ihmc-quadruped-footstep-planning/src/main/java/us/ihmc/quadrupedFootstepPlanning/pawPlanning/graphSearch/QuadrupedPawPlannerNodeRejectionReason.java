...
public enum QuadrupedPawPlannerNodeRejectionReason
{
...
//   OBSTACLE_HITTING_BODY;
   ...
   public static final QuadrupedPawPlannerNodeRejectionReason[] values = values();
   ...
   public static QuadrupedPawPlannerNodeRejectionReason fromByte(byte enumAsByte)
   {
      if (enumAsByte == -1)
         return null;
