...
public class QuadrupedAStarPawPlannerVisualizer implements PawPlannerListener
{
   ...
   public QuadrupedAStarPawPlannerVisualizer(PlanarRegionsList regions)
   {
      this(0.1, regions);
   }

   public QuadrupedAStarPawPlannerVisualizer(double playbackRate, PlanarRegionsList regions)
   {
