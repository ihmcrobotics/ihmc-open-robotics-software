...
public class YoPawPlannerParameters implements PawPlannerParametersBasics
{
   ...
   public YoPawPlannerParameters(PawPlannerParameters parameters, YoVariableRegistry parentRegistry)
   {
      set(parameters);
