...
public enum QuadrupedFootstepPlannerNodeRejectionReason
{
   ...
   STEP_IN_PLACE, STEP_ON_OTHER_FOOT, COULD_NOT_SNAP, COULD_NOT_WIGGLE_INSIDE, SURFACE_NORMAL_TOO_STEEP_TO_SNAP, TOO_MUCH_PENETRATION_AFTER_WIGGLE,
   OBSTACLE_BLOCKING_STEP, OBSTACLE_BLOCKING_BODY, OBSTACLE_HITTING_BODY, AT_CLIFF_BOTTOM;
