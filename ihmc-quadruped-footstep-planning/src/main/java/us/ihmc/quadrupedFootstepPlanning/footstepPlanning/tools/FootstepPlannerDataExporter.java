...
public class FootstepPlannerDataExporter
{
   ...
   private AtomicReference<PlanarRegionsList> planarRegionsState;
   private AtomicReference<String> dataDirectoryPath;

   private AtomicReference<Point3D> startPosition;
   private AtomicReference<Point3D> goalPosition;
   private AtomicReference<Quaternion> startOrientation;
   private AtomicReference<Quaternion> goalOrientation;
   private AtomicReference<Double> timeout;
   private AtomicReference<FootstepPlannerType> plannerType;
