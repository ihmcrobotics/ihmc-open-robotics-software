...
public class SnapBasedNodeTransitionChecker extends FootstepNodeTransitionChecker
{
   ...
   public SnapBasedNodeTransitionChecker(FootstepPlannerParameters parameters, FootstepNodeSnapper snapper)
   {
   ...
   {
      if (footPosition.distance(previousFootPosition) < FootstepNode.gridSizeXY)
         return false;
