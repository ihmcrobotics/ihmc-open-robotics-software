...
public class SkeletonPath
{
   ...
   private Point2D getLocationOfClosestPointOnSegment(int indexOfSegment, Point2D aPoint)
   {
      ...
      ret.setLocation((paramB * (paramB * aPoint.getX() - paramA * aPoint.getY()) - paramA * paramC) / (paramA * paramA + paramB * paramB),
                      (paramA * (-paramB * aPoint.getX() + paramA * aPoint.getY()) - paramB * paramC) / (paramA * paramA + paramB * paramB));
