...
public class EscherFullRobotModelVisualizer
{
   public EscherFullRobotModelVisualizer()
   {
//      EscherRobotInterface robotInterface = new EscherRobotInterface();
//
//
...
//      GeneralizedSDFRobotModel generalizedSDFRobotModel = robotInterface.getGeneralizedSDFRobotModel();
      ...
      EscherRobotModel robotModel = new EscherRobotModel(RobotTarget.SCS, false);
...
//      createNewWindow(graphicsAdapter.createNewViewport(null, true, false).getCanvas());
   ...
   {
      new EscherFullRobotModelVisualizer();
   }
}
