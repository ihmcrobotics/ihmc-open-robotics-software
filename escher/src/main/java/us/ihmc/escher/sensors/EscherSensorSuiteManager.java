...
public class EscherSensorSuiteManager implements DRCSensorSuiteManager
{
   ...
   public void initializePhysicalSensors(URI sensorURI)
   {
      ...
      DRCRobotCameraParameters multisenseLeftEyeCameraParameters = sensorInformation.getCameraParameters(EscherSensorInformation.MULTISENSE_SL_LEFT_CAMERA_ID);
      DRCRobotLidarParameters multisenseLidarParameters = sensorInformation.getLidarParameters(EscherSensorInformation.MULTISENSE_LIDAR_ID);
      DRCRobotPointCloudParameters multisenseStereoParameters = sensorInformation.getPointCloudParameters(EscherSensorInformation.MULTISENSE_STEREO_ID);
