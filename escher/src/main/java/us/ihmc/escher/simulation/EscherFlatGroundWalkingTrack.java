package us.ihmc.escher.simulation;
...
import us.ihmc.escher.EscherRobotModel;
...
public class EscherFlatGroundWalkingTrack
{
...
//      boolean USE_JOYSTICK_CONTROLLER = JoystickUpdater.isJoyStickConnected();
      ...
      DRCRobotModel robotModel = new EscherRobotModel(RobotTarget.SCS, false);
