...
public abstract class QuadrupedToolboxModule
{
                                 ...
                                 DataServerSettings dataServerSettings, int updatePeriodMilliseconds, PubSubImplementation pubSubImplementation)
   {
      ...
      ROS2Tools
            .createCallbackSubscriptionTypeNamed(realtimeRos2Node, ToolboxStateMessage.class, getSubscriberTopicNameGenerator(), s -> receivedPacket(s.takeNextData()));
   ...
   public abstract ROS2TopicName getPublisherTopicNameGenerator();

   public abstract ROS2TopicName getSubscriberTopicNameGenerator();
}
