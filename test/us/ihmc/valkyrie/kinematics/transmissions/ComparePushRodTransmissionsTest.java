...
public class ComparePushRodTransmissionsTest {
    ...
    public void testCompareInefficientToEfficientAnkle() {
        ...
        InefficientPushRodTransmission inefficientPushrodTransmission =
            new InefficientPushRodTransmission(pushRodTransmissionJoint, reflectTop, reflectBottom, topJointFirst,
                registry, yoGraphicsListRegistry);
        EfficientPushRodTransmission efficientPushrodTransmission =
            new EfficientPushRodTransmission(pushRodTransmissionJoint, reflectBottom);

        compareTwoPushRodTransmissionInterfaces(random, epsilon, inefficientPushrodTransmission,
                efficientPushrodTransmission, registry, yoGraphicsListRegistry);
    }
    ...
    public void testCompareInefficientToInterpolatedAnkles() {
        ...
        InterpolatedPushRodTransmission interpolatedPushRodTransmission =
            new InterpolatedPushRodTransmission(ankleNamespace, reflectBottom, compliance);
        InefficientPushRodTransmission inefficientPushrodTransmission =
            new InefficientPushRodTransmission(pushRodTransmissionJoint, reflectTop, reflectBottom, topJointFirst,
                registry, yoGraphicsListRegistry);
        ...
        compareTwoPushRodTransmissionInterfaces(random, epsilon, inefficientPushrodTransmission,
                interpolatedPushRodTransmission, registry, yoGraphicsListRegistry);
    }
    ...
    private void compareTwoPushRodTransmissionInterfaces(Random random, double epsilon,
            PushRodTransmissionInterface pushrodTransmissionA, PushRodTransmissionInterface pushrodTransmissionB,
...
//              force1.set(RandomTools.generateRandomDouble(random, -100.0, 100.0));
                ...
                printIfDebug(force0 + ", " + force1 + ", topJointTorqueA = " + topJointTorqueA.getDoubleValue()
                             + ", bottomJointTorqueA = " + bottomJointTorqueA.getDoubleValue() + ", topJointTorqueB = "
                             + topJointTorqueB.getDoubleValue() + ", tauRollEfficient = "
                             + bottomJointTorqueB.getDoubleValue());
        ...
        for (double topJoint = -1.0; topJoint < 1.0; topJoint = topJoint + increment) {
            for (double bottomJoint = -0.5; bottomJoint < 0.5; bottomJoint = bottomJoint + increment) {
                ...
                printIfDebug("topJointTorque = " + topJointTorque.getDoubleValue() + ", bottomJointTorque = "
                             + bottomJointTorque.getDoubleValue() + ", actuatorForceA0 = " + actuatorForceA0
