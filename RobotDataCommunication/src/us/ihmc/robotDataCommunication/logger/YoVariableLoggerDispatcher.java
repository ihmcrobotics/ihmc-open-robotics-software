...
public class YoVariableLoggerDispatcher
{
         ...
         try
         {
            ...
            else
            {
               try
               {
                  ...
                  try
                  {
                     new YoVariableLogger(request.getLogName(), request.getHost(), YoVariableLogger.defaultPort, options);
   ...
   public static void requestLogSession(String host)
   {
