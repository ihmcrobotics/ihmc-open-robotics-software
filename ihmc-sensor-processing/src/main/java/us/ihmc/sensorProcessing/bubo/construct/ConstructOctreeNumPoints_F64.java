...
/**
 * Creates an octree by adding new cells to the octree only when the number of points in a cell
 * exceeds a specified number. The divider point is always the center of the cube and the same graph
