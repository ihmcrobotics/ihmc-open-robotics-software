...
public class FindAllOfShapeInCloud implements PointCloudShapeFinder
{
   ...
   FastArray<PointVectorNN> prunedList = new FastArray<PointVectorNN>(PointVectorNN.class);
    ...
    */
   public FindAllOfShapeInCloud(ApproximateSurfaceNormals surfaceNormals, RansacMulti<PointVectorNN> ransac, List<ModelManager> modelManagers,
                                List<ModelFitter<Object, PointVectorNN>> fitters, int minimumPoints, int maxShapes, List<CloudShapeTypes> shapeList)
   {
