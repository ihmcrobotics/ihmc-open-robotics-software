 ...
 * </p>
 */
public class YoPID3DGains implements PID3DGainsBasics
{
   ...
   public YoPID3DGains(String suffix, PID3DConfiguration configuration, YoRegistry registry)
   {
      this(suffix, configuration.getGainCoupling(), configuration.isUseIntegrator(), configuration.getGains(), registry);
   }

   public YoPID3DGains(String suffix, GainCoupling gainCoupling, boolean useIntegrator, YoRegistry registry)
   {
      this(suffix, gainCoupling, useIntegrator, null, registry);
   }

   public YoPID3DGains(String suffix, GainCoupling gainCoupling, boolean useIntegrator, PID3DGainsReadOnly gains, YoRegistry registry)
   {
   ...
   @Override
   public YoDouble getMaximumFeedbackProvider()
   {
      return maxFeedback;
   }

   @Override
   public YoDouble getMaximumFeedbackRateProvider()
   {
