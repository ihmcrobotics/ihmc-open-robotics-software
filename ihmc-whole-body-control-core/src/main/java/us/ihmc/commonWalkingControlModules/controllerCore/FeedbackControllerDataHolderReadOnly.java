...
public interface FeedbackControllerDataHolderReadOnly
{
    ...
    * </p>
    *
    * @param positionDataListToPack list used to store the position data available. Modified.
    ...
    * </p>
    *
    * @param vectorDataListToPack list used to store the vector data available. Modified.
    ...
    *                           in {@link Type} are not applicable.
    */
   void getPositionData(RigidBodyReadOnly endEffector, List<FBPoint3D> positionDataListToPack, Type type);
    ...
    *
    * @param endEffector           the end-effector for which the data is requested.
    * @param orientationDataListToPack list used to store the orientation data available. Modified.
    * @param type                  whether the current or desired orientation is requested, the other
    *                              values in {@link Type} are not applicable.
    */
   void getOrientationData(RigidBodyReadOnly endEffector, List<FBQuaternion3D> orientationDataListToPack, Type type);
    ...
    *                         in {@link SpaceData3D}.
    */
   void getVectorData(RigidBodyReadOnly endEffector, List<FBVector3D> vectorDataListToPack, Type type, SpaceData3D space);
