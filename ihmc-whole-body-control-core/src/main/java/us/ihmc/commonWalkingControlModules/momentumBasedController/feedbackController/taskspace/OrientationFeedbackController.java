...
public class OrientationFeedbackController implements FeedbackControllerInterface
{
   ...
   private final FeedbackControllerSettings.FilterVector3D angularVelocityErrorFilter;
                                        ...
                                        YoRegistry parentRegistry)
   {
      ...
      isEnabled = new YoBoolean(FeedbackControllerToolbox.appendIndex(endEffectorName, controllerIndex) + "IsOrientationFBControllerEnabled", fbToolbox.getRegistry());
      isEnabled.set(false);
