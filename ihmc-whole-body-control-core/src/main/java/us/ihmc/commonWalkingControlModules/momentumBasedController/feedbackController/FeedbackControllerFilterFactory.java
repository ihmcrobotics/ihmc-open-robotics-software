...
public class FeedbackControllerFilterFactory
{
    ...
    */
   public static FeedbackControllerSettings.FilterDouble1D createVelocity1DErrorLPFFilter(String jointName, DoubleProvider breakFrequency, double dt, YoRegistry registry)
   {
    ...
    * @return the low-pass filter to apply to the error velocity.
    */
   public static FeedbackControllerSettings.FilterVector3D createAngularVelocityErrorLPFFilter(String endEffectorName, DoubleProvider breakFrequency, double dt, YoRegistry registry)
   {
    ...
    * @return the low-pass filter to apply to the error velocity.
    */
   public static FeedbackControllerSettings.FilterVector3D createLinearVelocityErrorLPFFilter(String endEffectorName, DoubleProvider breakFrequency, double dt, YoRegistry registry)
   {
    ...
    */
   public static FeedbackControllerSettings.FilterDouble1D createVelocity1DErrorHPRLFilter(String jointName, YoHPRLParameters parameters, double dt, YoRegistry registry)
   {
    ...
    * @return the HPRL filter to apply to the error velocity.
    */
   public static FeedbackControllerSettings.FilterVector3D createAngularVelocityErrorHPRLFilter(String endEffectorName, YoHPRLParameters parameters, double dt, YoRegistry registry)
   {
      parameters.setRegistryLazy(registry);
    ...
    * @return the HPRL filter to apply to the error velocity.
    */
   public static FeedbackControllerSettings.FilterVector3D createLinearVelocityErrorHPRLFilter(String endEffectorName, YoHPRLParameters parameters, double dt, YoRegistry registry)
   {
      parameters.setRegistryLazy(registry);
    ...
    */
   public static FeedbackControllerSettings.FilterDouble1D createVelocity1DErrorPIOFilter(String jointName, YoPIOParameters parameters, double dt, YoRegistry registry)
   {
      parameters.setRegistryLazy(registry);
    ...
    * @return the PIO filter to apply to the error velocity.
    */
   public static FeedbackControllerSettings.FilterVector3D createAngularVelocityErrorPIOFilter(String endEffectorName, YoPIOParameters parameters, double dt, YoRegistry registry)
   {
      parameters.setRegistryLazy(registry);
    ...
    * @return the PIO filter to apply to the error velocity.
    */
   public static FeedbackControllerSettings.FilterVector3D createLinearVelocityErrorPIOFilter(String endEffectorName, YoPIOParameters parameters, double dt, YoRegistry registry)
   {
      parameters.setRegistryLazy(registry);
   ...
   private static class YoLPFilterDouble1D implements FeedbackControllerSettings.FilterDouble1D
   {
   ...
   private static class YoHPRLFilterDouble1D implements FeedbackControllerSettings.FilterDouble1D
   {
    ...
    */
   public static class YoPIOFilterDouble1D implements FeedbackControllerSettings.FilterDouble1D
   {
      private final YoBoolean initialize;
   ...
   private static class YoLPFilterVector3D implements FeedbackControllerSettings.FilterVector3D
   {
   ...
   private static class YoHPRLFilterVector3D implements FeedbackControllerSettings.FilterVector3D
   {
      private final YoBoolean initialize;
   ...
   private static class YoPIOFilterVector3D implements FeedbackControllerSettings.FilterVector3D
   {
      private final YoBoolean initialize;
