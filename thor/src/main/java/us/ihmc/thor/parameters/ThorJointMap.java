...
import static us.ihmc.thor.parameters.ThorOrderedJointMap.jointNames;
...
public class ThorJointMap implements DRCRobotJointMap
{
   ...
   private final SpineJointName[] spineJoints = { SpineJointName.SPINE_YAW, SpineJointName.SPINE_PITCH};
   ...
   public ThorJointMap()
   {
      boolean selectedThorVersionHasArms = ThorConfigurationRoot.THOR_WITH_ARMS;
      if (selectedThorVersionHasArms)
      {
      ...
      {
         String[] forcedSideJointNames = ThorOrderedJointMap.forcedSideDependentJointNames.get(robotSide);
         legJointNames.put(forcedSideJointNames[ThorOrderedJointMap.LeftHipYaw], new ImmutablePair<>(robotSide, LegJointName.HIP_YAW));
         legJointNames.put(forcedSideJointNames[ThorOrderedJointMap.LeftHipRoll], new ImmutablePair<>(robotSide, LegJointName.HIP_ROLL));
         legJointNames.put(forcedSideJointNames[ThorOrderedJointMap.LeftHipPitch], new ImmutablePair<>(robotSide, LegJointName.HIP_PITCH));
         legJointNames.put(forcedSideJointNames[ThorOrderedJointMap.LeftKneePitch], new ImmutablePair<>(robotSide, LegJointName.KNEE_PITCH));
         legJointNames.put(forcedSideJointNames[ThorOrderedJointMap.LeftAnklePitch], new ImmutablePair<>(robotSide, LegJointName.ANKLE_PITCH));
         legJointNames.put(forcedSideJointNames[ThorOrderedJointMap.LeftAnkleRoll], new ImmutablePair<>(robotSide, LegJointName.ANKLE_ROLL));

         if (selectedThorVersionHasArms)
         {
            armJointNames.put(forcedSideJointNames[ThorOrderedJointMap.LeftShoulderPitch], new ImmutablePair<>(robotSide, ArmJointName.SHOULDER_PITCH));
            armJointNames.put(forcedSideJointNames[ThorOrderedJointMap.LeftShoulderRoll], new ImmutablePair<>(robotSide, ArmJointName.SHOULDER_ROLL));
            armJointNames.put(forcedSideJointNames[ThorOrderedJointMap.LeftShoulderYaw], new ImmutablePair<>(robotSide, ArmJointName.SHOULDER_YAW));
            armJointNames.put(forcedSideJointNames[ThorOrderedJointMap.LeftElbowPitch], new ImmutablePair<>(robotSide, ArmJointName.ELBOW_PITCH));
            armJointNames.put(forcedSideJointNames[ThorOrderedJointMap.LeftForearmYaw], new ImmutablePair<>(robotSide, ArmJointName.ELBOW_YAW));
            armJointNames.put(forcedSideJointNames[ThorOrderedJointMap.LeftWristPitch], new ImmutablePair<>(robotSide, ArmJointName.FIRST_WRIST_PITCH));
            armJointNames.put(forcedSideJointNames[ThorOrderedJointMap.LeftWristRoll], new ImmutablePair<>(robotSide, ArmJointName.WRIST_ROLL));
         }
      ...
      spineJointNames.put(jointNames[ThorOrderedJointMap.TorsoYaw], SpineJointName.SPINE_YAW);
      spineJointNames.put(jointNames[ThorOrderedJointMap.TorsoPitch], SpineJointName.SPINE_PITCH);

      neckJointNames.put(jointNames[ThorOrderedJointMap.NeckYaw], NeckJointName.DISTAL_NECK_YAW);
      neckJointNames.put(jointNames[ThorOrderedJointMap.NeckPitch], NeckJointName.DISTAL_NECK_PITCH);
   ...
   {
      return ThorPhysicalProperties.soleToAnkleFrameTransforms.get(robotSide);
   }

   @Override
   public RigidBodyTransform getHandControlFrameToWristTransform(RobotSide robotSide)
   {
      if (ThorConfigurationRoot.THOR_WITH_ARMS)
         return ThorPhysicalProperties.handControlFrameToWristTransforms.get(robotSide);
      else
         return null;
   }
