...
import us.ihmc.graphics3DAdapter.input.ModifierKeyHolder;
...
public class JMESelectedListener implements AnalogListener, ActionListener
{
   ...
   public JMESelectedListener(SelectedListenerHolder selectedListenerHolder, KeyListenerHolder keyListenerHolder, MouseListenerHolder mouseListenerHolder,
         HashBiMap<Graphics3DNode, JMEGraphics3DNode> jmeGraphicsNodes, Node rootNode, InputManager inputManager, JMECamera jmeCamera)
   {
      this.jmeGraphicsNodes = jmeGraphicsNodes.inverse();
      this.jmeCamera = jmeCamera;
      this.rootNode = rootNode;
      this.inputManager = inputManager;
      this.selectedListenerHolder = selectedListenerHolder;
      this.keyListenerHolder = keyListenerHolder;
      this.mouseListenerHolder = mouseListenerHolder;
   }
