...
({
   ...
   us.ihmc.graphics3DAdapter.jme.JMEGPULidarParallelSceneGraphTest.class,
   ...
   us.ihmc.graphics3DAdapter.jme.loaders.NormalCalculatorTest.class,
...
public class Graphics3DAdapterAFastTestSuite
{
   ...
   {
      new BambooTestSuiteRunner(Graphics3DAdapterAFastTestSuite.class);
   }
}
