...
public class JMEGraphics3dAdapterBambooJMETestSuite
{
   ...
   {
      String packageName = "us.ihmc.graphics3DAdapter.jme";
      System.out.println(JUnitTestSuiteConstructor.createTestSuite("JMEGraphics3dAdapterBambooTestSuite", packageName));
   }
}
