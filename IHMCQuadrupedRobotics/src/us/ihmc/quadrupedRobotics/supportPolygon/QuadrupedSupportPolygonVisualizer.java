...
//      }
   ...
   public void doControl()
   {
      ...
      {
         boolean successful = supportPolygon.getCenterOfCircleOfRadiusInCornerOfPolygon(RobotQuadrant.HIND_LEFT, miniCircleRadius.getDoubleValue(), centerOfMiniCircle);
