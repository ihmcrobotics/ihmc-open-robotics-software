...
public class CenterOfMassImuBasedRotationalStateUpdater
{
   ...
   public CenterOfMassImuBasedRotationalStateUpdater(FullInverseDynamicsStructure inverseDynamicsStructure, List<? extends IMUSensorReadOnly> imuProcessedOutputs,
