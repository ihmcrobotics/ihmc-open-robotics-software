...
public class QuadrupedXGaitTeleopMode implements QuadrupedTeleopMode
{
   ...
   private final DoubleParameter zRateParameter = parameterFactory.createDouble("zRateParameter", 0.05);
   private final DoubleParameter xStrideMaxParameter = parameterFactory.createDouble("xStrideMax", 0.5);
   private final DoubleParameter yStrideMaxParameter = parameterFactory.createDouble("yStrideMax", 0.5);
