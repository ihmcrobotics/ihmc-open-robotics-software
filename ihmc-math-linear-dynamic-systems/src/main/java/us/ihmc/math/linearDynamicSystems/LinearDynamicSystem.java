...
//       return computeSIMinusAInverseUsingEigenvalueDecomposition();
   ...
   private TransferFunctionMatrix computeSIMinusAInverseUsingEigenvalueDecomposition()
   {
      ...
      {
         TransferFunctionMatrix realModeMatrix = TransferFunctionMatrix.constructTransferFunctionMatrix(realMode);
      ...
      {
         TransferFunctionMatrix complexConjugateModeMatrix = TransferFunctionMatrix.constructTransferFunctionMatrix(complexConjugateMode);
