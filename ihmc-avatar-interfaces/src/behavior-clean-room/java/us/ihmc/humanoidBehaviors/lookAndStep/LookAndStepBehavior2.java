...
import static us.ihmc.humanoidBehaviors.lookAndStep.LookAndStepBehavior2.LookAndStepBehaviorAPI.*;
import static us.ihmc.humanoidBehaviors.lookAndStep.LookAndStepBehavior2.LookAndStepBehaviorState.*;

public class LookAndStepBehavior2 implements BehaviorInterface
{
   public static final BehaviorDefinition DEFINITION = new BehaviorDefinition("Look and Step", LookAndStepBehavior2::new, create());
   ...
   public LookAndStepBehavior2(BehaviorHelper helper)
   {
      this.helper = helper;
