...
public class JoystickBasedSteppingMainUI
{
   ...
   public JoystickBasedSteppingMainUI(Stage primaryStage, Ros2Node ros2Node, FullHumanoidRobotModelFactory fullRobotModelFactory,
         ...
         throws Exception
   {
      ...
      stepGeneratorJavaFXController = new StepGeneratorJavaFXController(messager, walkingControllerParameters, ros2Node, javaFXRobotVisualizer, kickMessenger,
                                                                        punchMessenger, lowLevelMessenger);
