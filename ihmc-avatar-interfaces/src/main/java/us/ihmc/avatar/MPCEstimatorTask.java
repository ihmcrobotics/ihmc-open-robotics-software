...
public class MPCEstimatorTask extends MPCHumanoidRobotControlTask
{
   ...
   protected void updateMasterContext(HumanoidRobotMPCContextData masterContext)
   {
      ...
      masterResolver.resolveHumanoidRobotContextDataEstimator((HumanoidRobotMPCContextData) estimatorThread.getHumanoidRobotContextData(), masterContext);
   ...
   {
      estimatorResolver.resolveHumanoidRobotContextDataScheduler(masterContext, (HumanoidRobotMPCContextData) estimatorThread.getHumanoidRobotContextData());
      estimatorResolver.resolveHumanoidRobotContextDataController(masterContext, (HumanoidRobotMPCContextData) estimatorThread.getHumanoidRobotContextData());
   }
