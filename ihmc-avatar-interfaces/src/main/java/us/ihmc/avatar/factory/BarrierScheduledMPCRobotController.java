...
public class BarrierScheduledMPCRobotController implements DisposableRobotController
{
   ...
   private final List<HumanoidRobotMPCControlTask> tasks;

   public BarrierScheduledMPCRobotController(String name,
                                             List<HumanoidRobotMPCControlTask> tasks,
