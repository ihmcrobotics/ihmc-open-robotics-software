...
public class NewMultiStageFootstepPlanningManager implements PlannerCompletionCallback
{
   ...
   public NewMultiStageFootstepPlanningManager(RobotContactPointParameters<RobotSide> contactPointParameters, FootstepPlannerParameters footstepPlannerParameters,
                                               ...
                                               YoVariableRegistry parentRegistry, YoGraphicsListRegistry graphicsListRegistry, long tickDurationMs)
   {
      ...
      {
         FootstepPlanningStage stepPlanningStage = createNewStepPlanningStage(graphicsListRegistry);
   ...
   private FootstepPlanningStage createNewStepPlanningStage(YoGraphicsListRegistry graphicsListRegistry)
   {
      FootstepPlanningStage footstepPlanningStage = new FootstepPlanningStage(allStepPlanningStages.getCopyForReading().size(), contactPointParameters, footstepPlanningParameters,
                                                              visibilityGraphsParameters, activePlanner, plannerListener, planId, graphicsListRegistry, tickDurationMs);
   ...
   private FootstepPlanningStage spawnNextAvailableFootstepPlanner()
   {
      ...
      { // create a new stage
         stageToReturn = createNewStepPlanningStage(null);
