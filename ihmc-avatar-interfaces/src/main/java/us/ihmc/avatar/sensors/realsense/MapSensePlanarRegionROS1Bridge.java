...
public class MapSensePlanarRegionROS1Bridge
{
   ...
   private final ROS2Publisher<PlanarRegionsListMessage> publisher;
   private final ROS2SyncedBufferedRobotModel syncedRobot;
   private final Timer throttleTimer = new Timer();

   public MapSensePlanarRegionROS1Bridge(DRCRobotModel robotModel, RosMainNode ros1Node, ROS2Node ros2Node)
   {
      ...
      publisher = ros2Node.createPublisher(PerceptionAPI.MAPSENSE_REGIONS);
