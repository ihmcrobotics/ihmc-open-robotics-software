...
public class ClusterTools
{
   ...
   public static List<Point2D> projectPointsVerticallyToPlanarRegionLocal(PlanarRegion planarRegionToProjectOnto,
                                                                                   List<? extends Point2DReadOnly> pointsToProjectInWorld,
                                                                                   RigidBodyTransformReadOnly transformFromWorldToPlanarRegion)
   {
      List<Point2D> extrusionHull = new ArrayList<>();
      for (int i = 0; i < pointsToProjectInWorld.size(); i++)
      {
         ...
         extrusionHull.add(new Point2D(extrudedPointOnHomeRegion));
      }
