...
public class SCS2PerfectOutputWriter implements JointDesiredOutputWriter
{
   ...
   public SCS2PerfectOutputWriter(ControllerInput controllerInput, ControllerOutput controllerOutput, boolean writeBeforeEstimatorTick)
   {
      this(controllerInput, controllerOutput, writeBeforeEstimatorTick, null);
   }

   public SCS2PerfectOutputWriter(ControllerInput controllerInput,
