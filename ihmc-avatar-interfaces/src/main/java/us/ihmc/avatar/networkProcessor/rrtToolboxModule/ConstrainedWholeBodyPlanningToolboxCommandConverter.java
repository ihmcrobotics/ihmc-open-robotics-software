 ...
 *
 */
public class ConstrainedWholeBodyPlanningToolboxCommandConverter implements CommandConversionInterface
{
   ...
   public ConstrainedWholeBodyPlanningToolboxCommandConverter(FullHumanoidRobotModel fullRobotModel)
   {
   ...
   public ConstrainedWholeBodyPlanningToolboxCommandConverter(RigidBody rootBody)
   {
