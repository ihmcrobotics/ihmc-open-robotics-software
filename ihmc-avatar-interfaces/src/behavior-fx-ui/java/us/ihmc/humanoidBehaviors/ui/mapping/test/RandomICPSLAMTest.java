...
public class RandomICPSLAMTest
{
   ...
   @Test
   public void testComputeDistanceForKinematicAssumed()
   {
      String stereoPath = "E:\\Data\\20200108_Normal Walk\\PointCloud\\";
      File pointCloudFile = new File(stereoPath);
      ...
      IhmcSLAMFrame previousFrame = new IhmcSLAMFrame(messages.get(40));
   ...
   @Test
   public void testSourcePointsInFixedOverlappedArea()
   {
      String stereoPath = "E:\\Data\\20200108_Normal Walk\\PointCloud\\";
      File pointCloudFile = new File(stereoPath);
