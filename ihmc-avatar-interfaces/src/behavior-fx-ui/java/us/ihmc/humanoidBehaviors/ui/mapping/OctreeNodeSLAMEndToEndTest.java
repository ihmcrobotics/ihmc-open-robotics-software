...
public class OctreeNodeSLAMEndToEndTest extends Application
{
   ...
   public void start(Stage primaryStage) throws Exception
   {
      ...
      OctreeNodeSLAM slam = new OctreeNodeSLAM(messages.get(0));
      ...
      {
         //stereoVisionPointCloudGraphic.addSingleMesh(messages.get(i), Color.BLACK);
      }
      for (int i = 0; i < slam.gePointCloudMap().size(); i++)
      {
         stereoVisionPointCloudGraphic.addPointsMeshes(slam.gePointCloudMap().get(i), Color.BLUE);
      }
