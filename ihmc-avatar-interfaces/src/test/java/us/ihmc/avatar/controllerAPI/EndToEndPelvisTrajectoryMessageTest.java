...
public abstract class EndToEndPelvisTrajectoryMessageTest implements MultiRobotTestInterface
{
   ...
   public void testSingleWaypointAndWalk() throws Exception
   {
      ...
      success = simulationTestHelper.simulateAndWait(4.0 * robotModel.getControllerDT());
      assertTrue(success);
      ...
      success = simulationTestHelper.simulateAndWait(2.0 + walkingTime);
      assertTrue(success);
   }
   ...
   public void testHeightUsingMultipleWaypoints() throws Exception
   {
      ...
      success = simulationTestHelper.simulateAndWait(pelvisTrajectoryMessage.getSe3Trajectory().getTaskspaceTrajectoryPoints().getLast().getTime() + 1.0);
      assertTrue(success);
   ...
   public void testHeightUsingMultipleWaypointsWhileWalking() throws Exception
   {
      ...
      success = simulationTestHelper.simulateAndWait(3.0 * robotModel.getControllerDT());
      assertTrue(success);
      ...
      success = simulationTestHelper.simulateAndWait(simTime + 3.0);
      assertTrue(success);
   ...
   public void testHeightModeSwitchWhileWalking() throws Exception
   {
      ...
      success = simulationTestHelper.simulateAndWait(simTime + 1.0);
      assertTrue(success);
   ...
   public void testSixDoFMovementsOfPelvis()
   {
      ...
      ReferenceFrame midFeetFrame = simulationTestHelper.getReferenceFrames().getMidFeetZUpFrame();
      MovingReferenceFrame pelvisFrame = simulationTestHelper.getReferenceFrames().getPelvisFrame();
      ...
      success = simulationTestHelper.simulateAndWait(4.0 * getRobotModel().getControllerDT());
      assertTrue(success);
      ...
      success = simulationTestHelper.simulateAndWait(lastMessage.getTime() + 1.0);
      assertTrue(success);
   ...
   public void testMultipleWaypoints() throws Exception
   {
      ...
      expectedTrajectoryPoint.set(fromMessage.getTime(),
                                  ...
                                  fromMessage.getAngularVelocity());
      expectedTrajectoryPoint.applyTransform(fromWorldToMidFeetZUpTransform);
      SE3TrajectoryPoint controllerTrajectoryPoint = findCurrentDesiredTrajectoryPoint(pelvisName, simulationTestHelper, supportFrame);
   ...
   public void testStopAllTrajectory() throws Exception
   {
      ...
      success = simulationTestHelper.simulateAndWait(0.05);
      assertTrue(success);
   ...
   public static SE3TrajectoryPoint findCurrentDesiredTrajectoryPoint(String bodyName, YoVariableHolder yoVariableHolder, ReferenceFrame supportFrame)
   {
      SE3TrajectoryPoint simpleSE3TrajectoryPoint = new SE3TrajectoryPoint();
