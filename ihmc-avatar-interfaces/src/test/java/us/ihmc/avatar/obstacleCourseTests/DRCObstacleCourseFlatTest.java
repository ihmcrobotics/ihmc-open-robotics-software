...
//      simulationTestHelper.createBambooVideo(getSimpleRobotName(), 1);
   ...
   public void testWalkingUpToRampWithLongSteps()
   {
      ...
      FootstepDataListMessage footstepDataList = createFootstepsForWalkingUpToRampOnFlatLongSteps();
   ...
   private FootstepDataListMessage createFootstepsForWalkingUpToRampOnFlatLongSteps()
   {
