...
public abstract class DRCObstacleCourseTrialsTerrainTest implements MultiRobotTestInterface
{
   ...
   public void testTrialsTerrainSlopeScript(double offsetHeight) throws SimulationExceededMaximumTimeException
   {
      ...
      if (offsetHeight != 0.0)
      {
         ...
         drcSimulationTestHelper.publishToController(HumanoidMessageTools.createPelvisHeightTrajectoryMessage(0.5, pelvisPosition.getZ() + offsetHeight));
      }
