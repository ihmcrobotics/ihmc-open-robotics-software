...
public abstract class DRCObstacleCourseRocksTest implements MultiRobotTestInterface
{
   ...
   public void testWalkingOntoRocks()
   {
      ...
      assertTrue(success, "Caught Exception: " + simulationTestHelper.getLastThrownException());
   ...
   {
      Pose3D[] footstepPoses = {new Pose3D(new Point3D(-0.1332474847934586, 2.17798187482979, 0.08940742138400676),
   ...
   {
      Pose3D[] footstepPoses = {new Pose3D(new Point3D(0.5529662090543602, 3.6286983881838646, 0.21590956237843234),
