...
public class ICPBasedPointCloudDriftCorrectionVisualizer
{
   ...
   private final double trajectoryTime = 200.0;
   ...
   private static final int INDEX_FRAME_ONE = 5;
   private static final int INDEX_FRAME_TWO = 6;
...
//            return linearDistance;
   ...
   private final TIntArrayList sourcePointsIndices = new TIntArrayList();
