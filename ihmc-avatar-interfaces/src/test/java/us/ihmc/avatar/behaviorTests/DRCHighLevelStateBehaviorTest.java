...
public abstract class DRCHighLevelStateBehaviorTest implements MultiRobotTestInterface
{
   ...
   {
      testState(HighLevelControllerState.WALKING);
   }
   ...
   {
      testState(HighLevelControllerState.DO_NOTHING_BEHAVIOR);
   ...
   {
      testState(HighLevelControllerState.DIAGNOSTICS);
   }

   private void testState(HighLevelControllerState desiredState) throws SimulationExceededMaximumTimeException
   {
      ...
      HighLevelControllerState actualState = getCurrentHighLevelState();
   ...
   private HighLevelControllerState getCurrentHighLevelState()
   {
