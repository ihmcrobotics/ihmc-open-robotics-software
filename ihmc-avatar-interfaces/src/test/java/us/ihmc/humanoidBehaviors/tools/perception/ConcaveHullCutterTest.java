...
public class ConcaveHullCutterTest
{
   ...
   public void testKeepRightSideOfS()
   {
      ...
      // cut it above a line
      List<ConcaveHull> result = ConcaveHullCutter.cutPolygonToLeftOfLine(concaveSPolygon, yAxis);
...
//      mutationTestFacilitator.addClassesToMutate(ConcaveHullCutter.class, ConvexPolygonTools.class);
//      mutationTestFacilitator.addMethodsToMutate("cutPolygonToLeftOfLine");
//      mutationTestFacilitator.addTestClassesToRun(ConcaveHullCutterTest.class);
