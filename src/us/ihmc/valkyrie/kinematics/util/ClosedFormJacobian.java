...
public class ClosedFormJacobian
{
   ...
   private static final double []rod5vals = new double[]{ 0.0, -0.0215689, -0.04128855, 1.0 };
   private static final double []rod6vals = new double[]{ 0.0, -0.0215689,  0.04128855, 1.0 };
...
//      System.out.println( roll + " " + pitch );
      ...
      DenseMatrix64F dHTM_0_2 = new DenseMatrix64F(4,4);
      DenseMatrix64F dHTM_2_0 = new DenseMatrix64F(4,4);
      ...
      Vector3d unitForceVector5r = new Vector3d(t5FF.get(0)-b5.get(0), t5FF.get(1)-b5.get(1), t5FF.get(2)-b5.get(2));
      Vector3d unitForceVector6r = new Vector3d(t6FF.get(0)-b6.get(0), t6FF.get(1)-b6.get(1), t6FF.get(2)-b6.get(2));
      Vector3d m11v = new Vector3d(); m11v.cross(radius5r, unitForceVector5r); 
      Vector3d m12v = new Vector3d(); m12v.cross(radius6r, unitForceVector6r);
      ...
      Vector3d unitForceVector5p = new Vector3d( t5.get(0)-b5BF.get(0), t5.get(1)-b5BF.get(1), t5.get(2)-b5BF.get(2) );
      Vector3d unitForceVector6p = new Vector3d( t6.get(0)-b6BF.get(0), t6.get(1)-b6BF.get(1), t6.get(2)-b6BF.get(2) );
      Vector3d m21v = new Vector3d(); m21v.cross(radius5p, unitForceVector5p); 
      Vector3d m22v = new Vector3d(); m22v.cross(radius6p, unitForceVector6p);
