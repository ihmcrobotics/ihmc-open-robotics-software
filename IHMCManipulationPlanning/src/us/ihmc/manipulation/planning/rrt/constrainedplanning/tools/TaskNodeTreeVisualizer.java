...
public class TaskNodeTreeVisualizer
{
   ...
   private YoArtifactLineSegment2d createBranch(TaskNode taskNode, int indexOfDimension, String prefix)
   {
      ...
      if (showNormalized)
      {
         nodePoint = new FramePoint2D(ReferenceFrame.getWorldFrame(), taskNode.getNormalizedNodeData(0), taskNode.getNormalizedNodeData(indexOfDimension),
                                      "" + prefix + "_this");
         parentNodePoint = new FramePoint2D(ReferenceFrame.getWorldFrame(), taskNode.getParentNode().getNormalizedNodeData(0),
                                            taskNode.getParentNode().getNormalizedNodeData(indexOfDimension), "" + prefix + "_parent");
      }
      else
      {
         ...
         parentNodePoint = new FramePoint2D(ReferenceFrame.getWorldFrame(), taskNode.getParentNode().getNodeData(0),
                                            taskNode.getParentNode().getNodeData(indexOfDimension), "" + prefix + "_parent");
      }
