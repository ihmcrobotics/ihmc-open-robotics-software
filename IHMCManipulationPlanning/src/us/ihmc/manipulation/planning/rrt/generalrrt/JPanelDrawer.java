...
public class JPanelDrawer extends JPanel
{
   ...
   public void paint(Graphics g)
   {
      ...
      for (int i = 0; i < validNodes.size(); i++)
      {
         ...
         {
            branchFill(g, validNodes.get(i).getNodeData(0), validNodes.get(i).getNodeData(1), validNodes.get(i).getParentNode().getNodeData(0),
                       validNodes.get(i).getParentNode().getNodeData(1), 4);
         }
         else
         {
      ...
      {
         branch(g, pathNodes.get(i - 1).getNodeData(0), pathNodes.get(i - 1).getNodeData(1), pathNodes.get(i).getNodeData(0), pathNodes.get(i).getNodeData(1),
                6);
      }
       ...
       */
      g.setColor(Color.red);
      branch(g, RRTNode2D.boxCenterX + RRTNode2D.boxSizeX * 0.5, RRTNode2D.boxCenterY + RRTNode2D.boxSizeY * 0.5,
             RRTNode2D.boxCenterX + RRTNode2D.boxSizeX * 0.5, RRTNode2D.boxCenterY - RRTNode2D.boxSizeY * 0.5, 2);
      branch(g, RRTNode2D.boxCenterX + RRTNode2D.boxSizeX * 0.5, RRTNode2D.boxCenterY + RRTNode2D.boxSizeY * 0.5,
             RRTNode2D.boxCenterX - RRTNode2D.boxSizeX * 0.5, RRTNode2D.boxCenterY + RRTNode2D.boxSizeY * 0.5, 2);
      branch(g, RRTNode2D.boxCenterX - RRTNode2D.boxSizeX * 0.5, RRTNode2D.boxCenterY - RRTNode2D.boxSizeY * 0.5,
             RRTNode2D.boxCenterX - RRTNode2D.boxSizeX * 0.5, RRTNode2D.boxCenterY + RRTNode2D.boxSizeY * 0.5, 2);
