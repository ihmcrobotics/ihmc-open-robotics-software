...
public class RobotCapsule implements RobotCollisionModelInterface
{
   ...
   public RobotCapsule(SimpleCollisionShapeFactory shapeFactory, OneDoFJoint currentJoint, OneDoFJoint nextJoint, double radius)
   {
   ...
   {        
      ...
      Point3D centerLocation = new Point3D((currentLocation.getX()+nextLocation.getX())/2, (currentLocation.getY()+nextLocation.getY())/2, (currentLocation.getZ()+nextLocation.getZ())/2);
