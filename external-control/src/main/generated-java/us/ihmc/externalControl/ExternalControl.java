...
public class ExternalControl
{
   ...
   public ExternalControl(RigidBodyBasics baseBody, OneDoFJointReadOnly[] joints)
   {
      ...
      externalControlImpl = new ExternalControlWrapper.ExternalControlImpl();
   }

   public void setFootStates(SideDependentList<ReferenceFrame> soleFrames, boolean leftInContact, boolean rightInContact)
   {
      int start = 0;
