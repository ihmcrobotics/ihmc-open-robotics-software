...
public class JerkLimitedYoDouble extends YoDouble
{
   ...
   public JerkLimitedYoDouble(String name, YoRegistry registry, YoDouble maxAcceleration, YoDouble maxJerk, double dt)
   {
      this(name, registry, maxAcceleration, maxJerk, null, null, null, dt);
   }

   public JerkLimitedYoDouble(String name, YoRegistry registry, YoDouble maxAcceleration, YoDouble maxJerk,
