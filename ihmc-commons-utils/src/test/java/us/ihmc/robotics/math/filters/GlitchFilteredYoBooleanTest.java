...
public class GlitchFilteredYoBooleanTest
{
   ...
   {
      GlitchFilteredYoBoolean number1 = new GlitchFilteredYoBoolean("stringInt", new YoRegistry("test"), WINDOW_SIZE);
      GlitchFilteredYoBoolean number2 = new GlitchFilteredYoBoolean("stringYoVariableRegistryInt", registry, WINDOW_SIZE);
      GlitchFilteredYoBoolean number3 = new GlitchFilteredYoBoolean("stringBooleanYoVariableInt", new YoRegistry("test"), yoVariableToFilter, WINDOW_SIZE);
