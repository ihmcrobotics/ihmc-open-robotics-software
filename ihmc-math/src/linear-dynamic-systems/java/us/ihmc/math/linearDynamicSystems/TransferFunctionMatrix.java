   ...
   public static TransferFunctionMatrix constructTransferFunctionMatrix(ComplexConjugateMode complexConjugateMode)
   {
      ...
      for (int i = 0; i < order; i++)
      {
         for (int j = 0; j < order; j++)
         {
            ...
            double[] numeratorCoefficients = new double[] {-2.0 * complexConjugateMode.getEigenvalue().real() * Rij.real() - 2.0 * complexConjugateMode.getEigenvalue().imaginary() * Rij.imaginary(), 2.0 * Rij.real() };
