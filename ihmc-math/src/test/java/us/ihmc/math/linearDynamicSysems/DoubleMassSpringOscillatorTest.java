...
public class DoubleMassSpringOscillatorTest
{
   ...
   public void testDecomposerGotEigenvaluesRight()
   {
      ...
      assertTrue(denominatorPolynomial.epsilonEquals(new Polynomial(false, 1.0, 0.0, 4.0, 0.0, 3.0 ), 1e-7));
      assertTrue(numeratorPolynomial.epsilonEquals(new Polynomial(false, 1.0, 0.0, 2.0), 1e-7));
