...
public class StateSpaceSystemDiscretizerTest
{
   ...
   public void testWithSimpleSpringDamperSystem()
   {
      ...
      EjmlUnitTests.assertEquals(discreteR, continuousR, 1e-7);
      ...
      assertEquals(1.5445857883898253E-5, squaredErrorDiscrete, 1e-7, "Regression Test. Only will be true for certain values. If failing, check changes.");
      assertEquals(0.25136292086153883, squaredErrorDiscreteSimple, 1e-7, "Regression Test. Only will be true for certain values. If failing, check changes.");
