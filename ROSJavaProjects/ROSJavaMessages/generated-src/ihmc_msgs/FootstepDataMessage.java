...
public interface FootstepDataMessage extends org.ros.internal.message.Message {
  ...
  java.util.List<geometry_msgs.Vector3> getPredictedContactPoints();
  void setPredictedContactPoints(java.util.List<geometry_msgs.Vector3> value);
}
