...
public interface AtlasBehaviorWalkFeedback extends org.ros.internal.message.Message {
  ...
  java.util.List<atlas_msgs.AtlasBehaviorStepData> getStepDataSaturated();
  void setStepDataSaturated(java.util.List<atlas_msgs.AtlasBehaviorStepData> value);
}
