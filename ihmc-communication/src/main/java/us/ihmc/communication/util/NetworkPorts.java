...
public class NetworkPorts
{
   ...
   public static final NetworkPorts WHOLE_BODY_TRAJECTORY_TOOLBOX_MODULE_PORT = new NetworkPorts(6028);
   public static final NetworkPorts CONTROLLER_FILTER_MODULE_PORT = new NetworkPorts(6029);
