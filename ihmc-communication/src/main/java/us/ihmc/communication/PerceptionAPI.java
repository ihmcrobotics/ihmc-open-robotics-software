...
public class PerceptionAPI
{
   ...
   public static final ROS2Topic<Empty> REQUEST_YOLO_ICP_ZED = PERCEPTION_MODULE.withSuffix("request_yolo_icp_zed").withType(Empty.class);
   public static final ROS2Topic<Empty> REQUEST_YOLO_ICP_REALSENSE = PERCEPTION_MODULE.withSuffix("request_yolo_icp_realsense").withType(Empty.class);
