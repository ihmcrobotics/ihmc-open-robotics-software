...
public final class PerceptionAPI
{
   ...
   public static final ROS2Topic<GlobalMapTileMessage> GLOBAL_HEIGHT_MAP = PERCEPTION_MODULE.withOutput().withTypeName(GlobalMapTileMessage.class).withSuffix("global_height_map");
