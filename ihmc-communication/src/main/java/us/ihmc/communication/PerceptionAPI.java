...
public class PerceptionAPI
{
   ...
   public static final ROS2Topic<Empty> REQUEST_RAPID_REGIONS = PERCEPTION_MODULE.withSuffix("request_rapid_regions").withType(Empty.class);
   public static final ROS2Topic<Empty> REQUEST_MAPPING = PERCEPTION_MODULE.withSuffix("request_mapping").withType(Empty.class);
