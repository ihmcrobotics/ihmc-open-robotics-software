...
public final class PerceptionAPI
{
   ...
   public static final ROS2Topic<GlobalMapCellMap> GLOBAL_HEIGHT_MAP = PERCEPTION_MODULE.withOutput().withTypeName(GlobalMapCellMap.class).withSuffix("global_height_map");
