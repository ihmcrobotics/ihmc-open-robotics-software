...
public class HandWrenchTrajectoryMessage implements ROS2Message<HandWrenchTrajectoryMessage>
{
   ...
   */
   ...
   /**
      The trajectory information for the force/moment to be achieved by the end-effector.
   */
   private final controller_msgs.WrenchTrajectoryMessage wrench_trajectory_;

   public HandWrenchTrajectoryMessage()
   {
      force_execution_ = (boolean) false;
      robot_side_ = (byte) 255;
      wrench_trajectory_ = new controller_msgs.WrenchTrajectoryMessage();

   }

   public HandWrenchTrajectoryMessage(HandWrenchTrajectoryMessage from)
   {
      this();
      set(from);
   }
   ...
   public controller_msgs.WrenchTrajectoryMessage getWrenchTrajectory()
   {
   ...
   public java.lang.String toString()
   {
      ...
      builder.append(robot_side_);
      builder.append("wrench_trajectory_=");
      builder.append(wrench_trajectory_);
