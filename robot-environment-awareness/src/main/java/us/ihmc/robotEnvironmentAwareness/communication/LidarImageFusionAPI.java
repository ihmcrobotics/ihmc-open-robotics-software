...
public class LidarImageFusionAPI
{
   ...
   @Deprecated
   private static final TypedTopicTheme<Object> CameraPinholeBrown = apiFactory.createTypedTopicTheme("CameraPinholeBrown");
   ...
   @Deprecated
   public static final Topic<Object> CameraIntrinsicParametersState = ModuleCategory.child(Camera).topic(CameraPinholeBrown);
