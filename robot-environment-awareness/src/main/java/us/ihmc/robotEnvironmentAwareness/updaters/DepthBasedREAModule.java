...
public class DepthBasedREAModule
{
   ...
   private DepthBasedREAModule(Messager reaMessager, File configurationFile) throws IOException
   {
   ...
   private void dispatchStereoVisionPointCloudMessage(Subscriber<StereoVisionPointCloudMessage> subscriber)
   {
      ...
      System.out.println("dispatchStereoVisionPointCloudMessage");
   }
   ...
   private void dispatchDepthPointCloudMessage(Subscriber<StereoVisionPointCloudMessage> subscriber)
   {
      ...
      slamModule.handlePointCloud(message);
      System.out.println("dispatchDepthPointCloudMessage");
   }
   ...
   public static DepthBasedREAModule createRemoteModule(String configurationFilePath) throws Exception
   {
      ...
      return new DepthBasedREAModule(server, new File(configurationFilePath));
   }

   public static DepthBasedREAModule createIntraprocessModule(String configurationFilePath) throws Exception
   {
      ...
      return new DepthBasedREAModule(messager, configurationFile);
   }
}
