...
public class PointCloudProjectionHelper
{
   ...
   public static final Object multisenseOnCartIntrinsicParameters = MultisenseInformation.CART.getIntrinsicParameters();
   static
   {
...
//          multisenseOnCartIntrinsicParameters.setCy(260.5);
    ...
    */
   public static void projectMultisensePointCloudOnImage(Point3DBasics point, Point2DBasics pixel, Object param)
   {
   ...
   public static void projectMultisensePointCloudOnImage(Point3DBasics point, Point2DBasics pixel, Object param, int offsetU, int offsetV)
   {
    ...
    */
   public static int[] projectMultisensePointCloudOnImage(Point3DBasics point, Object param, Point3DBasics cameraPosition,
   ...
   public static int[] projectMultisensePointCloudOnImage(Point3DBasics point, Object param)
   {
