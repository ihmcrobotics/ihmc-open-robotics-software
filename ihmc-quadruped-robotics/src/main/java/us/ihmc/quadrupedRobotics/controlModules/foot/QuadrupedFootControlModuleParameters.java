...
public class QuadrupedFootControlModuleParameters
{
   ...
   private final DoubleParameter minimumStepAdjustmentTimeRemaining = new DoubleParameter("minimumStepAdjustmentFractionRemaining", finalRegistry, 0.1);
   private final DoubleParameter fractionThroughSwingForAdjustment = new DoubleParameter("fractionThroughSwingForAdjustment", finalRegistry, 0.7);
