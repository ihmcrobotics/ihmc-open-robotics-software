...
public class QuadrupedJointIntegrator
{
   ...
   public QuadrupedJointIntegrator(OneDoFJointBasics controllerJoint, JointDesiredOutputBasics jointDesiredSetpoints, double controlDT, YoVariableRegistry parentRegistry)
   {
