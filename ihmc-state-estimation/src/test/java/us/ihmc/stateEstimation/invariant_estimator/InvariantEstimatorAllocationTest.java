...
public class InvariantEstimatorAllocationTest
{
   ...
   public void testLieGroupScratchOverloadsAreAllocationFree()
   {
      ...
      Runnable oneTick = () ->
      {
         SEK3_Utils.exp(xi, groupElement, vectorScratch, rotationScratch, matrixScratch);
         SEK3_Utils.adjoint(groupElement, adjoint, rotationScratch, vectorScratch, matrixScratch);
         SEK3_Utils.log(groupElement, recovered, rotationScratch, vectorScratch, matrixScratch);
