...
public class OscillateFeetPerturber implements Controller
{
   ...
   public OscillateFeetPerturber(Robot robot, SideDependentList<String> footNames, double deltaT)
   {
   ...
   private void startSlipping(RobotSide robotSide)
   {
      ...
      nextRotationToSlipEulerAngles.setX(nextRotationToSlipEulerAngles.getX()
            * (2.0 * Math.PI * rotationFreqHzYawPitchRoll[2] * Math.sin(rotationPhaseEuler.getX()) * deltaT));
      nextRotationToSlipEulerAngles.setY(nextRotationToSlipEulerAngles.getY()
            * (2.0 * Math.PI * rotationFreqHzYawPitchRoll[1] * Math.sin(rotationPhaseEuler.getY()) * deltaT));
      nextRotationToSlipEulerAngles.setZ(nextRotationToSlipEulerAngles.getZ()
            * (2.0 * Math.PI * rotationFreqHzYawPitchRoll[0] * Math.sin(rotationPhaseEuler.getZ()) * deltaT));
