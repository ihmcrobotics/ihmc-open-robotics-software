...
public class RobotDefinitionConverter
{
   ...
   public static RobotDescription toRobotDescription(RobotDefinition robotDefinition)
   {
      ...
      for (JointDefinition jointDefinition : robotDefinition.getAllJoints())
      {
         ...
         CrossFourBarJointDefinition fourBarDefinition = (CrossFourBarJointDefinition) jointDefinition;
         CrossFourBarJointDescription fourBarDescription = (CrossFourBarJointDescription) robotDescription.getJointDescription(fourBarDefinition.getName());
   ...
   public static CrossFourBarJointDescription toCrossFourBarJointDescription(CrossFourBarJointDefinition source)
   {
      ...
      CrossFourBarJointDescription output = new CrossFourBarJointDescription(source.getName());
