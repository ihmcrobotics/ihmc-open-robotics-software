...
public class YoVariableClientHelperUpdatedListener implements YoVariablesUpdatedListener
{
   ...
   public YoVariableClientHelperUpdatedListener(YoRegistry parentRegistry)
   {
