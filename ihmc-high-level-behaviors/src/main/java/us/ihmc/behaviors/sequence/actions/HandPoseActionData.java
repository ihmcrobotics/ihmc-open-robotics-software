...
public class HandPoseActionData implements BehaviorActionData
{
   ...
   public void loadFromFile(JsonNode jsonNode)
   {
      ...
      palmFrame.changeParentFrame(referenceFrameLibrary.findFrameByName(jsonNode.get("parentFrame").asText()));
   ...
   {
      palmFrame.changeParentFrame(referenceFrameLibrary.findFrameByName(message.getParentFrame().getString(0)));
