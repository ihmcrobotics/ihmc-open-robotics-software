...
public class BehaviorActionSequence
{
   ...
   public static final ROS2Topic<BodyPartPoseStatusMessage> PELVIS_POSITION_STATUS
         = STATUS_TOPIC.withType(BodyPartPoseStatusMessage.class).withSuffix("pelvis_position_status");
   public static final ROS2Topic<BodyPartPoseStatusMessage> IK_CHEST_POSE_STATUS
         = STATUS_TOPIC.withType(BodyPartPoseStatusMessage.class).withSuffix("ik_chest_pose_status");
