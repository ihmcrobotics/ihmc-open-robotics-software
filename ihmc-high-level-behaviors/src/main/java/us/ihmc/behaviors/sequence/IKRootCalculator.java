...
public class IKRootCalculator
{
    ...
    */
   public void computeRoot(String ui, RobotSide side, int index)
   {
...
//               if (ui.equals("RDX"))
//                  LogTools.info("RDX {} {} - nullCHEST {}", side, index, chestIndex);
//               else
//                  LogTools.info("REAL {} {} - nullCHEST {}", side, index, chestIndex);
//         }
//      }
