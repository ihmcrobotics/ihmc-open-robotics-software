...
public class FootstepPlanActionData implements BehaviorActionData
{
   ...
   public void loadFromFile(JsonNode jsonNode)
   {
      ...
      planFrame.changeParentFrame(referenceFrameLibrary.findFrameByNameOrWorld(jsonNode.get("parentFrame").asText()).get());
   ...
   {
      planFrame.changeParentFrame(referenceFrameLibrary.findFrameByNameOrWorld(message.getParentFrame().getString(0)).get());
