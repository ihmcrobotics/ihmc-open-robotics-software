...
public class WalkActionData implements BehaviorActionData
{
   ...
   public void loadFromFile(JsonNode jsonNode)
   {
      ...
      goalFrame.changeParentFrame(referenceFrameLibrary.findFrameByName(jsonNode.get("parentFrame").asText()));
   ...
   {
      goalFrame.changeParentFrame(referenceFrameLibrary.findFrameByName(message.getParentFrame().getString(0)));
