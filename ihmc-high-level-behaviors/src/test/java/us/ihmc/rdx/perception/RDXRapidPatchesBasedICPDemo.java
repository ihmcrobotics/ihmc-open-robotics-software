...
public class RDXRapidPatchesBasedICPDemo implements RenderableProvider
{
   ...
   public RDXRapidPatchesBasedICPDemo()
   {
      depthHeight = 128;
      depthWidth = 2048;
      ...
      baseUI.launchRDXApplication(new Lwjgl3ApplicationAdapter()
      {
         ...
         public void create()
         {
            ...
            rapidPatchesBasedICP.create(rapidPlanarRegionsExtractor.getPatchImageHeight(), rapidPlanarRegionsExtractor.getPatchImageWidth());
            planarRegionsGraphic = new RDXPlanarRegionsGraphic();
         ...
         public void render()
         {
            if (nativesLoadedActivator.poll())
            {
               ...
               {
                  baseUI.getPrimaryScene().addRenderableProvider(RDXRapidPatchesBasedICPDemo.this, RDXSceneLevel.VIRTUAL);
                  ...
                  updateRapidPatchesBasedICP(true);
               }
   ...
   private void updateRapidPatchesBasedICP(boolean changed)
   {
   }
   ...
   {
      new RDXRapidPatchesBasedICPDemo();
   }
