...
import us.ihmc.perception.gpuHeightMap.RapidHeightMapWithHistoryExtractor;
...
public class RDXRapidHeightMapWithHistoryExtractionDemo
{
   ...
   private final RapidHeightMapWithHistoryExtractor rapidHeightMapUpdater = new RapidHeightMapWithHistoryExtractor();
   ...
   public RDXRapidHeightMapWithHistoryExtractionDemo()
   {
   ...
   {
      new RDXRapidHeightMapWithHistoryExtractionDemo();
   }
}
