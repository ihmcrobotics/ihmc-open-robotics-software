...
public class RDXYOLOv8OpticalFlowDemo
{
   ...
   private OpenCVOpticalFlowProcessor opticalFlowProcessor;
   ...
   public void runStuff()
   {
      ...
      if (opticalFlowProcessor == null)
         opticalFlowProcessor = new OpenCVOpticalFlowProcessor(compressedColorImage);

      if (runYOLONotification.poll())
      {
