...
public class RDXRRTConnectPathPlannerDemo
{
   ...
   private final int[] multiRestartIterations = new int[] {25};
   ...
   public RDXRRTConnectPathPlannerDemo()
   {
      baseUI.launchRDXApplication(new Lwjgl3ApplicationAdapter()
      {
         ...
         {
            baseUI.create();
            planner.setMultiRestartIterations(multiRestartIterations[0]);
            ...
            startGizmo.setCenterSphereToTorusRatio(1.5f);
            ...
            goalGizmo.setCenterSphereToTorusRatio(1.5f);
            ...
            for (int i = 0; i < 5; i++)
            {
               ...
               obstacleGizmo.setCenterSphereToTorusRatio(1.5f);
         ...
         private void renderImGuiWidgets()
         {
            ...
            if (ImGui.sliderInt("Multi-restarts", multiRestartIterations, 1, 50))
               planner.setMultiRestartIterations(multiRestartIterations[0]);
         ...
         private void updatePathModel()
         {
           ...
           pathModel = RDXModelBuilder.buildModelInstance(builder ->
           {
               ...
               for (Point3D point : plannedPath)
               {
                  ...
                  if (previous != null)
                     builder.addLine(previous, point, 0.02, Color.CYAN);
                  previous = point;
               }
            });
         }
