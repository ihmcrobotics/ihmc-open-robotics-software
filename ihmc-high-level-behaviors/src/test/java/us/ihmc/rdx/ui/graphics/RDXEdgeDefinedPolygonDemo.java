...
public class RDXEdgeDefinedPolygonDemo
{
   ...
   private RDXEdgeDefinedPolygonGraphic polygon;
   ...
   public RDXEdgeDefinedPolygonDemo()
   {
      baseUI.launchRDXApplication(new Lwjgl3ApplicationAdapter()
      {
         ...
         public void create()
         {
            ...
            polygon = new RDXEdgeDefinedPolygonGraphic(Color.GREEN, Color.FOREST, 0.5f);
            ...
            Point3D[][] edges = new Point3D[][] {spline1, spline2, spline3, spline4, spline5};
            polygon.generateMesh(edges);
            polygon.update();

            baseUI.getPrimaryScene().addRenderableProvider(polygon);
         }
