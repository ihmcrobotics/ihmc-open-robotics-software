...
import us.ihmc.gdx.ui.GDXImGuiBasedUI2D;
import us.ihmc.gdx.ui.tools.ImGuiLogWidget;
import us.ihmc.tools.string.StringTools;

import java.time.LocalDateTime;

public class GDXImGuiBasedUI2DDemo
{
   private final GDXImGuiBasedUI2D baseUI = new GDXImGuiBasedUI2D(getClass(),
   ...
   public GDXImGuiBasedUI2DDemo()
   {
      baseUI.launchGDXApplication(new Lwjgl3ApplicationAdapter()
      {
         ...
         public void create()
         {
            ...
            baseUI.getImGuiPanelManager().addPanel("Window 1", GDXImGuiBasedUI2DDemo.this::renderWindow1);
            baseUI.getImGuiPanelManager().addPanel("Window 2", GDXImGuiBasedUI2DDemo.this::renderWindow2);
            baseUI.getImGuiPanelManager().addPanel("Window 3", GDXImGuiBasedUI2DDemo.this::renderWindow3);
