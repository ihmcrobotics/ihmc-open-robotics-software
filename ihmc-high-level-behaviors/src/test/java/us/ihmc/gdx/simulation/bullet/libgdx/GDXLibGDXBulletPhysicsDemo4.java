...
public class GDXLibGDXBulletPhysicsDemo4
{
   ...
   public GDXLibGDXBulletPhysicsDemo4()
   {
      Bullet.init();
      ...
      baseUI.launchGDXApplication(new Lwjgl3ApplicationAdapter()
      {
         ...
         public void create()
         {
            ...
            GDXTools.toGDX(groundTransform, groundTransformGDX);
            ...
            for (int i = 0; i < numberOfPolytopes; i++)
            {
               ...
               GDXTools.toGDX(polytopeTransform, polytopeTransformGDX);
   ...
   {
      new GDXLibGDXBulletPhysicsDemo4();
   }  
