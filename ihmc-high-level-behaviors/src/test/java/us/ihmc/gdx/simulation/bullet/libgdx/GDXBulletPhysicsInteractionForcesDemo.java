...
public class GDXBulletPhysicsInteractionForcesDemo
{
   ...
   public GDXBulletPhysicsInteractionForcesDemo()
   {
      ...
      baseUI.launchGDXApplication(new Lwjgl3ApplicationAdapter()
      {
         ...
         private GDXMediumCinderBlockRoughed fallingBlock;
         private GDXMediumCinderBlockRoughed sittingBlock;
...
//                  arrow.transform.translate(pointOnB);
            ...
            ImGuiPanel experimentPanel = new ImGuiPanel("Demo", () ->
            {
               ...
               GDXTools.setTransparency(fallingBlock.getRealisticModelInstance(), blockTransparency.get());
         ...
         public void recreateAndPlace()
         {
            ...
            fallingBlock = new GDXMediumCinderBlockRoughed();
            ...
            sittingBlock = new GDXMediumCinderBlockRoughed();
