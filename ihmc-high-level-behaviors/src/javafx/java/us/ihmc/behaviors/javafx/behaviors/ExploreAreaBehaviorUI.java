...
public class ExploreAreaBehaviorUI extends JavaFXBehaviorUIInterface
{
   ...
   private final Sphere pointToLookAt = JavaFXGraphicPrimitives.createSphere3D(new Point3D(100.0, 100.0, 0.0), Color.RED, 0.15);
   ...
   {
      observationPointsGraphicGroup.add(JavaFXGraphicPrimitives.createSphere3D(observationPosition, Color.AZURE, 0.04));
   }
   ...
   private void displayExplorationBoundingBoxes(ArrayList<BoundingBox3D> boxes)
   {
      ...
      for (int i = 0; i < boxes.size(); i++)
      {
         ...
         boundingBoxGraphics.add(JavaFXGraphicPrimitives.createBoundingBox3D(boxes.get(i), color, 0.02));
      }
   }
   ...
   public void displayPotentialPointsToExplore(ArrayList<Point3D> potentialPointsToExplore)
   {
      ...
      {
         potentialPointsToExploreGraphicGroup.add(JavaFXGraphicPrimitives.createSphere3D(potentialPointToExplore, Color.BLACK, 0.01));
      }
   }
   ...
   {
      planningToPointsGraphicGroup.removeAll();
      planningToPointsGraphicGroup.add(JavaFXGraphicPrimitives.createSphereWithArrow3D(planningToPosition, Color.BLUEVIOLET, 0.1));
   }
