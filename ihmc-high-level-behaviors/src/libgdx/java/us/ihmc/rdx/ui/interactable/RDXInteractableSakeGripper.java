...
public class RDXInteractableSakeGripper implements RDXInteractableAffordanceTemplateHand
{
   ...
   static
   {
      ...
      EuclidCoreTools.setYawPitchRollDegrees(FINGERS_TO_PALM_OPEN[1].getRotation(), 180.0, 0.0, 0.0);
   ...
   static
   {
      EuclidCoreTools.setYawPitchRollDegrees(FINGERS_TO_PALM_HALF_CLOSE[0].getRotation(), 0.0, 0.0, -65.0);
      FINGERS_TO_PALM_HALF_CLOSE[0].getTranslation().set(0.0, 0.03, 0.0);

      EuclidCoreTools.setYawPitchRollDegrees(FINGERS_TO_PALM_HALF_CLOSE[1].getRotation(), 180.0, 0.0, -65.0);
   ...
   static
   {
      EuclidCoreTools.setYawPitchRollDegrees(FINGERS_TO_PALM_CLOSE[0].getRotation(), 0.0, 0.0, -100.0);
      FINGERS_TO_PALM_CLOSE[0].getTranslation().set(0.0, 0.03, 0.0);

      EuclidCoreTools.setYawPitchRollDegrees(FINGERS_TO_PALM_CLOSE[1].getRotation(), 180.0, 0.0, -100.0);
   ...
   static
   {
      EuclidCoreTools.setYawPitchRollDegrees(FINGERS_TO_PALM_CRUSH[0].getRotation(), 0.0, 0.0, -106.0);
      FINGERS_TO_PALM_CRUSH[0].getTranslation().set(0.0, 0.03, 0.0);

      EuclidCoreTools.setYawPitchRollDegrees(FINGERS_TO_PALM_CRUSH[1].getRotation(), 180.0, 0.0, -106.0);
   ...
   {
      EuclidCoreTools.setYawPitchRollDegrees(fingersTransforms[0].getRotation(),
                                             fingersTransforms[0].getRotation().getYaw(),
                                             fingersTransforms[0].getRotation().getPitch(),
                                             closure);
      EuclidCoreTools.setYawPitchRollDegrees(fingersTransforms[1].getRotation(),
