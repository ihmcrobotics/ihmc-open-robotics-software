...
public class RDXROS2InteractableSensors
{
   ...
   {
      RDXInteractableOuster interactableOuster = new RDXInteractableOuster(baseUI.getPrimary3DPanel(),
      ...
      interactableOuster.getInteractableFrameModel()
                        .addRemoteTuning(ros2,
                                         ...
                                         syncedRobot.getRobotModel().getSensorInformation().getOusterLidarTransform());
      robotVisualizer.attachInteractableFrameModel(interactableOuster.getInteractableFrameModel());
   }
   ...
   {
      RDXInteractableBlackflyFujinon interactableBlackflyLeftFujinon
            = new RDXInteractableBlackflyFujinon(baseUI.getPrimary3DPanel(),
      ...
      interactableBlackflyLeftFujinon.getInteractableFrameModel()
                                     .addRemoteTuning(ros2,
                                                      ...
                                                      syncedRobot.getRobotModel().getSensorInformation().getSituationalAwarenessCameraTransform(RobotSide.LEFT));
      robotVisualizer.attachInteractableFrameModel(interactableBlackflyLeftFujinon.getInteractableFrameModel());

      RDXInteractableBlackflyFujinon interactableBlackflyRightFujinon
            = new RDXInteractableBlackflyFujinon(baseUI.getPrimary3DPanel(),
      ...
      interactableBlackflyRightFujinon.getInteractableFrameModel()
                                      .addRemoteTuning(ros2,
                                                       ...
                                                       syncedRobot.getRobotModel().getSensorInformation().getSituationalAwarenessCameraTransform(RobotSide.RIGHT));
      robotVisualizer.attachInteractableFrameModel(interactableBlackflyRightFujinon.getInteractableFrameModel());
   }
