...
import us.ihmc.rdx.GDXPointCloudRenderer;
import us.ihmc.rdx.imgui.ImGuiPlot;
import us.ihmc.rdx.imgui.ImGuiUniqueLabelMap;
import us.ihmc.rdx.ui.visualizers.ImGuiFrequencyPlot;
import us.ihmc.rdx.ui.visualizers.ImGuiGDXVisualizer;
...
public class GDXROS2PointCloudMapVisualizer extends ImGuiGDXVisualizer implements RenderableProvider
{
   ...
   private final ArrayList<GDXPointCloudRenderer> pointCloudRenderers = new ArrayList<>();
   ...
   public GDXROS2PointCloudMapVisualizer(String title, ROS2Node ros2Node, ROS2Topic<?> topic, ROS2SyncedRobotModel syncedRobot)
   {
      this(title, ros2Node, topic, syncedRobot, 500000);
   }

   public GDXROS2PointCloudMapVisualizer(String title, ROS2Node ros2Node, ROS2Topic<?> topic, ROS2SyncedRobotModel syncedRobot, int pointsPerSegment)
   {
      super(title);
