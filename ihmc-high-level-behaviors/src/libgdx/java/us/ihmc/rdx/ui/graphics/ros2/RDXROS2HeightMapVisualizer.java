...
public class RDXROS2HeightMapVisualizer extends RDXROS2MultiTopicVisualizer
{
   ...
   public RDXROS2HeightMapVisualizer(String title, @NotNull HeightMapParameters heightMapParameters)
   {
      ...
      int croppedCenterIndex = HeightMapTools.computeCenterIndex(heightMapParameters.getPublishedWidthInMeters(), heightMapParameters.getCellSizeInMeters());
   ...
   {
      this.ros2 = ros2;
      ros2.subscribeViaCallback(PerceptionAPI.HEIGHT_MAP_LOCAL, this::acceptImageMessage);
      ...
      executorService.clearQueueAndExecute(() ->
                                           {
                                              ...
                                              if (latestHeightMapData == null)
                                              {
                                                 latestHeightMapData = new HeightMapData(heightMapParameters.getCellSizeInMeters(),
                                                                                         heightMapParameters.getPublishedWidthInMeters(),
                                              ...
                                              PerceptionMessageTools.convertToHeightMapData(heightMapImage,
                                                                                            ...
                                                                                            (float) heightMapParameters.getPublishedWidthInMeters(),
