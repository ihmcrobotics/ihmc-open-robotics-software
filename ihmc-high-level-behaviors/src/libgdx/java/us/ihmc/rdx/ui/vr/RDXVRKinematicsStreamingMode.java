...
public class RDXVRKinematicsStreamingMode
{
   ...
   private final RDXVRSharedControl sharedControlAssistant = new RDXVRSharedControl(kinematicsRecorder.isReplayingEnabled(),kinematicsRecorder.isRecordingEnabled());
