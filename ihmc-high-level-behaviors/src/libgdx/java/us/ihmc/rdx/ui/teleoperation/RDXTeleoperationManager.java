...
import us.ihmc.rdx.ui.teleoperation.walking.RDXWalkingManager;
...
public class RDXTeleoperationManager extends ImGuiPanel
{
                                  ...
                                  YoVariableClientHelper yoVariableClientHelper)
   {
      ...
      walkingManager = new RDXWalkingManager(robotModel, communicationHelper, syncedRobot, teleoperationParameters, ros2Helper);
