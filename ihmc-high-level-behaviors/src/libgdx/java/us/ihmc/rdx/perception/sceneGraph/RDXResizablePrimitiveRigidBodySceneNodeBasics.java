 ...
 */
public class RDXResizablePrimitiveRigidBodySceneNodeBasics
{
   ...
   private final PrimitiveRigidBodySceneNode resizableRigidBodySceneNode;
   ...
   public RDXResizablePrimitiveRigidBodySceneNodeBasics(PrimitiveRigidBodySceneNode primitiveRigidBodySceneNode, RDX3DPanel panel3D)
   {
      this.resizableRigidBodySceneNode = primitiveRigidBodySceneNode;
      ...
      switch (primitiveRigidBodySceneNode.getShape())
      {
         ...
         case PYRAMID -> modelInstance = new RDXModelInstance(RDXModelBuilder.createPyramid(DEFAULT_DIMENSION, DEFAULT_DIMENSION, DEFAULT_DIMENSION, Color.WHITE));
         ...
         case SPHERE -> modelInstance = new RDXModelInstance(RDXModelBuilder.createSphere(DEFAULT_DIMENSION, Color.WHITE));
         case ELLIPSOID -> modelInstance = new RDXModelInstance(RDXModelBuilder.createTorus(DEFAULT_DIMENSION, DEFAULT_DIMENSION, DEFAULT_DIMENSION, DEFAULT_DIMENSION, Color.WHITE));
         case TORUS -> modelInstance = new RDXModelInstance(RDXModelBuilder.createEllipsoid(DEFAULT_DIMENSION, DEFAULT_DIMENSION, DEFAULT_DIMENSION, Color.WHITE));
      }
   ...
   public void update(SceneGraphModificationQueue modificationQueue)
   {
      ...
      {
         resizableRigidBodySceneNode.setTrackInitialParent(trackDetectedPoseChanged.read(), modificationQueue);
      ...
      if (offsetPoseGizmo.getPoseGizmo().getGizmoFrame() != resizableRigidBodySceneNode.getNodeFrame())
         offsetPoseGizmo.getPoseGizmo().setGizmoFrame(resizableRigidBodySceneNode.getNodeFrame());

      if (offsetPoseGizmo.getPoseGizmo().getGizmoModifiedByUser().poll())
      {
         resizableRigidBodySceneNode.freezeFromModification();
      }

      nodePose.setToZero(resizableRigidBodySceneNode.getNodeFrame());
      ...
      if (resizableRigidBodySceneNode.getTrackingInitialParent())
         initialParentName = resizableRigidBodySceneNode.getNodeFrame().getParent().getName();
   }
   ...
   public void renderImGuiWidgets()
   {
      ...
      ImGui.sameLine();
      ImGui.text(" Parent: " + resizableRigidBodySceneNode.getNodeFrame().getParent().getName());
...
//      }
      ...
      {
         resizableRigidBodySceneNode.clearOffset();
         resizableRigidBodySceneNode.freezeFromModification();
      }
   }
