...
public class RDXBookObject extends RDXEnvironmentObject
{
   public static final String NAME = "Book";
   public static final RDXEnvironmentObjectFactory FACTORY = new RDXEnvironmentObjectFactory(NAME, RDXBookObject.class);

   public RDXBookObject()
   {
      super(NAME, FACTORY);
      Model realisticModel = RDXModelLoader.load("environmentObjects/book/book.g3dj");
