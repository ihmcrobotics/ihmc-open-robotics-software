...
public class RDXMugObject extends RDXEnvironmentObject
{
   public static final String NAME = "Mug";
   public static final RDXEnvironmentObjectFactory FACTORY = new RDXEnvironmentObjectFactory(NAME, RDXMugObject.class);

   public RDXMugObject()
   {
      super(NAME, FACTORY);
      Model realisticModel = RDXModelLoader.load("environmentObjects/mug/mug.g3dj");
