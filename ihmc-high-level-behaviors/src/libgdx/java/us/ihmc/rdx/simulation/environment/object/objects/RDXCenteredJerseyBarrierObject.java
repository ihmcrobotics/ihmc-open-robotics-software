...
public class RDXCenteredJerseyBarrierObject extends RDXEnvironmentObject
{
   public static final String NAME = "Barrier";
   public static final RDXEnvironmentObjectFactory FACTORY = new RDXEnvironmentObjectFactory(NAME, RDXCenteredJerseyBarrierObject.class);

   public RDXCenteredJerseyBarrierObject()
   {
      super(NAME, FACTORY);
