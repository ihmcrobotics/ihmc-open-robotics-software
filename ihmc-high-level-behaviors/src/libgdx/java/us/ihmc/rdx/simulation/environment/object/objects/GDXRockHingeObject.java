...
public class GDXRockHingeObject extends GDXEnvironmentObject
{
   ...
   public GDXRockHingeObject()
   {
      super(NAME, FACTORY);

      rockParentObject = new GDXRockObject(40, 0.5, 0.3, 0f, 8121);
      rockChildObject = new GDXRockObject(40, 0.5, 0.3, 900f, 5214);
   }
