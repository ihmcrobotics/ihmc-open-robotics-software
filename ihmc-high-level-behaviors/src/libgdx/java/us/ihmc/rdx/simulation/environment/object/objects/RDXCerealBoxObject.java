...
public class RDXCerealBoxObject extends RDXEnvironmentObject
{
   public static final String NAME = "CerealBox";
   public static final RDXEnvironmentObjectFactory FACTORY = new RDXEnvironmentObjectFactory(NAME, RDXCerealBoxObject.class);

   public RDXCerealBoxObject()
   {
      super(NAME, FACTORY);
      Model realisticModel = RDXModelLoader.load("environmentObjects/cereal/cereal.g3dj");
