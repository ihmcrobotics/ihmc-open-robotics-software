...
public class RDXCanObject extends RDXEnvironmentObject
{
   public static final String NAME = "CanOfSoup";
   public static final RDXEnvironmentObjectFactory FACTORY = new RDXEnvironmentObjectFactory(NAME, RDXCanObject.class);

   public RDXCanObject()
   {
      super(NAME, FACTORY);
      Model realisticModel = RDXModelLoader.load("environmentObjects/canOfSoup/CanOfSoup.g3dj");
