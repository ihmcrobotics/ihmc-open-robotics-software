...
import us.ihmc.rdx.simulation.environment.object.GDXEnvironmentObjectLibrary;
import us.ihmc.rdx.simulation.environment.object.objects.GDXDirectionalLightObject;
import us.ihmc.rdx.simulation.environment.object.objects.GDXPointLightObject;
...
public class GDXEnvironmentBuilder extends ImGuiPanel
{
   ...
   public GDXEnvironmentBuilder(GDX3DPanel panel3D)
   {
      super(WINDOW_NAME);
