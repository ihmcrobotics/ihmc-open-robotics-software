...
public class RDXSimulatedSensorFactory
{
   ...
   public static RDXHighLevelDepthSensorSimulator createBlackflyFisheye(ROS2SyncedRobotModel syncedRobot, ReferenceFrame blackflyFrame, RobotSide side)
   {
   ...
   public static RDXHighLevelDepthSensorSimulator createBlackflyFisheye(ReferenceFrame sensorFrame, LongSupplier timeSupplier, RobotSide side)
   {
      ...
      RDXHighLevelDepthSensorSimulator highLevelDepthSensorSimulator = new RDXHighLevelDepthSensorSimulator(baseName,
                                                                                                            sensorFrame,
                                                                                                            timeSupplier,
                                                                                                            verticalFOV,
                                                                                                            imageWidth,
