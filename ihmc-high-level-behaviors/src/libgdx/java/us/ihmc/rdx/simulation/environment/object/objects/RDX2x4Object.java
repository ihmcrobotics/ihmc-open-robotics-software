...
public class RDX2x4Object extends RDXEnvironmentObject
{
   public static final String NAME = "PieceOfWood";
   public static final RDXEnvironmentObjectFactory FACTORY = new RDXEnvironmentObjectFactory(NAME, RDX2x4Object.class);

   public RDX2x4Object()
   {
      super(NAME, FACTORY);
      Model realisticModel = RDXModelLoader.load("environmentObjects/debris/2x4.g3dj");
