...
public class GDXSCS2SimpleObject
{
   ...
   protected GDXSCS2EnvironmentObjectFactory factory;
   protected Model realisticModel;
   protected GDXModelInstance realisticModelInstance;
   protected GDXModelInstance collisionModelInstance;
   ...
   public GDXSCS2SimpleObject(String titleCasedName, GDXSCS2EnvironmentObjectFactory factory)
   {
   ...
   public GDXSCS2SimpleObject(String titleCasedName)
   {
      this.titleCasedName = titleCasedName;
      pascalCasedName = FormattingTools.titleToKebabCase(titleCasedName);
   ...
   public GDXSCS2EnvironmentObjectFactory getFactory()
   {
      return factory;
   }
