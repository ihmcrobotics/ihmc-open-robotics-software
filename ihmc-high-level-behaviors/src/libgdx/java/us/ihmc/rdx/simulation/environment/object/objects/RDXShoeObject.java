...
public class RDXShoeObject extends RDXEnvironmentObject
{
   public static final String NAME = "Shoe";
   public static final RDXEnvironmentObjectFactory FACTORY = new RDXEnvironmentObjectFactory(NAME, RDXShoeObject.class);

   public RDXShoeObject()
   {
      super(NAME, FACTORY);
      Model realisticModel = RDXModelLoader.load("environmentObjects/shoe/shoe.g3dj");
