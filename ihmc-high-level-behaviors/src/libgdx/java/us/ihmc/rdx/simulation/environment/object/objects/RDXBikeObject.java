...
public class RDXBikeObject extends RDXEnvironmentObject
{
   public static final String NAME = "Bike";
   public static final RDXEnvironmentObjectFactory FACTORY = new RDXEnvironmentObjectFactory(NAME, RDXBikeObject.class);

   public RDXBikeObject()
   {
      super(NAME, FACTORY);
      Model realisticModel = RDXModelLoader.load("environmentObjects/bike/bike.g3dj");
