...
import us.ihmc.rdx.simulation.environment.object.GDXEnvironmentObjectFactory;
...
public class GDXRockObject extends GDXEnvironmentObject
{
   public static final String NAME = "Rock";
   public static final GDXEnvironmentObjectFactory FACTORY = new GDXEnvironmentObjectFactory(NAME, GDXRockObject.class);

   public GDXRockObject()
   {
      super(NAME, FACTORY);
   ...
   public GDXRockObject(int pointsPerRock, double rockBoundingBoxWidth, double maxRockCentroidHeight, float mass, long randomNumber)
   {
      super(NAME, FACTORY);
   ...
   private void CreateRockObject(int pointsPerRock, double rockBoundingBoxWidth, double maxRockCentroidHeight, float mass, long randomNumber)
   {
      ...
      {
         Color color = GDXTools.toGDX(YoAppearance.LightBlue());
