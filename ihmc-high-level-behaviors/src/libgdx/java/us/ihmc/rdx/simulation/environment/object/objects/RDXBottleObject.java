...
public class RDXBottleObject extends RDXEnvironmentObject
{
   public static final String NAME = "Bottle";
   public static final RDXEnvironmentObjectFactory FACTORY = new RDXEnvironmentObjectFactory(NAME, RDXBottleObject.class);
