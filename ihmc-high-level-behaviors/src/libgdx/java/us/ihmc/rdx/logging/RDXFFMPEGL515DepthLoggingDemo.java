   ...
   public RDXFFMPEGL515DepthLoggingDemo()
   {
      baseUI.launchRDXApplication(new Lwjgl3ApplicationAdapter()
      {
         ...
         public void create()
         {
            ...
            baseUI.getPrimary3DPanel().addImGui3DViewInputProcessor(this, robotInteractableReferenceFrame::process3DViewInput);
            ...
            baseUI.getPrimary3DPanel().addImGui3DViewPickCalculator(this, l515PoseGizmo::calculate3DViewPick);
            baseUI.getPrimary3DPanel().addImGui3DViewInputProcessor(this, l515PoseGizmo::process3DViewInput);
