...
public class RDXFFMPEGHDF5LoggingDemo
{
   ...
   public RDXFFMPEGHDF5LoggingDemo()
   {
      baseUI.launchRDXApplication(new Lwjgl3ApplicationAdapter()
      {
         ...
         public void create()
         {
            ...
            ffmpegLoggerDemoHelper.setLoggerClass(FFMPEGHDF5Logger.class);
