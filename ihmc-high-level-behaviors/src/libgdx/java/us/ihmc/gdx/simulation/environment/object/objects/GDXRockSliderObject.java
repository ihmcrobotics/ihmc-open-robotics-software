...
public class GDXRockSliderObject extends GDXEnvironmentObject
{
   ...
   private final GDXRockObject rockParentObject;
   private final GDXRockObject rockChildObject;
   private final GDXRockObject rockSliderObject;
   private btSliderConstraint rockSliderConstraint;

   public GDXRockSliderObject()
   {
      super(NAME, FACTORY);

      rockParentObject = new GDXRockObject(40, 0.5, 0.3, 0f, 4215);
      rockChildObject = new GDXRockObject(31, 0.5, 0.3, 60f, 487);
      rockSliderObject = new GDXRockObject(31, 0.5, 0.3, 150f, 521);
   }
