 ...
 */
public class GDXSCS2EnvironmentObject extends GDXSCS2SimpleObject
{
   ...
   public GDXSCS2EnvironmentObject(String titleCasedName, GDXSCS2EnvironmentObjectFactory factory)
   {
   ...
   public GDXSCS2EnvironmentObject duplicate()
   {
