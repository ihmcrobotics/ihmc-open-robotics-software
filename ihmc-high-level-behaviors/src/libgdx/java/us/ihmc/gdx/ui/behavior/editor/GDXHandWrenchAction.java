...
public class GDXHandWrenchAction implements GDXBehaviorAction
{
   ...
   public void performAction()
   {
      ...
      handWrenchTrajectoryMessage.getWrenchTrajectory().getWrenchTrajectoryPoints().add()
                                 .set(HumanoidMessageTools.createWrenchTrajectoryPointMessage(time0, torque0, force0));
      ...
      handWrenchTrajectoryMessage.getWrenchTrajectory().getWrenchTrajectoryPoints().add()
                                 .set(HumanoidMessageTools.createWrenchTrajectoryPointMessage(time1, torque1, force1));
