...
// TODO: We'll need a camera transform to set those colors to the right ouster
// points fusedOut is 10 floats: X,Y,Z,R,G,B,A,0.01,1.0,0.0
__kernel void projectZED2ToOusterPoints(__global unsigned char *ousterIn,
                                        __global unsigned char *zed2In,
