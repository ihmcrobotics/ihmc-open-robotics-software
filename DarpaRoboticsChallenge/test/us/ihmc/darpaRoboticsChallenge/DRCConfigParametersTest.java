...
public class DRCConfigParametersTest
{
   ...
   public void test()
   {
      ...
      assertTrue("Do not add parameters to DRCConfigParameters.", DRCConfigParameters.class.getFields().length <= 21);
      assertTrue("Do not add parameters to DRCLocalConfigParameters.", DRCLocalConfigParameters.class.getFields().length <= 5);
   }
