...
public abstract class PointCloudDataReceiverTest implements MultiRobotTestInterface
{
   ...
   public void testIsReceivingScansAnd95PercentOfPointsAreCorrect() throws SimulationExceededMaximumTimeException
   {
      ...
      testHelper = new DRCSimulationTestHelper(commonAvatarEnvironmentInterface, getClass().getSimpleName(), null, startingLocation, simulationTestingParameters, getRobotModel(), drcNetworkModuleParameters, null, null);
