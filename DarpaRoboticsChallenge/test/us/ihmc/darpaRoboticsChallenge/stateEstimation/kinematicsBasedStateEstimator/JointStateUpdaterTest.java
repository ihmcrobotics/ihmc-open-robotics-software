...
public class JointStateUpdaterTest
{
   ...
   private static SensorFilterParameters createParametersForNoFiltering()
   {
      ...
      SensorFilterParameters sensorFilterParameters = new SensorFilterParameters(Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY, updateDT);
