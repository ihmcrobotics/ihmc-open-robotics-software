...
import us.ihmc.humanoidRobotics.footstep.footstepGenerator.overheadPath.TurnInPlaceFootstepOverheadPath;
import us.ihmc.humanoidRobotics.footstep.footstepGenerator.overheadPath.TurnStraightTurnFootstepOverheadPath;
...
public class PathToFootstepGeneratorTest
{
   ...
   private void testLastFootstep(FramePose2d endPoint, FootstepData endFootstep, double horizontalDistance){
      ...
      double angleError = Math.abs(AngleTools.computeAngleDifferenceMinusPiToPi(yaw, RotationTools.computeYaw(endFootstep.getOrientation())));
