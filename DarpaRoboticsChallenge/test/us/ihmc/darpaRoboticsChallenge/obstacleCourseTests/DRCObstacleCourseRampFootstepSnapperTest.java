...
import us.ihmc.ihmcPerception.footstepSnapper.BasicFootstepMask;
import us.ihmc.ihmcPerception.footstepSnapper.FootstepSnappingParameters;
import us.ihmc.ihmcPerception.footstepSnapper.GenericFootstepSnappingParameters;
import us.ihmc.ihmcPerception.footstepSnapper.SimpleFootstepSnapper;
...
public abstract class DRCObstacleCourseRampFootstepSnapperTest implements MultiRobotTestInterface
{
   ...
   private void doUpRampTest() throws SimulationExceededMaximumTimeException
   {
      ...
      SDFFullRobotModel fullRobotModel = drcSimulationTestHelper.getDRCSimulationFactory().getThreadDataSynchronizer().getControllerFullRobotModel();
      ...
      us.ihmc.graphics3DAdapter.HeightMap inputHeightMap = drcSimulationTestHelper.getTestEnviroment().getTerrainObject3D().getHeightMapIfAvailable();
