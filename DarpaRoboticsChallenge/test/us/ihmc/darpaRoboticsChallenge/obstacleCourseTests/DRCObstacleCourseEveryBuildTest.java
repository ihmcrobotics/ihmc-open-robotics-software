...
public abstract class DRCObstacleCourseEveryBuildTest implements MultiRobotTestInterface
{
   ...
   public void testWalkingUpToRampWithLongSteps() throws SimulationExceededMaximumTimeException
   {
      ...
      drcSimulationTestHelper = new DRCSimulationTestHelper(flatGround, "DRCWalkingUpToRampLongStepsTest", "", selectedLocation, checkNothingChanged, simulationConstructionSetParameters, createMovie, getRobotModel());
