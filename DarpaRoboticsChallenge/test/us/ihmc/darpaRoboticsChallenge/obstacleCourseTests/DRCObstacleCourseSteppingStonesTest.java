...
public class DRCObstacleCourseSteppingStonesTest
{
   ...
   public void testWalkingOverEasySteppingStones() throws SimulationExceededMaximumTimeException
   {
      ...
      drcSimulationTestHelper = new DRCSimulationTestHelper("DRCWalkingEasySteppingStonesTest", "", selectedLocation, checkNothingChanged, showGUI, createMovie, robotModel);
