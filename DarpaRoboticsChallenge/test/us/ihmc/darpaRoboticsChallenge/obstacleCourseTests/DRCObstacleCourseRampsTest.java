...
public class DRCObstacleCourseRampsTest
{
   ...
   public void testWalkingDownRampWithMediumSteps() throws SimulationExceededMaximumTimeException
   {
      ...
      drcSimulationTestHelper = new DRCSimulationTestHelper("DRCWalkingDownRampWithMediumSteps", "", selectedLocation, selectedEnvironment, checkNothingChanged, createMovie);
   ...
   public void testWalkingUpRampWithShortStepsALittleTooHigh() throws SimulationExceededMaximumTimeException
   {
      ...
      Vector3d maxLocationCorruption = new Vector3d(0.0, 0.0, 0.06);
   ...
   private void doUpRampTest(FootstepDataListCorruptor footstepDataListCorruptor, StepLength stepLength) throws SimulationExceededMaximumTimeException
   {
      ...
      DRCEnvironmentModel selectedEnvironment = DRCEnvironmentModel.OBSTACLE_COURSE;
      drcSimulationTestHelper = new DRCSimulationTestHelper("DRCWalkingUpRampTest", "", selectedLocation, selectedEnvironment, checkNothingChanged, createMovie);
