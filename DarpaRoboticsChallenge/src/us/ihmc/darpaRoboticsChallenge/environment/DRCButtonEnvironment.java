...
public class DRCButtonEnvironment implements CommonAvatarEnvironmentInterface
{
   ...
   private final int NUMBER_OF_CONTACT_POINTS = 50;
	...
	public DRCButtonEnvironment(ArrayList<Point3d> buttonLocations, ArrayList<Vector3d> pushVectors)
	{
