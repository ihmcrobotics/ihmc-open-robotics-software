...
public class MultiContactDRCRobotInitialSetup implements RobotInitialSetup<SDFRobot>
{
   ...
   {
      // right arm
      robot.getPinJoint("r_arm_usy").setQ(0.3);
      robot.getPinJoint("r_arm_shx").setQ(1.0);
      robot.getPinJoint("r_arm_ely").setQ(1.0);
      robot.getPinJoint("r_arm_elx").setQ(-1.6);
      ...
      robot.getPinJoint("l_leg_mhx").setQ(0.4);
      robot.getPinJoint("l_leg_lhy").setQ(0.3);
      robot.getPinJoint("l_leg_kny").setQ(0.8);

      // right leg
      robot.getPinJoint("r_leg_mhx").setQ(-0.4);
