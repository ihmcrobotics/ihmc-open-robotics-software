...
public class AtlasPhysicalProperties extends DRCRobotPhysicalProperties
{
   ...
   public static final double footWidth = 0.11; //0.12; // 0.08;   //0.124887;
   public static final double toeWidth = 0.085; //0.095; // 0.07;   //0.05;   //
   public static final double footLength = 0.22; //0.255;
   ...
   static
   {
      ...
      {
         RigidBodyTransform soleToAnkleFrame = TransformTools.createTranslationTransform(footLength / 2.0 - footBack, 0.0, -ankleHeight);
