...
public class AtlasRobotModel implements DRCRobotModel, SDFDescriptionMutator
{
   ...
   public AtlasRobotModel(AtlasRobotVersion atlasVersion, DRCRobotModel.RobotTarget target, boolean headless, SimulationContactPoints simulationContactPoints)
   {
      if(SCALE_ATLAS)
      {
