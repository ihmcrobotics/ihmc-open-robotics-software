...
public class AtlasRobotModelFactory
{
   ...
   public static AtlasRobotModel createDefaultRobotModel(SimulationContactPoints simulationContactPoints)
   {
   ...
   public static AtlasRobotModel createDefaultRobotModel(AtlasRobotVersion robotVersion, SimulationContactPoints simulationContactPoints)
   {
   ...
   public static AtlasRobotModel createDRCRobotModel(String robotModelAsString, DRCRobotModel.RobotTarget runningOnRealRobot, boolean headless,
         SimulationContactPoints simulationContactPoints)
   {
