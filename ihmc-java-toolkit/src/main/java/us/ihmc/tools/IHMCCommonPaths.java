...
public class IHMCCommonPaths
{
   ...
   public static final String RECORDINGS_DIRECTORY_NAME = "recordings";
   public static final Path RECORDINGS_DIRECTORY = DOT_IHMC_DIRECTORY.resolve(RECORDINGS_DIRECTORY_NAME);
}
