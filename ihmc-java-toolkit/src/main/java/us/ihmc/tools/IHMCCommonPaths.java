...
public class IHMCCommonPaths
{
   ...
   private static final String DOT_IHMC_DIRECTORY_NAME = ".ihmc";
   ...
   private static final String PERCEPTION_LOGS_DIRECTORY_NAME = "perception";
   public static final Path PERCEPTION_LOGS_DIRECTORY = LOGS_DIRECTORY.resolve(PERCEPTION_LOGS_DIRECTORY_NAME);

   private static final String VR_DIRECTORY_NAME = "vr";
   public static final Path VR_DIRECTORY = DOT_IHMC_DIRECTORY.resolve(VR_DIRECTORY_NAME);

   private static final String ASTAR_FOOTSTEP_PLANNER_DIRECTORY_NAME = "astar_footstep_planner";
   public static final Path ASTAR_FOOTSTEP_PLANNER_DIRECTORY = LOGS_DIRECTORY.resolve(ASTAR_FOOTSTEP_PLANNER_DIRECTORY_NAME);

   private static final String MONTE_CARLO_FOOTSTEP_PLANNER_DIRECTORY_NAME = "monte-carlo-footstep-planner";
   ...
   private static final String PLANNING_DATASETS_DIRECTORY_NAME = "planning-datasets";
   public static final Path PLANNING_DATASETS_DIRECTORY = LOGS_DIRECTORY.resolve(PLANNING_DATASETS_DIRECTORY_NAME);

   private static final String ELEVATION_DATASETS_DIRECTORY_NAME = "elevation-maps";
   ...
   private static final String CONTINUOUS_HIKING_DIRECTORY_NAME = "continuous-hiking";
   public static final Path CONTINUOUS_HIKING_DIRECTORY = LOGS_DIRECTORY.resolve(CONTINUOUS_HIKING_DIRECTORY_NAME);

   private static final String TERRAIN_MAP_DIRECTORY_NAME = "terrain-map";
   public static final Path TERRAIN_MAP_DIRECTORY = LOGS_DIRECTORY.resolve(TERRAIN_MAP_DIRECTORY_NAME);

   private static final String MISSION_CONTROL_LOGS_DIRECTORY_NAME = "mission-control";
