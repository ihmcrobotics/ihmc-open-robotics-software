...
You can either register your key in the python file:
```
...
## Error resolution
Error: /usr/bin/python3.10 behaviors_example.py
Traceback (most recent call last):
  File "~/.../repository-group/ihmc-open-robotics-software/ihmc-interfaces/ros2ws/behaviors_example.py", line 10, in <module>
    from behavior_msgs.msg import AI2RCommandMessage
ModuleNotFoundError: No module named 'behavior_msgs'

Solution: Run 
    source ~/.../repository-group/ihmc-open-robotics-software/ihmc-interfaces/ros2ws/install/setup.bash
...
So Order is:
    ...
    3. /usr/bin/python3.10 behaviors_example.py or python3 behaviors_example.py
