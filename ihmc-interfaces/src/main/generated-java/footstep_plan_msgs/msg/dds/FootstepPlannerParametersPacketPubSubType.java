...
*
*/
public class FootstepPlannerParametersPacketPubSubType implements us.ihmc.pubsub.TopicDataType<footstep_plan_msgs.msg.dds.FootstepPlannerParametersPacket>
{
   public static final java.lang.String name = "footstep_plan_msgs::msg::dds_::FootstepPlannerParametersPacket_";

   private final us.ihmc.idl.CDR serializeCDR = new us.ihmc.idl.CDR();
   private final us.ihmc.idl.CDR deserializeCDR = new us.ihmc.idl.CDR();

   @Override
   public void serialize(footstep_plan_msgs.msg.dds.FootstepPlannerParametersPacket data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, footstep_plan_msgs.msg.dds.FootstepPlannerParametersPacket data) throws java.io.IOException
   {
   ...
   public final static int getCdrSerializedSize(footstep_plan_msgs.msg.dds.FootstepPlannerParametersPacket data)
   {
      return getCdrSerializedSize(data, 0);
   }

   public final static int getCdrSerializedSize(footstep_plan_msgs.msg.dds.FootstepPlannerParametersPacket data, int current_alignment)
   {
      int initial_alignment = current_alignment;
   ...
   public static void write(footstep_plan_msgs.msg.dds.FootstepPlannerParametersPacket data, us.ihmc.idl.CDR cdr)
   {
      ...
      cdr.write_type_6(data.getRmsErrorThreshold());

      cdr.write_type_6(data.getRmsErrorCost());
   ...
   public static void read(footstep_plan_msgs.msg.dds.FootstepPlannerParametersPacket data, us.ihmc.idl.CDR cdr)
   {
      ...
      data.setRmsErrorThreshold(cdr.read_type_6());
      	
      data.setRmsErrorCost(cdr.read_type_6());
   ...
   @Override
   public final void serialize(footstep_plan_msgs.msg.dds.FootstepPlannerParametersPacket data, us.ihmc.idl.InterchangeSerializer ser)
   {
   ...
   @Override
   public final void deserialize(us.ihmc.idl.InterchangeSerializer ser, footstep_plan_msgs.msg.dds.FootstepPlannerParametersPacket data)
   {
   ...
   public static void staticCopy(footstep_plan_msgs.msg.dds.FootstepPlannerParametersPacket src, footstep_plan_msgs.msg.dds.FootstepPlannerParametersPacket dest)
   {
      dest.set(src);
   }

   @Override
   public footstep_plan_msgs.msg.dds.FootstepPlannerParametersPacket createData()
   {
      return new footstep_plan_msgs.msg.dds.FootstepPlannerParametersPacket();
   }
   @Override
   ...
   public void serialize(footstep_plan_msgs.msg.dds.FootstepPlannerParametersPacket data, us.ihmc.idl.CDR cdr)
   {
      write(data, cdr);
   }

   public void deserialize(footstep_plan_msgs.msg.dds.FootstepPlannerParametersPacket data, us.ihmc.idl.CDR cdr)
   {
      read(data, cdr);
   }
   
   public void copy(footstep_plan_msgs.msg.dds.FootstepPlannerParametersPacket src, footstep_plan_msgs.msg.dds.FootstepPlannerParametersPacket dest)
   {
      staticCopy(src, dest);
   }
