...
*
*/
public class FootstepPlanningRequestPacketPubSubType implements us.ihmc.pubsub.TopicDataType<footstep_plan_msgs.msg.dds.FootstepPlanningRequestPacket>
{
   public static final java.lang.String name = "footstep_plan_msgs::msg::dds_::FootstepPlanningRequestPacket_";

   private final us.ihmc.idl.CDR serializeCDR = new us.ihmc.idl.CDR();
   private final us.ihmc.idl.CDR deserializeCDR = new us.ihmc.idl.CDR();

   @Override
   public void serialize(footstep_plan_msgs.msg.dds.FootstepPlanningRequestPacket data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, footstep_plan_msgs.msg.dds.FootstepPlanningRequestPacket data) throws java.io.IOException
   {
   ...
   public static int getMaxCdrSerializedSize(int current_alignment)
   {
      ...
      current_alignment += controller_msgs.msg.dds.HeightMapMessagePubSubType.getMaxCdrSerializedSize(current_alignment);
   ...
   public final static int getCdrSerializedSize(footstep_plan_msgs.msg.dds.FootstepPlanningRequestPacket data)
   {
      return getCdrSerializedSize(data, 0);
   }

   public final static int getCdrSerializedSize(footstep_plan_msgs.msg.dds.FootstepPlanningRequestPacket data, int current_alignment)
   {
      int initial_alignment = current_alignment;
      ...
      current_alignment += controller_msgs.msg.dds.HeightMapMessagePubSubType.getCdrSerializedSize(data.getHeightMapMessage(), current_alignment);
   ...
   public static void write(footstep_plan_msgs.msg.dds.FootstepPlanningRequestPacket data, us.ihmc.idl.CDR cdr)
   {
      ...
      controller_msgs.msg.dds.HeightMapMessagePubSubType.write(data.getHeightMapMessage(), cdr);
   ...
   public static void read(footstep_plan_msgs.msg.dds.FootstepPlanningRequestPacket data, us.ihmc.idl.CDR cdr)
   {
      ...
      controller_msgs.msg.dds.HeightMapMessagePubSubType.read(data.getHeightMapMessage(), cdr);	
   ...
   @Override
   public final void serialize(footstep_plan_msgs.msg.dds.FootstepPlanningRequestPacket data, us.ihmc.idl.InterchangeSerializer ser)
   {
      ...
      ser.write_type_a("height_map_message", new controller_msgs.msg.dds.HeightMapMessagePubSubType(), data.getHeightMapMessage());
   ...
   @Override
   public final void deserialize(us.ihmc.idl.InterchangeSerializer ser, footstep_plan_msgs.msg.dds.FootstepPlanningRequestPacket data)
   {
      ...
      ser.read_type_a("height_map_message", new controller_msgs.msg.dds.HeightMapMessagePubSubType(), data.getHeightMapMessage());
   ...
   public static void staticCopy(footstep_plan_msgs.msg.dds.FootstepPlanningRequestPacket src, footstep_plan_msgs.msg.dds.FootstepPlanningRequestPacket dest)
   {
      dest.set(src);
   }

   @Override
   public footstep_plan_msgs.msg.dds.FootstepPlanningRequestPacket createData()
   {
      return new footstep_plan_msgs.msg.dds.FootstepPlanningRequestPacket();
   }
   @Override
   ...
   public void serialize(footstep_plan_msgs.msg.dds.FootstepPlanningRequestPacket data, us.ihmc.idl.CDR cdr)
   {
      write(data, cdr);
   }

   public void deserialize(footstep_plan_msgs.msg.dds.FootstepPlanningRequestPacket data, us.ihmc.idl.CDR cdr)
   {
      read(data, cdr);
   }
   
   public void copy(footstep_plan_msgs.msg.dds.FootstepPlanningRequestPacket src, footstep_plan_msgs.msg.dds.FootstepPlanningRequestPacket dest)
   {
      staticCopy(src, dest);
   }
