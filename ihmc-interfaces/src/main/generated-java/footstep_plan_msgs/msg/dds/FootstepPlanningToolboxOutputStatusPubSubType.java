...
*
*/
public class FootstepPlanningToolboxOutputStatusPubSubType implements us.ihmc.pubsub.TopicDataType<footstep_plan_msgs.msg.dds.FootstepPlanningToolboxOutputStatus>
{
   public static final java.lang.String name = "footstep_plan_msgs::msg::dds_::FootstepPlanningToolboxOutputStatus_";

   private final us.ihmc.idl.CDR serializeCDR = new us.ihmc.idl.CDR();
   private final us.ihmc.idl.CDR deserializeCDR = new us.ihmc.idl.CDR();

   @Override
   public void serialize(footstep_plan_msgs.msg.dds.FootstepPlanningToolboxOutputStatus data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, footstep_plan_msgs.msg.dds.FootstepPlanningToolboxOutputStatus data) throws java.io.IOException
   {
   ...
   public static int getMaxCdrSerializedSize(int current_alignment)
   {
      ...
      current_alignment += footstep_plan_msgs.msg.dds.FootstepPlanningTimingsMessagePubSubType.getMaxCdrSerializedSize(current_alignment);
   ...
   public final static int getCdrSerializedSize(footstep_plan_msgs.msg.dds.FootstepPlanningToolboxOutputStatus data)
   {
      return getCdrSerializedSize(data, 0);
   }

   public final static int getCdrSerializedSize(footstep_plan_msgs.msg.dds.FootstepPlanningToolboxOutputStatus data, int current_alignment)
   {
      int initial_alignment = current_alignment;
      ...
      current_alignment += footstep_plan_msgs.msg.dds.FootstepPlanningTimingsMessagePubSubType.getCdrSerializedSize(data.getPlannerTimings(), current_alignment);
   ...
   public static void write(footstep_plan_msgs.msg.dds.FootstepPlanningToolboxOutputStatus data, us.ihmc.idl.CDR cdr)
   {
      ...
      footstep_plan_msgs.msg.dds.FootstepPlanningTimingsMessagePubSubType.write(data.getPlannerTimings(), cdr);
   ...
   public static void read(footstep_plan_msgs.msg.dds.FootstepPlanningToolboxOutputStatus data, us.ihmc.idl.CDR cdr)
   {
      ...
      footstep_plan_msgs.msg.dds.FootstepPlanningTimingsMessagePubSubType.read(data.getPlannerTimings(), cdr);	
   ...
   @Override
   public final void serialize(footstep_plan_msgs.msg.dds.FootstepPlanningToolboxOutputStatus data, us.ihmc.idl.InterchangeSerializer ser)
   {
      ...
      ser.write_type_a("planner_timings", new footstep_plan_msgs.msg.dds.FootstepPlanningTimingsMessagePubSubType(), data.getPlannerTimings());
   ...
   @Override
   public final void deserialize(us.ihmc.idl.InterchangeSerializer ser, footstep_plan_msgs.msg.dds.FootstepPlanningToolboxOutputStatus data)
   {
      ...
      ser.read_type_a("planner_timings", new footstep_plan_msgs.msg.dds.FootstepPlanningTimingsMessagePubSubType(), data.getPlannerTimings());

      ser.read_type_d("exception_message", data.getExceptionMessage());
      ser.read_type_e("stacktrace", data.getStacktrace());
   }

   public static void staticCopy(footstep_plan_msgs.msg.dds.FootstepPlanningToolboxOutputStatus src, footstep_plan_msgs.msg.dds.FootstepPlanningToolboxOutputStatus dest)
   {
      dest.set(src);
   }

   @Override
   public footstep_plan_msgs.msg.dds.FootstepPlanningToolboxOutputStatus createData()
   {
      return new footstep_plan_msgs.msg.dds.FootstepPlanningToolboxOutputStatus();
   }
   @Override
   ...
   public void serialize(footstep_plan_msgs.msg.dds.FootstepPlanningToolboxOutputStatus data, us.ihmc.idl.CDR cdr)
   {
      write(data, cdr);
   }

   public void deserialize(footstep_plan_msgs.msg.dds.FootstepPlanningToolboxOutputStatus data, us.ihmc.idl.CDR cdr)
   {
      read(data, cdr);
   }
   
   public void copy(footstep_plan_msgs.msg.dds.FootstepPlanningToolboxOutputStatus src, footstep_plan_msgs.msg.dds.FootstepPlanningToolboxOutputStatus dest)
   {
      staticCopy(src, dest);
   }
