...
*
*/
public class FootstepPlanningTimingsMessagePubSubType implements us.ihmc.pubsub.TopicDataType<footstep_plan_msgs.msg.dds.FootstepPlanningTimingsMessage>
{
   public static final java.lang.String name = "footstep_plan_msgs::msg::dds_::FootstepPlanningTimingsMessage_";

   private final us.ihmc.idl.CDR serializeCDR = new us.ihmc.idl.CDR();
   private final us.ihmc.idl.CDR deserializeCDR = new us.ihmc.idl.CDR();

   @Override
   public void serialize(footstep_plan_msgs.msg.dds.FootstepPlanningTimingsMessage data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, footstep_plan_msgs.msg.dds.FootstepPlanningTimingsMessage data) throws java.io.IOException
   {
   ...
   public final static int getCdrSerializedSize(footstep_plan_msgs.msg.dds.FootstepPlanningTimingsMessage data)
   {
      return getCdrSerializedSize(data, 0);
   }

   public final static int getCdrSerializedSize(footstep_plan_msgs.msg.dds.FootstepPlanningTimingsMessage data, int current_alignment)
   {
      int initial_alignment = current_alignment;
   ...
   public static void write(footstep_plan_msgs.msg.dds.FootstepPlanningTimingsMessage data, us.ihmc.idl.CDR cdr)
   {
   ...
   public static void read(footstep_plan_msgs.msg.dds.FootstepPlanningTimingsMessage data, us.ihmc.idl.CDR cdr)
   {
   ...
   @Override
   public final void serialize(footstep_plan_msgs.msg.dds.FootstepPlanningTimingsMessage data, us.ihmc.idl.InterchangeSerializer ser)
   {
   ...
   @Override
   public final void deserialize(us.ihmc.idl.InterchangeSerializer ser, footstep_plan_msgs.msg.dds.FootstepPlanningTimingsMessage data)
   {
   ...
   public static void staticCopy(footstep_plan_msgs.msg.dds.FootstepPlanningTimingsMessage src, footstep_plan_msgs.msg.dds.FootstepPlanningTimingsMessage dest)
   {
      dest.set(src);
   }

   @Override
   public footstep_plan_msgs.msg.dds.FootstepPlanningTimingsMessage createData()
   {
      return new footstep_plan_msgs.msg.dds.FootstepPlanningTimingsMessage();
   }
   @Override
   ...
   public void serialize(footstep_plan_msgs.msg.dds.FootstepPlanningTimingsMessage data, us.ihmc.idl.CDR cdr)
   {
      write(data, cdr);
   }

   public void deserialize(footstep_plan_msgs.msg.dds.FootstepPlanningTimingsMessage data, us.ihmc.idl.CDR cdr)
   {
      read(data, cdr);
   }
   
   public void copy(footstep_plan_msgs.msg.dds.FootstepPlanningTimingsMessage src, footstep_plan_msgs.msg.dds.FootstepPlanningTimingsMessage dest)
   {
      staticCopy(src, dest);
   }
