...
public class QuixCrutchMessage extends Packet<QuixCrutchMessage> implements Settable<QuixCrutchMessage>, EpsilonComparable<QuixCrutchMessage>
{
   ...
   public exoskeleton_msgs.msg.dds.QuixMotionStateMessage requested_motion_state_;
   public boolean execute_behavior_;
   public boolean continuous_walking_;
   public exoskeleton_msgs.msg.dds.FlatStepTypeMessage flat_step_type_;
   public exoskeleton_msgs.msg.dds.QuixStairsStepTypeMessage stairs_step_type_;
   public exoskeleton_msgs.msg.dds.QuixSideStepDirectionMessage side_step_direction_;
   public exoskeleton_msgs.msg.dds.QuixSlopeStepTypeMessage slope_step_type_;
   public byte force_swing_side_ = (byte) 255;

   public QuixCrutchMessage()
   {
      requested_motion_state_ = new exoskeleton_msgs.msg.dds.QuixMotionStateMessage();
      flat_step_type_ = new exoskeleton_msgs.msg.dds.FlatStepTypeMessage();
      stairs_step_type_ = new exoskeleton_msgs.msg.dds.QuixStairsStepTypeMessage();
      side_step_direction_ = new exoskeleton_msgs.msg.dds.QuixSideStepDirectionMessage();
      slope_step_type_ = new exoskeleton_msgs.msg.dds.QuixSlopeStepTypeMessage();
   }
   ...
   public void set(QuixCrutchMessage other)
   {
      ...
      exoskeleton_msgs.msg.dds.QuixMotionStateMessagePubSubType.staticCopy(other.requested_motion_state_, requested_motion_state_);
      execute_behavior_ = other.execute_behavior_;

      continuous_walking_ = other.continuous_walking_;

      exoskeleton_msgs.msg.dds.FlatStepTypeMessagePubSubType.staticCopy(other.flat_step_type_, flat_step_type_);
      exoskeleton_msgs.msg.dds.QuixStairsStepTypeMessagePubSubType.staticCopy(other.stairs_step_type_, stairs_step_type_);
      exoskeleton_msgs.msg.dds.QuixSideStepDirectionMessagePubSubType.staticCopy(other.side_step_direction_, side_step_direction_);
      exoskeleton_msgs.msg.dds.QuixSlopeStepTypeMessagePubSubType.staticCopy(other.slope_step_type_, slope_step_type_);
   ...
   public exoskeleton_msgs.msg.dds.QuixMotionStateMessage getRequestedMotionState()
   {
   ...
   public exoskeleton_msgs.msg.dds.FlatStepTypeMessage getFlatStepType()
   {
      return flat_step_type_;
   }


   public exoskeleton_msgs.msg.dds.QuixStairsStepTypeMessage getStairsStepType()
   {
      return stairs_step_type_;
   }


   public exoskeleton_msgs.msg.dds.QuixSideStepDirectionMessage getSideStepDirection()
   {
      return side_step_direction_;
   }


   public exoskeleton_msgs.msg.dds.QuixSlopeStepTypeMessage getSlopeStepType()
   {
