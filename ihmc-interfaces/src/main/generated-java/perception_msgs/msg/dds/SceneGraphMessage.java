...
public class SceneGraphMessage extends Packet<SceneGraphMessage> implements Settable<SceneGraphMessage>, EpsilonComparable<SceneGraphMessage>
{
   ...
   public SceneGraphMessage()
   {
      ...
      foundation_pose_scene_nodes_ = new us.ihmc.idl.IDLSequence.Object<perception_msgs.msg.dds.FoundationPoseNodeMessage> (100, new perception_msgs.msg.dds.FoundationPoseNodeMessagePubSubType());
