...
public class REAStatusMessage extends Packet<REAStatusMessage> implements Settable<REAStatusMessage>, EpsilonComparable<REAStatusMessage>
{
   ...
   /**
            ...
            */
   public perception_msgs.msg.dds.REASensorDataFilterParametersMessage current_sensor_filter_parameters_;
   ...
   public void set(REAStatusMessage other)
   {
      ...
      perception_msgs.msg.dds.REASensorDataFilterParametersMessagePubSubType.staticCopy(other.current_sensor_filter_parameters_, current_sensor_filter_parameters_);
   }
