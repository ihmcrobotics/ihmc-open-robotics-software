...
public class SteppableRegionsListCollectionMessage extends Packet<SteppableRegionsListCollectionMessage> implements Settable<SteppableRegionsListCollectionMessage>, EpsilonComparable<SteppableRegionsListCollectionMessage>
{
   ...
   /**
            ...
            */
   public us.ihmc.idl.IDLSequence.Double  foot_yaw_;
   /**
            * Indicates for each planar region the number of vertices for the concave hull.
            */
   public us.ihmc.idl.IDLSequence.Integer  regions_per_yaw_;
   /**
   ...
   public SteppableRegionsListCollectionMessage()
   {
      ...
      foot_yaw_ = new us.ihmc.idl.IDLSequence.Double (3000, "type_6");

      regions_per_yaw_ = new us.ihmc.idl.IDLSequence.Integer (3000, "type_2");
   ...
   public SteppableRegionsListCollectionMessage(SteppableRegionsListCollectionMessage other)
   {
      this();
      set(other);
   }

   public void set(SteppableRegionsListCollectionMessage other)
   {
      ...
      foot_yaw_.set(other.foot_yaw_);
      regions_per_yaw_.set(other.regions_per_yaw_);
   ...
   /**
            * foot yaw for the corresponding regions
            */
   public us.ihmc.idl.IDLSequence.Double  getFootYaw()
   {
      return foot_yaw_;
   }
   ...
   /**
            * Indicates for each planar region the number of vertices for the concave hull.
            */
   public us.ihmc.idl.IDLSequence.Integer  getRegionsPerYaw()
   {
      return regions_per_yaw_;
   }
   ...
   @Override
   public boolean epsilonEquals(SteppableRegionsListCollectionMessage other, double epsilon)
   {
      ...
      if (!us.ihmc.idl.IDLTools.epsilonEqualsDoubleSequence(this.foot_yaw_, other.foot_yaw_, epsilon)) return false;

      if (!us.ihmc.idl.IDLTools.epsilonEqualsIntegerSequence(this.regions_per_yaw_, other.regions_per_yaw_, epsilon)) return false;
   ...
   public boolean equals(Object other)
   {
      if(other == null) return false;
      if(other == this) return true;
      if(!(other instanceof SteppableRegionsListCollectionMessage)) return false;

      SteppableRegionsListCollectionMessage otherMyClass = (SteppableRegionsListCollectionMessage) other;
      ...
      if (!this.foot_yaw_.equals(otherMyClass.foot_yaw_)) return false;
      if (!this.regions_per_yaw_.equals(otherMyClass.regions_per_yaw_)) return false;
   ...
   public java.lang.String toString()
   {
      ...
      builder.append("SteppableRegionsListCollectionMessage {");
      ...
      builder.append("regions_per_yaw=");
      builder.append(this.regions_per_yaw_);      builder.append(", ");
