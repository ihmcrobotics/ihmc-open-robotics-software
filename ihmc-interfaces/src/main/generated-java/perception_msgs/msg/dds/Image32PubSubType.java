...
public class Image32PubSubType implements us.ihmc.pubsub.TopicDataType<perception_msgs.msg.dds.Image32>
{
   ...
   {
   		return "c3b25a243e311484cd182784f136614652d46d47c4336dd564c7c61fe1ce93ca";
   }
   ...
   @Override
   public void serialize(perception_msgs.msg.dds.Image32 data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, perception_msgs.msg.dds.Image32 data) throws java.io.IOException
   {
   ...
   public final static int getCdrSerializedSize(perception_msgs.msg.dds.Image32 data)
   {
      return getCdrSerializedSize(data, 0);
   }

   public final static int getCdrSerializedSize(perception_msgs.msg.dds.Image32 data, int current_alignment)
   {
      int initial_alignment = current_alignment;
   ...
   public static void staticCopy(perception_msgs.msg.dds.Image32 src, perception_msgs.msg.dds.Image32 dest)
   {
      dest.set(src);
   }

   @Override
   public perception_msgs.msg.dds.Image32 createData()
   {
      return new perception_msgs.msg.dds.Image32();
   }
   @Override
   ...
   public void serialize(perception_msgs.msg.dds.Image32 data, us.ihmc.idl.CDR cdr)
   {
      write(data, cdr);
   }

   public void deserialize(perception_msgs.msg.dds.Image32 data, us.ihmc.idl.CDR cdr)
   {
      read(data, cdr);
   }
   
   public void copy(perception_msgs.msg.dds.Image32 src, perception_msgs.msg.dds.Image32 dest)
   {
      staticCopy(src, dest);
   }
