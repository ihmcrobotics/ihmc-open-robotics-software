...
*
*/
public class PlanarRegionsListMessagePubSubType implements us.ihmc.pubsub.TopicDataType<perception_msgs.msg.dds.PlanarRegionsListMessage>
{
   ...
   {
   		return "cf9044bf0af893f11b56b155e92e7bcdd29386244e715addb8d4174d1ce68cc9";
   }
   ...
   @Override
   public void serialize(perception_msgs.msg.dds.PlanarRegionsListMessage data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, perception_msgs.msg.dds.PlanarRegionsListMessage data) throws java.io.IOException
   {
   ...
   public final static int getCdrSerializedSize(perception_msgs.msg.dds.PlanarRegionsListMessage data)
   {
      return getCdrSerializedSize(data, 0);
   }

   public final static int getCdrSerializedSize(perception_msgs.msg.dds.PlanarRegionsListMessage data, int current_alignment)
   {
      int initial_alignment = current_alignment;
   ...
   public static void write(perception_msgs.msg.dds.PlanarRegionsListMessage data, us.ihmc.idl.CDR cdr)
   {
   ...
   public static void read(perception_msgs.msg.dds.PlanarRegionsListMessage data, us.ihmc.idl.CDR cdr)
   {
   ...
   public static void staticCopy(perception_msgs.msg.dds.PlanarRegionsListMessage src, perception_msgs.msg.dds.PlanarRegionsListMessage dest)
   {
      dest.set(src);
   }

   @Override
   public perception_msgs.msg.dds.PlanarRegionsListMessage createData()
   {
      return new perception_msgs.msg.dds.PlanarRegionsListMessage();
   }
   @Override
   ...
   public void serialize(perception_msgs.msg.dds.PlanarRegionsListMessage data, us.ihmc.idl.CDR cdr)
   {
      write(data, cdr);
   }

   public void deserialize(perception_msgs.msg.dds.PlanarRegionsListMessage data, us.ihmc.idl.CDR cdr)
   {
      read(data, cdr);
   }
   
   public void copy(perception_msgs.msg.dds.PlanarRegionsListMessage src, perception_msgs.msg.dds.PlanarRegionsListMessage dest)
   {
      staticCopy(src, dest);
   }
