...
public class HeightMapMessage extends Packet<HeightMapMessage> implements Settable<HeightMapMessage>, EpsilonComparable<HeightMapMessage>
{
   ...
   {
      keys_ = new us.ihmc.idl.IDLSequence.Integer (150000, "type_2");

      heights_ = new us.ihmc.idl.IDLSequence.Float (150000, "type_5");

      variances_ = new us.ihmc.idl.IDLSequence.Float (150000, "type_5");

      centroids_ = new us.ihmc.idl.IDLSequence.Object<us.ihmc.euclid.tuple3D.Point3D> (150000, new geometry_msgs.msg.dds.PointPubSubType());
      normals_ = new us.ihmc.idl.IDLSequence.Object<us.ihmc.euclid.tuple3D.Vector3D> (150000, new geometry_msgs.msg.dds.Vector3PubSubType());
