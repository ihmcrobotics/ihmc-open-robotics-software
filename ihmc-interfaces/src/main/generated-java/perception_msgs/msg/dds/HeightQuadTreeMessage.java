...
public class HeightQuadTreeMessage extends Packet<HeightQuadTreeMessage> implements Settable<HeightQuadTreeMessage>, EpsilonComparable<HeightQuadTreeMessage>
{
   ...
   public us.ihmc.idl.IDLSequence.Object<perception_msgs.msg.dds.HeightQuadTreeLeafMessage>  leaves_;

   public HeightQuadTreeMessage()
   {
      leaves_ = new us.ihmc.idl.IDLSequence.Object<perception_msgs.msg.dds.HeightQuadTreeLeafMessage> (5000, new perception_msgs.msg.dds.HeightQuadTreeLeafMessagePubSubType());
   ...
   public us.ihmc.idl.IDLSequence.Object<perception_msgs.msg.dds.HeightQuadTreeLeafMessage>  getLeaves()
   {
      return leaves_;
   }
