...
public class WaypointBasedTrajectoryMessagePubSubType implements us.ihmc.pubsub.TopicDataType<toolbox_msgs.msg.dds.WaypointBasedTrajectoryMessage>
{
   ...
   {
   		return "39757cc5cb5778d9c6cc0b2c51e4eee0857d8be70d9903b37938e46e4bdd8b28";
   }
   ...
   @Override
   public void serialize(toolbox_msgs.msg.dds.WaypointBasedTrajectoryMessage data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, toolbox_msgs.msg.dds.WaypointBasedTrajectoryMessage data) throws java.io.IOException
   {
   ...
   public final static int getCdrSerializedSize(toolbox_msgs.msg.dds.WaypointBasedTrajectoryMessage data)
   {
      return getCdrSerializedSize(data, 0);
   }

   public final static int getCdrSerializedSize(toolbox_msgs.msg.dds.WaypointBasedTrajectoryMessage data, int current_alignment)
   {
      int initial_alignment = current_alignment;
   ...
   public static void staticCopy(toolbox_msgs.msg.dds.WaypointBasedTrajectoryMessage src, toolbox_msgs.msg.dds.WaypointBasedTrajectoryMessage dest)
   {
      dest.set(src);
   }

   @Override
   public toolbox_msgs.msg.dds.WaypointBasedTrajectoryMessage createData()
   {
      return new toolbox_msgs.msg.dds.WaypointBasedTrajectoryMessage();
   }
   @Override
   ...
   public void serialize(toolbox_msgs.msg.dds.WaypointBasedTrajectoryMessage data, us.ihmc.idl.CDR cdr)
   {
      write(data, cdr);
   }

   public void deserialize(toolbox_msgs.msg.dds.WaypointBasedTrajectoryMessage data, us.ihmc.idl.CDR cdr)
   {
      read(data, cdr);
   }
   
   public void copy(toolbox_msgs.msg.dds.WaypointBasedTrajectoryMessage src, toolbox_msgs.msg.dds.WaypointBasedTrajectoryMessage dest)
   {
      staticCopy(src, dest);
   }
