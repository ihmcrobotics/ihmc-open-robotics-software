...
public class WholeBodyTrajectoryToolboxMessage extends Packet<WholeBodyTrajectoryToolboxMessage> implements Settable<WholeBodyTrajectoryToolboxMessage>, EpsilonComparable<WholeBodyTrajectoryToolboxMessage>
{
   ...
   public toolbox_msgs.msg.dds.WholeBodyTrajectoryToolboxConfigurationMessage configuration_;
   public us.ihmc.idl.IDLSequence.Object<toolbox_msgs.msg.dds.WaypointBasedTrajectoryMessage>  end_effector_trajectories_;
   public us.ihmc.idl.IDLSequence.Object<toolbox_msgs.msg.dds.RigidBodyExplorationConfigurationMessage>  exploration_configurations_;
   public us.ihmc.idl.IDLSequence.Object<toolbox_msgs.msg.dds.ReachingManifoldMessage>  reaching_manifolds_;
   ...
   public WholeBodyTrajectoryToolboxMessage()
   {
      ...
      end_effector_trajectories_ = new us.ihmc.idl.IDLSequence.Object<toolbox_msgs.msg.dds.WaypointBasedTrajectoryMessage> (10, new toolbox_msgs.msg.dds.WaypointBasedTrajectoryMessagePubSubType());
      exploration_configurations_ = new us.ihmc.idl.IDLSequence.Object<toolbox_msgs.msg.dds.RigidBodyExplorationConfigurationMessage> (10, new toolbox_msgs.msg.dds.RigidBodyExplorationConfigurationMessagePubSubType());
      reaching_manifolds_ = new us.ihmc.idl.IDLSequence.Object<toolbox_msgs.msg.dds.ReachingManifoldMessage> (10, new toolbox_msgs.msg.dds.ReachingManifoldMessagePubSubType());
   ...
   public void set(WholeBodyTrajectoryToolboxMessage other)
   {
      ...
      toolbox_msgs.msg.dds.WholeBodyTrajectoryToolboxConfigurationMessagePubSubType.staticCopy(other.configuration_, configuration_);
   ...
   public us.ihmc.idl.IDLSequence.Object<toolbox_msgs.msg.dds.WaypointBasedTrajectoryMessage>  getEndEffectorTrajectories()
   {
      return end_effector_trajectories_;
   }


   public us.ihmc.idl.IDLSequence.Object<toolbox_msgs.msg.dds.RigidBodyExplorationConfigurationMessage>  getExplorationConfigurations()
   {
      return exploration_configurations_;
   }


   public us.ihmc.idl.IDLSequence.Object<toolbox_msgs.msg.dds.ReachingManifoldMessage>  getReachingManifolds()
   {
