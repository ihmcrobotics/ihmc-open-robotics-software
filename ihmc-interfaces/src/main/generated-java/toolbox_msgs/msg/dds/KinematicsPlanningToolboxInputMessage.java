...
public class KinematicsPlanningToolboxInputMessage extends Packet<KinematicsPlanningToolboxInputMessage> implements Settable<KinematicsPlanningToolboxInputMessage>, EpsilonComparable<KinematicsPlanningToolboxInputMessage>
{
   ...
   /**
            ...
            */
   public us.ihmc.idl.IDLSequence.Object<toolbox_msgs.msg.dds.KinematicsPlanningToolboxRigidBodyMessage>  rigid_body_messages_;
   /**
            ...
            */
   public toolbox_msgs.msg.dds.KinematicsPlanningToolboxCenterOfMassMessage center_of_mass_message_;
   /**
            * This is kinematics configuration message and will configure whole body inverse kinematics solver.
            * This is optional.
            */
   public toolbox_msgs.msg.dds.KinematicsToolboxConfigurationMessage kinematics_configuration_message_;

   public KinematicsPlanningToolboxInputMessage()
   {
      rigid_body_messages_ = new us.ihmc.idl.IDLSequence.Object<toolbox_msgs.msg.dds.KinematicsPlanningToolboxRigidBodyMessage> (100, new toolbox_msgs.msg.dds.KinematicsPlanningToolboxRigidBodyMessagePubSubType());
   ...
   public void set(KinematicsPlanningToolboxInputMessage other)
   {
      ...
      toolbox_msgs.msg.dds.KinematicsPlanningToolboxCenterOfMassMessagePubSubType.staticCopy(other.center_of_mass_message_, center_of_mass_message_);
      toolbox_msgs.msg.dds.KinematicsToolboxConfigurationMessagePubSubType.staticCopy(other.kinematics_configuration_message_, kinematics_configuration_message_);
   }
   ...
   /**
            ...
            * It should composed of at least one message. Each message represent the input for solving the trajectory for one rigid-body.
            */
   public us.ihmc.idl.IDLSequence.Object<toolbox_msgs.msg.dds.KinematicsPlanningToolboxRigidBodyMessage>  getRigidBodyMessages()
   {
