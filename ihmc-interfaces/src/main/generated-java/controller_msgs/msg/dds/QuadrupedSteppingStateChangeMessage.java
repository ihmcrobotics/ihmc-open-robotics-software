 ...
 */
public class QuadrupedSteppingStateChangeMessage extends Packet<QuadrupedSteppingStateChangeMessage>
      implements Settable<QuadrupedSteppingStateChangeMessage>, EpsilonComparable<QuadrupedSteppingStateChangeMessage>
{
   ...
   public boolean epsilonEquals(QuadrupedSteppingStateChangeMessage other, double epsilon)
   {
      ...
      if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.initial_stepping_controller_name_, other.initial_stepping_controller_name_, epsilon))
         return false;

      if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.end_stepping_controller_name_, other.end_stepping_controller_name_, epsilon))
         return false;
   ...
   public boolean equals(Object other)
   {
      ...
      if (other == this)
         return true;
      if (!(other instanceof QuadrupedSteppingStateChangeMessage))
         return false;

      QuadrupedSteppingStateChangeMessage otherMyClass = (QuadrupedSteppingStateChangeMessage) other;

      if (this.initial_stepping_controller_name_ != otherMyClass.initial_stepping_controller_name_)
         return false;

      if (this.end_stepping_controller_name_ != otherMyClass.end_stepping_controller_name_)
         return false;
   ...
   public java.lang.String toString()
   {
      ...
      builder.append(this.initial_stepping_controller_name_);
      builder.append(", ");
