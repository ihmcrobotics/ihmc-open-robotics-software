...
public class HeightQuadTreeToolboxRequestMessagePubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.HeightQuadTreeToolboxRequestMessage>
{
   ...
   @Override
   public void serialize(controller_msgs.msg.dds.HeightQuadTreeToolboxRequestMessage data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, controller_msgs.msg.dds.HeightQuadTreeToolboxRequestMessage data) throws java.io.IOException
   {
   ...
   public static void staticCopy(controller_msgs.msg.dds.HeightQuadTreeToolboxRequestMessage src, controller_msgs.msg.dds.HeightQuadTreeToolboxRequestMessage dest)
   {
      dest.set(src);
   }
