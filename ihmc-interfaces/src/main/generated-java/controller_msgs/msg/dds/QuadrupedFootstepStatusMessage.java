 ...
 */
public class QuadrupedFootstepStatusMessage extends Packet<QuadrupedFootstepStatusMessage>
      implements Settable<QuadrupedFootstepStatusMessage>, EpsilonComparable<QuadrupedFootstepStatusMessage>
{
   ...
   public boolean epsilonEquals(QuadrupedFootstepStatusMessage other, double epsilon)
   {
      ...
      if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.footstep_quadrant_, other.footstep_quadrant_, epsilon))
         return false;

      if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.robot_quadrant_, other.robot_quadrant_, epsilon))
         return false;

      if (!this.desired_touchdown_position_in_world_.epsilonEquals(other.desired_touchdown_position_in_world_, epsilon))
         return false;
      if (!this.actual_touchdown_position_in_world_.epsilonEquals(other.actual_touchdown_position_in_world_, epsilon))
         return false;
      if (!this.desired_step_interval_.epsilonEquals(other.desired_step_interval_, epsilon))
         return false;
      if (!this.actual_step_interval_.epsilonEquals(other.actual_step_interval_, epsilon))
         return false;
   ...
   public boolean equals(Object other)
   {
      ...
      if (other == this)
         return true;
      if (!(other instanceof QuadrupedFootstepStatusMessage))
         return false;
      ...
      if (this.footstep_quadrant_ != otherMyClass.footstep_quadrant_)
         return false;

      if (this.robot_quadrant_ != otherMyClass.robot_quadrant_)
         return false;

      if (!this.desired_touchdown_position_in_world_.equals(otherMyClass.desired_touchdown_position_in_world_))
         return false;
      if (!this.actual_touchdown_position_in_world_.equals(otherMyClass.actual_touchdown_position_in_world_))
         return false;
      if (!this.desired_step_interval_.equals(otherMyClass.desired_step_interval_))
         return false;
      if (!this.actual_step_interval_.equals(otherMyClass.actual_step_interval_))
         return false;
