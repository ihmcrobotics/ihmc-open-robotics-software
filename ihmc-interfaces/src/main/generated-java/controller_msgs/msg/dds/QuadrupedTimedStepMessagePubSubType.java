...
public class QuadrupedTimedStepMessagePubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.QuadrupedTimedStepMessage>
{
   ...
   @Override
   public void serialize(controller_msgs.msg.dds.QuadrupedTimedStepMessage data, us.ihmc.pubsub.common.SerializedPayload serializedPayload)
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, controller_msgs.msg.dds.QuadrupedTimedStepMessage data)
         throws java.io.IOException
   {
