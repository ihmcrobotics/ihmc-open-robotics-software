...
/**
 * 
 * Topic data type of the struct "SO3TrajectoryMessage" defined in "SO3TrajectoryMessage_.idl". Use
 * this class to provide the TopicDataType to a Participant.
 *
 * This file was automatically generated from SO3TrajectoryMessage_.idl by
 * us.ihmc.idl.generator.IDLGenerator. Do not update this file directly, edit
 * SO3TrajectoryMessage_.idl instead.
 *
 */
public class SO3TrajectoryMessagePubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.SO3TrajectoryMessage>
{
   ...
   @Override
   public void serialize(controller_msgs.msg.dds.SO3TrajectoryMessage data, us.ihmc.pubsub.common.SerializedPayload serializedPayload)
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, controller_msgs.msg.dds.SO3TrajectoryMessage data)
         throws java.io.IOException
   {
   ...
   public final static int getCdrSerializedSize(controller_msgs.msg.dds.SO3TrajectoryMessage data, int current_alignment)
   {
      ...
      {
         current_alignment += controller_msgs.msg.dds.SO3TrajectoryPointMessagePubSubType.getCdrSerializedSize(data.getTaskspaceTrajectoryPoints().get(i0),
                                                                                                               current_alignment);
      }
