      ...
      implements Settable<FootstepPlanningToolboxOutputStatus>, EpsilonComparable<FootstepPlanningToolboxOutputStatus>
{
   ...
   public boolean epsilonEquals(FootstepPlanningToolboxOutputStatus other, double epsilon)
   {
      ...
      if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.plan_id_, other.plan_id_, epsilon))
         return false;
      ...
      else
      {
         ...
         {
            if (!this.body_path_.get(i).epsilonEquals(other.body_path_.get(i), epsilon))
               return false;
         }
      }

      if (!this.low_level_planner_goal_.epsilonEquals(other.low_level_planner_goal_, epsilon))
         return false;
   ...
   public boolean equals(Object other)
   {
      ...
      if (other == this)
         return true;
      if (!(other instanceof FootstepPlanningToolboxOutputStatus))
         return false;
      ...
      if (this.plan_id_ != otherMyClass.plan_id_)
         return false;
