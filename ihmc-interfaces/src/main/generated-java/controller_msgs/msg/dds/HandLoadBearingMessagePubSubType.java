...
/**
 * 
 * Topic data type of the struct "HandLoadBearingMessage" defined in "HandLoadBearingMessage_.idl".
 * Use this class to provide the TopicDataType to a Participant.
 *
 * This file was automatically generated from HandLoadBearingMessage_.idl by
 * us.ihmc.idl.generator.IDLGenerator. Do not update this file directly, edit
 * HandLoadBearingMessage_.idl instead.
 *
 */
public class HandLoadBearingMessagePubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.HandLoadBearingMessage>
{
   ...
   @Override
   public void serialize(controller_msgs.msg.dds.HandLoadBearingMessage data, us.ihmc.pubsub.common.SerializedPayload serializedPayload)
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, controller_msgs.msg.dds.HandLoadBearingMessage data)
         throws java.io.IOException
   {
   ...
   public final static int getCdrSerializedSize(controller_msgs.msg.dds.HandLoadBearingMessage data, int current_alignment)
   {
      ...
      current_alignment += controller_msgs.msg.dds.JointspaceTrajectoryMessagePubSubType.getCdrSerializedSize(data.getJointspaceTrajectory(),
                                                                                                              current_alignment);
