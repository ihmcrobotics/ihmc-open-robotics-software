...
public class MessageCollectionPubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.MessageCollection>
{
   ...
   @Override
   public void serialize(controller_msgs.msg.dds.MessageCollection data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, controller_msgs.msg.dds.MessageCollection data) throws java.io.IOException
   {
   ...
   public final static int getCdrSerializedSize(controller_msgs.msg.dds.MessageCollection data)
   {
      return getCdrSerializedSize(data, 0);
   }

   public final static int getCdrSerializedSize(controller_msgs.msg.dds.MessageCollection data, int current_alignment)
   {
      int initial_alignment = current_alignment;
   ...
   public static void staticCopy(controller_msgs.msg.dds.MessageCollection src, controller_msgs.msg.dds.MessageCollection dest)
   {
      dest.set(src);
   }

   @Override
   public controller_msgs.msg.dds.MessageCollection createData()
   {
   ...
   public void deserialize(controller_msgs.msg.dds.MessageCollection data, us.ihmc.idl.CDR cdr)
   {
      read(data, cdr);
   }
