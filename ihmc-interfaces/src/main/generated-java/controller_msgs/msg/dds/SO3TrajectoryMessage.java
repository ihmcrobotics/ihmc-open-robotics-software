 ...
 * to execute a trajectory in taskspace (orientation only) by defining trajectory points. A Hermite
 * based curve (third order) is used to interpolate the orientations. To execute a single straight
 * "line" trajectory to reach a desired orientation, set only one trajectory point with zero
...
public class SO3TrajectoryMessage extends Packet<SO3TrajectoryMessage> implements Settable<SO3TrajectoryMessage>, EpsilonComparable<SO3TrajectoryMessage>
{
   ...
   public boolean equals(Object other)
   {
      ...
      if (other == this)
         return true;
      if (!(other instanceof SO3TrajectoryMessage))
         return false;
