...
/**
 * 
 * Topic data type of the struct "WholeBodyTrajectoryToolboxMessage" defined in
 * "WholeBodyTrajectoryToolboxMessage_.idl". Use this class to provide the TopicDataType to a
 * Participant.
 *
 * This file was automatically generated from WholeBodyTrajectoryToolboxMessage_.idl by
 * us.ihmc.idl.generator.IDLGenerator. Do not update this file directly, edit
 * WholeBodyTrajectoryToolboxMessage_.idl instead.
 *
 */
public class WholeBodyTrajectoryToolboxMessagePubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.WholeBodyTrajectoryToolboxMessage>
{
   ...
   @Override
   public void serialize(controller_msgs.msg.dds.WholeBodyTrajectoryToolboxMessage data, us.ihmc.pubsub.common.SerializedPayload serializedPayload)
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, controller_msgs.msg.dds.WholeBodyTrajectoryToolboxMessage data)
         throws java.io.IOException
   {
   ...
   public final static int getCdrSerializedSize(controller_msgs.msg.dds.WholeBodyTrajectoryToolboxMessage data, int current_alignment)
   {
      ...
      current_alignment += controller_msgs.msg.dds.WholeBodyTrajectoryToolboxConfigurationMessagePubSubType.getCdrSerializedSize(data.getConfiguration(),
                                                                                                                                 current_alignment);

      current_alignment += 4 + us.ihmc.idl.CDR.alignment(current_alignment, 4);
      for (int i0 = 0; i0 < data.getEndEffectorTrajectories().size(); ++i0)
      {
         current_alignment += controller_msgs.msg.dds.WaypointBasedTrajectoryMessagePubSubType.getCdrSerializedSize(data.getEndEffectorTrajectories().get(i0),
                                                                                                                    current_alignment);
      }
      ...
      {
         current_alignment += controller_msgs.msg.dds.RigidBodyExplorationConfigurationMessagePubSubType.getCdrSerializedSize(data.getExplorationConfigurations()
                                                                                                                                  .get(i0),
                                                                                                                              current_alignment);
      }
      ...
      {
         current_alignment += controller_msgs.msg.dds.ReachingManifoldMessagePubSubType.getCdrSerializedSize(data.getReachingManifolds().get(i0),
                                                                                                             current_alignment);
      }
   ...
   public static void write(controller_msgs.msg.dds.WholeBodyTrajectoryToolboxMessage data, us.ihmc.idl.CDR cdr)
   {
      ...
      if (data.getEndEffectorTrajectories().size() <= 10)
         cdr.write_type_e(data.getEndEffectorTrajectories());
      else
      ...
      if (data.getExplorationConfigurations().size() <= 10)
         cdr.write_type_e(data.getExplorationConfigurations());
      else
      ...
      if (data.getReachingManifolds().size() <= 10)
         cdr.write_type_e(data.getReachingManifolds());
      else
