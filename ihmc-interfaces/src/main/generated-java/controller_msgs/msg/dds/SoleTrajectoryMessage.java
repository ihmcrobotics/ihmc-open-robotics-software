...
public class SoleTrajectoryMessage extends Packet<SoleTrajectoryMessage> implements Settable<SoleTrajectoryMessage>, EpsilonComparable<SoleTrajectoryMessage>
{
   ...
   public boolean epsilonEquals(SoleTrajectoryMessage other, double epsilon)
   {
      ...
      if (!this.position_trajectory_.epsilonEquals(other.position_trajectory_, epsilon))
         return false;
   ...
   public boolean equals(Object other)
   {
      ...
      if (other == this)
         return true;
      if (!(other instanceof SoleTrajectoryMessage))
         return false;
      ...
      if (!this.position_trajectory_.equals(otherMyClass.position_trajectory_))
         return false;
