...
public class ExoskeletonBehaviorStatePacketPubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.ExoskeletonBehaviorStatePacket>
{
   ...
   public final static int getCdrSerializedSize(controller_msgs.msg.dds.ExoskeletonBehaviorStatePacket data)
   {
      return getCdrSerializedSize(data, 0);
   }

   public final static int getCdrSerializedSize(controller_msgs.msg.dds.ExoskeletonBehaviorStatePacket data, int current_alignment)
   {
      int initial_alignment = current_alignment;
   ...
   public static void staticCopy(controller_msgs.msg.dds.ExoskeletonBehaviorStatePacket src, controller_msgs.msg.dds.ExoskeletonBehaviorStatePacket dest)
   {
      dest.set(src);
   }

   @Override
   public controller_msgs.msg.dds.ExoskeletonBehaviorStatePacket createData()
   {
   ...
   public void deserialize(controller_msgs.msg.dds.ExoskeletonBehaviorStatePacket data, us.ihmc.idl.CDR cdr)
   {
      read(data, cdr);
   }
