...
public class PawStepPlannerParametersPacket extends Packet<PawStepPlannerParametersPacket> implements Settable<PawStepPlannerParametersPacket>, EpsilonComparable<PawStepPlannerParametersPacket>
{
   ...
   public PawStepPlannerParametersPacket(PawStepPlannerParametersPacket other)
   {
      this();
      set(other);
   }

   public void set(PawStepPlannerParametersPacket other)
   {
   ...
   @Override
   public boolean epsilonEquals(PawStepPlannerParametersPacket other, double epsilon)
   {
   ...
   public boolean equals(Object other)
   {
      if(other == null) return false;
      if(other == this) return true;
      if(!(other instanceof PawStepPlannerParametersPacket)) return false;

      PawStepPlannerParametersPacket otherMyClass = (PawStepPlannerParametersPacket) other;
   ...
   public java.lang.String toString()
   {
      ...
      builder.append("PawStepPlannerParametersPacket {");
