...
/**
 * This message is part of the IHMC whole-body controller API. This message is used to build
 * trajectory messages in taskspace. It holds the only the translational information for one
 * trajectory point (position & linear velocity). Feel free to look at SO3TrajectoryPointMessage
 * (rotational) and SE3TrajectoryPointMessage (rotational AND translational).
 */
      ...
      implements Settable<EuclideanTrajectoryPointMessage>, EpsilonComparable<EuclideanTrajectoryPointMessage>
{
   ...
   public double time_;
   /**
    * Define the desired 3D position to be reached at this trajectory point. It is expressed in
    * world frame.
    */
   public us.ihmc.euclid.tuple3D.Point3D position_;
   /**
    * Define the desired 3D linear velocity to be reached at this trajectory point. It is expressed
    * in world frame.
    */
