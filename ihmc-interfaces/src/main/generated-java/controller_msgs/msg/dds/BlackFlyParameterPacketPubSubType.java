...
public class BlackFlyParameterPacketPubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.BlackFlyParameterPacket>
{
   ...
   public final static int getCdrSerializedSize(controller_msgs.msg.dds.BlackFlyParameterPacket data)
   {
      return getCdrSerializedSize(data, 0);
   }

   public final static int getCdrSerializedSize(controller_msgs.msg.dds.BlackFlyParameterPacket data, int current_alignment)
   {
      int initial_alignment = current_alignment;
   ...
   @Override
   public controller_msgs.msg.dds.BlackFlyParameterPacket createData()
   {
   ...
   public void deserialize(controller_msgs.msg.dds.BlackFlyParameterPacket data, us.ihmc.idl.CDR cdr)
   {
      read(data, cdr);
   }
