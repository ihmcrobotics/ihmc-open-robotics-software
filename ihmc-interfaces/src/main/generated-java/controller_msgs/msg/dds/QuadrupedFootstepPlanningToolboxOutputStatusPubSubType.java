...
/**
* 
* Topic data type of the struct "QuadrupedFootstepPlanningToolboxOutputStatus" defined in "QuadrupedFootstepPlanningToolboxOutputStatus_.idl". Use this class to provide the TopicDataType to a Participant. 
*
* This file was automatically generated from QuadrupedFootstepPlanningToolboxOutputStatus_.idl by us.ihmc.idl.generator.IDLGenerator. 
* Do not update this file directly, edit QuadrupedFootstepPlanningToolboxOutputStatus_.idl instead.
*
*/
public class QuadrupedFootstepPlanningToolboxOutputStatusPubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.QuadrupedFootstepPlanningToolboxOutputStatus>
{
   public static final java.lang.String name = "controller_msgs::msg::dds_::QuadrupedFootstepPlanningToolboxOutputStatus_";

   private final us.ihmc.idl.CDR serializeCDR = new us.ihmc.idl.CDR();
   private final us.ihmc.idl.CDR deserializeCDR = new us.ihmc.idl.CDR();

   @Override
   public void serialize(controller_msgs.msg.dds.QuadrupedFootstepPlanningToolboxOutputStatus data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, controller_msgs.msg.dds.QuadrupedFootstepPlanningToolboxOutputStatus data) throws java.io.IOException
   {
   ...
   public final static int getCdrSerializedSize(controller_msgs.msg.dds.QuadrupedFootstepPlanningToolboxOutputStatus data)
   {
      return getCdrSerializedSize(data, 0);
   }

   public final static int getCdrSerializedSize(controller_msgs.msg.dds.QuadrupedFootstepPlanningToolboxOutputStatus data, int current_alignment)
   {
      int initial_alignment = current_alignment;
   ...
   public static void write(controller_msgs.msg.dds.QuadrupedFootstepPlanningToolboxOutputStatus data, us.ihmc.idl.CDR cdr)
   {
   ...
   public static void read(controller_msgs.msg.dds.QuadrupedFootstepPlanningToolboxOutputStatus data, us.ihmc.idl.CDR cdr)
   {
   ...
   @Override
   public final void serialize(controller_msgs.msg.dds.QuadrupedFootstepPlanningToolboxOutputStatus data, us.ihmc.idl.InterchangeSerializer ser)
   {
   ...
   @Override
   public final void deserialize(us.ihmc.idl.InterchangeSerializer ser, controller_msgs.msg.dds.QuadrupedFootstepPlanningToolboxOutputStatus data)
   {
   ...
   public static void staticCopy(controller_msgs.msg.dds.QuadrupedFootstepPlanningToolboxOutputStatus src, controller_msgs.msg.dds.QuadrupedFootstepPlanningToolboxOutputStatus dest)
   {
      dest.set(src);
   }

   @Override
   public controller_msgs.msg.dds.QuadrupedFootstepPlanningToolboxOutputStatus createData()
   {
      return new controller_msgs.msg.dds.QuadrupedFootstepPlanningToolboxOutputStatus();
   }
   @Override
   ...
   public void serialize(controller_msgs.msg.dds.QuadrupedFootstepPlanningToolboxOutputStatus data, us.ihmc.idl.CDR cdr)
   {
      write(data, cdr);
   }

   public void deserialize(controller_msgs.msg.dds.QuadrupedFootstepPlanningToolboxOutputStatus data, us.ihmc.idl.CDR cdr)
   {
      read(data, cdr);
   }
   
   public void copy(controller_msgs.msg.dds.QuadrupedFootstepPlanningToolboxOutputStatus src, controller_msgs.msg.dds.QuadrupedFootstepPlanningToolboxOutputStatus dest)
   {
      staticCopy(src, dest);
   }

   @Override
   public QuadrupedFootstepPlanningToolboxOutputStatusPubSubType newInstance()
   {
      return new QuadrupedFootstepPlanningToolboxOutputStatusPubSubType();
   }
}
