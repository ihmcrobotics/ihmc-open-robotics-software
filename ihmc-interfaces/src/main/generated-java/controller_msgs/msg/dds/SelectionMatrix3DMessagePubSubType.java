...
public class SelectionMatrix3DMessagePubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.SelectionMatrix3DMessage>
{
   ...
   public SelectionMatrix3DMessagePubSubType()
   {
   ...
   public final static int getCdrSerializedSize(controller_msgs.msg.dds.SelectionMatrix3DMessage data)
   {
      return getCdrSerializedSize(data, 0);
   }

   public final static int getCdrSerializedSize(controller_msgs.msg.dds.SelectionMatrix3DMessage data, int current_alignment)
   {
      int initial_alignment = current_alignment;
   ...
   public static void staticCopy(controller_msgs.msg.dds.SelectionMatrix3DMessage src, controller_msgs.msg.dds.SelectionMatrix3DMessage dest)
   {
      dest.set(src);
   }
   ...
   @Override
   public controller_msgs.msg.dds.SelectionMatrix3DMessage createData()
   {
   ...
   public void deserialize(controller_msgs.msg.dds.SelectionMatrix3DMessage data, us.ihmc.idl.CDR cdr)
   {
      read(data, cdr);
   }
