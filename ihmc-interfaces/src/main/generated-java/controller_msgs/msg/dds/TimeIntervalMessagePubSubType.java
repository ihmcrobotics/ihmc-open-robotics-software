...
public class TimeIntervalMessagePubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.TimeIntervalMessage>
{
   ...
   @Override
   public void serialize(controller_msgs.msg.dds.TimeIntervalMessage data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   public final static int getCdrSerializedSize(controller_msgs.msg.dds.TimeIntervalMessage data)
   {
      return getCdrSerializedSize(data, 0);
   }

   public final static int getCdrSerializedSize(controller_msgs.msg.dds.TimeIntervalMessage data, int current_alignment)
   {
      int initial_alignment = current_alignment;
   ...
   public static void staticCopy(controller_msgs.msg.dds.TimeIntervalMessage src, controller_msgs.msg.dds.TimeIntervalMessage dest)
   {
      dest.set(src);
   }

   @Override
   public controller_msgs.msg.dds.TimeIntervalMessage createData()
   {
   ...
   public void deserialize(controller_msgs.msg.dds.TimeIntervalMessage data, us.ihmc.idl.CDR cdr)
   {
      read(data, cdr);
   }
