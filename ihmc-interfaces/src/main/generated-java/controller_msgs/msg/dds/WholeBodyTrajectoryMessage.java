...
public class WholeBodyTrajectoryMessage extends Packet<WholeBodyTrajectoryMessage> implements Settable<WholeBodyTrajectoryMessage>, EpsilonComparable<WholeBodyTrajectoryMessage>
{
   ...
   /**
            * Desired Center of Mass, only xy components are used
            */
   public controller_msgs.msg.dds.CenterOfMassTrajectoryMessage com_trajectory_;
   ...
   public WholeBodyTrajectoryMessage()
   {
      ...
      com_trajectory_ = new controller_msgs.msg.dds.CenterOfMassTrajectoryMessage();
   }
   ...
   public void set(WholeBodyTrajectoryMessage other)
   {
      ...
      controller_msgs.msg.dds.CenterOfMassTrajectoryMessagePubSubType.staticCopy(other.com_trajectory_, com_trajectory_);
   }
   ...
   /**
            * Desired Center of Mass, only xy components are used
            */
   public controller_msgs.msg.dds.CenterOfMassTrajectoryMessage getComTrajectory()
   {
   ...
   public boolean epsilonEquals(WholeBodyTrajectoryMessage other, double epsilon)
   {
      ...
      if (!this.com_trajectory_.epsilonEquals(other.com_trajectory_, epsilon)) return false;
   ...
   public boolean equals(Object other)
   {
      ...
      if (!this.com_trajectory_.equals(otherMyClass.com_trajectory_)) return false;
   ...
   public java.lang.String toString()
   {
      ...
      builder.append("com_trajectory=");
      builder.append(this.com_trajectory_);
      builder.append("}");
