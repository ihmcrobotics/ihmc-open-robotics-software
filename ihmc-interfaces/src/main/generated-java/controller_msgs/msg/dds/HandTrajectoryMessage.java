 ...
 * to move in taskspace a hand to the desired pose (position & orientation) while going through the
 ...
 * single straight line trajectory to reach a desired hand pose, set only one trajectory point with
