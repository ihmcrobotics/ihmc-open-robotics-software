      ...
      implements Settable<FootstepPlanningRequestPacket>, EpsilonComparable<FootstepPlanningRequestPacket>
{
   ...
   public boolean epsilonEquals(FootstepPlanningRequestPacket other, double epsilon)
   {
      ...
      if (!this.stance_foot_position_in_world_.epsilonEquals(other.stance_foot_position_in_world_, epsilon))
         return false;

      if (!this.stance_foot_orientation_in_world_.epsilonEquals(other.stance_foot_orientation_in_world_, epsilon))
         return false;

      if (!this.goal_position_in_world_.epsilonEquals(other.goal_position_in_world_, epsilon))
         return false;

      if (!this.goal_orientation_in_world_.epsilonEquals(other.goal_orientation_in_world_, epsilon))
         return false;

      if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.requested_footstep_planner_type_, other.requested_footstep_planner_type_, epsilon))
         return false;

      if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.timeout_, other.timeout_, epsilon))
         return false;

      if (!this.planar_regions_list_message_.epsilonEquals(other.planar_regions_list_message_, epsilon))
         return false;

      if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.planner_request_id_, other.planner_request_id_, epsilon))
         return false;
   ...
   public boolean equals(Object other)
   {
      ...
      if (other == this)
         return true;
      if (!(other instanceof FootstepPlanningRequestPacket))
         return false;
      ...
      if (!this.stance_foot_position_in_world_.equals(otherMyClass.stance_foot_position_in_world_))
         return false;

      if (!this.stance_foot_orientation_in_world_.equals(otherMyClass.stance_foot_orientation_in_world_))
         return false;

      if (!this.goal_position_in_world_.equals(otherMyClass.goal_position_in_world_))
         return false;

      if (!this.goal_orientation_in_world_.equals(otherMyClass.goal_orientation_in_world_))
         return false;

      if (this.requested_footstep_planner_type_ != otherMyClass.requested_footstep_planner_type_)
         return false;

      if (this.timeout_ != otherMyClass.timeout_)
         return false;

      if (!this.planar_regions_list_message_.equals(otherMyClass.planar_regions_list_message_))
         return false;

      if (this.planner_request_id_ != otherMyClass.planner_request_id_)
         return false;
   ...
   public java.lang.String toString()
   {
      ...
      builder.append(this.stance_foot_position_in_world_);

      builder.append(", ");
      builder.append("stance_foot_orientation_in_world=");
      builder.append(this.stance_foot_orientation_in_world_);

      builder.append(", ");
      builder.append("goal_position_in_world=");
      builder.append(this.goal_position_in_world_);

      builder.append(", ");
      builder.append("goal_orientation_in_world=");
      builder.append(this.goal_orientation_in_world_);
      ...
      builder.append(this.planar_regions_list_message_);
