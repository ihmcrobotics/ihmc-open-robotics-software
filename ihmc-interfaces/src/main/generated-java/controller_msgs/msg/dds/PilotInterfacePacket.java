...
public class PilotInterfacePacket extends Packet<PilotInterfacePacket> implements Settable<PilotInterfacePacket>, EpsilonComparable<PilotInterfacePacket>
{
   ...
   public boolean epsilonEquals(PilotInterfacePacket other, double epsilon)
   {
      ...
      if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.requested_behavior_state_, other.requested_behavior_state_, epsilon))
         return false;

      if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.desired_step_type_, other.desired_step_type_, epsilon))
         return false;

      if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.desired_step_length_type_, other.desired_step_length_type_, epsilon))
         return false;

      if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.desired_step_stairs_type_, other.desired_step_stairs_type_, epsilon))
         return false;

      if (!us.ihmc.idl.IDLTools.epsilonEqualsBoolean(this.desired_step_continous_walk_, other.desired_step_continous_walk_, epsilon))
         return false;

      if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.desired_steps_to_take_, other.desired_steps_to_take_, epsilon))
         return false;

      if (!us.ihmc.idl.IDLTools.epsilonEqualsBoolean(this.execute_behavior_, other.execute_behavior_, epsilon))
         return false;

      if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.desired_slope_step_type_, other.desired_slope_step_type_, epsilon))
         return false;

      if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.current_pilot_state_, other.current_pilot_state_, epsilon))
         return false;
   ...
   public boolean equals(Object other)
   {
      ...
      if (other == this)
         return true;
      if (!(other instanceof PilotInterfacePacket))
         return false;
      ...
      if (this.requested_behavior_state_ != otherMyClass.requested_behavior_state_)
         return false;

      if (this.desired_step_type_ != otherMyClass.desired_step_type_)
         return false;

      if (this.desired_step_length_type_ != otherMyClass.desired_step_length_type_)
         return false;

      if (this.desired_step_stairs_type_ != otherMyClass.desired_step_stairs_type_)
         return false;

      if (this.desired_step_continous_walk_ != otherMyClass.desired_step_continous_walk_)
         return false;

      if (this.desired_steps_to_take_ != otherMyClass.desired_steps_to_take_)
         return false;

      if (this.execute_behavior_ != otherMyClass.execute_behavior_)
         return false;

      if (this.desired_slope_step_type_ != otherMyClass.desired_slope_step_type_)
         return false;

      if (this.current_pilot_state_ != otherMyClass.current_pilot_state_)
         return false;
   ...
   public java.lang.String toString()
   {
      ...
      builder.append(this.requested_behavior_state_);
      builder.append(", ");
      builder.append("desired_step_type=");
      builder.append(this.desired_step_type_);
      builder.append(", ");
      builder.append("desired_step_length_type=");
      builder.append(this.desired_step_length_type_);
      builder.append(", ");
      builder.append("desired_step_stairs_type=");
      builder.append(this.desired_step_stairs_type_);
      builder.append(", ");
      builder.append("desired_step_continous_walk=");
      builder.append(this.desired_step_continous_walk_);
      builder.append(", ");
      builder.append("desired_steps_to_take=");
      builder.append(this.desired_steps_to_take_);
      builder.append(", ");
