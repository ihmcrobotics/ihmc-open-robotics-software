 ...
 */
public class QuadrupedBodyHeightMessage extends Packet<QuadrupedBodyHeightMessage>
      implements Settable<QuadrupedBodyHeightMessage>, EpsilonComparable<QuadrupedBodyHeightMessage>
{
   /**
    ...
    */
   public boolean is_expressed_in_absolute_time_ = false;
   /**
   ...
   public boolean epsilonEquals(QuadrupedBodyHeightMessage other, double epsilon)
   {
      ...
      if (!us.ihmc.idl.IDLTools.epsilonEqualsBoolean(this.control_body_height_, other.control_body_height_, epsilon))
         return false;
   ...
   public boolean equals(Object other)
   {
      ...
      if (other == this)
         return true;
      if (!(other instanceof QuadrupedBodyHeightMessage))
         return false;
      ...
      if (this.control_body_height_ != otherMyClass.control_body_height_)
         return false;
   ...
   public java.lang.String toString()
   {
      ...
      builder.append(this.control_body_height_);
      builder.append(", ");
