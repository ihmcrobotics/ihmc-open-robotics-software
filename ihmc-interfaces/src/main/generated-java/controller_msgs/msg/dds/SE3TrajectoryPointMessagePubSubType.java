...
public class SE3TrajectoryPointMessagePubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.SE3TrajectoryPointMessage>
{
   ...
   @Override
   public void serialize(controller_msgs.msg.dds.SE3TrajectoryPointMessage data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, controller_msgs.msg.dds.SE3TrajectoryPointMessage data) throws java.io.IOException
   {
