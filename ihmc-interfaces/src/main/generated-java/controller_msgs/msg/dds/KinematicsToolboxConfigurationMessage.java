...
/**
 * This message is part of the IHMC hole-body inverse kinematics module. It contains auxiliary
 * information that allows to further customized the behavior of the solver.
 */
      ...
      implements Settable<KinematicsToolboxConfigurationMessage>, EpsilonComparable<KinematicsToolboxConfigurationMessage>
{
   ...
   /**
    * This array is used to identify to which joint each angle in privileged_joint_angles belongs
    * to. See AbstractInverseDynamicsJoint.getNameBaseHashCode() for the computation of a joint hash
    * code.
    */
