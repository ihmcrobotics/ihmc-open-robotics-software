 ...
 */
public class QuadrupedRequestedControllerStateMessage extends Packet<QuadrupedRequestedControllerStateMessage>
      implements Settable<QuadrupedRequestedControllerStateMessage>, EpsilonComparable<QuadrupedRequestedControllerStateMessage>
{
   ...
   public boolean epsilonEquals(QuadrupedRequestedControllerStateMessage other, double epsilon)
   {
      ...
      if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.quadruped_controller_name_, other.quadruped_controller_name_, epsilon))
         return false;
   ...
   public boolean equals(Object other)
   {
      ...
      if (other == this)
         return true;
      if (!(other instanceof QuadrupedRequestedControllerStateMessage))
         return false;
      ...
      if (this.quadruped_controller_name_ != otherMyClass.quadruped_controller_name_)
         return false;
