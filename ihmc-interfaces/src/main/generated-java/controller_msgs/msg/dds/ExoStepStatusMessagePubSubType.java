...
*
*/
public class ExoStepStatusMessagePubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.ExoStepStatusMessage>
{
   public static final java.lang.String name = "controller_msgs::msg::dds_::ExoStepStatusMessage_";

   private final us.ihmc.idl.CDR serializeCDR = new us.ihmc.idl.CDR();
   private final us.ihmc.idl.CDR deserializeCDR = new us.ihmc.idl.CDR();

   @Override
   public void serialize(controller_msgs.msg.dds.ExoStepStatusMessage data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, controller_msgs.msg.dds.ExoStepStatusMessage data) throws java.io.IOException
   {
   ...
   public final static int getCdrSerializedSize(controller_msgs.msg.dds.ExoStepStatusMessage data)
   {
      return getCdrSerializedSize(data, 0);
   }

   public final static int getCdrSerializedSize(controller_msgs.msg.dds.ExoStepStatusMessage data, int current_alignment)
   {
      int initial_alignment = current_alignment;
   ...
   public static void staticCopy(controller_msgs.msg.dds.ExoStepStatusMessage src, controller_msgs.msg.dds.ExoStepStatusMessage dest)
   {
      dest.set(src);
   }

   @Override
   public controller_msgs.msg.dds.ExoStepStatusMessage createData()
   {
      return new controller_msgs.msg.dds.ExoStepStatusMessage();
   }
   @Override
   ...
   public void serialize(controller_msgs.msg.dds.ExoStepStatusMessage data, us.ihmc.idl.CDR cdr)
   {
      write(data, cdr);
   }

   public void deserialize(controller_msgs.msg.dds.ExoStepStatusMessage data, us.ihmc.idl.CDR cdr)
   {
      read(data, cdr);
   }
   
   public void copy(controller_msgs.msg.dds.ExoStepStatusMessage src, controller_msgs.msg.dds.ExoStepStatusMessage dest)
   {
      staticCopy(src, dest);
   }
