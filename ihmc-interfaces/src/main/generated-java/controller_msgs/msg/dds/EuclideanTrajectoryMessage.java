...
/**
       ...
       */
public class EuclideanTrajectoryMessage extends Packet<EuclideanTrajectoryMessage> implements Settable<EuclideanTrajectoryMessage>, EpsilonComparable<EuclideanTrajectoryMessage>
{
   ...
   public EuclideanTrajectoryMessage()
   {
      ...
      taskspace_trajectory_points_ = new us.ihmc.idl.IDLSequence.Object<controller_msgs.msg.dds.EuclideanTrajectoryPointMessage> (50, new controller_msgs.msg.dds.EuclideanTrajectoryPointMessagePubSubType());
   ...
   public static Supplier<EuclideanTrajectoryMessagePubSubType> getPubSubType()
   {
      return EuclideanTrajectoryMessagePubSubType::new;
   }
   ...
   public boolean equals(Object other)
   {
      if(other == null) return false;
      if(other == this) return true;
      if(!(other instanceof EuclideanTrajectoryMessage)) return false;
