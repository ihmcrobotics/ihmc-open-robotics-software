 ...
 */
public class QuadrupedBodyPathPlanMessage extends Packet<QuadrupedBodyPathPlanMessage>
      implements Settable<QuadrupedBodyPathPlanMessage>, EpsilonComparable<QuadrupedBodyPathPlanMessage>
{
   /**
   ...
   {
      body_path_points_ = new us.ihmc.idl.IDLSequence.Object<controller_msgs.msg.dds.EuclideanTrajectoryPointMessage>(1,
   ...
   public boolean epsilonEquals(QuadrupedBodyPathPlanMessage other, double epsilon)
   {
      ...
      if (this.body_path_points_.size() != other.body_path_points_.size())
      {
         return false;
      }
      else
      {
         ...
         {
            if (!this.body_path_points_.get(i).epsilonEquals(other.body_path_points_.get(i), epsilon))
               return false;
         }
      }
   ...
   public boolean equals(Object other)
   {
      ...
      if (other == this)
         return true;
      if (!(other instanceof QuadrupedBodyPathPlanMessage))
         return false;
      ...
      if (!this.body_path_points_.equals(otherMyClass.body_path_points_))
         return false;
