...
public class QuadrupedStepMessagePubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.QuadrupedStepMessage>
{
   ...
   @Override
   public void serialize(controller_msgs.msg.dds.QuadrupedStepMessage data, us.ihmc.pubsub.common.SerializedPayload serializedPayload)
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, controller_msgs.msg.dds.QuadrupedStepMessage data)
         throws java.io.IOException
   {
