...
/**
       ...
       */
public class QuadrupedFootstepPlanningToolboxOutputStatus extends Packet<QuadrupedFootstepPlanningToolboxOutputStatus> implements Settable<QuadrupedFootstepPlanningToolboxOutputStatus>, EpsilonComparable<QuadrupedFootstepPlanningToolboxOutputStatus>
{
   ...
   public QuadrupedFootstepPlanningToolboxOutputStatus()
   {
   ...
   public QuadrupedFootstepPlanningToolboxOutputStatus(QuadrupedFootstepPlanningToolboxOutputStatus other)
   {
      this();
      set(other);
   }

   public void set(QuadrupedFootstepPlanningToolboxOutputStatus other)
   {
   ...
   public static Supplier<QuadrupedFootstepPlanningToolboxOutputStatusPubSubType> getPubSubType()
   {
      return QuadrupedFootstepPlanningToolboxOutputStatusPubSubType::new;
   }
   ...
   @Override
   public boolean epsilonEquals(QuadrupedFootstepPlanningToolboxOutputStatus other, double epsilon)
   {
   ...
   public boolean equals(Object other)
   {
      if(other == null) return false;
      if(other == this) return true;
      if(!(other instanceof QuadrupedFootstepPlanningToolboxOutputStatus)) return false;

      QuadrupedFootstepPlanningToolboxOutputStatus otherMyClass = (QuadrupedFootstepPlanningToolboxOutputStatus) other;
   ...
   public java.lang.String toString()
   {
      ...
      builder.append("QuadrupedFootstepPlanningToolboxOutputStatus {");
