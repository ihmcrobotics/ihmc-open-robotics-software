...
/**
 * This message is part of the IHMC whole-body controller API. Notifies the user that a
 * MessageCollection has been received. This is used to know when the controller is ready to start
 * collecting the actual collection of messages.
 */
public class MessageCollectionNotification extends Packet<MessageCollectionNotification>
      implements Settable<MessageCollectionNotification>, EpsilonComparable<MessageCollectionNotification>
{
   /**
   ...
   public boolean epsilonEquals(MessageCollectionNotification other, double epsilon)
   {
      ...
      if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.message_collection_sequence_id_, other.message_collection_sequence_id_, epsilon))
         return false;
   ...
   public boolean equals(Object other)
   {
      ...
      if (other == this)
         return true;
      if (!(other instanceof MessageCollectionNotification))
         return false;
      ...
      if (this.message_collection_sequence_id_ != otherMyClass.message_collection_sequence_id_)
         return false;
