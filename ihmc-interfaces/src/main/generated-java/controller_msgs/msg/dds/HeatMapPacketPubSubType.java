...
public class HeatMapPacketPubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.HeatMapPacket>
{
   ...
   public final static int getCdrSerializedSize(controller_msgs.msg.dds.HeatMapPacket data)
   {
      return getCdrSerializedSize(data, 0);
   }

   public final static int getCdrSerializedSize(controller_msgs.msg.dds.HeatMapPacket data, int current_alignment)
   {
      int initial_alignment = current_alignment;
   ...
   @Override
   public controller_msgs.msg.dds.HeatMapPacket createData()
   {
   ...
   public void deserialize(controller_msgs.msg.dds.HeatMapPacket data, us.ihmc.idl.CDR cdr)
   {
      read(data, cdr);
   }
