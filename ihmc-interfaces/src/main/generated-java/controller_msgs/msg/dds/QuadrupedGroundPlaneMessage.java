 ...
 */
public class QuadrupedGroundPlaneMessage extends Packet<QuadrupedGroundPlaneMessage>
      implements Settable<QuadrupedGroundPlaneMessage>, EpsilonComparable<QuadrupedGroundPlaneMessage>
{
   /**
   ...
   public boolean equals(Object other)
   {
      ...
      if (other == this)
         return true;
      if (!(other instanceof QuadrupedGroundPlaneMessage))
         return false;
