...
public class WholeBodyTrajectoryMessagePubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.WholeBodyTrajectoryMessage>
{
   ...
   public WholeBodyTrajectoryMessagePubSubType()
   {
   ...
   public final static int getCdrSerializedSize(controller_msgs.msg.dds.WholeBodyTrajectoryMessage data, int current_alignment)
   {
      ...
      current_alignment += controller_msgs.msg.dds.HandTrajectoryMessagePubSubType
            .getCdrSerializedSize(data.getRightHandTrajectoryMessage(), current_alignment);
      ...
      current_alignment += controller_msgs.msg.dds.FootTrajectoryMessagePubSubType
            .getCdrSerializedSize(data.getRightFootTrajectoryMessage(), current_alignment);
