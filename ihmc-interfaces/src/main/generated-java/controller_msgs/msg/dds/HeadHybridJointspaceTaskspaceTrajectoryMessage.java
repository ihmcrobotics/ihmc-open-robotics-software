 ...
 * to move the head in both taskspace and jointspace to the desired orientation and joint angles
      ...
      implements Settable<HeadHybridJointspaceTaskspaceTrajectoryMessage>, EpsilonComparable<HeadHybridJointspaceTaskspaceTrajectoryMessage>
{
    ...
    * joint the closest to the chest to the joint the closest to the head.
    */
