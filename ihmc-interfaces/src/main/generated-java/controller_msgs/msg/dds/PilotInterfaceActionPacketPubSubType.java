...
public class PilotInterfaceActionPacketPubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.PilotInterfaceActionPacket>
{
   ...
   @Override
   public void serialize(controller_msgs.msg.dds.PilotInterfaceActionPacket data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, controller_msgs.msg.dds.PilotInterfaceActionPacket data) throws java.io.IOException
   {
