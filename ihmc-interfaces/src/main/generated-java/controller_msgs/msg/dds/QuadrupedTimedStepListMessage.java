...
public class QuadrupedTimedStepListMessage extends Packet<QuadrupedTimedStepListMessage>
      implements Settable<QuadrupedTimedStepListMessage>, EpsilonComparable<QuadrupedTimedStepListMessage>
{
   /**
   ...
   {
      quadruped_step_list_ = new us.ihmc.idl.IDLSequence.Object<controller_msgs.msg.dds.QuadrupedTimedStepMessage>(100,
                                                                                                                   controller_msgs.msg.dds.QuadrupedTimedStepMessage.class,
                                                                                                                   new controller_msgs.msg.dds.QuadrupedTimedStepMessagePubSubType());
   ...
   public boolean epsilonEquals(QuadrupedTimedStepListMessage other, double epsilon)
   {
      ...
      if (this.quadruped_step_list_.size() != other.quadruped_step_list_.size())
      {
         return false;
      }
      else
      {
         ...
         {
            if (!this.quadruped_step_list_.get(i).epsilonEquals(other.quadruped_step_list_.get(i), epsilon))
               return false;
         }
      }
   ...
   public boolean equals(Object other)
   {
      ...
      if (other == this)
         return true;
      if (!(other instanceof QuadrupedTimedStepListMessage))
         return false;
      ...
      if (!this.quadruped_step_list_.equals(otherMyClass.quadruped_step_list_))
         return false;
   ...
   public java.lang.String toString()
   {
      ...
      builder.append(this.quadruped_step_list_);
      builder.append(", ");
