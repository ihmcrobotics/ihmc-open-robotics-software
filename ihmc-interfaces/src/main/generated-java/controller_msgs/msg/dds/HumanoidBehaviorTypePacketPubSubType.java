...
public class HumanoidBehaviorTypePacketPubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.HumanoidBehaviorTypePacket>
{
   ...
   @Override
   public void serialize(controller_msgs.msg.dds.HumanoidBehaviorTypePacket data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, controller_msgs.msg.dds.HumanoidBehaviorTypePacket data) throws java.io.IOException
   {
