...
/**
 * 
 * Topic data type of the struct "FootstepPlanningToolboxOutputStatus" defined in
 * "FootstepPlanningToolboxOutputStatus_.idl". Use this class to provide the TopicDataType to a
 * Participant.
 *
 * This file was automatically generated from FootstepPlanningToolboxOutputStatus_.idl by
 * us.ihmc.idl.generator.IDLGenerator. Do not update this file directly, edit
 * FootstepPlanningToolboxOutputStatus_.idl instead.
 *
 */
public class FootstepPlanningToolboxOutputStatusPubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.FootstepPlanningToolboxOutputStatus>
{
   ...
   @Override
   public void serialize(controller_msgs.msg.dds.FootstepPlanningToolboxOutputStatus data, us.ihmc.pubsub.common.SerializedPayload serializedPayload)
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, controller_msgs.msg.dds.FootstepPlanningToolboxOutputStatus data)
         throws java.io.IOException
   {
   ...
   public static void write(controller_msgs.msg.dds.FootstepPlanningToolboxOutputStatus data, us.ihmc.idl.CDR cdr)
   {
      ...
      if (data.getBodyPath().size() <= 100)
         cdr.write_type_e(data.getBodyPath());
      else
   ...
   public static void staticCopy(controller_msgs.msg.dds.FootstepPlanningToolboxOutputStatus src,
                                 controller_msgs.msg.dds.FootstepPlanningToolboxOutputStatus dest)
   {
      dest.set(src);
   }
