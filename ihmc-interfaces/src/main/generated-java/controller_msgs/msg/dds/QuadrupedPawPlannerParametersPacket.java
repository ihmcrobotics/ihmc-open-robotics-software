...
/**
       ...
       */
public class QuadrupedPawPlannerParametersPacket extends Packet<QuadrupedPawPlannerParametersPacket> implements Settable<QuadrupedPawPlannerParametersPacket>, EpsilonComparable<QuadrupedPawPlannerParametersPacket>
{
   ...
   public double min_x_clearance_from_paw_ = -11.1;
   public double min_y_clearance_from_paw_ = -11.1;
   ...
   public QuadrupedPawPlannerParametersPacket()
   {
   }

   public QuadrupedPawPlannerParametersPacket(QuadrupedPawPlannerParametersPacket other)
   {
      this();
      set(other);
   }

   public void set(QuadrupedPawPlannerParametersPacket other)
   {
      ...
      min_x_clearance_from_paw_ = other.min_x_clearance_from_paw_;

      min_y_clearance_from_paw_ = other.min_y_clearance_from_paw_;
   ...
   public void setMinXClearanceFromPaw(double min_x_clearance_from_paw)
   {
      min_x_clearance_from_paw_ = min_x_clearance_from_paw;
   }
   public double getMinXClearanceFromPaw()
   {
      return min_x_clearance_from_paw_;
   }

   public void setMinYClearanceFromPaw(double min_y_clearance_from_paw)
   {
      min_y_clearance_from_paw_ = min_y_clearance_from_paw;
   }
   public double getMinYClearanceFromPaw()
   {
      return min_y_clearance_from_paw_;
   }
   ...
   public static Supplier<QuadrupedPawPlannerParametersPacketPubSubType> getPubSubType()
   {
      return QuadrupedPawPlannerParametersPacketPubSubType::new;
   }
   ...
   @Override
   public boolean epsilonEquals(QuadrupedPawPlannerParametersPacket other, double epsilon)
   {
      ...
      if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.min_x_clearance_from_paw_, other.min_x_clearance_from_paw_, epsilon)) return false;

      if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.min_y_clearance_from_paw_, other.min_y_clearance_from_paw_, epsilon)) return false;
   ...
   public boolean equals(Object other)
   {
      if(other == null) return false;
      if(other == this) return true;
      if(!(other instanceof QuadrupedPawPlannerParametersPacket)) return false;

      QuadrupedPawPlannerParametersPacket otherMyClass = (QuadrupedPawPlannerParametersPacket) other;
      ...
      if(this.min_x_clearance_from_paw_ != otherMyClass.min_x_clearance_from_paw_) return false;

      if(this.min_y_clearance_from_paw_ != otherMyClass.min_y_clearance_from_paw_) return false;
   ...
   public java.lang.String toString()
   {
      ...
      builder.append("QuadrupedPawPlannerParametersPacket {");
      ...
      builder.append("min_x_clearance_from_paw=");
      builder.append(this.min_x_clearance_from_paw_);      builder.append(", ");
      builder.append("min_y_clearance_from_paw=");
      builder.append(this.min_y_clearance_from_paw_);      builder.append(", ");
