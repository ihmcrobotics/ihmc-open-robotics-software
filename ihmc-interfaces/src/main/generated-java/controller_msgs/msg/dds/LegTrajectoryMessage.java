...
/**
       ...
       */
public class LegTrajectoryMessage extends Packet<LegTrajectoryMessage> implements Settable<LegTrajectoryMessage>, EpsilonComparable<LegTrajectoryMessage>
{
   ...
   public LegTrajectoryMessage(LegTrajectoryMessage other)
   {
      this();
      set(other);
   }

   public void set(LegTrajectoryMessage other)
   {
   ...
   public static Supplier<LegTrajectoryMessagePubSubType> getPubSubType()
   {
      return LegTrajectoryMessagePubSubType::new;
   }
   ...
   @Override
   public boolean epsilonEquals(LegTrajectoryMessage other, double epsilon)
   {
   ...
   public boolean equals(Object other)
   {
      if(other == null) return false;
      if(other == this) return true;
      if(!(other instanceof LegTrajectoryMessage)) return false;

      LegTrajectoryMessage otherMyClass = (LegTrajectoryMessage) other;
