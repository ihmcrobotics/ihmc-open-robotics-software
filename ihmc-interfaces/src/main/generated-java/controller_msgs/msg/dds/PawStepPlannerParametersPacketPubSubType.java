...
*
*/
public class PawStepPlannerParametersPacketPubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.PawStepPlannerParametersPacket>
{
   public static final java.lang.String name = "controller_msgs::msg::dds_::PawStepPlannerParametersPacket_";

   private final us.ihmc.idl.CDR serializeCDR = new us.ihmc.idl.CDR();
   private final us.ihmc.idl.CDR deserializeCDR = new us.ihmc.idl.CDR();

   @Override
   public void serialize(controller_msgs.msg.dds.PawStepPlannerParametersPacket data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, controller_msgs.msg.dds.PawStepPlannerParametersPacket data) throws java.io.IOException
   {
   ...
   public final static int getCdrSerializedSize(controller_msgs.msg.dds.PawStepPlannerParametersPacket data)
   {
      return getCdrSerializedSize(data, 0);
   }

   public final static int getCdrSerializedSize(controller_msgs.msg.dds.PawStepPlannerParametersPacket data, int current_alignment)
   {
      int initial_alignment = current_alignment;
   ...
   public static void write(controller_msgs.msg.dds.PawStepPlannerParametersPacket data, us.ihmc.idl.CDR cdr)
   {
   ...
   public static void read(controller_msgs.msg.dds.PawStepPlannerParametersPacket data, us.ihmc.idl.CDR cdr)
   {
   ...
   @Override
   public final void serialize(controller_msgs.msg.dds.PawStepPlannerParametersPacket data, us.ihmc.idl.InterchangeSerializer ser)
   {
   ...
   @Override
   public final void deserialize(us.ihmc.idl.InterchangeSerializer ser, controller_msgs.msg.dds.PawStepPlannerParametersPacket data)
   {
   ...
   public static void staticCopy(controller_msgs.msg.dds.PawStepPlannerParametersPacket src, controller_msgs.msg.dds.PawStepPlannerParametersPacket dest)
   {
      dest.set(src);
   }

   @Override
   public controller_msgs.msg.dds.PawStepPlannerParametersPacket createData()
   {
      return new controller_msgs.msg.dds.PawStepPlannerParametersPacket();
   }
   @Override
   ...
   public void serialize(controller_msgs.msg.dds.PawStepPlannerParametersPacket data, us.ihmc.idl.CDR cdr)
   {
      write(data, cdr);
   }

   public void deserialize(controller_msgs.msg.dds.PawStepPlannerParametersPacket data, us.ihmc.idl.CDR cdr)
   {
      read(data, cdr);
   }
   
   public void copy(controller_msgs.msg.dds.PawStepPlannerParametersPacket src, controller_msgs.msg.dds.PawStepPlannerParametersPacket dest)
   {
      staticCopy(src, dest);
   }
