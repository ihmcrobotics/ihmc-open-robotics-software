...
/**
 * 
 * Topic data type of the struct "StereoVisionPointCloudMessage" defined in
 * "StereoVisionPointCloudMessage_.idl". Use this class to provide the TopicDataType to a
 * Participant.
 *
 * This file was automatically generated from StereoVisionPointCloudMessage_.idl by
 * us.ihmc.idl.generator.IDLGenerator. Do not update this file directly, edit
 * StereoVisionPointCloudMessage_.idl instead.
 *
 */
public class StereoVisionPointCloudMessagePubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.StereoVisionPointCloudMessage>
{
   ...
   @Override
   public void serialize(controller_msgs.msg.dds.StereoVisionPointCloudMessage data, us.ihmc.pubsub.common.SerializedPayload serializedPayload)
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, controller_msgs.msg.dds.StereoVisionPointCloudMessage data)
         throws java.io.IOException
   {
   ...
   public static void write(controller_msgs.msg.dds.StereoVisionPointCloudMessage data, us.ihmc.idl.CDR cdr)
   {
      ...
      if (data.getPointCloud().size() <= 100)
         cdr.write_type_e(data.getPointCloud());
      else
