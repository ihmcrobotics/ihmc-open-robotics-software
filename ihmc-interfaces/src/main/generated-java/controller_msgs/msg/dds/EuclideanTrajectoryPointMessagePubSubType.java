...
/**
 * 
 * Topic data type of the struct "EuclideanTrajectoryPointMessage" defined in
 * "EuclideanTrajectoryPointMessage_.idl". Use this class to provide the TopicDataType to a
 * Participant.
 *
 * This file was automatically generated from EuclideanTrajectoryPointMessage_.idl by
 * us.ihmc.idl.generator.IDLGenerator. Do not update this file directly, edit
 * EuclideanTrajectoryPointMessage_.idl instead.
 *
 */
public class EuclideanTrajectoryPointMessagePubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.EuclideanTrajectoryPointMessage>
{
   ...
   @Override
   public void serialize(controller_msgs.msg.dds.EuclideanTrajectoryPointMessage data, us.ihmc.pubsub.common.SerializedPayload serializedPayload)
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, controller_msgs.msg.dds.EuclideanTrajectoryPointMessage data)
         throws java.io.IOException
   {
