...
/**
 * 
 * Topic data type of the struct "RobotConfigurationData" defined in "RobotConfigurationData_.idl".
 * Use this class to provide the TopicDataType to a Participant.
 *
 * This file was automatically generated from RobotConfigurationData_.idl by
 * us.ihmc.idl.generator.IDLGenerator. Do not update this file directly, edit
 * RobotConfigurationData_.idl instead.
 *
 */
public class RobotConfigurationDataPubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.RobotConfigurationData>
{
   ...
   public static void write(controller_msgs.msg.dds.RobotConfigurationData data, us.ihmc.idl.CDR cdr)
   {
      ...
      if (data.getImuSensorData().size() <= 10)
