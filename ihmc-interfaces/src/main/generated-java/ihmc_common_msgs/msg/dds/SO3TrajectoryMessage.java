...
public class SO3TrajectoryMessage extends Packet<SO3TrajectoryMessage> implements Settable<SO3TrajectoryMessage>, EpsilonComparable<SO3TrajectoryMessage>
{
   ...
   /**
            ...
            */
   public us.ihmc.idl.IDLSequence.Object<ihmc_common_msgs.msg.dds.SO3TrajectoryPointMessage>  taskspace_trajectory_points_;
   /**
   ...
   /**
            ...
            */
   public ihmc_common_msgs.msg.dds.WeightMatrix3DMessage weight_matrix_;
   /**
   ...
   {
      taskspace_trajectory_points_ = new us.ihmc.idl.IDLSequence.Object<ihmc_common_msgs.msg.dds.SO3TrajectoryPointMessage> (50, new ihmc_common_msgs.msg.dds.SO3TrajectoryPointMessagePubSubType());
   ...
   public void set(SO3TrajectoryMessage other)
   {
      ...
      ihmc_common_msgs.msg.dds.WeightMatrix3DMessagePubSubType.staticCopy(other.weight_matrix_, weight_matrix_);
   ...
   /**
            * List of trajectory points (in taskpsace) to go through while executing the trajectory.
            */
   public us.ihmc.idl.IDLSequence.Object<ihmc_common_msgs.msg.dds.SO3TrajectoryPointMessage>  getTaskspaceTrajectoryPoints()
   {
