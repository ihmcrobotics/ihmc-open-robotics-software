...
public class AthenaTrajectoryMessage extends Packet<AthenaTrajectoryMessage> implements Settable<AthenaTrajectoryMessage>, EpsilonComparable<AthenaTrajectoryMessage>
{
   /**
   ...
   public AthenaTrajectoryMessage()
   {
   ...
   public AthenaTrajectoryMessage(AthenaTrajectoryMessage other)
   {
      this();
      set(other);
   }

   public void set(AthenaTrajectoryMessage other)
   {
   ...
   public static Supplier<AthenaTrajectoryMessagePubSubType> getPubSubType()
   {
      return AthenaTrajectoryMessagePubSubType::new;
   }
   ...
   @Override
   public boolean epsilonEquals(AthenaTrajectoryMessage other, double epsilon)
   {
   ...
   public boolean equals(Object other)
   {
      if(other == null) return false;
      if(other == this) return true;
      if(!(other instanceof AthenaTrajectoryMessage)) return false;

      AthenaTrajectoryMessage otherMyClass = (AthenaTrajectoryMessage) other;
   ...
   public java.lang.String toString()
   {
      ...
      builder.append("AthenaTrajectoryMessage {");
