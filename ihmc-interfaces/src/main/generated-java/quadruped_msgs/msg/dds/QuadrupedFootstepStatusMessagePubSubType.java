...
*
*/
public class QuadrupedFootstepStatusMessagePubSubType implements us.ihmc.pubsub.TopicDataType<quadruped_msgs.msg.dds.QuadrupedFootstepStatusMessage>
{
   public static final java.lang.String name = "quadruped_msgs::msg::dds_::QuadrupedFootstepStatusMessage_";
   ...
   @Override
   public void serialize(quadruped_msgs.msg.dds.QuadrupedFootstepStatusMessage data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, quadruped_msgs.msg.dds.QuadrupedFootstepStatusMessage data) throws java.io.IOException
   {
   ...
   public final static int getCdrSerializedSize(quadruped_msgs.msg.dds.QuadrupedFootstepStatusMessage data)
   {
      return getCdrSerializedSize(data, 0);
   }

   public final static int getCdrSerializedSize(quadruped_msgs.msg.dds.QuadrupedFootstepStatusMessage data, int current_alignment)
   {
      int initial_alignment = current_alignment;
   ...
   public static void write(quadruped_msgs.msg.dds.QuadrupedFootstepStatusMessage data, us.ihmc.idl.CDR cdr)
   {
   ...
   @Override
   public final void serialize(quadruped_msgs.msg.dds.QuadrupedFootstepStatusMessage data, us.ihmc.idl.InterchangeSerializer ser)
   {
   ...
   @Override
   public final void deserialize(us.ihmc.idl.InterchangeSerializer ser, quadruped_msgs.msg.dds.QuadrupedFootstepStatusMessage data)
   {
   ...
   public static void staticCopy(quadruped_msgs.msg.dds.QuadrupedFootstepStatusMessage src, quadruped_msgs.msg.dds.QuadrupedFootstepStatusMessage dest)
   {
      dest.set(src);
   }

   @Override
   public quadruped_msgs.msg.dds.QuadrupedFootstepStatusMessage createData()
   {
      return new quadruped_msgs.msg.dds.QuadrupedFootstepStatusMessage();
   }
   @Override
   ...
   public void serialize(quadruped_msgs.msg.dds.QuadrupedFootstepStatusMessage data, us.ihmc.idl.CDR cdr)
   {
      write(data, cdr);
   }

   public void deserialize(quadruped_msgs.msg.dds.QuadrupedFootstepStatusMessage data, us.ihmc.idl.CDR cdr)
   {
      read(data, cdr);
   }
   
   public void copy(quadruped_msgs.msg.dds.QuadrupedFootstepStatusMessage src, quadruped_msgs.msg.dds.QuadrupedFootstepStatusMessage dest)
   {
      staticCopy(src, dest);
   }
