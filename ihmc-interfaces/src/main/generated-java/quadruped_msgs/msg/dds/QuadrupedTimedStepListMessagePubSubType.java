...
*
*/
public class QuadrupedTimedStepListMessagePubSubType implements us.ihmc.pubsub.TopicDataType<quadruped_msgs.msg.dds.QuadrupedTimedStepListMessage>
{
   public static final java.lang.String name = "quadruped_msgs::msg::dds_::QuadrupedTimedStepListMessage_";
   ...
   @Override
   public void serialize(quadruped_msgs.msg.dds.QuadrupedTimedStepListMessage data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, quadruped_msgs.msg.dds.QuadrupedTimedStepListMessage data) throws java.io.IOException
   {
   ...
   public static int getMaxCdrSerializedSize(int current_alignment)
   {
      ...
      {
          current_alignment += quadruped_msgs.msg.dds.QuadrupedTimedStepMessagePubSubType.getMaxCdrSerializedSize(current_alignment);}
   ...
   public final static int getCdrSerializedSize(quadruped_msgs.msg.dds.QuadrupedTimedStepListMessage data)
   {
      return getCdrSerializedSize(data, 0);
   }

   public final static int getCdrSerializedSize(quadruped_msgs.msg.dds.QuadrupedTimedStepListMessage data, int current_alignment)
   {
      int initial_alignment = current_alignment;
      ...
      {
          current_alignment += quadruped_msgs.msg.dds.QuadrupedTimedStepMessagePubSubType.getCdrSerializedSize(data.getQuadrupedStepList().get(i0), current_alignment);}
   ...
   public static void write(quadruped_msgs.msg.dds.QuadrupedTimedStepListMessage data, us.ihmc.idl.CDR cdr)
   {
   ...
   public static void read(quadruped_msgs.msg.dds.QuadrupedTimedStepListMessage data, us.ihmc.idl.CDR cdr)
   {
   ...
   @Override
   public final void serialize(quadruped_msgs.msg.dds.QuadrupedTimedStepListMessage data, us.ihmc.idl.InterchangeSerializer ser)
   {
   ...
   @Override
   public final void deserialize(us.ihmc.idl.InterchangeSerializer ser, quadruped_msgs.msg.dds.QuadrupedTimedStepListMessage data)
   {
   ...
   public static void staticCopy(quadruped_msgs.msg.dds.QuadrupedTimedStepListMessage src, quadruped_msgs.msg.dds.QuadrupedTimedStepListMessage dest)
   {
      dest.set(src);
   }

   @Override
   public quadruped_msgs.msg.dds.QuadrupedTimedStepListMessage createData()
   {
      return new quadruped_msgs.msg.dds.QuadrupedTimedStepListMessage();
   }
   @Override
   ...
   public void serialize(quadruped_msgs.msg.dds.QuadrupedTimedStepListMessage data, us.ihmc.idl.CDR cdr)
   {
      write(data, cdr);
   }

   public void deserialize(quadruped_msgs.msg.dds.QuadrupedTimedStepListMessage data, us.ihmc.idl.CDR cdr)
   {
      read(data, cdr);
   }
   
   public void copy(quadruped_msgs.msg.dds.QuadrupedTimedStepListMessage src, quadruped_msgs.msg.dds.QuadrupedTimedStepListMessage dest)
   {
      staticCopy(src, dest);
   }
