...
public class PawStepPlanningToolboxOutputStatus extends Packet<PawStepPlanningToolboxOutputStatus> implements Settable<PawStepPlanningToolboxOutputStatus>, EpsilonComparable<PawStepPlanningToolboxOutputStatus>
{
   ...
   public quadruped_msgs.msg.dds.QuadrupedTimedStepListMessage footstep_data_list_;
   ...
   public void set(PawStepPlanningToolboxOutputStatus other)
   {
      ...
      quadruped_msgs.msg.dds.QuadrupedTimedStepListMessagePubSubType.staticCopy(other.footstep_data_list_, footstep_data_list_);
   ...
   public quadruped_msgs.msg.dds.QuadrupedTimedStepListMessage getFootstepDataList()
   {
