...
public class QuadrupedXGaitSettingsPacket extends Packet<QuadrupedXGaitSettingsPacket> implements Settable<QuadrupedXGaitSettingsPacket>, EpsilonComparable<QuadrupedXGaitSettingsPacket>
{
   ...
   public quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacket pace_slow_settings_packet_;
   public quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacket pace_medium_settings_packet_;
   public quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacket pace_fast_settings_packet_;
   public quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacket amble_slow_settings_packet_;
   public quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacket amble_medium_settings_packet_;
   public quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacket amble_fast_settings_packet_;
   public quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacket trot_slow_settings_packet_;
   public quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacket trot_medium_settings_packet_;
   public quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacket trot_fast_settings_packet_;

   public QuadrupedXGaitSettingsPacket()
   {
      pace_slow_settings_packet_ = new quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacket();
      pace_medium_settings_packet_ = new quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacket();
      pace_fast_settings_packet_ = new quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacket();
      amble_slow_settings_packet_ = new quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacket();
      amble_medium_settings_packet_ = new quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacket();
      amble_fast_settings_packet_ = new quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacket();
      trot_slow_settings_packet_ = new quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacket();
      trot_medium_settings_packet_ = new quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacket();
      trot_fast_settings_packet_ = new quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacket();
   }
   ...
   public void set(QuadrupedXGaitSettingsPacket other)
   {
      ...
      quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacketPubSubType.staticCopy(other.pace_slow_settings_packet_, pace_slow_settings_packet_);
      quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacketPubSubType.staticCopy(other.pace_medium_settings_packet_, pace_medium_settings_packet_);
      quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacketPubSubType.staticCopy(other.pace_fast_settings_packet_, pace_fast_settings_packet_);
      quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacketPubSubType.staticCopy(other.amble_slow_settings_packet_, amble_slow_settings_packet_);
      quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacketPubSubType.staticCopy(other.amble_medium_settings_packet_, amble_medium_settings_packet_);
      quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacketPubSubType.staticCopy(other.amble_fast_settings_packet_, amble_fast_settings_packet_);
      quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacketPubSubType.staticCopy(other.trot_slow_settings_packet_, trot_slow_settings_packet_);
      quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacketPubSubType.staticCopy(other.trot_medium_settings_packet_, trot_medium_settings_packet_);
      quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacketPubSubType.staticCopy(other.trot_fast_settings_packet_, trot_fast_settings_packet_);
   }
   ...
   public quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacket getPaceSlowSettingsPacket()
   {
      return pace_slow_settings_packet_;
   }


   public quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacket getPaceMediumSettingsPacket()
   {
      return pace_medium_settings_packet_;
   }


   public quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacket getPaceFastSettingsPacket()
   {
      return pace_fast_settings_packet_;
   }


   public quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacket getAmbleSlowSettingsPacket()
   {
      return amble_slow_settings_packet_;
   }


   public quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacket getAmbleMediumSettingsPacket()
   {
      return amble_medium_settings_packet_;
   }


   public quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacket getAmbleFastSettingsPacket()
   {
      return amble_fast_settings_packet_;
   }


   public quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacket getTrotSlowSettingsPacket()
   {
      return trot_slow_settings_packet_;
   }


   public quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacket getTrotMediumSettingsPacket()
   {
      return trot_medium_settings_packet_;
   }


   public quadruped_msgs.msg.dds.QuadrupedGaitTimingsPacket getTrotFastSettingsPacket()
   {
