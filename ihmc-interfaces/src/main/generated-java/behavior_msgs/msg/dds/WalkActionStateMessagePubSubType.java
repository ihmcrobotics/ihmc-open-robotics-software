...
public class WalkActionStateMessagePubSubType implements us.ihmc.pubsub.TopicDataType<behavior_msgs.msg.dds.WalkActionStateMessage>
{
   ...
   {
   		return "27db4582b4c5300f6796573ae3274af8ce06f02f69a70767c352f545648f5dd2";
   }
   ...
   public static int getMaxCdrSerializedSize(int current_alignment)
   {
      ...
      {
          current_alignment += behavior_msgs.msg.dds.WalkActionFootstepStateMessagePubSubType.getMaxCdrSerializedSize(current_alignment);}
   ...
   public final static int getCdrSerializedSize(behavior_msgs.msg.dds.WalkActionStateMessage data, int current_alignment)
   {
      ...
      {
          current_alignment += behavior_msgs.msg.dds.WalkActionFootstepStateMessagePubSubType.getCdrSerializedSize(data.getFootsteps().get(i0), current_alignment);}
      ...
      {
          current_alignment += behavior_msgs.msg.dds.WalkActionFootstepDefinitionMessagePubSubType.getCdrSerializedSize(data.getPreviewFootsteps().get(i0), current_alignment);}
