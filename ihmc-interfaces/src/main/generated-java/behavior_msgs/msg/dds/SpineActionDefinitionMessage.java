...
public class SpineActionDefinitionMessage extends Packet<SpineActionDefinitionMessage> implements Settable<SpineActionDefinitionMessage>, EpsilonComparable<SpineActionDefinitionMessage>
{
   /**
   ...
   public SpineActionDefinitionMessage(SpineActionDefinitionMessage other)
   {
      this();
      set(other);
   }

   public void set(SpineActionDefinitionMessage other)
   {
   ...
   public static Supplier<SpineActionDefinitionMessagePubSubType> getPubSubType()
   {
      return SpineActionDefinitionMessagePubSubType::new;
   }
   ...
   @Override
   public boolean epsilonEquals(SpineActionDefinitionMessage other, double epsilon)
   {
   ...
   public boolean equals(Object other)
   {
      if(other == null) return false;
      if(other == this) return true;
      if(!(other instanceof SpineActionDefinitionMessage)) return false;

      SpineActionDefinitionMessage otherMyClass = (SpineActionDefinitionMessage) other;
