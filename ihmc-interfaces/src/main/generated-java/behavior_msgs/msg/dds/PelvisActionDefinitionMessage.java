...
public class PelvisActionDefinitionMessage extends Packet<PelvisActionDefinitionMessage> implements Settable<PelvisActionDefinitionMessage>, EpsilonComparable<PelvisActionDefinitionMessage>
{
   /**
   ...
   public PelvisActionDefinitionMessage(PelvisActionDefinitionMessage other)
   {
      this();
      set(other);
   }

   public void set(PelvisActionDefinitionMessage other)
   {
   ...
   public static Supplier<PelvisActionDefinitionMessagePubSubType> getPubSubType()
   {
      return PelvisActionDefinitionMessagePubSubType::new;
   }
   ...
   @Override
   public boolean epsilonEquals(PelvisActionDefinitionMessage other, double epsilon)
   {
   ...
   public boolean equals(Object other)
   {
      if(other == null) return false;
      if(other == this) return true;
      if(!(other instanceof PelvisActionDefinitionMessage)) return false;

      PelvisActionDefinitionMessage otherMyClass = (PelvisActionDefinitionMessage) other;
