...
public class SakeHandCommandActionMessage extends Packet<SakeHandCommandActionMessage> implements Settable<SakeHandCommandActionMessage>, EpsilonComparable<SakeHandCommandActionMessage>
{
   /**
   ...
   public SakeHandCommandActionMessage()
   {
      action_information_ = new behavior_msgs.msg.dds.ActionInformationMessage();
   }

   public SakeHandCommandActionMessage(SakeHandCommandActionMessage other)
   {
      this();
      set(other);
   }

   public void set(SakeHandCommandActionMessage other)
   {
   ...
   public static Supplier<SakeHandCommandActionMessagePubSubType> getPubSubType()
   {
      return SakeHandCommandActionMessagePubSubType::new;
   }
   ...
   @Override
   public boolean epsilonEquals(SakeHandCommandActionMessage other, double epsilon)
   {
   ...
   public boolean equals(Object other)
   {
      if(other == null) return false;
      if(other == this) return true;
      if(!(other instanceof SakeHandCommandActionMessage)) return false;

      SakeHandCommandActionMessage otherMyClass = (SakeHandCommandActionMessage) other;
   ...
   public java.lang.String toString()
   {
      ...
      builder.append("SakeHandCommandActionMessage {");
