...
public class LegActionDefinitionMessage extends Packet<LegActionDefinitionMessage> implements Settable<LegActionDefinitionMessage>, EpsilonComparable<LegActionDefinitionMessage>
{
   /**
   ...
   public LegActionDefinitionMessage(LegActionDefinitionMessage other)
   {
      this();
      set(other);
   }

   public void set(LegActionDefinitionMessage other)
   {
   ...
   public static Supplier<LegActionDefinitionMessagePubSubType> getPubSubType()
   {
      return LegActionDefinitionMessagePubSubType::new;
   }
   ...
   @Override
   public boolean epsilonEquals(LegActionDefinitionMessage other, double epsilon)
   {
   ...
   public boolean equals(Object other)
   {
      if(other == null) return false;
      if(other == this) return true;
      if(!(other instanceof LegActionDefinitionMessage)) return false;

      LegActionDefinitionMessage otherMyClass = (LegActionDefinitionMessage) other;
