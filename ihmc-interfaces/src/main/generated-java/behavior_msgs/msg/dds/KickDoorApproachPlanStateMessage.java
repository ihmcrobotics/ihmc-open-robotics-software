...
public class KickDoorApproachPlanStateMessage extends Packet<KickDoorApproachPlanStateMessage> implements Settable<KickDoorApproachPlanStateMessage>, EpsilonComparable<KickDoorApproachPlanStateMessage>
{
   ...
   /**
            * Kick goal pose
            */
   public us.ihmc.euclid.geometry.Pose3D kick_goal_pose_;
   /**
            * Left foot goal pose
            */
   public us.ihmc.euclid.geometry.Pose3D left_foot_goal_pose_;
   /**
            * Right foot goal pose
            */
   public us.ihmc.euclid.geometry.Pose3D right_foot_goal_pose_;
   /**
            * Execution state
            */
   ...
   public KickDoorApproachPlanStateMessage()
   {
      ...
      kick_goal_pose_ = new us.ihmc.euclid.geometry.Pose3D();
      ...
      desired_right_footsteps_ = new us.ihmc.idl.IDLSequence.Object<ihmc_common_msgs.msg.dds.SE3TrajectoryPointMessage> (100, new ihmc_common_msgs.msg.dds.SE3TrajectoryPointMessagePubSubType());
      current_left_foot_pose_ = new us.ihmc.euclid.geometry.Pose3D();
      current_right_foot_pose_ = new us.ihmc.euclid.geometry.Pose3D();

   }

   public KickDoorApproachPlanStateMessage(KickDoorApproachPlanStateMessage other)
   {
      this();
      set(other);
   }

   public void set(KickDoorApproachPlanStateMessage other)
   {
      ...
      geometry_msgs.msg.dds.PosePubSubType.staticCopy(other.kick_goal_pose_, kick_goal_pose_);
   ...
   /**
            * Kick goal pose
            */
   public us.ihmc.euclid.geometry.Pose3D getKickGoalPose()
   {
      return kick_goal_pose_;
   }
   ...
   /**
            * Left foot goal pose
            */
   public us.ihmc.euclid.geometry.Pose3D getLeftFootGoalPose()
   {
      return left_foot_goal_pose_;
   }
   ...
   /**
            * Right foot goal pose
            */
   public us.ihmc.euclid.geometry.Pose3D getRightFootGoalPose()
   {
      return right_foot_goal_pose_;
   }
   ...
   public static Supplier<KickDoorApproachPlanStateMessagePubSubType> getPubSubType()
   {
      return KickDoorApproachPlanStateMessagePubSubType::new;
   }
   ...
   @Override
   public boolean epsilonEquals(KickDoorApproachPlanStateMessage other, double epsilon)
   {
      ...
      if (!this.kick_goal_pose_.epsilonEquals(other.kick_goal_pose_, epsilon)) return false;
   ...
   public boolean equals(Object other)
   {
      if(other == null) return false;
      if(other == this) return true;
      if(!(other instanceof KickDoorApproachPlanStateMessage)) return false;

      KickDoorApproachPlanStateMessage otherMyClass = (KickDoorApproachPlanStateMessage) other;

      if (!this.state_.equals(otherMyClass.state_)) return false;
      if (!this.definition_.equals(otherMyClass.definition_)) return false;
      if (!this.kick_goal_pose_.equals(otherMyClass.kick_goal_pose_)) return false;
   ...
   public java.lang.String toString()
   {
      ...
      builder.append("KickDoorApproachPlanStateMessage {");
      builder.append("state=");
      builder.append(this.state_);      builder.append(", ");
      builder.append("definition=");
      builder.append(this.definition_);      builder.append(", ");
      builder.append("kick_goal_pose=");
      builder.append(this.kick_goal_pose_);      builder.append(", ");
      ...
      builder.append(this.right_foot_goal_pose_);      builder.append(", ");
