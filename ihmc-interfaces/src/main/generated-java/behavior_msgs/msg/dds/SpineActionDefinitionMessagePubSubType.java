...
/**
* 
* Topic data type of the struct "SpineActionDefinitionMessage" defined in "SpineActionDefinitionMessage_.idl". Use this class to provide the TopicDataType to a Participant. 
*
* This file was automatically generated from SpineActionDefinitionMessage_.idl by us.ihmc.idl.generator.IDLGenerator. 
* Do not update this file directly, edit SpineActionDefinitionMessage_.idl instead.
*
*/
public class SpineActionDefinitionMessagePubSubType implements us.ihmc.pubsub.TopicDataType<behavior_msgs.msg.dds.SpineActionDefinitionMessage>
{
   ...
   {
   		return "f74c4ea4fe4bbebf3fbd87db549ff5272ec0f86886e6ed23895b8d8091f0af19";
   }
   ...
   @Override
   public void serialize(behavior_msgs.msg.dds.SpineActionDefinitionMessage data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, behavior_msgs.msg.dds.SpineActionDefinitionMessage data) throws java.io.IOException
   {
   ...
   public final static int getCdrSerializedSize(behavior_msgs.msg.dds.SpineActionDefinitionMessage data)
   {
      return getCdrSerializedSize(data, 0);
   }

   public final static int getCdrSerializedSize(behavior_msgs.msg.dds.SpineActionDefinitionMessage data, int current_alignment)
   {
      int initial_alignment = current_alignment;
   ...
   public static void write(behavior_msgs.msg.dds.SpineActionDefinitionMessage data, us.ihmc.idl.CDR cdr)
   {
   ...
   public static void read(behavior_msgs.msg.dds.SpineActionDefinitionMessage data, us.ihmc.idl.CDR cdr)
   {
   ...
   @Override
   public final void serialize(behavior_msgs.msg.dds.SpineActionDefinitionMessage data, us.ihmc.idl.InterchangeSerializer ser)
   {
   ...
   @Override
   public final void deserialize(us.ihmc.idl.InterchangeSerializer ser, behavior_msgs.msg.dds.SpineActionDefinitionMessage data)
   {
   ...
   public static void staticCopy(behavior_msgs.msg.dds.SpineActionDefinitionMessage src, behavior_msgs.msg.dds.SpineActionDefinitionMessage dest)
   {
      dest.set(src);
   }

   @Override
   public behavior_msgs.msg.dds.SpineActionDefinitionMessage createData()
   {
      return new behavior_msgs.msg.dds.SpineActionDefinitionMessage();
   }
   @Override
   ...
   public void serialize(behavior_msgs.msg.dds.SpineActionDefinitionMessage data, us.ihmc.idl.CDR cdr)
   {
      write(data, cdr);
   }

   public void deserialize(behavior_msgs.msg.dds.SpineActionDefinitionMessage data, us.ihmc.idl.CDR cdr)
   {
      read(data, cdr);
   }
   
   public void copy(behavior_msgs.msg.dds.SpineActionDefinitionMessage src, behavior_msgs.msg.dds.SpineActionDefinitionMessage dest)
   {
      staticCopy(src, dest);
   }

   @Override
   public SpineActionDefinitionMessagePubSubType newInstance()
   {
      return new SpineActionDefinitionMessagePubSubType();
   }
}
