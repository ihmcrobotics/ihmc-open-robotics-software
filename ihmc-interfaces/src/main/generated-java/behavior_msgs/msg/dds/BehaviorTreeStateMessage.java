...
public class BehaviorTreeStateMessage extends Packet<BehaviorTreeStateMessage> implements Settable<BehaviorTreeStateMessage>, EpsilonComparable<BehaviorTreeStateMessage>
{
   ...
   public static final byte WHOLE_BODY_COORDINATION = (byte) 2;
   ...
   public us.ihmc.idl.IDLSequence.Object<behavior_msgs.msg.dds.WholeBodyCoordinatorStateMessage>  whole_body_coordinators_;
   ...
   public BehaviorTreeStateMessage()
   {
      ...
      whole_body_coordinators_ = new us.ihmc.idl.IDLSequence.Object<behavior_msgs.msg.dds.WholeBodyCoordinatorStateMessage> (200, new behavior_msgs.msg.dds.WholeBodyCoordinatorStateMessagePubSubType());
   ...
   public void set(BehaviorTreeStateMessage other)
   {
      ...
      whole_body_coordinators_.set(other.whole_body_coordinators_);
   ...
   public us.ihmc.idl.IDLSequence.Object<behavior_msgs.msg.dds.WholeBodyCoordinatorStateMessage>  getWholeBodyCoordinators()
   {
      return whole_body_coordinators_;
   }
   ...
   public boolean epsilonEquals(BehaviorTreeStateMessage other, double epsilon)
   {
      ...
      if (this.whole_body_coordinators_.size() != other.whole_body_coordinators_.size()) { return false; }
      else
      {
         for (int i = 0; i < this.whole_body_coordinators_.size(); i++)
         {  if (!this.whole_body_coordinators_.get(i).epsilonEquals(other.whole_body_coordinators_.get(i), epsilon)) return false; }
      }
   ...
   public boolean equals(Object other)
   {
      ...
      if (!this.whole_body_coordinators_.equals(otherMyClass.whole_body_coordinators_)) return false;
   ...
   public java.lang.String toString()
   {
      ...
      builder.append("whole_body_coordinators=");
      builder.append(this.whole_body_coordinators_);      builder.append(", ");
