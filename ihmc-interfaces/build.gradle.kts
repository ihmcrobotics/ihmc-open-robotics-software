buildscript {
   ...
   dependencies {
      classpath("us.ihmc:ros2-msg-to-pubsub-generator:0.24.5")
...
mainDependencies {
   ...
   api("us.ihmc:ros2-common-interfaces:0.24.5") {
...
testDependencies {
   api("us.ihmc:ihmc-ros2-library:0.24.5")
}

generatorDependencies {
   api("us.ihmc:euclid:0.22.2")
   api("us.ihmc:ihmc-commons:0.34.0")
   api("us.ihmc:ros2-msg-to-pubsub-generator:0.24.5")
}
