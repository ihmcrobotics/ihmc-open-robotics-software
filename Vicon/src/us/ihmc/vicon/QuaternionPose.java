...
public class QuaternionPose implements Serializable
{
   ...
   {
      if(xPosition != pose.xPosition) return false;
      if(yPosition != pose.yPosition) return false;
      if(zPosition != pose.zPosition) return false;
      if(qx != pose.qx) return false;
      if(qy != pose.qy) return false;
      if(qz != pose.qz) return false;
