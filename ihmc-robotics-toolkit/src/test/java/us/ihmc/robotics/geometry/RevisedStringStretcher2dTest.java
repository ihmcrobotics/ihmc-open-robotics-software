...
public class RevisedStringStretcher2dTest
{

	@Test
   public void testSimpleExampleWithNoWaypoints()
   {
      RevisedStringStretcher2d stringStretcher2d = new RevisedStringStretcher2d();
      ...
      stringStretcher2d.addMinMaxPoints(0.5, 0.0, 2.0);
   ...
   public void testSimpleExampleWithOneWaypointsNoInterpolation()
   {
      ...
      stringStretcher2d.addMinMaxPoints(5.0, -1.0, 0.0);
   ...
   public void testSimpleExampleWithAllWaypointsNoInterpolation()
   {
      ...
      stringStretcher2d.addMinMaxPoints(2.0, 2.0 ,3.0);

      Point2D minPoint2 = new Point2D(8.0, 2.0);
      Point2D maxPoint2 = new Point2D(8.0, 3.0);

      stringStretcher2d.addMinMaxPoints(8.0, 2.0, 3.0);
   ...
   public void testRandomExample()
   {
      ...
      for (int i = 0; i < numberOfPoints; i++)
      {
         ...
         {
            stringStretcher2d.addMinMaxPoints(point.getX(), point.getY(), otherPoint.getY());
         }

         else
         {
            stringStretcher2d.addMinMaxPoints(otherPoint.getX(), otherPoint.getY(), point.getY());
         }
      ...
      for (Point2DBasics point2d : stretchedString)
      {
         ...
         {
            RevisedMinMaxPointHolder minMaxPoints = stringStretcher2d.findMinMaxPoints(x);
            assertTrue(point2d.getY() >= minMaxPoints.getMinY());
            assertTrue(point2d.getY() <= minMaxPoints.getMaxY());
         }
      }
   }
