...
public class ConcavePolygonToolsTest
{
   ...
   public void testCutSimpleConvexPolygonAbove()
   {
      ...
      ConvexPolygonTools.ConvexPolygonCropResult result = ConvexPolygonTools.cropPolygonToAboveLine(size2square0center, yAxis, xDirection, croppedResult);

      assertEquals(result, ConvexPolygonTools.ConvexPolygonCropResult.CUT, "supposed to cut");
      ...
      // assert equal
      croppedResult.epsilonEquals(aboveYAxisRectangle, 1e-7);
   }
