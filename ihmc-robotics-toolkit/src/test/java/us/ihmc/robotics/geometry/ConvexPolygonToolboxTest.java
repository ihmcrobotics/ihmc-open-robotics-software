...
public class ConvexPolygonToolboxTest
{
   ...
   */
   ...
   public void testDistanceBetweenPolygonsIntersectingPolygons()
   {
      ...
      try
      {
         toolbox.computeMinimumDistancePoints(polygon1, polygon2);
         fail();
      }
      ...
      try
      {
         toolbox.computeMinimumDistancePoints(polygon2, polygon1);
         fail();
      }
   ...
   */
   ...
   private void assertPolygons(double[] p1, double[] p2, double[] expectedSolution, double epsilon)
   {
      ...
      Point2DReadOnly[] closestPoints = toolbox.computeMinimumDistancePoints(polygon1, polygon2);
      Point2DReadOnly[] closestPointsReversed = toolbox.computeMinimumDistancePoints(polygon2, polygon1);
