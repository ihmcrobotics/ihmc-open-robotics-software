...
public class OldFourBarKinematicLoopTest
{
   ...
   private OldFourBarKinematicLoop fourBarKinematicLoop;
   ...
   private void testPlanarSquare(boolean recomputeJointLimits, Vector3DReadOnly jointAtoD)
   {
      ...
      try
      {
         new OldFourBarKinematicLoop("fourBar", masterJointA, passiveJointB, passiveJointC, passiveJointD, jointAtoD,
      ...
      fourBarKinematicLoop = new OldFourBarKinematicLoop("fourBar", masterJointA, passiveJointB, passiveJointC, passiveJointD, jointAtoD,
            recomputeJointLimits);
   ...
   public void testSquareWithoutClosureAtZeroAngles()
   {
      ...
      fourBarKinematicLoop = new OldFourBarKinematicLoop("fourBar", masterJointA, passiveJointB, passiveJointC, passiveJointD, jointAtoD, recomputeJointLimits);
   ...
   public void testParallelJointAxesIsEnforced_TranslatedJointsFrames()
   {
      ...
      try
      {
         ...
         new OldFourBarKinematicLoop("fourBar", masterJointA, passiveJointB, passiveJointC, passiveJointD, jointAtoD, recomputeJointLimits);
         ...
         PassiveRevoluteJoint passiveJointC, PassiveRevoluteJoint passiveJointD, Vector3DReadOnly closurePointFromLastPassiveJoint, boolean recomputeJointLimits)
   {
      try
      {
         new OldFourBarKinematicLoop("fourBar", masterJointA, passiveJointB, passiveJointC, passiveJointD, closurePointFromLastPassiveJoint, recomputeJointLimits);
         fail();
      }
      catch (Exception e)
      {
   ...
   {
      ReferenceFrame jointAFrame = GeometryTools.constructReferenceFrameFromPointAndAxis("jointAFrame", jointAPosition, Axis3D.Z, new FrameVector3D(worldFrame, RandomGeometry.nextVector3D(random, 1.0)));
      ReferenceFrame jointBFrame = GeometryTools.constructReferenceFrameFromPointAndAxis("jointBFrame", jointBPosition, Axis3D.Z, new FrameVector3D(worldFrame, RandomGeometry.nextVector3D(random, 1.0)));
      ReferenceFrame jointCFrame = GeometryTools.constructReferenceFrameFromPointAndAxis("jointCFrame", jointCPosition, Axis3D.Z, new FrameVector3D(worldFrame, RandomGeometry.nextVector3D(random, 1.0)));
      ReferenceFrame jointDFrame = GeometryTools.constructReferenceFrameFromPointAndAxis("jointDFrame", jointDPosition, Axis3D.Z, new FrameVector3D(worldFrame, RandomGeometry.nextVector3D(random, 1.0)));
   ...
   {
      Matrix3D inertiaCylinder = RotationalInertiaCalculator.getRotationalInertiaMatrixOfSolidCylinder(1.0, 1.0, 1.0, Axis3D.Z);
