...
public class MultiCubicSpline1DSolverTest
{
   ...
   public void testGetWaypointVelocityFromSolution()
   {
      ...
      for (int i = 0; i < 100; i++)
      {
         ...
         double expectedVelocity = computeExpectedWaypointVelocity(waypointTime, waypointIndex, solution);
   ...
   private static double computeExpectedWaypointVelocity(double waypointTime, int waypointIndex, DMatrixRMaj solution)
   {
