...
public class BlendedWaypointPositionTrajectoryGeneratorTest
{
   ...
   public void testTroublingDataSet1WithBlending()
   {
      ...
      BlendedWaypointPositionTrajectoryGenerator blendedTrajectory = new BlendedWaypointPositionTrajectoryGenerator("blendedTrajectory", swingTrajectory, worldFrame, registry);
