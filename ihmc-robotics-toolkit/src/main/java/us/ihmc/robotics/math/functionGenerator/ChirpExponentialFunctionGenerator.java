...
public class ChirpExponentialFunctionGenerator
{
   ...
   public ChirpExponentialFunctionGenerator()
   {
      ...
      frequencyProvider = () ->
      {
         double k = highFrequency.getValue() / lowFrequency.getValue();
         return lowFrequency.getValue() * Math.pow(k, frequencyFunction.getValue());
      };
