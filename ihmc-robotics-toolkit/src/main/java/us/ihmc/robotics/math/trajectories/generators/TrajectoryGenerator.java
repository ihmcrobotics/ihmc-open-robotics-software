 ...
 * The Multi-Square Waveform will generate a series of square waves in order repeating forever. It can be initilized using:
 * DesiredTrajectory = new TrajectoryGenerator("OpenLoop", registry, Trajectory.MULTI_SQUARE, 2000.0, 0.2, new ArrayList<Double>(Arrays.asList(1000.0, 0.0, 2000.0, 0.0, 3000.0, 0.0)));
...
public class TrajectoryGenerator {
	...
	public TrajectoryGenerator(String name, YoRegistry registry, Trajectory desiredWaveform, double waveAmp, double waveFreq, double rampSlope, double phaseOffset, double amplitudeOffset) {
		this.name 				= name;
	...
	public TrajectoryGenerator(String name, YoRegistry registry, Trajectory desiredWaveform, ChirpType desiredChirpType, double totalTime, double amplitude, double minFreqHz, double maxFreqHz) {
		this.name 				= name;
		this.registry 			= registry;
		this.myTrajectory 		= desiredWaveform;
	...
	public double updateTrajectoryDot(Trajectory Desired_Trajectory, double curSecTime, double waveAmp, double waveFreq,
			double phaseOffset) {
