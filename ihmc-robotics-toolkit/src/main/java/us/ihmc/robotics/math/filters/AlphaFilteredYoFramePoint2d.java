...
public class AlphaFilteredYoFramePoint2d extends YoFramePoint2D
{
    ...
    */
   @Deprecated
   public static AlphaFilteredYoFramePoint2d createAlphaFilteredYoFramePoint2d(String namePrefix, String nameSuffix, YoRegistry registry, double alpha,
   ...
   /**
    * @deprecated Use
    *             {@link #AlphaFilteredYoFramePoint2d(String, String, YoRegistry, DoubleProvider, ReferenceFrame)}
    *             instead.
    */
   @Deprecated
   public static AlphaFilteredYoFramePoint2d createAlphaFilteredYoFramePoint2d(String namePrefix, String nameSuffix, YoRegistry registry,
   ...
   public static AlphaFilteredYoFramePoint2d createAlphaFilteredYoFramePoint2d(String namePrefix, String nameSuffix, String description,
                                                                               YoRegistry registry, DoubleProvider alpha, ReferenceFrame referenceFrame)
   {
      return new AlphaFilteredYoFramePoint2d(namePrefix, nameSuffix, registry, alpha, referenceFrame);
   }
   ...
   /**
    * @deprecated Use
    *             {@link #AlphaFilteredYoFramePoint2d(String, String, YoRegistry, double, FrameTuple2DReadOnly)}
    *             instead.
    */
   @Deprecated
   public static AlphaFilteredYoFramePoint2d createAlphaFilteredYoFramePoint2d(String namePrefix, String nameSuffix, YoRegistry registry, double alpha,
   ...
   /**
    * @deprecated Use
    *             {@link #AlphaFilteredYoFramePoint2d(String, String, YoRegistry, DoubleProvider, FrameTuple2DReadOnly)}
    *             instead.
    */
   @Deprecated
   public static AlphaFilteredYoFramePoint2d createAlphaFilteredYoFramePoint2d(String namePrefix, String nameSuffix, YoRegistry registry,
   ...
   public AlphaFilteredYoFramePoint2d(String namePrefix, String nameSuffix, YoRegistry registry, double alpha,
                                      FrameTuple2DReadOnly unfilteredFrameTuple2D)
   {
