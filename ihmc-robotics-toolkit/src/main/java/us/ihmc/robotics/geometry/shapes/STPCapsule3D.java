...
public class STPCapsule3D implements STPCapsule3DBasics
{
   ...
   public boolean equals(Object object)
   {
      if (object instanceof STPCapsule3DReadOnly)
         return STPCapsule3DBasics.super.equals((Capsule3DReadOnly) object);
      else
         return false;
   }
   ...
   {
      String stpSuffix = String.format(", small radius: " + EuclidCoreIOTools.DEFAULT_FORMAT + ", large radius: " + EuclidCoreIOTools.DEFAULT_FORMAT + "]",
                                       smallRadius,
                                       largeRadius);
