...
public interface PDGainsReadOnly
{
   ...
   /**
    * Get the maximum feedback that the controller can use. This is equivalent
    * to limiting the maximum output for a PD or PID controller. Not all PD
    * controller implementations use this parameter.
    * <p>
   ...
   /**
    * Get the maximum rate of feedback that the controller can return. Not all PD
    * controller implementations use this parameter.
    * <p>
   ...
   /**
    * Get a position deadband for the controller. If the magnitude of the position
    * error is below this value it will be set to zero. Not all PD
    * controller implementations use this parameter.
    * <p>
