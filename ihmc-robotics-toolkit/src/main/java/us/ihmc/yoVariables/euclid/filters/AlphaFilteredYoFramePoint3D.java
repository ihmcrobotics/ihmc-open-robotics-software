...
public class AlphaFilteredYoFramePoint3D extends YoFramePoint3D
{
   ...
   /**
    * @deprecated Use
    *             {@link #AlphaFilteredYoFramePoint3D(String, String, YoRegistry, double, ReferenceFrame)}
    *             instead.
    */
   @Deprecated
   public static AlphaFilteredYoFramePoint3D createAlphaFilteredYoFramePoint(String namePrefix, String nameSuffix, YoRegistry registry, double alpha,
                                                                             ReferenceFrame referenceFrame)
   {
      return new AlphaFilteredYoFramePoint3D(namePrefix, nameSuffix, registry, alpha, referenceFrame);
   }

   /**
    * @deprecated Use
    *             {@link #AlphaFilteredYoFramePoint3D(String, String, YoRegistry, DoubleProvider, ReferenceFrame)}
    *             instead.
    */
   @Deprecated
   public static AlphaFilteredYoFramePoint3D createAlphaFilteredYoFramePoint(String namePrefix, String nameSuffix, YoRegistry registry,
   ...
   /**
    * @deprecated Use
    *             {@link #AlphaFilteredYoFramePoint3D(String, String, YoRegistry, double, FrameTuple3DReadOnly)}
    *             instead.
    */
   @Deprecated
   public static AlphaFilteredYoFramePoint3D createAlphaFilteredYoFramePoint(String namePrefix, String nameSuffix, YoRegistry registry, double alpha,
   ...
   {
      return new AlphaFilteredYoFramePoint3D(namePrefix, nameSuffix, registry, alpha, unfilteredFrameTuple3D);
   }

   /**
    * @deprecated Use
    *             {@link #AlphaFilteredYoFramePoint3D(String, String, YoRegistry, DoubleProvider, FrameTuple3DReadOnly)}
    *             instead.
    */
   @Deprecated
   public static AlphaFilteredYoFramePoint3D createAlphaFilteredYoFramePoint(String namePrefix, String nameSuffix, YoRegistry registry,
   ...
   public AlphaFilteredYoFramePoint3D(String namePrefix, String nameSuffix, YoRegistry registry, double alpha,
                                      FrameTuple3DReadOnly unfilteredFrameTuple3D)
   {
