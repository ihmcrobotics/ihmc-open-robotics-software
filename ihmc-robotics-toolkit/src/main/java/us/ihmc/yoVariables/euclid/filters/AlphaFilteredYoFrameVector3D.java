...
public class AlphaFilteredYoFrameVector3D extends YoFrameVector3D implements ProcessingYoVariable
{
   ...
   /**
    * @deprecated Use
    *             {@link #AlphaFilteredYoFrameVector3D(String, String, YoRegistry, double, ReferenceFrame)}
    *             instead.
    */
   @Deprecated
   public static AlphaFilteredYoFrameVector3D createAlphaFilteredYoFrameVector(String namePrefix, String nameSuffix, YoRegistry registry, double alpha,
                                                                               ReferenceFrame referenceFrame)
   {
      return new AlphaFilteredYoFrameVector3D(namePrefix, nameSuffix, registry, alpha, referenceFrame);
   }

   /**
    * @deprecated Use
    *             {@link #AlphaFilteredYoFrameVector3D(String, String, YoRegistry, DoubleProvider, ReferenceFrame)}
    *             instead.
    */
   @Deprecated
   public static AlphaFilteredYoFrameVector3D createAlphaFilteredYoFrameVector(String namePrefix, String nameSuffix, YoRegistry registry,
   ...
   /**
    * @deprecated Use
    *             {@link #AlphaFilteredYoFrameVector3D(String, String, YoRegistry, double, FrameTuple3DReadOnly)}
    *             instead.
    */
   @Deprecated
   public static AlphaFilteredYoFrameVector3D createAlphaFilteredYoFrameVector(String namePrefix, String nameSuffix, YoRegistry registry, double alpha,
   ...
   {
      return new AlphaFilteredYoFrameVector3D(namePrefix, nameSuffix, registry, alpha, unfilteredFrameTuple3D);
   }

   /**
    * @deprecated Use
    *             {@link #AlphaFilteredYoFrameVector3D(String, String, YoRegistry, DoubleProvider, FrameTuple3DReadOnly)}
    *             instead.
    */
   @Deprecated
   public static AlphaFilteredYoFrameVector3D createAlphaFilteredYoFrameVector(String namePrefix, String nameSuffix, YoRegistry registry,
