...
public class FilteredFiniteDifferenceYoFrameVector3D extends YoFrameVector3D
{
   ...
   /**
    * @deprecated Use
    *             {@link #FilteredFiniteDifferenceYoFrameVector3D(String, String, DoubleProvider, double, YoRegistry, FrameTuple3DReadOnly)}
    *             instead.
    */
   @Deprecated
   public static FilteredFiniteDifferenceYoFrameVector3D createFilteredVelocityYoFrameVector(String namePrefix, String nameSuffix, DoubleProvider alpha, double dt,
                                                                                             YoRegistry registry,
                                                                                             FrameTuple3DReadOnly frameTuple3DToDifferentiate)
   {
      return new FilteredFiniteDifferenceYoFrameVector3D(namePrefix, nameSuffix, alpha, dt, registry, frameTuple3DToDifferentiate);
   }

   /**
    * @deprecated Use
    *             {@link #FilteredFiniteDifferenceYoFrameVector3D(String, String, DoubleProvider, double, YoRegistry, ReferenceFrame)}
    *             instead.
    */
   @Deprecated
   public static FilteredFiniteDifferenceYoFrameVector3D createFilteredVelocityYoFrameVector(String namePrefix, String nameSuffix, DoubleProvider alpha, double dt,
   ...
   {
      return new FilteredFiniteDifferenceYoFrameVector3D(namePrefix, nameSuffix, alpha, dt, registry, referenceFrame);
   }

   public FilteredFiniteDifferenceYoFrameVector3D(String namePrefix, String nameSuffix, DoubleProvider alpha, double dt, YoRegistry registry,
                                                  FrameTuple3DReadOnly frameTuple3DToDifferentiate)
   {
