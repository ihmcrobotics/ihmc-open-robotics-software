...
public class BacklashCompensatingVelocityYoFrameVector3D extends YoFrameVector3D
{
   ...
   public static BacklashCompensatingVelocityYoFrameVector3D createBacklashCompensatingVelocityYoFrameVector(String namePrefix, String nameSuffix, YoDouble alpha, double dt, YoDouble slopTime,
                                                                                                             YoRegistry registry, YoFrameVector3D yoFrameVectorToDifferentiate)
   {
      ...
      BacklashCompensatingVelocityYoFrameVector3D ret = new BacklashCompensatingVelocityYoFrameVector3D(xDot, yDot, zDot, registry, yoFrameVectorToDifferentiate);
                                                                                                             ...
                                                                                                             YoRegistry registry, YoFramePoint3D yoFramePointToDifferentiate)
   {
      ...
      BacklashCompensatingVelocityYoFrameVector3D ret = new BacklashCompensatingVelocityYoFrameVector3D(xDot, yDot, zDot, registry, yoFramePointToDifferentiate);

      return ret;
   }

   private BacklashCompensatingVelocityYoFrameVector3D(BacklashCompensatingVelocityYoVariable xDot, BacklashCompensatingVelocityYoVariable yDot, BacklashCompensatingVelocityYoVariable zDot,
                                                       YoRegistry registry, YoFrameVector3D yoFrameVectorToDifferentiate)
   {
