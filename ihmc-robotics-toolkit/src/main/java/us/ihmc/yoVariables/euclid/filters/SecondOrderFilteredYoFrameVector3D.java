...
public class SecondOrderFilteredYoFrameVector3D extends YoFrameVector3D implements ProcessingYoVariable
{
   ...
   private SecondOrderFilteredYoFrameVector3D(SecondOrderFilteredYoVariable x, SecondOrderFilteredYoVariable y, SecondOrderFilteredYoVariable z,
   ...
   public static SecondOrderFilteredYoFrameVector3D createSecondOrderFilteredYoFrameVector(String namePrefix, String nameSuffix, YoRegistry registry,
                                                                                           ...
                                                                                           double dt, SecondOrderFilteredYoVariableParameters parameters, YoFrameVector3D unfilteredVector)
   {
      ...
      return new SecondOrderFilteredYoFrameVector3D(x, y, z, unfilteredVector.getReferenceFrame());
   }
