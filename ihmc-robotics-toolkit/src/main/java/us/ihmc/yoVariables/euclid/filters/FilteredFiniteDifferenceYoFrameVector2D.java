...
public class FilteredFiniteDifferenceYoFrameVector2D extends YoFrameVector2D
{
   ...
   /**
    * @deprecated Use
    *             {@link #FilteredFiniteDifferenceYoFrameVector2D(String, String, DoubleProvider, double, YoRegistry, FrameTuple2DReadOnly)}
    *             instead.
    */
   @Deprecated
   public static FilteredFiniteDifferenceYoFrameVector2D createFilteredVelocityYoFrameVector2d(String namePrefix, String nameSuffix, DoubleProvider alpha, double dt,
                                                                                               YoRegistry registry,
                                                                                               FrameTuple2DReadOnly frameTuple2DToDifferentiate)
   {
      return new FilteredFiniteDifferenceYoFrameVector2D(namePrefix, nameSuffix, alpha, dt, registry, frameTuple2DToDifferentiate);
   }
    ...
    */
   @Deprecated
   public static FilteredFiniteDifferenceYoFrameVector2D createFilteredVelocityYoFrameVector2d(String namePrefix, String nameSuffix, String description,
   ...
   /**
    * @deprecated Use
    *             {@link #FilteredFiniteDifferenceYoFrameVector2D(String, String, DoubleProvider, double, YoRegistry, ReferenceFrame)}
    *             instead.
    */
   @Deprecated
   public static FilteredFiniteDifferenceYoFrameVector2D createFilteredVelocityYoFrameVector2d(String namePrefix, String nameSuffix, DoubleProvider alpha, double dt,
   ...
   {
      return new FilteredFiniteDifferenceYoFrameVector2D(namePrefix, nameSuffix, alpha, dt, registry, referenceFrame);
   }

   public FilteredFiniteDifferenceYoFrameVector2D(String namePrefix, String nameSuffix, DoubleProvider alpha, double dt, YoRegistry registry,
                                                  FrameTuple2DReadOnly frameTuple2DToDifferentiate)
   {
