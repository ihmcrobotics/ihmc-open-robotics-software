...
public class BacklashProcessingYoFrameVector3D extends YoFrameVector3D implements ProcessingYoVariable
{
   ...
   public static BacklashProcessingYoFrameVector3D createBacklashProcessingYoFrameVector(String namePrefix, String nameSuffix, double dt, DoubleProvider slopTime,
                                                                                         YoRegistry registry, YoFrameTuple3D yoFrameTupleToProcess)
   {
      ...
      return new BacklashProcessingYoFrameVector3D(x, y, z, registry, referenceFrame);
   }
