...
public class DeadbandedYoVariable extends YoDouble implements ProcessingYoVariable
{
   ...
   public DeadbandedYoVariable(String name, YoDouble deadzoneSize, YoRegistry registry)
   {
      super(name, registry);
   ...
   public DeadbandedYoVariable(String name, YoDouble inputVariable, YoDouble deadzoneSize, YoRegistry registry)
   {
      super(name, registry);
