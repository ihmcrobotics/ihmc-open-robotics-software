...
public class WebsocketDataServerDiscoveryDisplay extends JFrame
{
   ...
   public WebsocketDataServerDiscoveryDisplay(DataConsumerParticipant dataConsumerParticipant) throws IOException
   {
      this(dataConsumerParticipant, null);
   }

   public WebsocketDataServerDiscoveryDisplay(DataConsumerParticipant dataConsumerParticipant, MouseAdapter mouseAdapter) throws IOException
   {
   ...
   {
      WebsocketDataServerDiscoveryDisplay.filters = filters;
   ...
   private static Announcement selectLogSession(DataConsumerParticipant dataConsumerParticipant) throws IOException
   {
      ...
      final WebsocketDataServerDiscoveryDisplay display = new WebsocketDataServerDiscoveryDisplay(dataConsumerParticipant, adapter);
