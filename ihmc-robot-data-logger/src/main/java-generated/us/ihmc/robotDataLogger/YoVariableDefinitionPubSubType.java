...
public class YoVariableDefinitionPubSubType implements us.ihmc.pubsub.TopicDataType<us.ihmc.robotDataLogger.YoVariableDefinition>
{
   ...
   @Override
   public void serialize(us.ihmc.robotDataLogger.YoVariableDefinition data, us.ihmc.pubsub.common.SerializedPayload serializedPayload)
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, us.ihmc.robotDataLogger.YoVariableDefinition data)
         throws java.io.IOException
   {
