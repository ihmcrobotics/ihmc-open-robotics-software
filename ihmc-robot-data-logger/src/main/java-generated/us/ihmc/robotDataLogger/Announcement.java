...
public class Announcement extends Packet<Announcement> implements Settable<Announcement>, EpsilonComparable<Announcement>
{
   ...
   public us.ihmc.robotDataLogger.ModelFileDescription model_file_description_;
   public boolean log_;
   ...
   public Announcement()
   {
      ...
      cameras_ = new us.ihmc.idl.IDLSequence.Object<us.ihmc.robotDataLogger.CameraAnnouncement>(127, us.ihmc.robotDataLogger.CameraAnnouncement.class,
                                                                                                new us.ihmc.robotDataLogger.CameraAnnouncementPubSubType());

      model_file_description_ = new us.ihmc.robotDataLogger.ModelFileDescription();
   }
   ...
   public void set(Announcement other)
   {
      ...
      us.ihmc.robotDataLogger.ModelFileDescriptionPubSubType.staticCopy(other.model_file_description_, model_file_description_);
      log_ = other.log_;
   }
   ...
   {
      return model_file_description_;
   }
   ...
   public boolean epsilonEquals(Announcement other, double epsilon)
   {
      ...
      if (!this.model_file_description_.epsilonEquals(other.model_file_description_, epsilon))
         return false;
   ...
   public boolean equals(Object other)
   {
      ...
      if (!this.model_file_description_.equals(otherMyClass.model_file_description_))
         return false;
   ...
   public java.lang.String toString()
   {
      ...
      builder.append(", ");
      builder.append("model_file_description=");
      builder.append(this.model_file_description_);
