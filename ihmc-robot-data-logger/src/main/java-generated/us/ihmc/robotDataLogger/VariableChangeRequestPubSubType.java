...
public class VariableChangeRequestPubSubType implements us.ihmc.pubsub.TopicDataType<us.ihmc.robotDataLogger.VariableChangeRequest>
{
   ...
   @Override
   public void serialize(us.ihmc.robotDataLogger.VariableChangeRequest data, us.ihmc.pubsub.common.SerializedPayload serializedPayload)
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, us.ihmc.robotDataLogger.VariableChangeRequest data)
         throws java.io.IOException
   {
