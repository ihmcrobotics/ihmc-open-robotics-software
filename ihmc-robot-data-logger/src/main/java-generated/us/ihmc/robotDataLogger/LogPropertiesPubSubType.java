...
*
*/
public class LogPropertiesPubSubType implements TopicDataType<us.ihmc.robotDataLogger.LogProperties>
{
    ...
    @Override
   public void serialize(us.ihmc.robotDataLogger.LogProperties data, SerializedPayload serializedPayload) throws IOException
   {
   ...
   @Override
   public void deserialize(SerializedPayload serializedPayload, us.ihmc.robotDataLogger.LogProperties data) throws IOException
   {
   ...
   public static void write(us.ihmc.robotDataLogger.LogProperties data, CDR cdr)
   {
   ...
   public static void read(us.ihmc.robotDataLogger.LogProperties data, CDR cdr)
   {
	...
	@Override
	public final void serialize(us.ihmc.robotDataLogger.LogProperties data, InterchangeSerializer ser)
	{
	...
	@Override
	public final void deserialize(InterchangeSerializer ser, us.ihmc.robotDataLogger.LogProperties data)
	{
   ...
   public void serialize(us.ihmc.robotDataLogger.LogProperties data, CDR cdr)
	{
		write(data, cdr);
	}

   public void deserialize(us.ihmc.robotDataLogger.LogProperties data, CDR cdr)
   {
        read(data, cdr);
   }
