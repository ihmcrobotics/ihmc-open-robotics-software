...
public class YoRegistryDefinitionPubSubType implements us.ihmc.pubsub.TopicDataType<us.ihmc.robotDataLogger.YoRegistryDefinition>
{
   ...
   @Override
   public void serialize(us.ihmc.robotDataLogger.YoRegistryDefinition data, us.ihmc.pubsub.common.SerializedPayload serializedPayload)
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, us.ihmc.robotDataLogger.YoRegistryDefinition data)
         throws java.io.IOException
   {
