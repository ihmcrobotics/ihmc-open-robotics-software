...
public class LogProperties extends Packet<LogProperties> implements Settable<LogProperties>, EpsilonComparable<LogProperties>
{
   ...
   public LogProperties()
   {
      ...
      cameras_ = new us.ihmc.idl.IDLSequence.Object<us.ihmc.robotDataLogger.Camera>(255, us.ihmc.robotDataLogger.Camera.class,
                                                                                    new us.ihmc.robotDataLogger.CameraPubSubType());
   ...
   public boolean epsilonEquals(LogProperties other, double epsilon)
   {
      ...
      if (!us.ihmc.idl.IDLTools.epsilonEqualsStringBuilder(this.version_, other.version_, epsilon))
         return false;
      ...
      if (!us.ihmc.idl.IDLTools.epsilonEqualsStringBuilder(this.timestamp_, other.timestamp_, epsilon))
         return false;
      ...
      if (!this.video_.epsilonEquals(other.video_, epsilon))
         return false;
   ...
   public boolean equals(Object other)
   {
      ...
      if (!us.ihmc.idl.IDLTools.equals(this.version_, otherMyClass.version_))
         return false;
      ...
      if (!this.model_.equals(otherMyClass.model_))
         return false;

      if (!us.ihmc.idl.IDLTools.equals(this.timestamp_, otherMyClass.timestamp_))
         return false;

      if (!this.cameras_.equals(otherMyClass.cameras_))
         return false;

      if (!this.video_.equals(otherMyClass.video_))
         return false;
