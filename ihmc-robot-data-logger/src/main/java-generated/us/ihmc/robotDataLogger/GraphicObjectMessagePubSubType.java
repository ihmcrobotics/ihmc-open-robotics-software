...
public class GraphicObjectMessagePubSubType implements us.ihmc.pubsub.TopicDataType<us.ihmc.robotDataLogger.GraphicObjectMessage>
{
   ...
   @Override
   public void serialize(us.ihmc.robotDataLogger.GraphicObjectMessage data, us.ihmc.pubsub.common.SerializedPayload serializedPayload)
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, us.ihmc.robotDataLogger.GraphicObjectMessage data)
         throws java.io.IOException
   {
