 ...
 */
@RosMessagePacket(documentation = "Send a request to change the desired PSI of the Atlas hydraulic pump.", rosPackage = "ihmc_atlas_ros", topic = "/control/desired_pump_psi")
