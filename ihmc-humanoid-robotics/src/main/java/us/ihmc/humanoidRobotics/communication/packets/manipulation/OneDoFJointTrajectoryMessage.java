...
public class OneDoFJointTrajectoryMessage extends Packet<OneDoFJointTrajectoryMessage>
{
   ...
   public RecyclingArrayListPubSub<TrajectoryPoint1DMessage> trajectoryPoints = new RecyclingArrayListPubSub<>(TrajectoryPoint1DMessage.class, TrajectoryPoint1DMessage::new,
                                                                                               2000);
   ...
   public void getTrajectoryPoints(SimpleTrajectoryPoint1DList trajectoryPointListToPack)
   {
      ...
      List<TrajectoryPoint1DMessage> trajectoryPointMessages = getTrajectoryPoints();
