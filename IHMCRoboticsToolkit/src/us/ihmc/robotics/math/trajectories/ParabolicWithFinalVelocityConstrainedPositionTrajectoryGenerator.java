...
public class ParabolicWithFinalVelocityConstrainedPositionTrajectoryGenerator implements PositionTrajectoryGenerator
{
   ...
   public void setTrajectoryParameters(double duration, FramePoint3D initialPosition, double intermediateZPosition, FramePoint3D finalPosition, FrameVector finalVelocity)
   {
      trajectoryTime.set(duration);
