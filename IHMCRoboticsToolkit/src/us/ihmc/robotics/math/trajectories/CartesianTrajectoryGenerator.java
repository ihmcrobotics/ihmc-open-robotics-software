...
public interface CartesianTrajectoryGenerator extends Finishable
{
    ...
    */
   public abstract void initialize(FramePoint3D initialPosition, FrameVector initialVelocity, FrameVector initialAcceleration, FramePoint3D finalDesiredPosition,
    ...
    */
   public abstract void computeNextTick(FramePoint3D positionToPack, FrameVector velocityToPack, FrameVector accelerationToPack, double deltaT);
