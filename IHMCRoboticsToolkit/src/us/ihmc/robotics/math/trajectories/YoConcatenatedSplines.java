...
public class YoConcatenatedSplines
{
   ...
   public void setQuadraticQuinticQuadratic(double[] times, FramePoint[] positions, FrameVector3D initialVelocity, FrameVector3D finalVelocity)
   {
   ...
   public void setCubicLinearQuinticLinearCubic(double[] fixedPointTimes, FramePoint[] fixedPointPositions, FrameVector3D[] fixedPointVelocities,
   ...
   public void setQuarticLinearQuinticLinearQuartic(double[] fixedPointTimes, FramePoint[] fixedPointPositions, FrameVector3D[] fixedPointVelocities,
           double[] intermediateTimes)
   {
      MathTools.checkEquals(rangeList.size(), 5);
      MathTools.checkEquals(fixedPointTimes.length, 4);
   ...
   public void setCubicQuarticQuinticCubic(double[] times, FramePoint[] positions, FrameVector3D[] velocities)
   {
   ...
   public void setCubicQuarticQuinticQuarticCubic(double[] times, FramePoint[] positions, FrameVector3D[] velocities)
   {
      MathTools.checkEquals(rangeList.size(), 5);
   ...
   public void setCubicQuinticCubic(double[] times, FramePoint[] positions, FrameVector3D[] velocities)
   {
   ...
   public void setQuarticQuinticQuartic(double[] times, FramePoint[] positions, FrameVector3D[] velocities, double[] intermediateTimes,
   ...
   public void setQuinticsUsingIntermediateVeloctiesAndAccelerations(double[] times, FramePoint[] positions, FrameVector3D[] velocities,
   ...
   public void setQuinticSexticQuinticUsingWaypointAndIntermediateVeloctiesAndAccelerations(double[] times, FramePoint[] positions, FrameVector3D[] velocities,
           double ghostTime, FramePoint ghostWaypoint, double[] intermediateTimes, FrameVector3D[] intermediateVelocities,
   ...
   public void setSexticQuinticSexticUsingIntermediateVelocitiesAndAccelerations(double[] times, FramePoint[] positions, FrameVector3D[] velocities,
   ...
   public void setQuintics(double[] times, FramePoint[] positions, FrameVector3D[] velocities, FrameVector3D[] accelerations)
   {
