 ...
 * <li>{@link #getLinearAccelerationOfBodyFixedPoint(RigidBody, FramePoint3D, FrameVector)} provides
 * the linear acceleration of a point of a rigid-body with respect to the {@code inertialFrame}.
 * <li>{@link #getLinearAccelerationOfBodyFixedPoint(RigidBody, RigidBody, FramePoint3D, FrameVector)}
...
public class SpatialAccelerationCalculator
{
    ...
    * Temporary acceleration used for intermediate garbage free operations. To use only in the
    * method
    * {@link #getLinearVelocityOfBodyFixedPoint(RigidBody, RigidBody, FramePoint3D, FrameVector)} and
    * {@link #getLinearAccelerationOfBodyFixedPoint(RigidBody, FramePoint3D, FrameVector)}.
    */
    ...
    */
   public void getLinearAccelerationOfBodyFixedPoint(RigidBody base, RigidBody body, FramePoint3D bodyFixedPoint, FrameVector linearAccelerationToPack)
   {
    ...
    * {@link #getLinearAccelerationOfBodyFixedPoint(RigidBody, RigidBody, FramePoint3D, FrameVector)}
    ...
    * @param linearAccelerationToPack the linear acceleration of the body fixed point. Modified.
    */
   public void getLinearAccelerationOfBodyFixedPoint(RigidBody body, FramePoint3D bodyFixedPoint, FrameVector linearAccelerationToPack)
   {
      FramePoint3D localPoint = pointForGetLinearAccelerationOfBodyFixedPoint;
      Twist localTwist = twistForGetLinearAccelerationOfBodyFixedPoint;
      SpatialAccelerationVector localAcceleration = accelerationForGetLinearAccelerationOfBodyFixedPoint;
