 ...
 * @version 2.0
 */
public abstract class FrameTuple3D<S extends FrameTuple3D<S, T>, T extends Tuple3DBasics & GeometryObject<T>> extends AbstractFrameObject<S, T> implements Serializable
{
   ...
   public FrameTuple3D(ReferenceFrame referenceFrame, T tuple, String name)
   {
