...
public class FrameSE3Waypoint extends AbstractFrameObject<FrameSE3Waypoint, SE3Waypoint> implements SE3WaypointInterface<FrameSE3Waypoint>
{
   ...
   public void set(FramePoint3D position, FrameOrientation orientation, FrameVector linearVelocity, FrameVector angularVelocity)
   {
      checkReferenceFrameMatch(position);
   ...
   public void setIncludingFrame(FramePoint3D position, FrameOrientation orientation, FrameVector linearVelocity, FrameVector angularVelocity)
   {
