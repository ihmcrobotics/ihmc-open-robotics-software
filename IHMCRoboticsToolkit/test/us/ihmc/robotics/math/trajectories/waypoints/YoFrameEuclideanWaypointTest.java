...
public class YoFrameEuclideanWaypointTest
{
   ...
   public void testConstructor()
   {
      ...
      YoFrameEuclideanTrajectoryPoint testedYoFrameEuclideanWaypoint = new YoFrameEuclideanTrajectoryPoint(expectedNamePrefix, expectedNameSuffix, new YoVariableRegistry("schnoop"), expectedFrame);
   ...
   public void testSetters()
   {
      ...
      YoFrameEuclideanTrajectoryPoint expectedYoFrameEuclideanWaypoint = new YoFrameEuclideanTrajectoryPoint("sdfsd", "asd", new YoVariableRegistry("asawe"), expectedFrame);

      testedYoFrameEuclideanWaypoint.set(expectedYoFrameEuclideanWaypoint);
      FrameEuclideanTrajectoryPoint expectedFrameEuclideanWaypoint = expectedYoFrameEuclideanWaypoint.getFrameEuclideanTrajectoryPointCopy();
   ...
   private void assertWaypointContainsExpectedData(String expectedNamePrefix, String expectedNameSuffix, ReferenceFrame expectedFrame, double expectedTime, FramePoint expectedPosition,
         FrameVector expectedLinearVelocity, YoFrameEuclideanTrajectoryPoint testedYoFrameEuclideanWaypoint, double epsilon)
   {
      assertTrue(expectedFrame == testedYoFrameEuclideanWaypoint.getReferenceFrame());
      ...
      FrameEuclideanTrajectoryPoint actualFrameEuclideanWaypoint = new FrameEuclideanTrajectoryPoint();
      testedYoFrameEuclideanWaypoint.getFrameEuclideanTrajectoryPointIncludingFrame(actualFrameEuclideanWaypoint);
      FrameEuclideanTrajectoryPointTest.assertTrajectoryPointContainsExpectedData(expectedFrame, expectedTime, expectedPosition, expectedLinearVelocity, actualFrameEuclideanWaypoint, epsilon);
      actualFrameEuclideanWaypoint = new FrameEuclideanTrajectoryPoint(expectedFrame);
      testedYoFrameEuclideanWaypoint.getFrameEuclideanTrajectoryPoint(actualFrameEuclideanWaypoint);
      FrameEuclideanTrajectoryPointTest.assertTrajectoryPointContainsExpectedData(expectedFrame, expectedTime, expectedPosition, expectedLinearVelocity, actualFrameEuclideanWaypoint, epsilon);
