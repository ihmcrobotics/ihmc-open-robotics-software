...
public class YoFrameSO3WaypointTest
{
   ...
   public void testConstructor()
   {
      ...
      YoFrameSO3TrajectoryPoint testedYoFrameSO3Waypoint = new YoFrameSO3TrajectoryPoint(expectedNamePrefix, expectedNameSuffix, new YoVariableRegistry("schnoop"), expectedFrame);
   ...
   public void testSetters()
   {
      ...
      YoFrameSO3TrajectoryPoint expectedYoFrameSO3Waypoint = new YoFrameSO3TrajectoryPoint("sdfsd", "asd", new YoVariableRegistry("asawe"), expectedFrame);

      testedYoFrameSO3Waypoint.set(expectedYoFrameSO3Waypoint);
      FrameSO3TrajectoryPoint expectedFrameSO3Waypoint = expectedYoFrameSO3Waypoint.getFrameSO3TrajectoryPointCopy();
   ...
   private void assertWaypointContainsExpectedData(String expectedNamePrefix, String expectedNameSuffix, ReferenceFrame expectedFrame, double expectedTime, FrameOrientation expectedOrientation,
         FrameVector expectedAngularVelocity, YoFrameSO3TrajectoryPoint testedYoFrameSO3Waypoint, double epsilon)
   {
      assertTrue(expectedFrame == testedYoFrameSO3Waypoint.getReferenceFrame());
      ...
      FrameSO3TrajectoryPoint actualFrameSO3Waypoint = new FrameSO3TrajectoryPoint();
      testedYoFrameSO3Waypoint.getFrameSO3TrajectoryPointIncludingFrame(actualFrameSO3Waypoint);
      FrameSO3TrajectoryPointTest.assertTrajectoryPointContainsExpectedData(expectedFrame, expectedTime, expectedOrientation, expectedAngularVelocity, actualFrameSO3Waypoint, epsilon);
      actualFrameSO3Waypoint = new FrameSO3TrajectoryPoint(expectedFrame);
      testedYoFrameSO3Waypoint.getFrameSO3TrajectoryPoint(actualFrameSO3Waypoint);
      FrameSO3TrajectoryPointTest.assertTrajectoryPointContainsExpectedData(expectedFrame, expectedTime, expectedOrientation, expectedAngularVelocity, actualFrameSO3Waypoint, epsilon);
