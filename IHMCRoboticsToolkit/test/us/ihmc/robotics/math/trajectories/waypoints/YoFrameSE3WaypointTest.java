...
public class YoFrameSE3WaypointTest
{
   ...
   public void testConstructor()
   {
      ...
      YoFrameSE3TrajectoryPoint testedYoFrameSE3Waypoint = new YoFrameSE3TrajectoryPoint(expectedNamePrefix, expectedNameSuffix, new YoVariableRegistry("schnoop"), expectedFrame);
   ...
   public void testSetters()
   {
      ...
      YoFrameSE3TrajectoryPoint expectedYoFrameSE3Waypoint = new YoFrameSE3TrajectoryPoint("sdfsd", "asd", new YoVariableRegistry("asawe"), expectedFrame);

      testedYoFrameSE3Waypoint.set(expectedYoFrameSE3Waypoint);
      FrameSE3TrajectoryPoint expectedFrameSE3Waypoint = expectedYoFrameSE3Waypoint.getFrameSE3TrajectoryPointCopy();
   ...
   private void assertWaypointContainsExpectedData(String expectedNamePrefix, String expectedNameSuffix, ReferenceFrame expectedFrame, double expectedTime, FramePoint expectedPosition,
         FrameOrientation expectedOrientation, FrameVector expectedLinearVelocity, FrameVector expectedAngularVelocity, YoFrameSE3TrajectoryPoint testedYoFrameSE3Waypoint,
         double epsilon)
   {
      assertTrue(expectedFrame == testedYoFrameSE3Waypoint.getReferenceFrame());
      ...
      FrameSE3TrajectoryPoint actualFrameSE3Waypoint = new FrameSE3TrajectoryPoint();
      testedYoFrameSE3Waypoint.getFrameSE3TrajectoryPointIncludingFrame(actualFrameSE3Waypoint);
      FrameSE3TrajectoryPointTest.assertTrajectoryPointContainsExpectedData(expectedFrame, expectedTime, expectedPosition, expectedOrientation, expectedLinearVelocity, expectedAngularVelocity, actualFrameSE3Waypoint, epsilon);
      actualFrameSE3Waypoint = new FrameSE3TrajectoryPoint(expectedFrame);
      testedYoFrameSE3Waypoint.getFrameSE3TrajectoryPoint(actualFrameSE3Waypoint);
      FrameSE3TrajectoryPointTest.assertTrajectoryPointContainsExpectedData(expectedFrame, expectedTime, expectedPosition, expectedOrientation, expectedLinearVelocity, expectedAngularVelocity, actualFrameSE3Waypoint, epsilon);
