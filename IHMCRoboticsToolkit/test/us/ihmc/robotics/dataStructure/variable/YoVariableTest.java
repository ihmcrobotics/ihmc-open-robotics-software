package us.ihmc.yoUtilities.dataStructure.variable;
...
//      catch (NoSuchElementException e)
   ...
   public void testRecursiveCompareYoVariables() throws IllegalArgumentException, IllegalAccessException, SecurityException, NoSuchFieldException
   {
      ...
      RecursiveObjectComparer comparer = new YoVariableComparer(Integer.MAX_VALUE, Integer.MAX_VALUE);
      ...
      comparer = new YoVariableComparer(Integer.MAX_VALUE, Integer.MAX_VALUE);
      ...
      Field field = YoVariable.class.getDeclaredField("name");
      
      stringFieldMatcherToIgnore.addStringFieldToMatchExactly(DoubleYoVariable.class, field,  "variableOne");
   ...
   private class YoVariableComparer extends RecursiveObjectComparer
   {
      public YoVariableComparer(int maxDepth, int maxSize) throws NoSuchFieldException, SecurityException
      {
         super(maxDepth, maxSize);
         this.addFieldToIgnore(YoVariable.class.getDeclaredField("stackTraceAtInitialization"));
      }
   }
}
