...
public class FramePointTest extends FrameTupleTest<Point3D>
{
   ...
   public final void testRunTestMain()
   {
      ...
      ReferenceFrame B = ReferenceFrame.constructFrameWithUnchangingTransformToParent("B", A, transform, true, true);
      ...
      ReferenceFrame C = ReferenceFrame.constructFrameWithUnchangingTransformToParent("C", B, transform, true, true);
      ...
      ReferenceFrame D = ReferenceFrame.constructFrameWithUnchangingTransformToParent("D", C, transform, true, true);
