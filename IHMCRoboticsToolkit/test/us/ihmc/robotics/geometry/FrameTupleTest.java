...
public abstract class FrameTupleTest<T extends Tuple3DBasics & GeometryObject<T>>
{
   ...
   public final void testSetXYZ()
   {
      ...
      ReferenceFrame randomFrame = ReferenceFrame.constructFrameWithUnchangingTransformToParent("childFrame", ReferenceFrame.getWorldFrame(), randomTransform, false, false);
