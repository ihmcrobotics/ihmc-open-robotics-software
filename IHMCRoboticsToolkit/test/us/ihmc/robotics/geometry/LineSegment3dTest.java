...
public class LineSegment3dTest
{
   ...
   public void directionTest()
   {
      ...
      EuclidCoreTestTools.assertTuple3DEquals(new Point3D(1.0, 0.0, 0.0), s.getDirection(true), 0.0);

      s = new LineSegment3D(new Point3D(0.0, 0.0, 0.0), new Point3D(0.0, 1.0, 0.0));
      EuclidCoreTestTools.assertTuple3DEquals(new Point3D(0.0, 1.0, 0.0), s.getDirection(true), 0.0);

      s = new LineSegment3D(new Point3D(0.0, 0.0, 0.0), new Point3D(0.0, 0.0, 1.0));
      EuclidCoreTestTools.assertTuple3DEquals(new Point3D(0.0, 0.0, 1.0), s.getDirection(true), 0.0);
      ...
      EuclidCoreTestTools.assertTuple3DEquals(new Point3D(Math.cos(Math.PI / 4), Math.sin(Math.PI / 4), 0.0), s.getDirection(true), 0.0);
   }
}
