...
public class LineSegment3dTest {
	...
	public void testLenght() {
	    ...
	    point0.set(Math.sqrt(3), Math.sqrt(3), Math.sqrt(3));
	    point1.set(Math.sqrt(3), Math.sqrt(3), Math.sqrt(3));
	    assertEquals(0.0, segment.length(),1e-14);
	    
	    point1.negate();
	    assertEquals(6.0, segment.length(),1e-14);
	    point1.set(0.0,0.0,0.0);
