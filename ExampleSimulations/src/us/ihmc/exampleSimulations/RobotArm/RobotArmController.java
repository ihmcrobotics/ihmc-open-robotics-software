...
public class RobotArmController implements RobotController
{
   ...
   public static String variableName7 = "axis7";

   // tau_* is torque, q_* is position, qd_* is velocity for joint *
   private DoubleYoVariable q_axis1, q_axis2, q_axis4, q_axis3, q_axis5, q_axis6, q_axis7;
   ...
   private final DoubleYoVariable axis7 = new DoubleYoVariable(variableName7, registry);
   ...
   public RobotArmController(RobotArm robot, String robotName)
   {
      ...
      q_axis7 = (DoubleYoVariable) robot.getVariable("q_axis7");
   }
   ...
   public void doControl()
   {
      ...
      q_axis7.set(axis7.getDoubleValue());
