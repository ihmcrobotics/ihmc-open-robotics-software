...
public class RobotArmController implements RobotController
{
   ...
   public RobotArmController(RobotArm robot, String robotName)
   {
      ...
      q_circle = (DoubleYoVariable) robot.getVariable("q_circle");
      q_stick1 = (DoubleYoVariable) robot.getVariable("q_stick1");
      q_circle2 = (DoubleYoVariable) robot.getVariable("q_circle2");
      q_stick2 = (DoubleYoVariable) robot.getVariable("q_stick2");
      q_circle3 = (DoubleYoVariable) robot.getVariable("q_circle3");
      q_stick3 = (DoubleYoVariable) robot.getVariable("q_stick3");
//      q_circle4 = (DoubleYoVariable) rob.getVariable("q_circle4");
      q_stick4 = (DoubleYoVariable) robot.getVariable("q_stick4");
...
//      q_circle4.set(circle4.getDoubleValue());
