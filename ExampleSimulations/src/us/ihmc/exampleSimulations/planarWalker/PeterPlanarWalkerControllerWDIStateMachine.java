...
public class PeterPlanarWalkerControllerWDIStateMachine implements RobotController
{
   ...
   private FiniteStateMachineBuilder<WalkerLegsControllerState, ControllerEvent> stateMachineBuilder;
   private FiniteStateMachine<WalkerLegsControllerState, ControllerEvent> stateMachine;

   public PeterPlanarWalkerControllerWDIStateMachine(PeterPlanarWalkerRobot robot, double deltaT)
   {
      this.robot = robot;
      this.deltaT = deltaT;
...
//   {
//
//      stateMachineBuilder = new FiniteStateMachineBuilder(WalkerLegsControllerState.class, ControllerEvent.class, "legState", registry);
//        
//      stateMachineBuilder.addState(WalkerLegsControllerState.LEFT_SUPPORT, new SingleSupportState(RobotSide.LEFT));
//      stateMachineBuilder.addState(WalkerLegsControllerState.RIGHT_SUPPORT, new SingleSupportState(RobotSide.RIGHT));
//      stateMachineBuilder.addTransition(ControllerEvent.DONE, WalkerLegsControllerState.RIGHT_SUPPORT, WalkerLegsControllerState.LEFT_SUPPORT);
//      stateMachineBuilder.addTransition(ControllerEvent.DONE, WalkerLegsControllerState.LEFT_SUPPORT, WalkerLegsControllerState.RIGHT_SUPPORT);
//      
//      stateMachine = stateMachineBuilder.build(WalkerLegsControllerState.RIGHT_SUPPORT);
//   }
   
//   private class SingleSupportState implements FiniteStateMachineState<ControllerEvent>
//   {
...
//      stateMachine.checkTransitionConditions();
   ...
   public enum WalkerLegsControllerState
   {
