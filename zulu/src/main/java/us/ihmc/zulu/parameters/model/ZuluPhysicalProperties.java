...
{
   private final double ANKLE_HEIGHT = 0.072;

   private final double FOOT_WIDTH_REDUCTION = 0.005;
   private final double FOOT_LENGTH_REDUCTION = 0.005;

   private final double ACTUAL_FOOT_LENGTH = 0.197;
   private final double ACTUAL_FOOT_WIDTH = 0.09;
   private final double FOOT_BACK = 0.052;
