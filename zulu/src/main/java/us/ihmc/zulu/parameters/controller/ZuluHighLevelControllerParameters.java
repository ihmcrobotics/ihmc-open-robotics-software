...
{
   protected final ZuluVersionInterface alexanderVersion;
   ...
   public ZuluHighLevelControllerParameters(ZuluVersionInterface alexanderVersion, ZuluJointMap jointMap, RobotTarget target)
   {
