...
public class ZuluFullyCoveredKinematicsCollisionModel implements RobotCollisionModel
{
   private final HumanoidJointNameMap jointMap;

   public ZuluFullyCoveredKinematicsCollisionModel(HumanoidJointNameMap jointMap)
   {
