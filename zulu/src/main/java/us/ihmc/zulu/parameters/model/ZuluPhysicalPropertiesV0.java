...
public class ZuluPhysicalPropertiesV0 implements ZuluPhysicalProperties
{
   ...
   public ZuluPhysicalPropertiesV0(boolean hasArms)
   {
      this(1.0, 1.0, hasArms);
   }
   public ZuluPhysicalPropertiesV0()
   {
      this(1.0, 1.0, true);
   }

   public ZuluPhysicalPropertiesV0(double modelSizeScale, double modelMassScale, boolean hasArms)
   {
