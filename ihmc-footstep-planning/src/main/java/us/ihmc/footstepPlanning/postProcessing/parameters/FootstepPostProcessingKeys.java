...
public class FootstepPostProcessingKeys
{
   ...
   public static final BooleanStoredPropertyKey positionSplitFractionProcessingEnabled  = keys.addBooleanKey("Position split fraction processing enabled", false);
