...
public class FootstepCliffProximityCostCalculator
{
   ...
   public FootstepCliffProximityCostCalculator(FootstepPlannerParametersReadOnly parameters, FootstepNodeSnapperReadOnly snapper, SideDependentList<ConvexPolygon2D> footPolygons)
   {
