...
public class DiscreteFootstepTools
{
                                                           ...
                                                           SideDependentList<? extends ConvexPolygon2DReadOnly> footPolygonsInSoleFrame)
   {
      ...
      if (ConvexPolygonTools.arePolygonsIntersecting(footPolygonA, footPolygonB))
      {
         return 0.0;
      }

      return ConvexPolygonTools.distanceBetweenNonIntersectingPolygons(footPolygonA, footPolygonB);
   }
