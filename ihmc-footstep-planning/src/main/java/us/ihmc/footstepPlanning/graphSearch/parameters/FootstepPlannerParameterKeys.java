...
public class FootstepPlannerParameterKeys
{
   ...
   public static final DoubleStoredPropertyKey  solutionQualityThreshold                     = keys.addDoubleKey ("Solution quality threshold", 7.0);
   ...
   public static final DoubleStoredPropertyKey  rmsMinErrorToPenalize                        = keys.addDoubleKey ("RMS Min Error To Penalize", 0.07);
