...
public class FootstepPlannerParameterKeys
{
   ...
   public static final DoubleStoredPropertyKey  shinRadius                                   = keys.addDoubleKey("Shin radius", 0.05);
   public static final DoubleStoredPropertyKey  shinLength                                   = keys.addDoubleKey("Shin length", 0.45);
   public static final DoubleStoredPropertyKey  shinPitch                                    = keys.addDoubleKey("Shin pitch", Math.toRadians(20.0));
