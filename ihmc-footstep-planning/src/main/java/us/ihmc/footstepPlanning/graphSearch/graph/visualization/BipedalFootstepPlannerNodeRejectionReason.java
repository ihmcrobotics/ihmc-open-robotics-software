...
{
   STEP_TOO_HIGH_OR_LOW, STEP_TOO_LOW_WHEN_PITCHED, STEP_TOO_FORWARD_AND_DOWN, STEP_TOO_WIDE_AND_DOWN,  STEP_TOO_FAR, STEP_TOO_FAR_AND_HIGH, STEP_TOO_WIDE_AND_HIGH, STEP_NOT_WIDE_ENOUGH,
