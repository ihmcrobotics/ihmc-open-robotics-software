...
public enum BipedalFootstepPlannerNodeRejectionReason
{
   ...
   OBSTACLE_BLOCKING_BODY, OBSTACLE_HITTING_BODY, AT_CLIFF_BOTTOM, STEP_YAWS_TOO_MUCH, WIGGLE_CONSTRAINT_NOT_MET, SWING_HEIGHT_TOO_LARGE, SWING_REACH_TOO_LARGE, REACHABILITY_CHECK;
