...
//   {
//      LogTools.debug("wiggleIntoConvexHullOfPlanarRegions: {}", getWiggleIntoConvexHullOfPlanarRegions ()  );
//      LogTools.debug("rejectIfCannotFullyWiggleInside    : {}", getRejectIfCannotFullyWiggleInside     ()  );
//      LogTools.debug("returnBestEffortPlan               : {}", getReturnBestEffortPlan                ()  );
//      LogTools.debug("checkForBodyBoxCollisions          : {}", checkForBodyBoxCollisions              ()  );
//      LogTools.debug("performHeuristicSearchPolicies     : {}", performHeuristicSearchPolicies         ()  );
//      LogTools.debug("minimumStepsForBestEffortPlan      : {}", getMinimumStepsForBestEffortPlan       ()  );
//      LogTools.debug("idealFootstepWidth                 : {}", getIdealFootstepWidth                  ()  );
//      LogTools.debug("idealFootstepLength                : {}", getIdealFootstepLength                 ()  );
//      LogTools.debug("wiggleInsideDelta                  : {}", getWiggleInsideDelta                   ()  );
//      LogTools.debug("maximumXYWiggleDistance            : {}", getMaximumXYWiggleDistance             ()  );
//      LogTools.debug("maximumYawWiggle                   : {}", getMaximumYawWiggle                    ()  );
//      LogTools.debug("maxStepReach                       : {}", getMaximumStepReach                    ()  );
//      LogTools.debug("maxStepYaw                         : {}", getMaximumStepYaw                      ()  );
//      LogTools.debug("minStepWidth                       : {}", getMinimumStepWidth                    ()  );
//      LogTools.debug("minStepLength                      : {}", getMinimumStepLength                   ()  );
//      LogTools.debug("minStepYaw                         : {}", getMinimumStepYaw                      ()  );
//      LogTools.debug("maxStepZ                           : {}", getMaximumStepZ                        ()  );
//      LogTools.debug("minFootholdPercent                 : {}", getMinimumFootholdPercent              ()  );
//      LogTools.debug("minSurfaceIncline                  : {}", getMinimumSurfaceInclineRadians        ()  );
//      LogTools.debug("maxStepWidth                       : {}", getMaximumStepWidth                    ()  );
//      LogTools.debug("minXClearanceFromStance            : {}", getMinXClearanceFromStance             ()  );
//      LogTools.debug("minYClearanceFromStance            : {}", getMinYClearanceFromStance             ()  );
//      LogTools.debug("maximumStepReachWhenSteppingUp     : {}", getMaximumStepReachWhenSteppingUp      ()  );
//      LogTools.debug("maximumStepZWhenSteppingUp         : {}", getMaximumStepZWhenSteppingUp          ()  );
//      LogTools.debug("maximumStepXWhenForwardAndDown     : {}", getMaximumStepXWhenForwardAndDown      ()  );
//      LogTools.debug("maximumStepZWhenForwardAndDown     : {}", getMaximumStepZWhenForwardAndDown      ()  );
//      LogTools.debug("maximumZPenetrationOnValleyRegions : {}", getMaximumZPenetrationOnValleyRegions  ()  );
//      LogTools.debug("cliffHeightToAvoid                 : {}", getCliffHeightToAvoid                  ()  );
//      LogTools.debug("minimumDistanceFromCliffBottoms    : {}", getMinimumDistanceFromCliffBottoms     ()  );
//      LogTools.debug("bodyGroundClearance                : {}", getBodyGroundClearance                 ()  );
//      LogTools.debug("bodyBoxWidth                       : {}", getBodyBoxWidth                        ()  );
//      LogTools.debug("bodyBoxHeight                      : {}", getBodyBoxHeight                       ()  );
//      LogTools.debug("bodyBoxDepth                       : {}", getBodyBoxDepth                        ()  );
//      LogTools.debug("bodyBoxBaseX                       : {}", getBodyBoxBaseX                        ()  );
//      LogTools.debug("bodyBoxBaseY                       : {}", getBodyBoxBaseY                        ()  );
//      LogTools.debug("bodyBoxBaseZ                       : {}", getBodyBoxBaseZ                        ()  );
//      LogTools.debug("finalTurnProximity                 : {}", getFinalTurnProximity                  ()  );
//      LogTools.debug("checkForBodyBoxCollisions          s: {}", getWiggleIntoConvexHullOfPlanarRegions ()  );
//      LogTools.debug("performHeuristicSearchPolicies      : {}", getRejectIfCannotFullyWiggleInside     ()  );
//      LogTools.debug("maximumStepReach                    : {}", getReturnBestEffortPlan                ()  );
//      LogTools.debug("minimumFootholdPercent              : {}", checkForBodyBoxCollisions              ()  );
//      LogTools.debug("idealFootstepLength                 : {}", performHeuristicSearchPolicies         ()  );
//      LogTools.debug("idealFootstepWidth                  : {}", getMinimumStepsForBestEffortPlan       ()  );
//      LogTools.debug("maximumStepZ                        : {}", getIdealFootstepWidth                  ()  );
//      LogTools.debug("maximumStepYaw                      : {}", getIdealFootstepLength                 ()  );
//      LogTools.debug("maximumStepWidth                    : {}", getWiggleInsideDelta                   ()  );
//      LogTools.debug("minimumStepWidth                    : {}", getMaximumXYWiggleDistance             ()  );
//      LogTools.debug("minimumStepLength                   : {}", getMaximumYawWiggle                    ()  );
//      LogTools.debug("minimumStepYaw                      : {}", getMaximumStepReach                    ()  );
//      LogTools.debug("maximumStepReachWhenSteppingUp      : {}", getMaximumStepYaw                      ()  );
//      LogTools.debug("maximumStepZWhenSteppingUp          : {}", getMinimumStepWidth                    ()  );
//      LogTools.debug("maximumStepXWhenForwardAndDown      : {}", getMinimumStepLength                   ()  );
//      LogTools.debug("maximumStepZWhenForwardAndDown      : {}", getMinimumStepYaw                      ()  );
//      LogTools.debug("wiggleInsideDelta                   : {}", getMaximumStepZ                        ()  );
//      LogTools.debug("rejectIfCannotFullyWiggleInside     : {}", getMinimumFootholdPercent              ()  );
//      LogTools.debug("wiggleIntoConvexHullOfPlanarRegions : {}", getMinimumSurfaceInclineRadians        ()  );
//      LogTools.debug("maximumXYWiggleDistance             : {}", getMaximumStepWidth                    ()  );
//      LogTools.debug("maximumYawWiggle                    : {}", getMinXClearanceFromStance             ()  );
//      LogTools.debug("cliffHeightToShiftAwayFrom          : {}", getMinYClearanceFromStance             ()  );
//      LogTools.debug("minimumDistanceFromCliffBottoms     : {}", getMaximumStepReachWhenSteppingUp      ()  );
//      LogTools.debug("minimumSurfaceInclineRadians        : {}", getMaximumStepZWhenSteppingUp          ()  );
//      LogTools.debug("maximumZPenetrationOnValleyRegions  : {}", getMaximumStepXWhenForwardAndDown      ()  );
//      LogTools.debug("bodyGroundClearance                 : {}", getMaximumStepZWhenForwardAndDown      ()  );
//      LogTools.debug("bodyBoxHeight                       : {}", getMaximumZPenetrationOnValleyRegions  ()  );
//      LogTools.debug("bodyBoxWidth                        : {}", getCliffHeightToAvoid                  ()  );
//      LogTools.debug("bodyBoxDepth                        : {}", getMinimumDistanceFromCliffBottoms     ()  );
//      LogTools.debug("bodyBoxBaseX                        : {}", getBodyGroundClearance                 ()  );
//      LogTools.debug("bodyBoxBaseY                        : {}", getBodyBoxWidth                        ()  );
//      LogTools.debug("bodyBoxBaseZ                        : {}", getBodyBoxHeight                       ()  );
//      LogTools.debug("returnBestEffortPlan                : {}", getBodyBoxDepth                        ()  );
//      LogTools.debug("minimumStepForBestEffortPlan        : {}", getBodyBoxBaseX                        ()  );
//      LogTools.debug("minXClearanceFromStance             : {}", getBodyBoxBaseY                        ()  );
//      LogTools.debug("minYClearanceFromStance             : {}", getBodyBoxBaseZ                        ()  );
//   }
}
