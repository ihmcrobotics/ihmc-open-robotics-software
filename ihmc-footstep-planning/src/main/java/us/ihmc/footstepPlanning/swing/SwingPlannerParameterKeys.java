...
public class SwingPlannerParameterKeys
{
   ...
   public static final DoubleStoredPropertyKey percentageExtraSizeXHigh = keys.addDoubleKey("Percentage extra size x high", 0.3);
   public static final DoubleStoredPropertyKey extraSizeXLow = keys.addDoubleKey("Extra size x low", 0.05);
   public static final DoubleStoredPropertyKey extraSizeXHigh = keys.addDoubleKey("Extra size x high", 0.08);
