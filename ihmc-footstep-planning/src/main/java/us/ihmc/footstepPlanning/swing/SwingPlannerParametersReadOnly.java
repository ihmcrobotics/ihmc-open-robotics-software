...
public interface SwingPlannerParametersReadOnly extends StoredPropertySetReadOnly
{
   ...
   /**
    * Ground clearance for toe and heel collision boxes
    */
   default double getCollisionBoxGroundClearance()
   {
      return get(SwingPlannerParameterKeys.collisionBoxGroundClearance);
   }

   /**
    * Height of toe and heel collision boxes
    */
   ...
   /**
    * Mid swing collision box extra Y size
    */
   default double getMidSwingCollisionBoxExtraY()
   {
      return get(SwingPlannerParameterKeys.midSwingCollisionBoxExtraY);
   }

   /**
    * Mid swing collision box extra Z size
    */
   default double getMidSwingCollisionBoxExtraZ()
   {
      return get(SwingPlannerParameterKeys.midSwingCollisionBoxExtraZ);
   }

   /**
    * Magnitude of X shift when toe or heel collision is detected
    */
   default double getXShiftForToeOrHeelCollision()
   {
      return get(SwingPlannerParameterKeys.xShiftForToeOrHeelCollision);
   }

   /**
    * Z shift when toe or heel collision is detected
    */
   default double getZShiftForToeOrHeelCollision()
   {
      return get(SwingPlannerParameterKeys.zShiftForToeOrHeelCollision);
   }

   /**
    * Z shift when mid-swing collision is detected
    */
   default double getZShiftForMidSwingCollision()
   {
