...
public class FootstepPlannerUI
{
   ...
   public FootstepPlannerUI(Stage primaryStage, FootstepPlanningParameters plannerParameters, VisibilityGraphsParameters visibilityGraphsParameters) throws Exception
   {
   ...
   {
      this(primaryStage, messager, new FootstepPlanningParameters(), new DefaultVisibilityGraphParameters(), null, null, null);
   }

   public FootstepPlannerUI(Stage primaryStage, JavaFXMessager messager, FootstepPlanningParameters plannerParameters,
   ...
   public static FootstepPlannerUI createMessagerUI(Stage primaryStage, JavaFXMessager messager, FootstepPlanningParameters plannerParameters,
