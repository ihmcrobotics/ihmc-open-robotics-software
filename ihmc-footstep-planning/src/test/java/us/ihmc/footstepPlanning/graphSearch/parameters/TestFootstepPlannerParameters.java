...
public class TestFootstepPlannerParameters extends StoredPropertySet implements DefaultFootstepPlannerParametersBasics
{
    ...
    */
   public TestFootstepPlannerParameters()
   {
      this(null);
   }

   private TestFootstepPlannerParameters(DefaultFootstepPlannerParameters footstepPlannerParameters)
   {
      super(keys, TestFootstepPlannerParameters.class);
   ...
   {
      TestFootstepPlannerParameters parameters = new TestFootstepPlannerParameters();
      parameters.save();
   }
}
