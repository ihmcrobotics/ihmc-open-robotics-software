...
public class SimplePlanarRegionFootstepSnapperTest
{
   ...
   {
      DiscreteFootstep nodeToSnap = new DiscreteFootstep(-0.3, 2.2);
      RigidBodyTransform nodeTransform = new RigidBodyTransform();
      DiscreteFootstepTools.getStepTransform(nodeToSnap, nodeTransform);
   ...
   {
      DiscreteFootstep nodeToSnap = new DiscreteFootstep(2.5, -0.5);
      RigidBodyTransform nodeTransform = new RigidBodyTransform();
      DiscreteFootstepTools.getStepTransform(nodeToSnap, nodeTransform);
   ...
   {
      DiscreteFootstep nodeToSnap = new DiscreteFootstep(0.0, 0.0);
      RigidBodyTransform nodeTransform = new RigidBodyTransform();
      DiscreteFootstepTools.getStepTransform(nodeToSnap, nodeTransform);
   ...
   {
      DiscreteFootstep nodeToSnap = new DiscreteFootstep(1.1, 0.0);
      RigidBodyTransform nodeTransform = new RigidBodyTransform();
      DiscreteFootstepTools.getStepTransform(nodeToSnap, nodeTransform);
   ...
   {
      DiscreteFootstep nodeToSnap = new DiscreteFootstep(1.0, 0.0);
      RigidBodyTransform nodeTransform = new RigidBodyTransform();
      DiscreteFootstepTools.getStepTransform(nodeToSnap, nodeTransform);
   ...
   public void testRandomFullFootholds()
   {
      ...
      {
         DiscreteFootstep node = DiscreteFootstep.generateRandomFootstep(random, 5.0);
         DiscreteFootstepTools.getStepTransform(node, nodeToWorldTransform);
   ...
   private void doAFullFootholdTest(RigidBodyTransform regionToWorldFrameTransform, DiscreteFootstep nodeToSnap)
   {
      RigidBodyTransform nodeTransform = new RigidBodyTransform();
      DiscreteFootstepTools.getStepTransform(nodeToSnap, nodeTransform);
      ...
      if(visualize)
      {
         ...
         DiscreteFootstepTools.getSnappedStepTransform(nodeToSnap, snapData.getSnapTransform(), snappedNodeTransform);
