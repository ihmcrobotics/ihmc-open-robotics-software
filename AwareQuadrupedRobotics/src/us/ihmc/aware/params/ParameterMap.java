 ...
 * <p/>
 * If existing parameter values exist at the time of creation, they may be set with {@link #insert(String, double...)}. A controller can then A controller can
 * then set any previously unset parameters with {@link #setDefault(String, double...)} to ensure thatrs contain at least default values.
 * <p/>
...
public class ParameterMap
{
   ...
   /**
    * Establishes a default value for the given parameter base name. If the key is not present in the map, then it will be inserted wit be inserted with the
    * given value. If it tion will be taken.
    *
    * @param name   the base parameter name
    * @param values the parameter values
    */
   ...
   /**
    * Gets a temporary array of values. The returned array is a reference to an internal buffer and is not guaranteed to remain consiste remain consistent with
    * the actual successive {@link #set(String, double...)} calls.
    *
    * @param name the base parameter name
