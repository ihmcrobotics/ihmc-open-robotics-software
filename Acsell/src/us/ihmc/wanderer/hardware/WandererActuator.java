...
public enum WandererActuator implements AcsellActuator
{
   ...
   RIGHT_KNEE("rightKneeActuator",              2.142e-3, 0.612, 0.991, 50.0, 0, 3, 2.0*Math.PI/16384.0, -2.0*Math.PI/16384.0, 12971.5),
   ...
   LEFT_KNEE("leftKneeActuator",              2.142e-3, 0.612, 0.991, 50.0, 1, 3, 2.0*Math.PI/16384.0, +2.0*Math.PI/16384.0, 15642.5),
   ...
   TORSO_X("torsoXActuator", 0.069e-3, 0.398, .104,  6.8, 2, 1, 2.0*Math.PI/16384.0, 2.0*Math.PI/16384.0, 0),
   TORSO_Y("torsoYActuator", 0.197e-3, 0.450, .192, 18.3, 2, 2, 2.0*Math.PI/16384.0, 2.0*Math.PI/16384.0, 0),
   TORSO_Z("torsoZActuator", 0.069e-3, 0.316, .104, 10.8, 2, 3, 2.0*Math.PI/16384.0, 2.0*Math.PI/16384.0, 0);
