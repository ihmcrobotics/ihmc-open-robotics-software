...
public enum WandererActuator
{
   ...
   private WandererActuator(String name, double motorInertial, double ktPeak, double km, int bus, int index, int SensedCurrentToTorqueDirection)
   {
      this.name = name;
