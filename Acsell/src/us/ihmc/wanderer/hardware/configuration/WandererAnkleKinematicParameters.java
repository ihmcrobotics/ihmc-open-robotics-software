...
public final class WandererAnkleKinematicParameters implements AcsellAnkleKinematicParameters
{
   ...
   /*
    * //Wide bracket linkage private static final double px[] = { 0.0000,
    * 0.9030, -0.9030, -0.0010, 0.0010, -0.0000, -0.0100, -0.1011, 0.1011,
    * 0.0100}; private static final double py[] = { 0.0005, 0.4636, 0.4636,
    * -0.0260, -0.0260, 0.0541, -0.0714, 0.0540, 0.0540, -0.0714}; private
    * static final double pM1[] = { -0.0054, 3.3165, 6.4421, 0.2435, -0.0085,
    * 0.0131, -0.1054, 1.4838, 0.6777, 0.3746}; private static final double
    * pM2[] = { -0.0054, -3.3165, 6.4421, 0.2435, -0.0085, -0.0131, 0.1054,
    * 1.4838, -0.6777, 0.3746}; private static final double p_m_JitX[] = {
    * 0.9064, 0.0228, -0.0042, -0.0031, 0.1523, -0.2989, -0.1515, 0.2460,
    * -0.0961, -0.0190}; private static final double p_m_JitY[] = { 0.4651,
    * -0.0357, 0.0409, -0.2213, 0.0411, 0.1234, -0.0712, 0.1660, -0.1495,
    * 0.0511}; private static final double p_j_JitX[] = { 0.9060, 0.0149,
    * 0.0221, 0.1463, -0.1834, -0.2054, -0.0819, -0.2685, -0.0467, -0.0326};
    * private static final double p_j_JitY[] = { 0.4661, -0.0382, 0.0064,
    * -0.1044, -0.0740, -0.3509, -0.1060, -0.0376, -0.0597, -0.0058};
    */
