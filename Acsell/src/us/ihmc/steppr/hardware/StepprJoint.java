...
public enum StepprJoint
{
   ...
   LEFT_KNEE_Y("l_leg_kny", 6 * 1.3333333333, true, new StrainGaugeInformation(StepprActuator.LEFT_KNEE, 0, 79.65*1.33, 2.5), StepprActuator.LEFT_KNEE, StepprActuator.LEFT_ANKLE_LEFT),
   LEFT_ANKLE_Y("l_leg_uay", 6, true, null, StepprActuator.LEFT_ANKLE_RIGHT, StepprActuator.LEFT_ANKLE_LEFT),
   LEFT_ANKLE_X("l_leg_lax", LEFT_ANKLE_Y.getRatio(), true, null, LEFT_ANKLE_Y.getActuators()),
   ...
   RIGHT_KNEE_Y("r_leg_kny", 6 * 1.3333333333, true, new StrainGaugeInformation(StepprActuator.RIGHT_KNEE, 0, -78.5*1.33, 2.5), StepprActuator.RIGHT_KNEE, StepprActuator.RIGHT_ANKLE_RIGHT),
   RIGHT_ANKLE_Y("r_leg_uay", 6, true, null, StepprActuator.RIGHT_ANKLE_RIGHT, StepprActuator.RIGHT_ANKLE_LEFT),
   RIGHT_ANKLE_X("r_leg_lax", RIGHT_ANKLE_Y.getRatio(), true, null, RIGHT_ANKLE_Y.getActuators()),
