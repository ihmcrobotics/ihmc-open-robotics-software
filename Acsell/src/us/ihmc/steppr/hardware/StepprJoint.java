...
public enum StepprJoint
{
   ...
   LEFT_KNEE_Y("l_leg_kny", 6 * 1.3333333333, true, new StrainGaugeInformation(StepprActuator.LEFT_KNEE, 0, 79.65, 2.5), StepprActuator.LEFT_KNEE, StepprActuator.LEFT_ANKLE_LEFT),
   ...
   RIGHT_KNEE_Y("r_leg_kny", 6 * 1.3333333333, true, new StrainGaugeInformation(StepprActuator.RIGHT_KNEE, 0, -78.5, 2.5), StepprActuator.RIGHT_KNEE, StepprActuator.RIGHT_ANKLE_RIGHT),
