...
public class StepprAnkleInterpolator implements StepprAnkleAngleCalculator
{
	   ...
	   private final static double N = StepprAnkleKinematicParameters.getN();
	   
	   private final static double[] px = StepprAnkleKinematicParameters.getXParams();
	   private final static double[] py = StepprAnkleKinematicParameters.getYParams();
	   private final static double[] p_m_JitX = StepprAnkleKinematicParameters.getJITX_FromMotorParams();
	   private final static double[] p_m_JitY = StepprAnkleKinematicParameters.getJITY_FromMotorParams();
	   private final static double[] p_j_JitX = StepprAnkleKinematicParameters.getJITX_FromJointParams();
	   private final static double[] p_j_JitY = StepprAnkleKinematicParameters.getJITY_FromJointParams();
	   private final static double[] pM1 = StepprAnkleKinematicParameters.getM1Params();
	   private final static double[] pM2 = StepprAnkleKinematicParameters.getM2Params();
   ...
   private static double scaledDownCubicApprox(double p[], double m1, double m2)
   {
   ...
   private static void computeSymmetricLinkageJacobianInverseTransposeFromMotorAngles(DenseMatrix64F Jit, double m1, double m2)
   {
   ...
   private static void computeSymmetricLinkageJacobianInverseTransposeFromJointAngles(DenseMatrix64F Jit, double q_x, double q_y)
   {
