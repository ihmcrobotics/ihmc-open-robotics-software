...
{
   LEFT_ANKLE_RIGHT("leftAnkleRightActuator", 0.0 /*1.01e-3*/, 1.152, 0.587, 0, 1, -1), //measured current is -1*commanded current
   LEFT_ANKLE_LEFT("leftAnkleLeftActuator", 0.0 /*1.01e-3*/, 1.152, 0.587, 0, 2, 1),
   ...
   RIGHT_ANKLE_RIGHT("rightAnkleRightActuator", 0.0/*1.01e-3*/, 1.152, .587, 1, 1, -1),
   RIGHT_ANKLE_LEFT("rightAnkleLeftActuator", 0.0/*1.01e-3*/, 1.152, .587, 1, 2, 1),
