...
public class ValkyrieMultiContactStaticPoseEndToEndTest
{
   ...
   public void testRolling1()
   {
      ...
      addOuterKneeContactPoint(RobotSide.RIGHT, jointMap, contactPointParameters);
      addOuterToeContactPoint(RobotSide.RIGHT, jointMap, contactPointParameters);
      ...
      setRobotToRolling1Configuration(robot, jointMap);
      scs.startOnAThread();
   ...
   public void testRolling2()
   {
      ...
      setRobotToRolling2Configuration(robot, jointMap);
      scs.startOnAThread();
   ...
   public void testRolling3()
   {
      ...
      setRobotToRolling3Configuration(robot, jointMap);
      scs.startOnAThread();
   ...
   public void testRolling4()
   {
      ...
      setRobotToRolling4Configuration(robot, jointMap);
      scs.startOnAThread();
   ...
   public void testRolling5()
   {
      ...
      setRobotToRolling5Configuration(robot, jointMap);
      scs.startOnAThread();
   ...
   public void testRolling6()
   {
      ...
      setRobotToRolling6Configuration(robot, jointMap);
      scs.startOnAThread();
   ...
   public void testRolling7()
   {
      ...
      setRobotToRolling7Configuration(robot, jointMap);
      scs.startOnAThread();
   ...
   public void testLieDown1()
   {
      ...
      addBackpackMiddleContactPoint(jointMap, contactPointParameters);
      robotModel.setContactPointParameters(contactPointParameters);
   ...
   private static void setRobotToRolling1Configuration(HumanoidFloatingRootJointRobot robot, DRCRobotJointMap jointMap)
   {
   ...
   private static void setRobotToRolling2Configuration(HumanoidFloatingRootJointRobot robot, DRCRobotJointMap jointMap)
   {
      RobotSide leftSide = RobotSide.LEFT;
      robot.getOneDegreeOfFreedomJoint(jointMap.getLegJointName(leftSide, LegJointName.HIP_YAW)).setQ(0.8);
      robot.getOneDegreeOfFreedomJoint(jointMap.getLegJointName(leftSide, LegJointName.HIP_ROLL)).setQ(0.2);
   ...
   private static void setRobotToRolling3Configuration(HumanoidFloatingRootJointRobot robot, DRCRobotJointMap jointMap)
   {
      RobotSide leftSide = RobotSide.LEFT;
      robot.getOneDegreeOfFreedomJoint(jointMap.getLegJointName(leftSide, LegJointName.HIP_YAW)).setQ(0.8);
      robot.getOneDegreeOfFreedomJoint(jointMap.getLegJointName(leftSide, LegJointName.HIP_ROLL)).setQ(0.2);
   ...
   private static void setRobotToRolling4Configuration(HumanoidFloatingRootJointRobot robot, DRCRobotJointMap jointMap)
   {
      RobotSide leftSide = RobotSide.LEFT;
   ...
   private static void setRobotToRolling5Configuration(HumanoidFloatingRootJointRobot robot, DRCRobotJointMap jointMap)
   {
      RobotSide leftSide = RobotSide.LEFT;
   ...
   private static void setRobotToRolling6Configuration(HumanoidFloatingRootJointRobot robot, DRCRobotJointMap jointMap)
   {
      RobotSide leftSide = RobotSide.LEFT;
   ...
   private static void setRobotToRolling7Configuration(HumanoidFloatingRootJointRobot robot, DRCRobotJointMap jointMap)
   {
      RobotSide leftSide = RobotSide.LEFT;
   ...
   {
      Point3D position = new Point3D(-0.105, 0.0, -0.29);
      RigidBodyTransform rigidBodyTransform = new RigidBodyTransform();
      rigidBodyTransform.setTranslation(position);
      String parentJointName = jointMap.getPelvisName();
      String bodyName = parentJointName;
   ...
   private static void addOuterKneeContactPoint(RobotSide robotSide, ValkyrieJointMap jointMap, ValkyrieMultiContactPointParameters contactPointParameters)
   {
      Point3D position = new Point3D(0.0, robotSide.negateIfRightSide(0.115), 0.0);
      RigidBodyTransform rigidBodyTransform = new RigidBodyTransform();
      rigidBodyTransform.setTranslation(position);
   ...
   {
      Point3D position = new Point3D(0.18, robotSide.negateIfLeftSide(0.07), -0.085);
      RigidBodyTransform rigidBodyTransform = new RigidBodyTransform();
      rigidBodyTransform.setTranslation(position);
      String parentJointName = jointMap.getJointBeforeFootName(robotSide);
      String bodyName = jointMap.getFootName(robotSide);
   ...
   private static void addOuterToeContactPoint(RobotSide robotSide, ValkyrieJointMap jointMap, ValkyrieMultiContactPointParameters contactPointParameters)
   {
      Point3D position = new Point3D(0.165, robotSide.negateIfRightSide(0.075), -0.06);
      RigidBodyTransform rigidBodyTransform = new RigidBodyTransform();
      rigidBodyTransform.setTranslation(position);
      String parentJointName = jointMap.getJointBeforeFootName(robotSide);
      String bodyName = jointMap.getFootName(robotSide);
   ...
   {
      Point3D position = new Point3D(-0.085, robotSide.negateIfLeftSide(0.07), -0.085);
      RigidBodyTransform rigidBodyTransform = new RigidBodyTransform();
      rigidBodyTransform.setTranslation(position);
      String parentJointName = jointMap.getJointBeforeFootName(robotSide);
      String bodyName = jointMap.getFootName(robotSide);
   ...
   private static void addBackpackMiddleContactPoint(ValkyrieJointMap jointMap, ValkyrieMultiContactPointParameters contactPointParameters)
   {
      Point3D position = new Point3D(-0.29, 0.0, 0.2);
      RigidBodyTransform rigidBodyTransform = new RigidBodyTransform();
      rigidBodyTransform.setTranslation(position);
