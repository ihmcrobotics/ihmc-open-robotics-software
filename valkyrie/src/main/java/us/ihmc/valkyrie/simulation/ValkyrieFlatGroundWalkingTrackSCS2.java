...
public class ValkyrieFlatGroundWalkingTrackSCS2
{
   ...
   private static HighLevelHumanoidControllerFactory createControllerFactory(DRCRobotModel robotModel,
   ...
   public static void setupHighLevelStates(HighLevelHumanoidControllerFactory controllerFactory,
