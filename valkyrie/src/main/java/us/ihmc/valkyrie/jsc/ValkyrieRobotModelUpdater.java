...
public class ValkyrieRobotModelUpdater {
	...
	/**
	 * Update the robot model based on the new configuration data. This function does not do the actual updating,
	 * but rather sets up the information to be processed by the scheduled task defined in the constructor.
	 * This function relies on being call with update, either directly, or as the callback function to a
	 * RobotConfigurationData topic.
	 * 
	...
	public void updateConfiguration(RobotConfigurationData robotConfigurationData) {
		...
		newRootJointPoseReference.set(new RigidBodyTransform(robotConfigurationData.getRootOrientation(),
	...
	public static int calculateJointNameHash(OneDoFJointBasics[] joints, ForceSensorDefinition[] forceSensorDefinitions,
