...
public class ValkyrieModelFileLoadingDemoSCS2
{
...
//      robotModel.setCustomModel("models/valkyrie_A_psyonic.urdf");
   ...
   public static void addKinematicsCollisionGraphics(FullHumanoidRobotModel fullRobotModel,
                                                     us.ihmc.simulationconstructionset.Robot robot,
   ...
   {
      new ValkyrieModelFileLoadingDemoSCS2();
   }
