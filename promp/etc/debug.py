...
for i in range(0,n_demos):
    ...
    plotter.plot(alphas[i][:,4],democolorX)
    plotter.plot(alphas[i][:,5],democolorY)
    plotter.plot(alphas[i][:,6],democolorZ)
    plotter.plot(test[:,11],testcolorX,linewidth=1.0)
    plotter.plot(test[:,12],testcolorY,linewidth=1.0)
    plotter.plot(test[:,13],testcolorZ,linewidth=1.0)
...
for i in range(0,n_demos):
    ...
    plotter.plot(alphas[i][:,0],democolorX)
    plotter.plot(alphas[i][:,1],democolorY)
    plotter.plot(alphas[i][:,2],democolorZ)
    plotter.plot(alphas[i][:,3],democolorZ)
    plotter.plot(test[:,7],testcolorX,linewidth=1.0)
    plotter.plot(test[:,8],testcolorY,linewidth=1.0)
    plotter.plot(test[:,9],testcolorZ,linewidth=1.0)
