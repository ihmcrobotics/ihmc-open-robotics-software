...
for bodyPart in bodyParts:
    ...
    fig = plotter.figure()
    fig.suptitle('Shared-control arbitrated motion', fontsize=16)
    plotter.plot(x,colorX,linewidth=4.0)
    plotter.plot(y,colorY,linewidth=4.0)
    plotter.plot(z,colorZ,linewidth=4.0)
    plotter.plot(meanConditionedX,democolorX,linewidth=2.0)
    plotter.plot(meanConditionedY,democolorY,linewidth=2.0)
    plotter.plot(meanConditionedZ,democolorZ,linewidth=2.0)
    if bodyPart == bodyParts[0]:
        plotter.plot(test[:,4],testcolorX,linewidth=2.0)
        plotter.plot(test[:,5],testcolorY,linewidth=2.0)
        plotter.plot(test[:,6],testcolorZ,linewidth=2.0)
    elif bodyPart == bodyParts[1]:
        plotter.plot(test[:,11],testcolorX,linewidth=2.0)
        plotter.plot(test[:,12],testcolorY,linewidth=2.0)
        plotter.plot(test[:,13],testcolorZ,linewidth=2.0)
    ...
    plotter.plot(qX,colorX,linewidth=4.0)
    plotter.plot(qY,colorY,linewidth=4.0)
    plotter.plot(qZ,colorZ,linewidth=4.0)
    plotter.plot(qS,colorS,linewidth=4.0)
    plotter.plot(meanConditionedQX,democolorX,linewidth=2.0)
    plotter.plot(meanConditionedQY,democolorY,linewidth=2.0)
    plotter.plot(meanConditionedQZ,democolorZ,linewidth=2.0)
    plotter.plot(meanConditionedQS,democolorS,linewidth=2.0)
    if bodyPart == bodyParts[0]:
        plotter.plot(test[:,0],testcolorX,linewidth=2.0)
        plotter.plot(test[:,1],testcolorY,linewidth=2.0)
        plotter.plot(test[:,2],testcolorZ,linewidth=2.0)
        plotter.plot(test[:,3],testcolorS,linewidth=2.0)
    elif bodyPart == bodyParts[1]:
        plotter.plot(test[:,7],testcolorX,linewidth=2.0)
        plotter.plot(test[:,8],testcolorY,linewidth=2.0)
        plotter.plot(test[:,9],testcolorZ,linewidth=2.0)
        plotter.plot(test[:,10],testcolorS,linewidth=2.0)
