...
public class SideDependentListTest
{
   ...
   public void testCommonUse()
   {
      ...
      double epsilon = 0.0;
      Assertions.assertEquals(leftFavoriteNumber, sideDependentList.get(RobotSide.LEFT), epsilon);
      Assertions.assertEquals(rightFavoriteNumber, sideDependentList.get(RobotSide.RIGHT), epsilon);
   ...
   public void testCreateListOfHashMaps()
   {
      ...
      Assertions.assertEquals(sideDependentList.get(RobotSide.LEFT).get(1.0), "1.0");
      Assertions.assertEquals(sideDependentList.get(RobotSide.LEFT).get(2.0), "2.0");
      Assertions.assertEquals(sideDependentList.get(RobotSide.RIGHT).get(3.0), "3.0");
      Assertions.assertEquals(sideDependentList.get(RobotSide.RIGHT).get(4.0), "4.0");
   }
   ...
   public void testCreateListOfEnumMaps()
   {
      ...
      Assertions.assertEquals("YummyChocolate", sideDependentList.get(RobotSide.LEFT).get(IceCreamFlavor.CHOCOLATE));
      Assertions.assertEquals("YummyVanilla", sideDependentList.get(RobotSide.LEFT).get(IceCreamFlavor.VANILLA));
      Assertions.assertEquals("YummyTootyFruity", sideDependentList.get(RobotSide.LEFT).get(IceCreamFlavor.TOOTYFRUITY));
      
      Assertions.assertEquals("ChocolateWow", sideDependentList.get(RobotSide.RIGHT).get(IceCreamFlavor.CHOCOLATE));
      Assertions.assertEquals(null, sideDependentList.get(RobotSide.RIGHT).get(IceCreamFlavor.VANILLA));
      Assertions.assertEquals(null, sideDependentList.get(RobotSide.RIGHT).get(IceCreamFlavor.TOOTYFRUITY));
   }
