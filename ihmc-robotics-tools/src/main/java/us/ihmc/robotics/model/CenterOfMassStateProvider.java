package us.ihmc.robotics.model;
...
public interface CenterOfMassStateProvider
{
    ...
    */
   static CenterOfMassStateProvider createJacobianBasedStateCalculator(RigidBodyReadOnly elevator, ReferenceFrame referenceFrame)
   {
