...
public final class RobotiqHandParameters
{
	...
	public static final String RIGHT_HAND_ADDRESS = "10.66.171.140"; //placeholder
	public static final String LEFT_HAND_ADDRESS = "10.66.171.135";
	public static final byte UNIT_ID = 0x02;
}
