...
public abstract class GLTexture implements Disposable {
	...
	public static void uploadImageData (int target, TextureData data, int miplevel) {
		...
		if (data.useMipMaps()) {
			...
			Gdx.gl.glTexParameteri(Gdx.gl.GL_TEXTURE_2D, Gdx.gl30.GL_TEXTURE_BASE_LEVEL, miplevel);
			Gdx.gl.glTexParameteri(Gdx.gl.GL_TEXTURE_2D, Gdx.gl30.GL_TEXTURE_MAX_LEVEL, miplevel);
