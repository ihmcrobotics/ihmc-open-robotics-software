...
/**
 * This class works with a deep copy of a Model that it will mutate to create scaled ModelInstances.
 ...
 *
 * Not used, but keeping the code around in case we need it again. - @dcalvert
 */
