...
public class DepthSensorShader extends BaseShader
{
	public static class Config {
		...
		/** Set to 0 to disable culling, -1 to inherit from {@link DepthSensorShader#defaultCullFace} */
		public int defaultCullFace = -1;
		/** Set to 0 to disable depth test, -1 to inherit from {@link DepthSensorShader#defaultDepthFunc} */
	...
	public DepthSensorShader(final Renderable renderable) {
		this(renderable, new Config());
	}

	public DepthSensorShader(final Renderable renderable, final Config config) {
		this(renderable, config, createPrefix(renderable, config));
	}

	public DepthSensorShader(final Renderable renderable, final Config config, final String prefix) {
		this(renderable, config, prefix, config.vertexShader != null ? config.vertexShader : getDefaultVertexShader(),
			config.fragmentShader != null ? config.fragmentShader : getDefaultFragmentShader());
	}

	public DepthSensorShader(final Renderable renderable, final Config config, final String prefix, final String vertexShader,
                            final String fragmentShader) {

		this(renderable, config, new ShaderProgram(prefix + vertexShader, prefix + fragmentShader));
	}

	public DepthSensorShader(final Renderable renderable, final Config config, final ShaderProgram shaderProgram) {
		final Attributes attributes = combineAttributes(renderable);
		this.config = config;
		this.program = shaderProgram;
//		GL41.glBindFragDataLocation(program.getHandle(), 0, "out_color");
//		GL41.glBindFragDataLocation(program.getHandle(), 0, "out_depth");
		GL41.glBindFragDataLocation(program.getHandle(), 1, "out_processedDepth");
		ShaderProgram.invalidateAllShaderPrograms(Gdx.app);
//		LogTools.info("Vertex shader: \n{}", shaderProgram.getVertexShaderSource());
//		LogTools.info("Fragment shader: \n{}", shaderProgram.getFragmentShaderSource());
	...
	public boolean equals (Object obj) {
		return (obj instanceof DepthSensorShader) && equals((DepthSensorShader) obj);
	}

	public boolean equals (DepthSensorShader obj) {
		return (obj == this);
	}
