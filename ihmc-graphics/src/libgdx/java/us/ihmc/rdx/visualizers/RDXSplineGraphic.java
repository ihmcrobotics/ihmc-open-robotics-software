...
public class RDXSplineGraphic
{
   ...
   {
      sphereStartPoint = RDXModelBuilder.createSphere((float) 0.01, color);
   ...
   {
      sphereEndPoint = RDXModelBuilder.createSphere((float) 0.01, color);
   ...
   {
      lineSegments.add(RDXModelBuilder.createLine(lastPoint, point, 0.005, color));
      lastPoint = point;
   }
