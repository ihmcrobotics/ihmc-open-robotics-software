         ...
         vrContext.getController(side).runIfConnected(controller ->
                                                      {
                                                         ...
                                                         if (controller.getSelectedPick() == null)
                                                         {
                                                            ...
                                                            controller.setTopJoystickText("Test Top");
                                                            controller.setBottomJoystickText("Test Bottom");
                                                            controller.setLeftJoystickText("Test Left");
                                                            controller.setRightJoystickText("Test Right");
