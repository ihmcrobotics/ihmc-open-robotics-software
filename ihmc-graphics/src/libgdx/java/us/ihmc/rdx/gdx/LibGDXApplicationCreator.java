...
public class LibGDXApplicationCreator
{
   ...
   public static void launchGDXApplication(RDXLwjgl3ApplicationAdapter applicationAdapter, Class<?> clazz)
   {
    ...
    */
   public static void launchGDXApplication(RDXLwjgl3ApplicationAdapter applicationAdapter, String title, double width, double height)
   {
    ...
    * @param applicationAdapter the adapter for the application
    */
   public static void launchGDXApplication(Lwjgl3ApplicationConfiguration applicationConfiguration, RDXLwjgl3ApplicationAdapter applicationAdapter)
   {
