...
{
   public static QuadTreeForGroundHeightMap createHeightMap(us.ihmc.graphics3DAdapter.HeightMap inputHeightMap, BoundingBox2d testingRange, double resolution)
   {
      double heightThreshold = 0.002;
      return createHeightMap(inputHeightMap, testingRange, resolution, heightThreshold);
   }

   public static QuadTreeForGroundHeightMap createHeightMap(us.ihmc.graphics3DAdapter.HeightMap inputHeightMap, BoundingBox2d testingRange, double resolution, double heightThreshold)
   {
