...
public class PointVelocityDataObject
{
   ...
   public void set(RigidBody rigidBody, FramePoint3D measurementPointInBodyFrame, FrameVector velocityOfMeasurementPointInWorldFrame, boolean isPointVelocityValid)
   {
