...
@ClassDocumentation(documentation = "This message is used to switch the control scheme between force and position control.\n"
...
{
   public us.ihmc.communication.packets.dataobjects.HighLevelState highLevelState;
