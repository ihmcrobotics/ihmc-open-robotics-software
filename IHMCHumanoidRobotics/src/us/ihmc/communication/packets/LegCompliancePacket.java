...
@ClassDocumentation(documentation = "This packet controls the stiffness of LegJoints. i.e., the maximum force a joint puts out"
...
{
   @FieldDocumentation(documentation = "maximum allowed force (ratio) from velocity control in the range of [0.0, 1.0]. "
   ...
   @FieldDocumentation(documentation = "LEFT or RIGHT leg")
