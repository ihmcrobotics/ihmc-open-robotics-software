...
public abstract class AbstractSE3HybridJointSpaceTaskSpaceTrajectoryMessage<
...
> extends QueueableMessage<M> implements VisualizablePacket
{
    ...
    */
   public AbstractSE3HybridJointSpaceTaskSpaceTrajectoryMessage()
   {
    ...
    */
   public AbstractSE3HybridJointSpaceTaskSpaceTrajectoryMessage(AbstractSE3HybridJointSpaceTaskSpaceTrajectoryMessage<M, TM, JM> hybridJointSpaceTaskSpaceTrajectoryMessage)
   {
   ...
   /**
    */
   public AbstractSE3HybridJointSpaceTaskSpaceTrajectoryMessage(TM taskspaceTrajectoryMessage, JM jointspaceTrajectoryMessage)
   {
