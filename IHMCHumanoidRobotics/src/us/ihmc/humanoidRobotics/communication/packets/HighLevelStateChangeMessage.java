...
public class HighLevelStateChangeMessage extends Packet<HighLevelStateChangeMessage>
{
   ...
   public HighLevelStateChangeMessage()
   {
   }
   ...
   public HighLevelStateChangeMessage(Random random)
   {
   ...
   @Override
   public boolean epsilonEquals(HighLevelStateChangeMessage other, double epsilon)
   {
