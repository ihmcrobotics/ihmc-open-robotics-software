...
@RosMessagePacket(documentation = "This message contains wraps up multiple SingleJointAnglePackets so they will be" + "executed simultaneusly.",
      rosPackage = "ihmc_msgs",
      topic = "/control/multi_joint_angles")
