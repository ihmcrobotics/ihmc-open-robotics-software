...
public class SimpleMovingAverageFilteredYoFrameVector3D extends YoFrameVector3D implements ProcessingYoVariable
{
   private final SimpleMovingAverageFilteredYoVariable x, y, z;

   private SimpleMovingAverageFilteredYoFrameVector3D(SimpleMovingAverageFilteredYoVariable x, SimpleMovingAverageFilteredYoVariable y,
   ...
   public static SimpleMovingAverageFilteredYoFrameVector3D createSimpleMovingAverageFilteredYoFrameVector(String namePrefix, String nameSuffix, int windowSize,
                                                                                                           ReferenceFrame referenceFrame, YoRegistry registry)
   {
      ...
      return new SimpleMovingAverageFilteredYoFrameVector3D(x, y, z, referenceFrame);
   }
                                                                                                           ...
                                                                                                           YoFrameVector3D unfilteredVector, YoRegistry registry)
   {
      ...
      return new SimpleMovingAverageFilteredYoFrameVector3D(x, y, z, unfilteredVector.getReferenceFrame());
   }
