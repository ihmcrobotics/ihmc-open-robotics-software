...
{
   private final IntegerProvider position;
   ...
   public GlitchFilteredYoInteger(String name, int windowSize, IntegerProvider position, YoRegistry registry)
   {
      this(name, VariableTools.createWindowSizeYoInteger(name, "", windowSize, registry), position, registry);
   }
   ...
   public GlitchFilteredYoInteger(String name, IntegerProvider windowSize, IntegerProvider position, YoRegistry registry)
   {
