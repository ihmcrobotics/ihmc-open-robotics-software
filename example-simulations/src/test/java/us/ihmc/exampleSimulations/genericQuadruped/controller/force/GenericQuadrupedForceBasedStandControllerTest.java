...
public class GenericQuadrupedForceBasedStandControllerTest extends QuadrupedForceBasedStandControllerTest
{
   ...
   @ContinuousIntegrationTest(estimatedDuration = 78.0)
   @Test(timeout = 390000)
   ...
   @Override
   @ContinuousIntegrationTest(estimatedDuration = 119.5)
   @Test(timeout = 600000)
   ...
   @Override
   @ContinuousIntegrationTest(estimatedDuration = 66.6)
   @Test(timeout = 330000)
   ...
   @Override
   @ContinuousIntegrationTest(estimatedDuration = 66.5)
   @Test(timeout = 330000)
