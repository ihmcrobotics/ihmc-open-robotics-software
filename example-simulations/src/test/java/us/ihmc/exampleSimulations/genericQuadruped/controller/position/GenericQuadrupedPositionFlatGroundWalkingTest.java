...
import us.ihmc.quadrupedRobotics.controller.position.QuadrupedPositionFlatGroundWalkingTest;

@ContinuousIntegrationPlan(categories = IntegrationCategory.FAST)
public class GenericQuadrupedPositionFlatGroundWalkingTest extends QuadrupedPositionFlatGroundWalkingTest
{
   @Override
   ...
   {
      super.testFlatGroundWalking(90.0, 0.4);
   }
   ...
   {
      super.testFlatGroundWalking(90.0, -0.5);
   }
   ...
   {
      super.testWalkingInASemiCircle(90.0, 0.3, 0.1);
   }
   ...
   {
      super.testFlatGroundWalking(180.0, 0.4);
   }
   ...
   {
      super.testWalkingInASemiCircle(180.0, 0.3, 0.1);
   }
