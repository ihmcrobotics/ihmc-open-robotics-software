...
import us.ihmc.quadrupedRobotics.controller.position.QuadrupedPositionBasedStandControllerTest;

import java.io.IOException;

@ContinuousIntegrationPlan(categories = IntegrationCategory.FAST)
public class GenericQuadrupedPositionBasedStandControllerTest extends QuadrupedPositionBasedStandControllerTest
{
   @Override
