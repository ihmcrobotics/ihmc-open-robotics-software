...
public class LIPMWalkerJae
{
   ...
   private final LIPMWalkerRobotDefinition robotDefintion;
   /**
    * We need to be able to write to the controller output
    */
   private final ControllerOutput controllerOutput;

   public LIPMWalkerJae(ControllerInput controllerInput, ControllerOutput controllerOutput, LIPMWalkerRobotDefinition robotDefinition)
   {
