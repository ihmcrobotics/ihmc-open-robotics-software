...
public class ControllerJae implements Controller
{
   ...
   private final LIPMWalkerJae robotJae;
   ...
   private final YoFramePoint3D desiredFootstepPositionForVisual = new YoFramePoint3D("desiredFootstepPosition", WORLD_FRAME, registry);
   ...
   public ControllerJae(ControllerInput controllerInput,
                        ControllerOutput controllerOutput,
                        double controlDT,
                        double gravityZ,
                        LIPMWalkerRobotDefinition robotDefinition)
   {
      this.controllerInput = controllerInput;
      this.robotJae = new LIPMWalkerJae(controllerInput, controllerOutput, robotDefinition);
   ...
   public YoGraphicDefinition createVisualization()
   {
      ...
      graphicsGroup.addChild(YoGraphicDefinitionFactory.newYoGraphicPoint3D("measuredCenterOfMass", measuredCenterOfMass, 0.15, ColorDefinitions.Black()));
      ...
      graphicsGroup.addChild(YoGraphicDefinitionFactory.newYoGraphicPoint3D("desiredFootStepLocation",
                                                                            desiredFootstepPositionForVisual,
                                                                            0.05,
   ...
   public void doControl()
   {
      ...
      pelvisOrientationCommand.setWeightForSolver(10.0);
...
//         multiWaypointSwingGenerator = new MultipleWaypointsTrajectoryGenerator(swingSide.getCamelCaseName() + "MultiWaypointSwing", 5, registry);
      ...
      public void onEntry()
      {
         ...
         desiredFootstepPositionForVisual.set(desiredFootstepPosition);
         // normal
...
//         FramePoint3D centerOfMassPosition = new FramePoint3D(robotJae.getMidFeetFrame());
