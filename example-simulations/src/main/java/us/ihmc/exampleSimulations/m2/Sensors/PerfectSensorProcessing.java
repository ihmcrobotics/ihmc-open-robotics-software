...
public class PerfectSensorProcessing
{
   ...
   {
      t = (YoDouble)robot.findVariable("t");

      q_yaw = (YoDouble)robot.findVariable("q_yaw");
      q_pitch = (YoDouble)robot.findVariable("q_pitch");
      q_roll = (YoDouble)robot.findVariable("q_roll");

      q_x = (YoDouble)robot.findVariable("q_x");
      q_y = (YoDouble)robot.findVariable("q_y");
      q_z = (YoDouble)robot.findVariable("q_z");
      qd_x = (YoDouble)robot.findVariable("qd_x");
      qd_y = (YoDouble)robot.findVariable("qd_y");
      qd_z = (YoDouble)robot.findVariable("qd_z");
      qdd_x = (YoDouble)robot.findVariable("qdd_x");
      qdd_y = (YoDouble)robot.findVariable("qdd_y");
      qdd_z = (YoDouble)robot.findVariable("qdd_z");
      q_qs = (YoDouble)robot.findVariable("q_qs");
      q_qx = (YoDouble)robot.findVariable("q_qx");
      q_qy = (YoDouble)robot.findVariable("q_qy");
      q_qz = (YoDouble)robot.findVariable("q_qz");
      qd_wx = (YoDouble)robot.findVariable("qd_wx");
      qd_wy = (YoDouble)robot.findVariable("qd_wy");
      qd_wz = (YoDouble)robot.findVariable("qd_wz");
      qdd_wx = (YoDouble)robot.findVariable("qdd_wx");
      qdd_wy = (YoDouble)robot.findVariable("qdd_wy");
      qdd_wz = (YoDouble)robot.findVariable("qdd_wz");
      q_right_hip_yaw = (YoDouble)robot.findVariable("q_right_hip_yaw");
      qd_right_hip_yaw = (YoDouble)robot.findVariable("qd_right_hip_yaw");
      qdd_right_hip_yaw = (YoDouble)robot.findVariable("qdd_right_hip_yaw");
      tau_right_hip_yaw = (YoDouble)robot.findVariable("tau_right_hip_yaw");
      q_right_hip_roll = (YoDouble)robot.findVariable("q_right_hip_roll");
      qd_right_hip_roll = (YoDouble)robot.findVariable("qd_right_hip_roll");
      qdd_right_hip_roll = (YoDouble)robot.findVariable("qdd_right_hip_roll");
      tau_right_hip_roll = (YoDouble)robot.findVariable("tau_right_hip_roll");
      q_right_hip_pitch = (YoDouble)robot.findVariable("q_right_hip_pitch");
      qd_right_hip_pitch = (YoDouble)robot.findVariable("qd_right_hip_pitch");
      qdd_right_hip_pitch = (YoDouble)robot.findVariable("qdd_right_hip_pitch");
      tau_right_hip_pitch = (YoDouble)robot.findVariable("tau_right_hip_pitch");
      q_right_knee = (YoDouble)robot.findVariable("q_right_knee");
      qd_right_knee = (YoDouble)robot.findVariable("qd_right_knee");
      qdd_right_knee = (YoDouble)robot.findVariable("qdd_right_knee");
      tau_right_knee = (YoDouble)robot.findVariable("tau_right_knee");
      tau_lim_right_knee = (YoDouble)robot.findVariable("tau_lim_right_knee");
      q_right_ankle_roll = (YoDouble)robot.findVariable("q_right_ankle_roll");
      qd_right_ankle_roll = (YoDouble)robot.findVariable("qd_right_ankle_roll");
      qdd_right_ankle_roll = (YoDouble)robot.findVariable("qdd_right_ankle_roll");
      tau_right_ankle_roll = (YoDouble)robot.findVariable("tau_right_ankle_roll");
      q_right_ankle_pitch = (YoDouble)robot.findVariable("q_right_ankle_pitch");
      qd_right_ankle_pitch = (YoDouble)robot.findVariable("qd_right_ankle_pitch");
      qdd_right_ankle_pitch = (YoDouble)robot.findVariable("qdd_right_ankle_pitch");
      tau_right_ankle_pitch = (YoDouble)robot.findVariable("tau_right_ankle_pitch");
      gc_right_toe_in_x = (YoDouble)robot.findVariable("gc_right_toe_in_x");
      gc_right_toe_in_y = (YoDouble)robot.findVariable("gc_right_toe_in_y");
      gc_right_toe_in_z = (YoDouble)robot.findVariable("gc_right_toe_in_z");
      gc_right_toe_in_dx = (YoDouble)robot.findVariable("gc_right_toe_in_dx");
      gc_right_toe_in_dy = (YoDouble)robot.findVariable("gc_right_toe_in_dy");
      gc_right_toe_in_dz = (YoDouble)robot.findVariable("gc_right_toe_in_dz");
      gc_right_toe_in_fx = (YoDouble)robot.findVariable("gc_right_toe_in_fx");
      gc_right_toe_in_fy = (YoDouble)robot.findVariable("gc_right_toe_in_fy");
      gc_right_toe_in_fz = (YoDouble)robot.findVariable("gc_right_toe_in_fz");
      gc_right_toe_in_px = (YoDouble)robot.findVariable("gc_right_toe_in_px");
      gc_right_toe_in_py = (YoDouble)robot.findVariable("gc_right_toe_in_py");
      gc_right_toe_in_pz = (YoDouble)robot.findVariable("gc_right_toe_in_pz");
      gc_right_toe_in_tdx = (YoDouble)robot.findVariable("gc_right_toe_in_tdx");
      gc_right_toe_in_tdy = (YoDouble)robot.findVariable("gc_right_toe_in_tdy");
      gc_right_toe_in_tdz = (YoDouble)robot.findVariable("gc_right_toe_in_tdz");
      gc_right_toe_in_fs = (YoDouble)robot.findVariable("gc_right_toe_in_fs");
      gc_right_toe_in_slip = (YoBoolean)robot.findVariable("gc_right_toe_in_slip");
      gc_right_toe_in_coll = (YoInteger)robot.findVariable("gc_right_toe_in_coll");
      gc_right_toe_out_x = (YoDouble)robot.findVariable("gc_right_toe_out_x");
      gc_right_toe_out_y = (YoDouble)robot.findVariable("gc_right_toe_out_y");
      gc_right_toe_out_z = (YoDouble)robot.findVariable("gc_right_toe_out_z");
      gc_right_toe_out_dx = (YoDouble)robot.findVariable("gc_right_toe_out_dx");
      gc_right_toe_out_dy = (YoDouble)robot.findVariable("gc_right_toe_out_dy");
      gc_right_toe_out_dz = (YoDouble)robot.findVariable("gc_right_toe_out_dz");
      gc_right_toe_out_fx = (YoDouble)robot.findVariable("gc_right_toe_out_fx");
      gc_right_toe_out_fy = (YoDouble)robot.findVariable("gc_right_toe_out_fy");
      gc_right_toe_out_fz = (YoDouble)robot.findVariable("gc_right_toe_out_fz");
      gc_right_toe_out_px = (YoDouble)robot.findVariable("gc_right_toe_out_px");
      gc_right_toe_out_py = (YoDouble)robot.findVariable("gc_right_toe_out_py");
      gc_right_toe_out_pz = (YoDouble)robot.findVariable("gc_right_toe_out_pz");
      gc_right_toe_out_tdx = (YoDouble)robot.findVariable("gc_right_toe_out_tdx");
      gc_right_toe_out_tdy = (YoDouble)robot.findVariable("gc_right_toe_out_tdy");
      gc_right_toe_out_tdz = (YoDouble)robot.findVariable("gc_right_toe_out_tdz");
      gc_right_toe_out_fs = (YoDouble)robot.findVariable("gc_right_toe_out_fs");
      gc_right_toe_out_slip = (YoBoolean)robot.findVariable("gc_right_toe_out_slip");
      gc_right_toe_out_coll = (YoInteger)robot.findVariable("gc_right_toe_out_coll");
      gc_right_heel_in_x = (YoDouble)robot.findVariable("gc_right_heel_in_x");
      gc_right_heel_in_y = (YoDouble)robot.findVariable("gc_right_heel_in_y");
      gc_right_heel_in_z = (YoDouble)robot.findVariable("gc_right_heel_in_z");
      gc_right_heel_in_dx = (YoDouble)robot.findVariable("gc_right_heel_in_dx");
      gc_right_heel_in_dy = (YoDouble)robot.findVariable("gc_right_heel_in_dy");
      gc_right_heel_in_dz = (YoDouble)robot.findVariable("gc_right_heel_in_dz");
      gc_right_heel_in_fx = (YoDouble)robot.findVariable("gc_right_heel_in_fx");
      gc_right_heel_in_fy = (YoDouble)robot.findVariable("gc_right_heel_in_fy");
      gc_right_heel_in_fz = (YoDouble)robot.findVariable("gc_right_heel_in_fz");
      gc_right_heel_in_px = (YoDouble)robot.findVariable("gc_right_heel_in_px");
      gc_right_heel_in_py = (YoDouble)robot.findVariable("gc_right_heel_in_py");
      gc_right_heel_in_pz = (YoDouble)robot.findVariable("gc_right_heel_in_pz");
      gc_right_heel_in_tdx = (YoDouble)robot.findVariable("gc_right_heel_in_tdx");
      gc_right_heel_in_tdy = (YoDouble)robot.findVariable("gc_right_heel_in_tdy");
      gc_right_heel_in_tdz = (YoDouble)robot.findVariable("gc_right_heel_in_tdz");
      gc_right_heel_in_fs = (YoDouble)robot.findVariable("gc_right_heel_in_fs");
      gc_right_heel_in_slip = (YoBoolean)robot.findVariable("gc_right_heel_in_slip");
      gc_right_heel_in_coll = (YoInteger)robot.findVariable("gc_right_heel_in_coll");
      gc_right_heel_out_x = (YoDouble)robot.findVariable("gc_right_heel_out_x");
      gc_right_heel_out_y = (YoDouble)robot.findVariable("gc_right_heel_out_y");
      gc_right_heel_out_z = (YoDouble)robot.findVariable("gc_right_heel_out_z");
      gc_right_heel_out_dx = (YoDouble)robot.findVariable("gc_right_heel_out_dx");
      gc_right_heel_out_dy = (YoDouble)robot.findVariable("gc_right_heel_out_dy");
      gc_right_heel_out_dz = (YoDouble)robot.findVariable("gc_right_heel_out_dz");
      gc_right_heel_out_fx = (YoDouble)robot.findVariable("gc_right_heel_out_fx");
      gc_right_heel_out_fy = (YoDouble)robot.findVariable("gc_right_heel_out_fy");
      gc_right_heel_out_fz = (YoDouble)robot.findVariable("gc_right_heel_out_fz");
      gc_right_heel_out_px = (YoDouble)robot.findVariable("gc_right_heel_out_px");
      gc_right_heel_out_py = (YoDouble)robot.findVariable("gc_right_heel_out_py");
      gc_right_heel_out_pz = (YoDouble)robot.findVariable("gc_right_heel_out_pz");
      gc_right_heel_out_tdx = (YoDouble)robot.findVariable("gc_right_heel_out_tdx");
      gc_right_heel_out_tdy = (YoDouble)robot.findVariable("gc_right_heel_out_tdy");
      gc_right_heel_out_tdz = (YoDouble)robot.findVariable("gc_right_heel_out_tdz");
      gc_right_heel_out_fs = (YoDouble)robot.findVariable("gc_right_heel_out_fs");
      gc_right_heel_out_slip = (YoBoolean)robot.findVariable("gc_right_heel_out_slip");
      gc_right_heel_out_coll = (YoInteger)robot.findVariable("gc_right_heel_out_coll");
      q_left_hip_yaw = (YoDouble)robot.findVariable("q_left_hip_yaw");
      qd_left_hip_yaw = (YoDouble)robot.findVariable("qd_left_hip_yaw");
      qdd_left_hip_yaw = (YoDouble)robot.findVariable("qdd_left_hip_yaw");
      tau_left_hip_yaw = (YoDouble)robot.findVariable("tau_left_hip_yaw");
      q_left_hip_roll = (YoDouble)robot.findVariable("q_left_hip_roll");
      qd_left_hip_roll = (YoDouble)robot.findVariable("qd_left_hip_roll");
      qdd_left_hip_roll = (YoDouble)robot.findVariable("qdd_left_hip_roll");
      tau_left_hip_roll = (YoDouble)robot.findVariable("tau_left_hip_roll");
      q_left_hip_pitch = (YoDouble)robot.findVariable("q_left_hip_pitch");
      qd_left_hip_pitch = (YoDouble)robot.findVariable("qd_left_hip_pitch");
      qdd_left_hip_pitch = (YoDouble)robot.findVariable("qdd_left_hip_pitch");
      tau_left_hip_pitch = (YoDouble)robot.findVariable("tau_left_hip_pitch");
      q_left_knee = (YoDouble)robot.findVariable("q_left_knee");
      qd_left_knee = (YoDouble)robot.findVariable("qd_left_knee");
      qdd_left_knee = (YoDouble)robot.findVariable("qdd_left_knee");
      tau_left_knee = (YoDouble)robot.findVariable("tau_left_knee");
      tau_lim_left_knee = (YoDouble)robot.findVariable("tau_lim_left_knee");
      q_left_ankle_roll = (YoDouble)robot.findVariable("q_left_ankle_roll");
      qd_left_ankle_roll = (YoDouble)robot.findVariable("qd_left_ankle_roll");
      qdd_left_ankle_roll = (YoDouble)robot.findVariable("qdd_left_ankle_roll");
      tau_left_ankle_roll = (YoDouble)robot.findVariable("tau_left_ankle_roll");
      q_left_ankle_pitch = (YoDouble)robot.findVariable("q_left_ankle_pitch");
      qd_left_ankle_pitch = (YoDouble)robot.findVariable("qd_left_ankle_pitch");
      qdd_left_ankle_pitch = (YoDouble)robot.findVariable("qdd_left_ankle_pitch");
      tau_left_ankle_pitch = (YoDouble)robot.findVariable("tau_left_ankle_pitch");
      gc_left_toe_in_x = (YoDouble)robot.findVariable("gc_left_toe_in_x");
      gc_left_toe_in_y = (YoDouble)robot.findVariable("gc_left_toe_in_y");
      gc_left_toe_in_z = (YoDouble)robot.findVariable("gc_left_toe_in_z");
      gc_left_toe_in_dx = (YoDouble)robot.findVariable("gc_left_toe_in_dx");
      gc_left_toe_in_dy = (YoDouble)robot.findVariable("gc_left_toe_in_dy");
      gc_left_toe_in_dz = (YoDouble)robot.findVariable("gc_left_toe_in_dz");
      gc_left_toe_in_fx = (YoDouble)robot.findVariable("gc_left_toe_in_fx");
      gc_left_toe_in_fy = (YoDouble)robot.findVariable("gc_left_toe_in_fy");
      gc_left_toe_in_fz = (YoDouble)robot.findVariable("gc_left_toe_in_fz");
      gc_left_toe_in_px = (YoDouble)robot.findVariable("gc_left_toe_in_px");
      gc_left_toe_in_py = (YoDouble)robot.findVariable("gc_left_toe_in_py");
      gc_left_toe_in_pz = (YoDouble)robot.findVariable("gc_left_toe_in_pz");
      gc_left_toe_in_tdx = (YoDouble)robot.findVariable("gc_left_toe_in_tdx");
      gc_left_toe_in_tdy = (YoDouble)robot.findVariable("gc_left_toe_in_tdy");
      gc_left_toe_in_tdz = (YoDouble)robot.findVariable("gc_left_toe_in_tdz");
      gc_left_toe_in_fs = (YoDouble)robot.findVariable("gc_left_toe_in_fs");
      gc_left_toe_in_slip = (YoBoolean)robot.findVariable("gc_left_toe_in_slip");
      gc_left_toe_in_coll = (YoInteger)robot.findVariable("gc_left_toe_in_coll");
      gc_left_toe_out_x = (YoDouble)robot.findVariable("gc_left_toe_out_x");
      gc_left_toe_out_y = (YoDouble)robot.findVariable("gc_left_toe_out_y");
      gc_left_toe_out_z = (YoDouble)robot.findVariable("gc_left_toe_out_z");
      gc_left_toe_out_dx = (YoDouble)robot.findVariable("gc_left_toe_out_dx");
      gc_left_toe_out_dy = (YoDouble)robot.findVariable("gc_left_toe_out_dy");
      gc_left_toe_out_dz = (YoDouble)robot.findVariable("gc_left_toe_out_dz");
      gc_left_toe_out_fx = (YoDouble)robot.findVariable("gc_left_toe_out_fx");
      gc_left_toe_out_fy = (YoDouble)robot.findVariable("gc_left_toe_out_fy");
      gc_left_toe_out_fz = (YoDouble)robot.findVariable("gc_left_toe_out_fz");
      gc_left_toe_out_px = (YoDouble)robot.findVariable("gc_left_toe_out_px");
      gc_left_toe_out_py = (YoDouble)robot.findVariable("gc_left_toe_out_py");
      gc_left_toe_out_pz = (YoDouble)robot.findVariable("gc_left_toe_out_pz");
      gc_left_toe_out_tdx = (YoDouble)robot.findVariable("gc_left_toe_out_tdx");
      gc_left_toe_out_tdy = (YoDouble)robot.findVariable("gc_left_toe_out_tdy");
      gc_left_toe_out_tdz = (YoDouble)robot.findVariable("gc_left_toe_out_tdz");
      gc_left_toe_out_fs = (YoDouble)robot.findVariable("gc_left_toe_out_fs");
      gc_left_toe_out_slip = (YoBoolean)robot.findVariable("gc_left_toe_out_slip");
      gc_left_toe_out_coll = (YoInteger)robot.findVariable("gc_left_toe_out_coll");
      gc_left_heel_in_x = (YoDouble)robot.findVariable("gc_left_heel_in_x");
      gc_left_heel_in_y = (YoDouble)robot.findVariable("gc_left_heel_in_y");
      gc_left_heel_in_z = (YoDouble)robot.findVariable("gc_left_heel_in_z");
      gc_left_heel_in_dx = (YoDouble)robot.findVariable("gc_left_heel_in_dx");
      gc_left_heel_in_dy = (YoDouble)robot.findVariable("gc_left_heel_in_dy");
      gc_left_heel_in_dz = (YoDouble)robot.findVariable("gc_left_heel_in_dz");
      gc_left_heel_in_fx = (YoDouble)robot.findVariable("gc_left_heel_in_fx");
      gc_left_heel_in_fy = (YoDouble)robot.findVariable("gc_left_heel_in_fy");
      gc_left_heel_in_fz = (YoDouble)robot.findVariable("gc_left_heel_in_fz");
      gc_left_heel_in_px = (YoDouble)robot.findVariable("gc_left_heel_in_px");
      gc_left_heel_in_py = (YoDouble)robot.findVariable("gc_left_heel_in_py");
      gc_left_heel_in_pz = (YoDouble)robot.findVariable("gc_left_heel_in_pz");
      gc_left_heel_in_tdx = (YoDouble)robot.findVariable("gc_left_heel_in_tdx");
      gc_left_heel_in_tdy = (YoDouble)robot.findVariable("gc_left_heel_in_tdy");
      gc_left_heel_in_tdz = (YoDouble)robot.findVariable("gc_left_heel_in_tdz");
      gc_left_heel_in_fs = (YoDouble)robot.findVariable("gc_left_heel_in_fs");
      gc_left_heel_in_slip = (YoBoolean)robot.findVariable("gc_left_heel_in_slip");
      gc_left_heel_in_coll = (YoInteger)robot.findVariable("gc_left_heel_in_coll");
      gc_left_heel_out_x = (YoDouble)robot.findVariable("gc_left_heel_out_x");
      gc_left_heel_out_y = (YoDouble)robot.findVariable("gc_left_heel_out_y");
      gc_left_heel_out_z = (YoDouble)robot.findVariable("gc_left_heel_out_z");
      gc_left_heel_out_dx = (YoDouble)robot.findVariable("gc_left_heel_out_dx");
      gc_left_heel_out_dy = (YoDouble)robot.findVariable("gc_left_heel_out_dy");
      gc_left_heel_out_dz = (YoDouble)robot.findVariable("gc_left_heel_out_dz");
      gc_left_heel_out_fx = (YoDouble)robot.findVariable("gc_left_heel_out_fx");
      gc_left_heel_out_fy = (YoDouble)robot.findVariable("gc_left_heel_out_fy");
      gc_left_heel_out_fz = (YoDouble)robot.findVariable("gc_left_heel_out_fz");
      gc_left_heel_out_px = (YoDouble)robot.findVariable("gc_left_heel_out_px");
      gc_left_heel_out_py = (YoDouble)robot.findVariable("gc_left_heel_out_py");
      gc_left_heel_out_pz = (YoDouble)robot.findVariable("gc_left_heel_out_pz");
      gc_left_heel_out_tdx = (YoDouble)robot.findVariable("gc_left_heel_out_tdx");
      gc_left_heel_out_tdy = (YoDouble)robot.findVariable("gc_left_heel_out_tdy");
      gc_left_heel_out_tdz = (YoDouble)robot.findVariable("gc_left_heel_out_tdz");
      gc_left_heel_out_fs = (YoDouble)robot.findVariable("gc_left_heel_out_fs");
      gc_left_heel_out_slip = (YoBoolean)robot.findVariable("gc_left_heel_out_slip");
      gc_left_heel_out_coll = (YoInteger)robot.findVariable("gc_left_heel_out_coll");
