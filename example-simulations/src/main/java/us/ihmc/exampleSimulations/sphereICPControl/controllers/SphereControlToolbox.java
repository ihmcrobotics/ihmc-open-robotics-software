...
public class SphereControlToolbox
{
         ...
         YoRegistry parentRegistry, YoGraphicsListRegistry yoGraphicsListRegistry)
   {
      ...
      icpVelocity = FilteredFiniteDifferenceYoFrameVector3D.createFilteredVelocityYoFrameVector("capturePointVelocity", "", capturePointVelocityAlpha, controlDT, registry, icp);
