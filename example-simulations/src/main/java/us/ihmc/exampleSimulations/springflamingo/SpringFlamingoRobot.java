...
public class SpringFlamingoRobot
{
   ...
   public SpringFlamingoRobot(String name)
   {
      ...
      qd_pitch = (YoDouble) robot.findVariable("qd_pitch");
      qdd_x = (YoDouble) robot.findVariable("qdd_x");
      qdd_z = (YoDouble) robot.findVariable("qdd_z");
      qdd_pitch = (YoDouble) robot.findVariable("qdd_pitch");
      q_rh = (YoDouble) robot.findVariable("q_rh");
      qd_rh = (YoDouble) robot.findVariable("qd_rh");
      qdd_rh = (YoDouble) robot.findVariable("qdd_rh");
      tau_rh = (YoDouble) robot.findVariable("tau_rh");
      q_rk = (YoDouble) robot.findVariable("q_rk");
      qd_rk = (YoDouble) robot.findVariable("qd_rk");
      qdd_rk = (YoDouble) robot.findVariable("qdd_rk");
      tau_rk = (YoDouble) robot.findVariable("tau_rk");
      tau_joint_limit_rk = (YoDouble) robot.findVariable("tau_joint_limit_rk");
      q_ra = (YoDouble) robot.findVariable("q_ra");
      qd_ra = (YoDouble) robot.findVariable("qd_ra");
      qdd_ra = (YoDouble) robot.findVariable("qdd_ra");
      tau_ra = (YoDouble) robot.findVariable("tau_ra");
      q_lh = (YoDouble) robot.findVariable("q_lh");
      qd_lh = (YoDouble) robot.findVariable("qd_lh");
      qdd_lh = (YoDouble) robot.findVariable("qdd_lh");
      tau_lh = (YoDouble) robot.findVariable("tau_lh");
      q_lk = (YoDouble) robot.findVariable("q_lk");
      qd_lk = (YoDouble) robot.findVariable("qd_lk");
      qdd_lk = (YoDouble) robot.findVariable("qdd_lk");
      tau_lk = (YoDouble) robot.findVariable("tau_lk");
      tau_joint_limit_lk = (YoDouble) robot.findVariable("tau_joint_limit_lk");
      q_la = (YoDouble) robot.findVariable("q_la");
      qd_la = (YoDouble) robot.findVariable("qd_la");
      qdd_la = (YoDouble) robot.findVariable("qdd_la");
      tau_la = (YoDouble) robot.findVariable("tau_la");

      gc_rheel_x = (YoDouble) robot.findVariable("gc_rheel_x");
      gc_rheel_y = (YoDouble) robot.findVariable("gc_rheel_y");
      gc_rheel_z = (YoDouble) robot.findVariable("gc_rheel_z");
      gc_rheel_dx = (YoDouble) robot.findVariable("gc_rheel_dx");
      gc_rheel_dy = (YoDouble) robot.findVariable("gc_rheel_dy");
      gc_rheel_dz = (YoDouble) robot.findVariable("gc_rheel_dz");
      gc_rheel_fx = (YoDouble) robot.findVariable("gc_rheel_fx");
      gc_rheel_fy = (YoDouble) robot.findVariable("gc_rheel_fy");
      gc_rheel_fz = (YoDouble) robot.findVariable("gc_rheel_fz");
      gc_rheel_px = (YoDouble) robot.findVariable("gc_rheel_px");
      gc_rheel_py = (YoDouble) robot.findVariable("gc_rheel_py");
      gc_rheel_pz = (YoDouble) robot.findVariable("gc_rheel_pz");
      gc_rheel_tdx = (YoDouble) robot.findVariable("gc_rheel_tdx");
      gc_rheel_tdy = (YoDouble) robot.findVariable("gc_rheel_tdy");
      gc_rheel_tdz = (YoDouble) robot.findVariable("gc_rheel_tdz");
      gc_rheel_fs = (YoDouble) robot.findVariable("gc_rheel_fs");
      gc_rheel_slip = (YoBoolean) robot.findVariable("gc_rheel_slip");
      gc_rtoe_x = (YoDouble) robot.findVariable("gc_rtoe_x");
      gc_rtoe_y = (YoDouble) robot.findVariable("gc_rtoe_y");
      gc_rtoe_z = (YoDouble) robot.findVariable("gc_rtoe_z");
      gc_rtoe_dx = (YoDouble) robot.findVariable("gc_rtoe_dx");
      gc_rtoe_dy = (YoDouble) robot.findVariable("gc_rtoe_dy");
      gc_rtoe_dz = (YoDouble) robot.findVariable("gc_rtoe_dz");
      gc_rtoe_fx = (YoDouble) robot.findVariable("gc_rtoe_fx");
      gc_rtoe_fy = (YoDouble) robot.findVariable("gc_rtoe_fy");
      gc_rtoe_fz = (YoDouble) robot.findVariable("gc_rtoe_fz");
      gc_rtoe_px = (YoDouble) robot.findVariable("gc_rtoe_px");
      gc_rtoe_py = (YoDouble) robot.findVariable("gc_rtoe_py");
      gc_rtoe_pz = (YoDouble) robot.findVariable("gc_rtoe_pz");
      gc_rtoe_tdx = (YoDouble) robot.findVariable("gc_rtoe_tdx");
      gc_rtoe_tdy = (YoDouble) robot.findVariable("gc_rtoe_tdy");
      gc_rtoe_tdz = (YoDouble) robot.findVariable("gc_rtoe_tdz");
      gc_rtoe_fs = (YoDouble) robot.findVariable("gc_rtoe_fs");
      gc_rtoe_slip = (YoBoolean) robot.findVariable("gc_rtoe_slip");
      gc_lheel_x = (YoDouble) robot.findVariable("gc_lheel_x");
      gc_lheel_y = (YoDouble) robot.findVariable("gc_lheel_y");
      gc_lheel_z = (YoDouble) robot.findVariable("gc_lheel_z");
      gc_lheel_dx = (YoDouble) robot.findVariable("gc_lheel_dx");
      gc_lheel_dy = (YoDouble) robot.findVariable("gc_lheel_dy");
      gc_lheel_dz = (YoDouble) robot.findVariable("gc_lheel_dz");
      gc_lheel_fx = (YoDouble) robot.findVariable("gc_lheel_fx");
      gc_lheel_fy = (YoDouble) robot.findVariable("gc_lheel_fy");
      gc_lheel_fz = (YoDouble) robot.findVariable("gc_lheel_fz");
      gc_lheel_px = (YoDouble) robot.findVariable("gc_lheel_px");
      gc_lheel_py = (YoDouble) robot.findVariable("gc_lheel_py");
      gc_lheel_pz = (YoDouble) robot.findVariable("gc_lheel_pz");
      gc_lheel_tdx = (YoDouble) robot.findVariable("gc_lheel_tdx");
      gc_lheel_tdy = (YoDouble) robot.findVariable("gc_lheel_tdy");
      gc_lheel_tdz = (YoDouble) robot.findVariable("gc_lheel_tdz");
      gc_lheel_fs = (YoDouble) robot.findVariable("gc_lheel_fs");
      gc_lheel_slip = (YoBoolean) robot.findVariable("gc_lheel_slip");
      gc_ltoe_x = (YoDouble) robot.findVariable("gc_ltoe_x");
      gc_ltoe_y = (YoDouble) robot.findVariable("gc_ltoe_y");
      gc_ltoe_z = (YoDouble) robot.findVariable("gc_ltoe_z");
      gc_ltoe_dx = (YoDouble) robot.findVariable("gc_ltoe_dx");
      gc_ltoe_dy = (YoDouble) robot.findVariable("gc_ltoe_dy");
      gc_ltoe_dz = (YoDouble) robot.findVariable("gc_ltoe_dz");
      gc_ltoe_fx = (YoDouble) robot.findVariable("gc_ltoe_fx");
      gc_ltoe_fy = (YoDouble) robot.findVariable("gc_ltoe_fy");
      gc_ltoe_fz = (YoDouble) robot.findVariable("gc_ltoe_fz");
      gc_ltoe_px = (YoDouble) robot.findVariable("gc_ltoe_px");
      gc_ltoe_py = (YoDouble) robot.findVariable("gc_ltoe_py");
      gc_ltoe_pz = (YoDouble) robot.findVariable("gc_ltoe_pz");
      gc_ltoe_tdx = (YoDouble) robot.findVariable("gc_ltoe_tdx");
      gc_ltoe_tdy = (YoDouble) robot.findVariable("gc_ltoe_tdy");
      gc_ltoe_tdz = (YoDouble) robot.findVariable("gc_ltoe_tdz");
      gc_ltoe_fs = (YoDouble) robot.findVariable("gc_ltoe_fs");
      gc_ltoe_slip = (YoBoolean) robot.findVariable("gc_ltoe_slip");
