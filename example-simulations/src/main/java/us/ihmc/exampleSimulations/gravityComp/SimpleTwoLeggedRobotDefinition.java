...
public class SimpleTwoLeggedRobotDefinition extends RobotDefinition
{
   ...
   public SimpleTwoLeggedRobotDefinition()
   {
      super("leggy");
      ...
      for (RobotSide robotSide : RobotSide.values)
      {
         ...
         RevoluteJointDefinition hipRollJoint = new RevoluteJointDefinition(robotSide.getShortLowerCaseName() + "_" + hipRollJointName,
         ...
         RevoluteJointDefinition anklePitchJoint = new RevoluteJointDefinition(robotSide.getShortLowerCaseName() + "_" + anklePitchJointName,
                                                                               ...
                                                                               Axis3D.Y);
         RevoluteJointDefinition ankleRollJoint = new RevoluteJointDefinition(robotSide.getShortLowerCaseName() + "_" + ankleRollJointName,
                                                                              new Vector3D(0, 0, 0),
                                                                              Axis3D.X);

         RigidBodyDefinition hipRollBody = new RigidBodyDefinition(robotSide.getShortLowerCaseName() + "_" + hipRollBodyName);
         ...
         RigidBodyDefinition anklePitchBody = new RigidBodyDefinition(robotSide.getShortLowerCaseName() + "_" + anklePitchBodyName);
