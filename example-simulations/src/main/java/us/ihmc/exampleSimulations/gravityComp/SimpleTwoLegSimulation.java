...
public class SimpleTwoLegSimulation
{
   public static void main(String[] args)
   {
      ...
      SimpleTwoLeggedRobotDefinition robotDefinition = new SimpleTwoLeggedRobotDefinition();
      RobotFromDescription scsRobot = new RobotFromDescription(robotDefinition);
      initializeRobot(scsRobot);
      scsRobot.setController(new SimpleTwoLegController(controlDT, new SimpleTwoLeggedRobot(robotDefinition, scsRobot), yoGraphicsListRegistry));
