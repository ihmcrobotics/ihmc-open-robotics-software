...
public class MovingBaseRobotArm
{
   ...
   public MovingBaseRobotArm(Robot robot, double dt, YoRegistry registry)
   {
      this.robot = robot;
      ...
      elevator = MultiBodySystemTools.findRigidBody(robot.getRootBody(), MovingBaseRobotArmDefinition.elevatorName);
      base = MultiBodySystemTools.findRigidBody(robot.getRootBody(), MovingBaseRobotArmDefinition.baseName);
      hand = MultiBodySystemTools.findRigidBody(robot.getRootBody(), MovingBaseRobotArmDefinition.handName);

      elbowPitch = MultiBodySystemTools.findJoint(robot.getRootBody(), MovingBaseRobotArmDefinition.elbowPitchName);
      wristYaw = MultiBodySystemTools.findJoint(robot.getRootBody(), MovingBaseRobotArmDefinition.wristYawName);
   ...
   {
      return robot.getJoint(MovingBaseRobotArmDefinition.wristYawName);
   }
}
