...
public class FixedBaseRobotArmMPTCSimulation
{
   public static void main(String[] args)
   {
      ...
      FixedBaseRobotArmMPTCController robotArmController = new FixedBaseRobotArmMPTCController(robotArm, controlDT, yoGraphicsListRegistry);
