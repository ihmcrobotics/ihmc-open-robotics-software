...
public class ContactParticleFilter
{
   ...
   private final ExternalTorqueDisturbanceObserver externalTorqueDisturbanceObserver;
   ...
   {
      externalTorqueDisturbanceObserver.doControl();

      DMatrixRMaj jointspaceResidual = externalTorqueDisturbanceObserver.getObservedExternalJointTorque();
   ...
   {
      return externalTorqueDisturbanceObserver.getObservedExternalJointTorque();
   }
}
