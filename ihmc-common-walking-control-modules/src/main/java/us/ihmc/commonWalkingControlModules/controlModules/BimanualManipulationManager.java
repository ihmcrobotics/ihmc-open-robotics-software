...
public class BimanualManipulationManager implements SCS2YoGraphicHolder
{
   ...
   private final FrameVector3D walkingFrameX = new FrameVector3D();
   ...
   public BimanualManipulationManager(HighLevelHumanoidControllerToolbox controllerToolbox, YoRegistry parentRegistry)
   {
      this.controllerToolbox = controllerToolbox;
      fullRobotModel = controllerToolbox.getFullRobotModel();

      maxEnableRate.set(1.0 / DEFAULT_INITIALIZE_DURATION);
      alphaEnabled = new RateLimitedYoVariable("alphaEnabled", registry, maxEnableRate, controllerToolbox.getControlDT());
   ...
   private void updateFrames()
   {
      ...
      walkingFrameX.setMatchingFrame(controllerToolbox.getWalkingTrajectoryPath().getWalkingTrajectoryPathFrame(), Axis3D.X);
      midHandFrameZ.cross(walkingFrameX, midHandFrameY);
