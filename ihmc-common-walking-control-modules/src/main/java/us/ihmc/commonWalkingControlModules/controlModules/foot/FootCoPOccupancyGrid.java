...
public class FootCoPOccupancyGrid
{
   ...
   private void setupChangedGridParameterListeners()
   {
      ...
      changedGridSizeListener.notifyOfVariableChanged(null);
      ...
      changedThresholdForCellActivationListener.notifyOfVariableChanged(null);
      ...
      resetGridListener.notifyOfVariableChanged(null);
   }
