...
public class MPCWholeBodyControllerCore implements SCS2YoGraphicHolder
{
   ...
   @Deprecated
   public MPCWholeBodyControllerCore(WholeBodyControlCoreToolbox toolbox, FeedbackControlCommandList allPossibleCommands, YoRegistry parentRegistry)
   {
      this(toolbox, allPossibleCommands, null, parentRegistry);
   }

   @Deprecated
   public MPCWholeBodyControllerCore(WholeBodyControlCoreToolbox toolbox,
   ...
   public MPCWholeBodyControllerCore(WholeBodyControlCoreToolbox toolbox, FeedbackControllerTemplate feedbackControllerTemplate, YoRegistry parentRegistry)
   {
