...
/**
 * {@link ImpedancePointFeedbackControlCommand} is a command meant to be submit to the
 * {@link WholeBodyControllerCore} via the {@link ControllerCoreCommand}.
 * <p>
 * The objective of a {@link ImpedancePointFeedbackControlCommand} is to notify the feedback controller
 ...
 */
public class ImpedancePointFeedbackControlCommand implements FeedbackControlCommand<ImpedancePointFeedbackControlCommand>
{
    ...
    * core.
    */
   public ImpedancePointFeedbackControlCommand()
   {
    ...
    */
   @Override
   public void set(ImpedancePointFeedbackControlCommand other)
   {
    ...
    */
   public void setGains(PID3DGainsReadOnly gains) { this.gains.set(gains);}
   ...
   public boolean equals(Object object)
   {
      ...
      else if (object instanceof ImpedancePointFeedbackControlCommand)
      {
         ImpedancePointFeedbackControlCommand other = (ImpedancePointFeedbackControlCommand) object;
