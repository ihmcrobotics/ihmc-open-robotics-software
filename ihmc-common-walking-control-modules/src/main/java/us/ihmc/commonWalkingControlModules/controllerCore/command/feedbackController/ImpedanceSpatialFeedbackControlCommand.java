...
/**
 * {@link ImpedanceSpatialFeedbackControlCommand} is a command meant to be submitted to the
 * {@link WholeBodyControllerCore} via the {@link ControllerCoreCommand}.
 * <p>
 * The objective of a {@link ImpedanceSpatialFeedbackControlCommand} is to notify the feedback controller
 ...
 */
public class ImpedanceSpatialFeedbackControlCommand implements FeedbackControlCommand<ImpedanceSpatialFeedbackControlCommand>
{
    ...
    * core.
    */
   public ImpedanceSpatialFeedbackControlCommand()
   {
    ...
    */
   @Override
   public void set(ImpedanceSpatialFeedbackControlCommand other)
   {
   ...
   public boolean equals(Object object)
   {
      ...
      else if (object instanceof ImpedanceSpatialFeedbackControlCommand)
      {
         ImpedanceSpatialFeedbackControlCommand other = (ImpedanceSpatialFeedbackControlCommand) object;
