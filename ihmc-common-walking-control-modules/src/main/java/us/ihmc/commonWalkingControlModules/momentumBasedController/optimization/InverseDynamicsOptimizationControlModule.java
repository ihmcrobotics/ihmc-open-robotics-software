...
public class InverseDynamicsOptimizationControlModule implements SCS2YoGraphicHolder
{
                                                   ...
                                                   YoRegistry parentRegistry)
   {
      ...
      externalWrenchHandler = new ExternalWrenchHandler(gravityZ, centerOfMassFrame, toolbox.getTotalMassProvider(), contactablePlaneBodies);
   ...
   public boolean compute()
   {
      ...
      for (int i = 0; i < nullspaceQPObjectiveCommands.size(); i++)
      {
         ...
         submitQPObjectiveCommandNow(command); // TODO It's silly, we keep recomputing the nullspace. It is recomputed for the privileged accelerations
      }
