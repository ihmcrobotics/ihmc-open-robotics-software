...
public class ModifiedCapturePointCalculator
{
   private static final ReferenceFrame worldFrame = ReferenceFrame.getWorldFrame();

   private final MomentumStateProvider centerOfMassStateProvider;
...
//   public ModifiedCapturePointCalculator(ReferenceFrame centerOfMassFrame, RigidBodyReadOnly elevator)
//   {
...
//   }
   ...
   public ModifiedCapturePointCalculator(MomentumStateProvider centerOfMassStateProvider)
   {
   ...
   public void compute(FramePoint2DBasics capturePointToPack, double omega0)
   {
      ...
      centerOfMassVelocity.setIncludingFrame(centerOfMassStateProvider.getModifiedCenterOfMassVelocity());
