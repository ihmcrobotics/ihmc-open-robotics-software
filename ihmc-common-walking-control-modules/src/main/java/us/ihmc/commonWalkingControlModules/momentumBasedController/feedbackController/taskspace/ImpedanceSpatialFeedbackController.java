...
public class ImpedanceSpatialFeedbackController implements FeedbackControllerInterface
{
   ...
   public ImpedanceSpatialFeedbackController(RigidBodyBasics endEffector,
