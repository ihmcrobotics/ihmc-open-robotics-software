...
public class DoNothingMPCControllerState extends MPCHighLevelControllerState
{
   ...
   public DoNothingMPCControllerState(OneDoFJointBasics[] controlledJoints, HighLevelControllerParameters highLevelControllerParameters)
   {
      this("", controlledJoints, highLevelControllerParameters);
   }

   public DoNothingMPCControllerState(String namePrefix, OneDoFJointBasics[] controlledJoints, HighLevelControllerParameters highLevelControllerParameters)
   {
