...
public class MPCControllerComponentBasedFootstepDataMessageGeneratorFactory implements MPCControllerHumanoidSteppingPluginFactory
{
   ...
   private final OptionalFactoryField<HeadingAndVelocityEvaluationScriptParameters> headingAndVelocityEvaluationScriptParametersField = new OptionalFactoryField<>(
   ...
   private final OptionalFactoryField<Boolean> createSupportFootBasedFootstepAdjustment = new OptionalFactoryField<>(
         "csgCreateSupportFootBasedFootstepAdjustment");
   /**
   ...
   public MPCControllerComponentBasedFootstepDataMessageGeneratorFactory()
   {
   ...
   @Override
   public MPCControllerComponentBasedFootstepDataMessageGenerator buildPlugin(CommonHumanoidReferenceFrames referenceFrames,
                                                                              double updateDT,
                                                                              ...
                                                                              DoubleProvider timeProvider)
   {
      ...
      MPCControllerComponentBasedFootstepDataMessageGenerator plugin = new MPCControllerComponentBasedFootstepDataMessageGenerator(continuousStepGenerator,
                                                                                                                                   updatables,
                                                                                                                                   registryField.get());
