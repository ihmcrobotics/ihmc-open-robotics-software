...
public class TransferToFlamingoPushRecoveryStanceState extends PushRecoveryTransferState
{
   private final FootstepTiming footstepTiming = new FootstepTiming();

   public TransferToFlamingoPushRecoveryStanceState(PushRecoveryStateEnum stateEnum, WalkingMessageHandler walkingMessageHandler,
