...
public class MPCControllerComponentBasedFootstepDataMessageGenerator implements MPCControllerHumanoidSteppingPlugin
{
   private final YoRegistry registry;
   private final ContinuousStepGenerator continuousStepGenerator;
   private final List<Updatable> updatables;

   public MPCControllerComponentBasedFootstepDataMessageGenerator(ContinuousStepGenerator continuousStepGenerator, List<Updatable> updatables, YoRegistry registry)
   {
