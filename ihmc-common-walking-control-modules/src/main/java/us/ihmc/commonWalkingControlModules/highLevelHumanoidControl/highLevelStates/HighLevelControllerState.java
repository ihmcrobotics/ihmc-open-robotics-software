...
public abstract class HighLevelControllerState extends FinishableState<HighLevelController>
{

   public HighLevelControllerState(HighLevelController stateEnum)
   {
      super(stateEnum);
   }
