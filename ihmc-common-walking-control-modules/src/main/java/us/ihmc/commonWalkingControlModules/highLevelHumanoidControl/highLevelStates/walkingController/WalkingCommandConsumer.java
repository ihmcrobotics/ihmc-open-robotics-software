...
public class WalkingCommandConsumer
{
                                 ...
                                 YoRegistry parentRegistry)
   {
      ...
      commandsToRegister.add(BimanualManipulationCommand.class);
   ...
   public void consumeBoxManipulationCommands()
   {
      if (!commandConsumerWithDelayBuffers.isNewCommandAvailable(BimanualManipulationCommand.class))
         return;

      BimanualManipulationCommand bimanualManipulationCommand = commandConsumerWithDelayBuffers.pollNewestCommand(BimanualManipulationCommand.class);
      bimanualManipulationManager.handleBimanualManipulationCommand(bimanualManipulationCommand);
   }
}
