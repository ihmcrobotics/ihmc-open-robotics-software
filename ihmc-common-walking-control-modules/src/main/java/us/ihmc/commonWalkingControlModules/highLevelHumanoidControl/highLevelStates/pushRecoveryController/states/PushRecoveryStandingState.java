...
public class PushRecoveryStandingState extends PushRecoveryState
{
   ...
   public PushRecoveryStandingState(CommandInputManager commandInputManager,
   ...
   {
      super(PushRecoveryStateEnum.STANDING, parentRegistry);
