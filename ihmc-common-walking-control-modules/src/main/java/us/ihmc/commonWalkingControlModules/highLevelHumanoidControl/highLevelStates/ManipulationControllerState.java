...
public class ManipulationControllerState extends HighLevelControllerState
{
   ...
   {
      super(controllerName, highLevelControllerParameters, MultiBodySystemTools.filterJoints(controllerToolbox.getControlledJoints(), OneDoFJointBasics.class));

      this.commandInputManager = commandInputManager;
      this.statusMessageOutputManager = statusMessageOutputManager;
      this.controllerToolbox = controllerToolbox;
      this.fullHumanoidRobotModel = controllerToolbox.getFullRobotModel();

      this.highLevelControllerParameters = highLevelControllerParameters;
      this.walkingControllerParameters = walkingControllerParameters;

      ReferenceFrameHashCodeResolver referenceFrameHashCodeResolver = new ReferenceFrameHashCodeResolver();
      referenceFrameHashCodeResolver.put(controllerToolbox.getFullRobotModel().getRootBody().getBodyFixedFrame());
      ...
      chestManager = createRigidBodyManager(chest, elevator, chest.getBodyFixedFrame(), elevator.getBodyFixedFrame(), elevator);
      headManager = createRigidBodyManager(head, chest, head.getBodyFixedFrame(), chest.getBodyFixedFrame(), elevator);
      ...
      for (RobotSide robotSide : RobotSide.values)
      {
         ...
         RigidBodyControlManager handManager = createRigidBodyManager(hand, chest, handControlFrames.get(robotSide), chest.getBodyFixedFrame(), elevator);
      ...
      controlCoreToolbox = new WholeBodyControlCoreToolbox(controllerToolbox.getControlDT(),
                                                           Math.abs(controllerToolbox.getGravityZ()),
                                                           null,
                                                           controlledJoints,
                                                           centerOfMassFrame,
