...
public class FinishedMPCControllerStateTransitionFactory<E extends Enum<E>> implements MPCControllerStateTransitionFactory<E>
{
    ...
    */
   public FinishedMPCControllerStateTransitionFactory(E currentStateEnum, E nextStateEnum)
   {
    ...
    */
   public FinishedMPCControllerStateTransitionFactory(E currentStateEnum, E nextStateEnum, boolean performNextStateOnEntry)
   {
    ...
    * @param nextStateEnum    The state to transition to.
    */
   public FinishedMPCControllerStateTransitionFactory(E stateToAttach, E currentStateEnum, E nextStateEnum)
   {
    ...
    *                                invoked (if {@code true}), or skipped ({@code false}).
    */
   public FinishedMPCControllerStateTransitionFactory(E stateToAttach, E currentStateEnum, E nextStateEnum, boolean performNextStateOnEntry)
   {
