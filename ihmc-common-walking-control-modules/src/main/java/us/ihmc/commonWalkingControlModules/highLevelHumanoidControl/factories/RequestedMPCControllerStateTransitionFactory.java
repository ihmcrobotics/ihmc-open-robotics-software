...
public class RequestedMPCControllerStateTransitionFactory<E extends Enum<E>> implements MPCControllerStateTransitionFactory<E>
{
    ...
    */
   public RequestedMPCControllerStateTransitionFactory(YoEnum<E> requestedControlState, E stateToAttachEnum, E nextStateEnum)
   {
   ...
   public StateTransition<E> getOrCreateStateTransition(EnumMap<E, ? extends State> stateMap,
                                                        HighLevelMPCControllerFactoryHelper controllerFactoryHelper, YoRegistry parentRegistry)
   {
