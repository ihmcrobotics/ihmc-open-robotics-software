...
public abstract class SingleSupportPushRecoveryState extends PushRecoveryState
{
   ...
   public SingleSupportPushRecoveryState(PushRecoveryStateEnum singleSupportStateEnum, WalkingMessageHandler walkingMessageHandler,
