...
public class VelocityBasedSteppingGeneratorFactory implements HighLevelHumanoidControllerPluginFactory
{
   ...
   @Override
   public VelocityBasedSteppingGenerator buildPlugin(HighLevelControllerFactoryHelper controllerFactoryHelper)
   {
      return buildPlugin(controllerFactoryHelper.getStatusMessageOutputManager(),
                         controllerFactoryHelper.getCommandInputManager());
   }

   public VelocityBasedSteppingGenerator buildPlugin(StatusMessageOutputManager walkingStatusMessageOutputManager,
