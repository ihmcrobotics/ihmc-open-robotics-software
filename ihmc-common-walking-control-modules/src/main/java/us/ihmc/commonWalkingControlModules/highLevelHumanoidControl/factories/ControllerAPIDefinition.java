...
public class ControllerAPIDefinition
{
   ...
   static
   {
      ...
      commands.add(PushRecoveryResultCommand.class);
   ...
   public static MessageValidator createDefaultMessageValidation()
   {
      ...
      validators.put(PushRecoveryResultMessage.class, message -> validatePushRecoveryResultMessage((PushRecoveryResultMessage) message));
