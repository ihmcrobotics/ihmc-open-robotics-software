...
public class MPCHumanoidHighLevelControllerManager implements RobotController, SCS2YoGraphicHolder
{
   ...
   public MPCHumanoidHighLevelControllerManager(CommandInputManager commandInputManager,
