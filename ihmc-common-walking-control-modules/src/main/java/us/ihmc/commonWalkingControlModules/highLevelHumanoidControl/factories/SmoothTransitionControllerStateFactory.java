...
public class SmoothTransitionControllerStateFactory implements HighLevelControllerStateFactory
{
   ...
   public SmoothTransitionControllerStateFactory(String transitionName, HighLevelControllerName transitionStateEnum, HighLevelControllerName startState, HighLevelControllerName endState)
   {
