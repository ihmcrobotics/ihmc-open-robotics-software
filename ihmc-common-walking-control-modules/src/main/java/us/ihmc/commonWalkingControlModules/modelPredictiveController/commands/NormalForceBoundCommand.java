 ...
 */
public class NormalForceBoundCommand implements MPCCommand<NormalForceBoundCommand>
{
   ...
   {
      return MPCCommandType.NORMAL_FORCE_BOUND;
   }

   @Override
   public void set(NormalForceBoundCommand other)
   {
      clear();
   ...
   public boolean equals(Object object)
   {
      ...
      else if (object instanceof NormalForceBoundCommand)
      {
         NormalForceBoundCommand other = (NormalForceBoundCommand) object;
