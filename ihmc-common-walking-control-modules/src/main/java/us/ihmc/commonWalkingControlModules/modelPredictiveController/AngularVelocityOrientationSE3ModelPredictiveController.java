...
public class AngularVelocityOrientationSE3ModelPredictiveController
{
   ...
   final AngularVelocityOrientationMPCTrajectoryHandler orientationTrajectoryHandler;
...
//      momentOfInertia = body.getInertia().getMomentOfInertia();
      ...
      orientationTrajectoryHandler = new AngularVelocityOrientationMPCTrajectoryHandler(indexHandler, registry);
