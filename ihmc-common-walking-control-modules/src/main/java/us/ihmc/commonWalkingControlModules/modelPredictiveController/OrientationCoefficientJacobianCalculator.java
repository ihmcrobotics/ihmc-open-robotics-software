...
public class OrientationCoefficientJacobianCalculator
{
   ...
   public static void calculateOrientationJacobian(int yawStart, int pitchStart, int rollStart, double omega, double time, DMatrix orientationJacobianToPack, double scale)
   {
      ...
      add(orientationJacobianToPack, 0, rollStart + 3, c5);
      add(orientationJacobianToPack, 1, pitchStart + 3, c5);
      add(orientationJacobianToPack, 2, yawStart + 3, c5);
      ...
      if (!MathTools.epsilonEquals(time, 0.0, 1e-5))
      {
         ...
         double c3 = time * c4;
         double c2 = time * c3;
         add(orientationJacobianToPack, 0, rollStart, c2);
         add(orientationJacobianToPack, 0, rollStart + 1, c3);
         add(orientationJacobianToPack, 0, rollStart + 2, c4);

         add(orientationJacobianToPack, 1, pitchStart, c2);
         add(orientationJacobianToPack, 1, pitchStart + 1, c3);
         add(orientationJacobianToPack, 1, pitchStart + 2, c4);

         add(orientationJacobianToPack, 2, yawStart, c2);
         add(orientationJacobianToPack, 2, yawStart + 1, c3);
         add(orientationJacobianToPack, 2, yawStart + 2, c4);
      }
   }
   ...
   public static void calculateAngularVelocityJacobian(int yawStart, int pitchStart, int rollStart, double omega, double time, DMatrix velocityJacobianToPack, double scale)
   {
      ...
      add(velocityJacobianToPack, 0, rollStart + 2, c4);
      add(velocityJacobianToPack, 1, pitchStart + 2, c4);
      add(velocityJacobianToPack, 2, yawStart + 2, c4);
      ...
      if (!MathTools.epsilonEquals(time, 0.0, 1e-5))
      {
         ...
         add(velocityJacobianToPack, 0, rollStart, c2);
         add(velocityJacobianToPack, 1, pitchStart, c2);
         add(velocityJacobianToPack, 2, yawStart, c2);
         add(velocityJacobianToPack, 0, rollStart + 1, c3);
         add(velocityJacobianToPack, 1, pitchStart + 1, c3);
         add(velocityJacobianToPack, 2, yawStart + 1, c3);
      }
   }
   ...
   public static void calculateAngularAccelerationJacobian(int yawStart, int pitchStart, int rollStart, double omega, double time, DMatrix accelerationJacobianToPack, double scale)
   {
      ...
      add(accelerationJacobianToPack, 0, rollStart + 1, c3);
      add(accelerationJacobianToPack, 1, pitchStart + 1, c3);
      add(accelerationJacobianToPack, 2, yawStart + 1, c3);

      if (!MathTools.epsilonEquals(time, 0.0, 1e-5))
      {
         time = Math.min(MPCQPInputCalculator.sufficientlyLongTime, time);
         double c2 = 6.0 * time * scale;
         add(accelerationJacobianToPack, 0, rollStart, c2);
         add(accelerationJacobianToPack, 1, pitchStart, c2);
         add(accelerationJacobianToPack, 2, yawStart, c2);
      }
   }
   ...
   public static void calculateAngularJerkJacobian(int yawStart, int pitchStart, int rollStart, double omega, double time, DMatrix jerkJacobianToPack, double scale)
   {
      ...
      add(jerkJacobianToPack, 0, rollStart, c2);
      add(jerkJacobianToPack, 1, pitchStart, c2);
      add(jerkJacobianToPack, 2, yawStart, c2);
   }
