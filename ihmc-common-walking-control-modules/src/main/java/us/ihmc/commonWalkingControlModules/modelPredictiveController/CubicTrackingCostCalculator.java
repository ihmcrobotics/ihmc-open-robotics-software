...
public class CubicTrackingCostCalculator
{
   public static boolean calculateTrackingObjective(DMatrixRMaj costHessianToPack, DMatrixRMaj costGradientToPack, CubicTrackingCommand objective)
   {
      ...
      costGradientToPack.set(startIndex + 1, 0, a0 * t6 / 6.0 + a1 * t5 / 5.0 + a2 * t4 / 4.0 + a3 * t3 / 3.0);
      costGradientToPack.set(startIndex + 2, 0, a0 * t5 / 5.0 + a1 * t4 / 4.0 + a2 * t3 / 3.0 + a3 * t2 / 2.0);
      costGradientToPack.set(startIndex + 3, 0, a0 * t4 / 4.0 + a1 * t3 / 3.0 + a2 * t2 / 2.0 + a3 * t);
