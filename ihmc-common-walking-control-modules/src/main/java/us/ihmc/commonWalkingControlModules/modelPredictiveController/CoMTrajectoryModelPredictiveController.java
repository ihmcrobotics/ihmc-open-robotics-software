 ...
 *    </p>
 */
public class CoMTrajectoryModelPredictiveController implements CoMTrajectoryProvider
{
   ...
   public CoMTrajectoryModelPredictiveController(double gravityZ, YoDouble omega, YoRegistry parentRegistry)
   {
      this.omega = omega;
      this.gravityZ = Math.abs(gravityZ);
