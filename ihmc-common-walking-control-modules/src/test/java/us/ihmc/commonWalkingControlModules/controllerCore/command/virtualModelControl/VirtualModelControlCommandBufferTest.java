...
class VirtualModelControlCommandBufferTest
{
   ...
   {
      VirtualModelControlCommandBuffer instance = new VirtualModelControlCommandBuffer();
      int expectedSize = 0;
      Field[] fields = VirtualModelControlCommandBuffer.class.getDeclaredFields();
      ...
      for (Class<? extends VirtualModelControlCommand> commandType : commandTypes)
      {
         ...
         try
         {
            addCommandMethod = VirtualModelControlCommandBuffer.class.getDeclaredMethod("add" + commandType.getSimpleName());
         }
