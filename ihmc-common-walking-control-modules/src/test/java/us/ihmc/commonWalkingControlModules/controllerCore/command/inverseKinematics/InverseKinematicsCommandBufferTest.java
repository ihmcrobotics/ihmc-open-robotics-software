...
class InverseKinematicsCommandBufferTest
{
   ...
   {
      InverseKinematicsCommandBuffer instance = new InverseKinematicsCommandBuffer();
      int expectedSize = 0;
      Field[] fields = InverseKinematicsCommandBuffer.class.getDeclaredFields();
      ...
      for (Class<? extends InverseKinematicsCommand> commandType : commandTypes)
      {
         ...
         try
         {
            addCommandMethod = InverseKinematicsCommandBuffer.class.getDeclaredMethod("add" + commandType.getSimpleName());
         }
