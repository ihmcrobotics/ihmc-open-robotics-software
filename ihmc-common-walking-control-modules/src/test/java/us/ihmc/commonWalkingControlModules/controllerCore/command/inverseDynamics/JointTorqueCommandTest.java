...
{
   @Test
   public void testJointTorqueCommandOnFixedBaseMechanism()
   {
   ...
   public void testJointTorqueCommandOnFloatingBaseMechanism()
   {
      ...
      for (int i = 0; i < numTests; i++)
      {
         ...
         DMatrixRMaj contactingLinkAcceleration = computeSpatialAcceleration(contactingLinkJacobian, lowLevelOneDoFJointDesiredDataHolder, rootJointDesiredData);
         ...
         Assertions.assertTrue(EuclidCoreTools.epsilonEquals(lowLevelOneDoFJointDesiredDataHolder.getDesiredJointTorque(requestedJoint), desiredActuatorForce, 1e-9));
      }
   }
