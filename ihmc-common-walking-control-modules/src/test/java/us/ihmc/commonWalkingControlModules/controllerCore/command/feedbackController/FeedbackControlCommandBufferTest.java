...
class FeedbackControlCommandBufferTest
{
   ...
   {
      FeedbackControlCommandBuffer instance = new FeedbackControlCommandBuffer();
      int expectedSize = 0;
      Field[] fields = FeedbackControlCommandBuffer.class.getDeclaredFields();
      ...
      for (Class<? extends FeedbackControlCommand> commandType : commandTypes)
      {
         ...
         try
         {
            addCommandMethod = FeedbackControlCommandBuffer.class.getDeclaredMethod("add" + commandType.getSimpleName());
         }
