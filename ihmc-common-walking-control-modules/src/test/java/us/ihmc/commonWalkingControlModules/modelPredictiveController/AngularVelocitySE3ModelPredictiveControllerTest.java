...
public class AngularVelocitySE3ModelPredictiveControllerTest
{
   ...
   public void testSimpleStanding()
   {
      ...
      AngularVelocitySE3ModelPredictiveController mpc = new AngularVelocitySE3ModelPredictiveController(momentOfInertia,
                                                                                                        gravityZ,
                                                                                                        nominalHeight,
                                                                                                        mass,
                                                                                                        dt,
   ...
   private static void visualize(AngularVelocitySE3ModelPredictiveController mpc,
