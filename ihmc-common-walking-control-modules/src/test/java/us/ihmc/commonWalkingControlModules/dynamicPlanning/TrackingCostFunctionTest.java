...
public abstract class TrackingCostFunctionTest<E extends Enum>
{
   ...
   public void testCostStateGradientNumerically()
   {
      ...
      for (int hybridStateIndex = 0; hybridStateIndex < getNumberOfStates(); hybridStateIndex++)
      {
         ...
         double cost = costFunction.getCost(hybridState, currentControl, currentState, desiredControl, desiredState);

         costFunction.getCostStateGradient(hybridState, currentControl, currentState, desiredControl, desiredState, costGradient);
         ...
         for (int modifiedStateIndex = 0; modifiedStateIndex < getStateVectorSize(); modifiedStateIndex++)
         {
            ...
            double modifiedCost = costFunction.getCost(hybridState, currentControl, currentStateModified, desiredControl, desiredState);
   ...
   public void testCostControlGradientNumerically()
   {
      ...
      for (int hybridStateIndex = 0; hybridStateIndex < getNumberOfStates(); hybridStateIndex++)
      {
         ...
         costFunction.getCostControlGradient(hybridState, currentControl, currentState, desiredControl, desiredState, costGradient);
         ...
         for (int controlModifiedIndex = 0; controlModifiedIndex < getControlVectorSize(); controlModifiedIndex++)
         {
            ...
            double modifiedCost = costFunction.getCost(hybridState, currentControlModified, currentState, desiredControl, desiredState);
   ...
   public void testCostStateHessianNumerically()
   {
      ...
      for (int hybridStateIndex = 0; hybridStateIndex < getNumberOfStates(); hybridStateIndex++)
      {
         ...
         costFunction.getCostStateHessian(hybridState, currentControl, currentState, costHessian);
         costFunction.getCostStateGradient(hybridState, currentControl, currentState, desiredControl, desiredState, currentGradient);

         for (int partialState = 0; partialState < getStateVectorSize(); partialState++)
         {
            DenseMatrix64F currentStateModified = new DenseMatrix64F(currentState);
            currentStateModified.add(partialState, 0, epsilon);
            costFunction.getCostStateGradient(hybridState, currentControl, currentStateModified, desiredControl, desiredState, modifiedGradient);
   ...
   public void testCostControlHessianNumerically()
   {
      ...
      for (int hybridStateIndex = 0; hybridStateIndex < getNumberOfStates(); hybridStateIndex++)
      {
         ...
         for (int partialControl = 0; partialControl < getControlVectorSize(); partialControl++)
         {
            ...
            costFunction.getCostControlGradient(hybridState, currentControlModified, currentState, desiredControl, desiredState, modifiedGradient);
   ...
   public void testCostStateControlHessianNumerically()
   {
      ...
      for (int hybridStateIndex = 0; hybridStateIndex < getNumberOfStates(); hybridStateIndex++)
      {
         ...
         costFunction.getCostControlGradientOfStateGradient(hybridState, currentControl, currentState, costHessian);
         costFunction.getCostStateGradient(hybridState, currentControl, currentState, desiredControl, desiredState, currentGradient);
         ...
         for (int partialControl = 0; partialControl < getControlVectorSize(); partialControl++)
         {
            DenseMatrix64F currentControlModified = new DenseMatrix64F(currentControl);
            currentControlModified.add(partialControl, 0, epsilon);
            costFunction.getCostStateGradient(hybridState, currentControlModified, currentState, desiredControl, desiredState, modifiedGradient);
