...
public class RigidBodyControlManagerTest
{
   ...
   private RigidBodyControlManager createManager()
   {
      ...
      PID3DGainsReadOnly taskspaceOrientationGains = new YoPID3DGains("OrientationGains", GainCoupling.XYZ, false, testRegistry);
      PID3DGainsReadOnly taskspacePositionGains = new YoPID3DGains("PositionGains", GainCoupling.XYZ, false, testRegistry);
