...
public class TriangleToolsTest
{
   ...
   @Test
   public void testComputeSideLengethFromSideSideAngle()
   ...
   // Each result was found by constructing the triangle in OnShape, so there's a margin of error.
   {
      ...
      assertEquals("Case 1 failed.", result, TriangleTools.computeSideLengethFromSideSideAngle(sideALength, sideBLength, angleB, isAngleAObtuse), epsilon);
      ...
      result = 1.393413;
      isAngleAObtuse = false;
      assertEquals("Case 2 failed.", result, TriangleTools.computeSideLengethFromSideSideAngle(sideALength, sideBLength, angleB, isAngleAObtuse), epsilon);
      ...
      angleB = 0.8;
      isAngleAObtuse = false;
      assertTrue("Case 3 failed.", new Double(TriangleTools.computeSideLengethFromSideSideAngle(sideALength, sideBLength, angleB, isAngleAObtuse)).isNaN());
      ...
      result = 1.769654;
      isAngleAObtuse = false;
      assertEquals("Case 4 failed.", result, TriangleTools.computeSideLengethFromSideSideAngle(sideALength, sideBLength, angleB, isAngleAObtuse), epsilon);
      ...
      result = 0.706353;
      isAngleAObtuse = true;
      assertEquals("Case 5 failed.", result, TriangleTools.computeSideLengethFromSideSideAngle(sideALength, sideBLength, angleB, isAngleAObtuse), epsilon);
      ...
      result = 0.781476;
      isAngleAObtuse = false;
      assertEquals("Case 6 failed.", result, TriangleTools.computeSideLengethFromSideSideAngle(sideALength, sideBLength, angleB, isAngleAObtuse), epsilon);
      ...
      angleB = 1.75;
      isAngleAObtuse = false;
      assertTrue("Case 7 failed.", new Double(TriangleTools.computeSideLengethFromSideSideAngle(sideALength, sideBLength, angleB, isAngleAObtuse)).isNaN());
      ...
      angleB = 1.75;
      isAngleAObtuse = false;
      assertTrue("Case 8 failed.", new Double(TriangleTools.computeSideLengethFromSideSideAngle(sideALength, sideBLength, angleB, isAngleAObtuse)).isNaN());
      ...
      for (int iter = 0; iter < 1000; iter++)
      {
         ...
         assertEquals(acLength, TriangleTools.computeSideLengethFromSideSideAngle(bcLength, abLength, bca, cab > Math.PI / 2), epsilon);
         assertEquals(bcLength, TriangleTools.computeSideLengethFromSideSideAngle(abLength, acLength, abc, bca > Math.PI / 2), epsilon);
         assertEquals(abLength, TriangleTools.computeSideLengethFromSideSideAngle(acLength, bcLength, cab, abc > Math.PI / 2), epsilon);
      }
   }
}
