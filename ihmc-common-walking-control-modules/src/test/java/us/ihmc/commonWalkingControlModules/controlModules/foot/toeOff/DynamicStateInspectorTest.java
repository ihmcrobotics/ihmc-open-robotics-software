...
public class DynamicStateInspectorTest
{
   ...
   public void testLeftStep()
   {
      ...
      inspector.checkICPLocations(parameters, RobotSide.RIGHT, leftFootPose, desiredICP, currentICP, null, null, toePosition);
...
//      visualize(inspector);
   ...
   public void test20220206_164237_Nadia_HeuristicICPController_StepsAndFallCrop02_6_99()
   {
      ...
      for (int i = 0; i < 4; i++)
         inspector.checkICPLocations(parameters, RobotSide.LEFT, rightFootPose, desiredICP, currentICP, null, null, toePosition);
                               ...
                               List<YoFramePoint2D> invalidPoints, SimulationConstructionSet scs)
   {
...

      {
         for (int heightIdx = 0; heightIdx < heightTicks; heightIdx++)
         {
            ...
            inspector.checkICPLocations(parameters, RobotSide.RIGHT, leadingFootPose, desiredICP, currentICP, null, null, toePosition);
