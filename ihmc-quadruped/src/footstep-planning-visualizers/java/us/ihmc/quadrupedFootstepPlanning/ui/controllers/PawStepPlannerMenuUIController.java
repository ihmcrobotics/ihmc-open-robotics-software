...
public class PawStepPlannerMenuUIController
{
   ...
   public void loadPlanarRegions()
   {
      ...
      if (loadedPlanarRegions != null)
      {
         ...
         messager.submitMessage(PawStepPlannerMessagerAPI.GlobalResetTopic, true);
         messager.submitMessage(PawStepPlannerMessagerAPI.PlanarRegionDataTopic, loadedPlanarRegions);
      }
      else
      {
         if (VERBOSE)
