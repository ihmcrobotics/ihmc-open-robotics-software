...
public class YoQuadrupedTimedStep extends QuadrupedTimedStep
{
   ...
   public YoQuadrupedTimedStep(String prefix, YoRegistry registry)
   {
      super();
      ...
      this.trajectoryType = new YoEnum<>(prefix + "TrajectoryType", prefix + "TrajectoryType", registry, TrajectoryType.class, true);
   }
