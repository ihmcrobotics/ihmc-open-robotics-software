...
{
   private final RequiredFactoryField<PawStepPlannerParametersReadOnly> pawPlannerParameters = new RequiredFactoryField<>("pawPlannerParameters");
   ...
   public void setPawPlannerParameters(PawStepPlannerParametersReadOnly pawPlannerParameters)
   {
