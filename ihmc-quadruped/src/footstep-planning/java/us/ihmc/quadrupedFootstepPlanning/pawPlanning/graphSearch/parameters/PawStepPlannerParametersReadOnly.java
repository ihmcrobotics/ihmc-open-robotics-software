...
public interface PawStepPlannerParametersReadOnly extends StoredPropertySetReadOnly
{
   /**
   ...
   default PawStepPlannerParametersPacket getAsPacket()
   {
      PawStepPlannerParametersPacket packet = new PawStepPlannerParametersPacket();
