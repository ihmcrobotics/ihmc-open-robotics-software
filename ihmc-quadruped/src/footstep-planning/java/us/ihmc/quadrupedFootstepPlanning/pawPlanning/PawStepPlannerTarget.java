...
public class PawStepPlannerTarget
{
   ...
   protected PawStepPlannerTargetType targetType = PawStepPlannerTargetType.POSE_BETWEEN_FEET;
   ...
   public PawStepPlannerTargetType getTargetType()
   {
      return targetType;
   }
}
