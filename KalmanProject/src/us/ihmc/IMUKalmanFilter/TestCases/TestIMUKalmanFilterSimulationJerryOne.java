...
public class TestIMUKalmanFilterSimulationJerryOne
{
   ...
   public void setupSimulationConstructionSet(SimulationConstructionSet simulationConstructionSet) {
      ...
      simulationConstructionSet.setupGraphGroup("compare filters", new String[][]
                                                {
                                                {"estimated_yaw", "estimated_yaw_2", "yaw"},
                                                {"estimated_pitch", "estimated_pitch_2", "pitch"},
                                                {"estimated_roll", "estimated_roll_2", "roll"},
      }, 1);

      simulationConstructionSet.setupGraphGroup("test", new String[][]
                                                {
                                                {"x_accel", "y_accel", "z_accel"},
                                                {"x_accel_sensor", "y_accel_sensor", "z_accel_sensor"},
                                                {"x_gyro", "y_gyro", "z_gyro"},
                                                {"x_gyro_sensor", "y_gyro_sensor", "z_gyro_sensor"},
//                                                {"x_error", "y_error", "z_error"},
//                                                {"estimated_roll", "estimated_pitch", "estimated_yaw"},
                                                {"estimated_roll", "roll", "accel_to_roll"},
                                                {"estimated_pitch", "pitch", "accel_to_pitch"},
                                                {"estimated_yaw", "yaw"}
      }, 2);

      simulationConstructionSet.setupGraphGroup("quaternions", new String[][]
                                                {
                                                {"q_qs", "estimated_q0", "estimated_q0_2"},
                                                {"q_qx", "estimated_q1", "estimated_q1_2"},
                                                {"q_qy", "estimated_q2", "estimated_q2_2"},
                                                {"q_qz", "estimated_q3", "estimated_q3_2"},
                                                {"estimated_qd_wx_bias"},
                                                {"estimated_qd_wy_bias"},
                                                {"estimated_qd_wz_bias"}
      });
      ...
      simulationConstructionSet.setupGraphGroup("from accel", new String[][]
                                                ...
                                                {"q_qy", "q2_from_accel"},
                                                {"q_qz", "q3_from_accel"},
                                                {"yaw", "yaw_from_accel", "yaw_from_quat"},
                                                {"pitch", "pitch_from_accel", "pitch_from_quat"},
                                                {"roll", "roll_from_accel", "roll_from_quat"},
      });
