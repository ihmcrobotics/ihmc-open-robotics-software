...
public class BehaviorUIMessagerAPI
{
   ...
   private static final TypedTopicTheme<us.ihmc.footstepPlanning.FootstepPlannerType> FootstepPlannerType = apiFactory.createTypedTopicTheme("FootstepPlannerType");
   ...
   private static final TypedTopicTheme<us.ihmc.footstepPlanning.FootstepPlannerStatus> FootstepPlannerStatus = apiFactory.createTypedTopicTheme("FootstepPlannerStatus");
   private static final TypedTopicTheme<us.ihmc.footstepPlanning.graphSearch.parameters.FootstepPlannerParameters> FootstepPlannerParameters = apiFactory.createTypedTopicTheme("FootstepPlannerParameters");
   private static final TypedTopicTheme<controller_msgs.msg.dds.FootstepDataListMessage> FootstepDataListMessage = apiFactory.createTypedTopicTheme("FootstepDataListMessage");
   ...
   private static final TypedTopicTheme<us.ihmc.pathPlanning.visibilityGraphs.interfaces.VisibilityGraphsParameters> VisibilityGraphsParameters = apiFactory.createTypedTopicTheme("VisibilityGraphsParameters");
   ...
   public static final Topic<Boolean> WaypointAOrientationEditModeEnabledTopic = Root.child(Start).child(EditMode).child(OrientationTheme).topic(Enable);
   public static final Topic<Boolean> WaypointBOrientationEditModeEnabledTopic = Root.child(Goal).child(EditMode).child(OrientationTheme).topic(Enable);

   public static final Topic<RobotSide> InitialSupportSideTopic = Root.child(Start).topic(Side);
   public static final Topic<Point3D> WaypointAPositionTopic = Root.child(FootstepPlan).child(Start).topic(Position);
   public static final Topic<Point3D> WaypointBPositionTopic = Root.child(FootstepPlan).child(Goal).topic(Position);
