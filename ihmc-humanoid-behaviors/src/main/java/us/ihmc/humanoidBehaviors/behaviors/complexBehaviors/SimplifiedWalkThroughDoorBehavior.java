...
import us.ihmc.humanoidBehaviors.behaviors.complexBehaviors.SimplifiedWalkThroughDoorBehavior.WalkThroughDoorBehaviorState;
...
//          double[] leftArmPose = new double[] {-1.4573707384127728, -0.8679045375063197, 1.7161679382174408, 1.5565002230277143, -0.1665184664421956, -1.2894759927886323, -2.5972820987306298};
          ...
          double[] rightArmPose = new double[] {1.5708, 0.3996067438100709, 0.9277993765158472, -1.99245586501775, 2.9237335374002837, -0.11746773005668545, 0.8906311670054284};
      ...
      factory.addStateAndDoneTransition(WalkThroughDoorBehaviorState.SETUP_ROBOT, resetRobot, WalkThroughDoorBehaviorState.SEARCHING_FOR_DOOR_FINAL);
   ...
   public static class MessengerAPI
   {
      ...
      private static final Category Root = apiFactory.createRootCategory("VRWalkThroughDoor");
