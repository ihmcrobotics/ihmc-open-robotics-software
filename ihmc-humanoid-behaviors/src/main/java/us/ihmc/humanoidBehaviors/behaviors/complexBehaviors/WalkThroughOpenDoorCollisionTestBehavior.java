...
import us.ihmc.humanoidBehaviors.behaviors.complexBehaviors.WalkThroughOpenDoorCollisionTestBehavior.WalkThroughDoorBehaviorState;
...
public class WalkThroughOpenDoorCollisionTestBehavior extends StateMachineBehavior<WalkThroughDoorBehaviorState>
{
...
//   private Vector3D32 pullDoorOffsetPoint1 = new Vector3D32(0.45f, 1.2f, 0f);
   ...
   public WalkThroughOpenDoorCollisionTestBehavior(String robotName, String yoNamePrefix, ROS2Node ros2Node, YoDouble yoTime, YoBoolean yoDoubleSupport,
   ...
   {
      super(robotName, "WalkThroughOpenDoorCollisionTestBehavior", WalkThroughDoorBehaviorState.class, yoTime, ros2Node);
      headTrajectoryPublisher = createPublisherForController(HeadTrajectoryMessage.class);
      this.referenceFrames = referenceFrames;
      doorOpenDetectorBehaviorService = new DoorOpenDetectorBehaviorService(robotName, yoNamePrefix + "DoorOpenServiceTEst", ros2Node, yoGraphicsListRegistry);
   ...
   protected WalkThroughDoorBehaviorState configureStateMachineAndReturnInitialKey(StateMachineFactory<WalkThroughDoorBehaviorState, BehaviorAction> factory)
   {
      ...
      BehaviorAction walkThroughDoor = new BehaviorAction(atlasPrimitiveActions.walkToLocationPlannedBehavior)
      {
   ...
   private Pair<FramePose3D, Double> computeDesiredGoalAndHeading(FramePoint3D pointToWalkTo, boolean keepHeadingIfClose)
   {
      ...
      FramePoint3D robotPosition = new FramePoint3D(referenceFrames.getMidFeetUnderPelvisFrame(), 0.0, 0.0, 0.0);
      ...
      double pathToGoalYaw = Math.atan2(walkingDirection.getY(), walkingDirection.getX());
         ...
         com.jme3.math.Quaternion goalOrientation = new com.jme3.math.Quaternion(new float[] {0, 0, (float) pathToGoalYaw});
   ...
   public static class MessengerAPI
   {
      ...
      private static final Category Root = apiFactory.createRootCategory("WalkThroughDoorCollisionTEst");
