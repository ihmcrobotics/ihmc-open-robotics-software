...
public class FollowFiducialBehaviorOld extends AbstractBehavior
{
   ...
   public FollowFiducialBehaviorOld(String robotName, Ros2Node ros2Node, FullHumanoidRobotModel fullRobotModel,
                                 HumanoidReferenceFrames referenceFrames, GoalDetectorBehaviorService goalDetectorBehaviorService)
   {
      super(robotName, FollowFiducialBehaviorOld.class.getSimpleName() + "_" + goalDetectorBehaviorService.getClass().getSimpleName(), ros2Node);
