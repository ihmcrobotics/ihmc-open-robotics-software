...
public class StepprKneeHysterisisCompensationLogProcessor implements LogDataProcessorFunction
{
   ...
   private final SideDependentList<YoDouble> ankleOutsideMotorPositions = new SideDependentList<>();
   private final SideDependentList<YoDouble> ankleOutsideMotorVelocities = new SideDependentList<>();
   private final SideDependentList<YoDouble> qKnees = new SideDependentList<>();

   private final SideDependentList<YoDouble> kneeHysteresisAmounts = new SideDependentList<>();
