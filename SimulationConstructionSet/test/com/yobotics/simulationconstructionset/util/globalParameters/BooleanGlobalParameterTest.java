...
public class BooleanGlobalParameterTest
{
  private final boolean DEFAULT_VALUE = true;
	...
	BooleanGlobalParameter booleanGlobalParameter = new BooleanGlobalParameter("testParameter", "test description", DEFAULT_VALUE, systemOutGlobalParameterChangedListener);
