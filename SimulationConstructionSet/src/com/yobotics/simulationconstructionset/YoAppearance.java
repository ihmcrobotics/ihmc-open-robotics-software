...
public class YoAppearance
{
  ...
  public static Appearance Black() {return RGBColor(0.0f,0.0f,0.0f);}
  public static Appearance White() {return RGBColor(1.0f,1.0f,1.0f);}

  public static Appearance Red() {return RGBColor(1.0f,0.0f,0.0f);}
  public static Appearance DarkRed() {return RGBColor(0.3f,0.0f,0.0f);}
  public static Appearance Blue() {return RGBColor(0.0f,0.0f,1.0f);}
  public static Appearance DarkBlue() {return RGBColor(0.0f,0.0f,0.3f);}
  public static Appearance Green()  {return RGBColor(0.0f,1.0f,0.0f);}
  public static Appearance DarkGreen()  {return RGBColor(0.0f,0.3f,0.0f);}

  public static Appearance Silver()  {return RGBColor(0.75f,0.75f,0.75f);}
  public static Appearance Gray()  {return RGBColor(0.50f,0.50f,0.50f);}
  public static Appearance Maroon()  {return RGBColor(0.50f,0.0f,0.0f);}
  public static Appearance Purple()  {return RGBColor(0.50f,0.0f,0.50f);}
  public static Appearance Fuchsia()  {return RGBColor(1.0f,0.0f,1.0f);}
  public static Appearance Olive()  {return RGBColor(0.50f,0.50f,0.0f);}
  public static Appearance Yellow()  {return RGBColor(1.0f,1.0f,0.0f);}
  public static Appearance Navy()  {return RGBColor(0.0f,0.0f,0.50f);}
  public static Appearance Teal()  {return RGBColor(0.0f,0.50f,0.50f);}
  public static Appearance Aqua()  {return RGBColor(0.0f,1.0f,1.0f);}
