...
public interface FootstepDataRosMessage extends org.ros.internal.message.Message {
  ...
  java.util.List<geometry_msgs.Point> getCustomPositionWaypoints();
  void setCustomPositionWaypoints(java.util.List<geometry_msgs.Point> value);
  ...
  double getTouchdownDuration();
  void setTouchdownDuration(double value);
  long getUniqueId();
