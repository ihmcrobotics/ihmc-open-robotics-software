...
public class TopicDeclaration
{
   ...
   public static TopicDeclaration newFromTopicName(GraphName topicName, TopicDescription topicDescription, TransportHints transportHints)
   {
   ...
   public ConnectionHeader toConnectionHeader()
   {
      ...
      connectionHeader.addField(ConnectionHeaderFields.MESSAGE_DEFINITION, topicDescription.getDefinition());
      connectionHeader.addField(ConnectionHeaderFields.MD5_CHECKSUM, topicDescription.getMd5Checksum());
