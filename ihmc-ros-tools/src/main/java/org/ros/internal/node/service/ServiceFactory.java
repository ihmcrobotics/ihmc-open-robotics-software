...
public class ServiceFactory
{
   ...
   public ServiceFactory(final GraphName nodeName,
                                                      ...
                                                      final MessageFactory messageFactory)
   {
      ...
      synchronized (mutex)
      {
         ...
         {
            serviceServer = new DefaultServiceServer<T, S>(serviceDeclaration,
                                                           responseBuilder,
                                                      ...
                                                      final MessageFactory messageFactory)
   {
      ...
      synchronized (mutex)
      {
         ...
         serviceClient = DefaultServiceClient.newDefault(nodeName, serviceDeclaration, serializer, deserializer, messageFactory, executorService);
