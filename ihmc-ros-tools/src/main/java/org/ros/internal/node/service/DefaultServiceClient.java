...
public class DefaultServiceClient<T, S> implements ServiceClient<T, S>
{
   ...
   private final class HandshakeLatch implements ClientHandshakeListener
   {
      ...
      @Override
      public void onSuccess(final ConnectionHeader outgoingConnectionHeader, final ConnectionHeader incomingConnectionHeader)
      {
         success = true;
         latch.countDown();
      }
                                ...
                                final ScheduledExecutorService executorService)
   {
      ...
      final ServiceClientHandshakeHandler<T, S> serviceClientHandshakeHandler = new ServiceClientHandshakeHandler<T, S>(connectionHeader,
                                                                                                                        responseListeners,
                                                                                                                        deserializer,
                                                                                                                        executorService);
