...
public class MasterClient extends Client<MasterXmlRpcEndpoint>
{
   ...
   public Response<Void> registerService(NodeIdentifier slave, ServiceServer<?, ?> service)
   {
      return Response.fromListChecked(xmlRpcEndpoint.registerService(slave.getName().toString(),
                                                                     ...
                                                                     slave.getUri().toString()), new VoidResultFactory());
   }
   ...
   {
      return Response.fromListChecked(xmlRpcEndpoint.unregisterService(slave.getName().toString(), service.getName().toString(), service.getUri().toString()),
   ...
   public Response<List<URI>> registerSubscriber(NodeIdentifier slave, Subscriber<?> subscriber)
   {
      return Response.fromListChecked(xmlRpcEndpoint.registerSubscriber(slave.getName().toString(),
                                                                        ...
                                                                        slave.getUri().toString()), new UriListResultFactory());
   }
   ...
   public Response<List<URI>> registerPublisher(PublisherDeclaration publisherDeclaration)
   {
      ...
      return Response.fromListChecked(xmlRpcEndpoint.registerPublisher(slaveName, topicName, messageType, slaveUri), new UriListResultFactory());
   }
   ...
   public Response<Integer> unregisterPublisher(PublisherIdentifier publisherIdentifier)
   {
      ...
      return Response.fromListChecked(xmlRpcEndpoint.unregisterPublisher(slaveName, topicName, slaveUri), new IntegerResultFactory());
   }
   ...
   {
      return Response.fromListChecked(xmlRpcEndpoint.lookupNode(slaveName.toString(), nodeName), new UriResultFactory());
   }
   ...
   {
      return Response.fromListChecked(xmlRpcEndpoint.getUri(slaveName.toString()), new UriResultFactory());
   }
   ...
   {
      return Response.fromListCheckedFailure(xmlRpcEndpoint.lookupService(callerName.toString(), serviceName), new UriResultFactory());
   }
   ...
   {
      return Response.fromListChecked(xmlRpcEndpoint.getPublishedTopics(callerName.toString(), subgraph), new TopicListResultFactory());
   }
   ...
   {
      return Response.fromListChecked(xmlRpcEndpoint.getTopicTypes(callerName.toString()), new TopicTypeListResultFactory());
   }
   ...
   {
      return Response.fromListChecked(xmlRpcEndpoint.getSystemState(callerName.toString()), new SystemStateResultFactory());
   }
}
