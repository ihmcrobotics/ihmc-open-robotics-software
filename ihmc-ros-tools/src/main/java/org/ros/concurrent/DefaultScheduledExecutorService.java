...
public class DefaultScheduledExecutorService implements ScheduledExecutorService
{
    ...
    */
   public DefaultScheduledExecutorService(ExecutorService executorService, ScheduledExecutorService scheduledExecutorService)
   {
   ...
   public boolean awaitTermination(long timeout, TimeUnit unit) throws InterruptedException
   {
      ...
      boolean scheduledExecutorServiceResult = scheduledExecutorService.awaitTermination(timeout, unit);
