...
public class jFreePlotUtility extends JFrame
{
    ...
    public void createXYLineChart(double[] xDATA, double[] yDATA, String TITLE, String XLABEL, String YLABEL, int WIDTH, int HEIGHT, boolean ISXAXISLOGARITHMIC, boolean ISYAXISLOGARITHMIC)
    {
    ...
    public void createCombinedChart(double[][] xDATA, double[][] yDATA, String TITLE, String[] XLABEL, String[] YLABEL, int WIDTH, int HEIGHT, boolean ISXAXISLOGARITHMIC, boolean ISYAXISLOGARITHMIC)
    {
