...
public class RobotiqControlThread extends HandControlThread
{
   ...
   public RobotiqControlThread(String robotName, RobotSide robotSide)
   {
      ...
      ROS2Tools.createCallbackSubscriptionTypeNamed(realtimeRos2Node, HandDesiredConfigurationMessage.class, subscriberTopicName,
                                                    handDesiredConfigurationMessageSubscriber);
      ROS2Tools.createCallbackSubscriptionTypeNamed(realtimeRos2Node, ManualHandControlPacket.class, subscriberTopicName, manualHandControlProvider);
