...
public class RobotiqControlThread extends HandControlThread
{
   ...
   public RobotiqControlThread(String robotName, RobotSide robotSide)
   {
      ...
      IHMCRealtimeROS2Publisher<HandJointAnglePacket> handJointAnglePublisher = ROS2Tools.createPublisherWithType(realtimeRos2Node, HandJointAnglePacket.class,
                                                                                                                  publisherTopicNameGenerator);
      jointAngleCommunicator = new HandJointAngleCommunicator(robotSide, handJointAnglePublisher);
      ROS2Tools.createCallbackSubscriptionWithType(realtimeRos2Node, HandDesiredConfigurationMessage.class, subscriberTopicNameGenerator,
                                                   handDesiredConfigurationMessageSubscriber);
      ROS2Tools.createCallbackSubscriptionWithType(realtimeRos2Node, ManualHandControlPacket.class, subscriberTopicNameGenerator, manualHandControlProvider);
