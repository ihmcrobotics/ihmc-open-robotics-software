...
public interface FootstepDataRosMessage extends org.ros.internal.message.Message {
  ...
  java.util.List<geometry_msgs.Vector3> getPositionWaypoints();
  void setPositionWaypoints(java.util.List<geometry_msgs.Vector3> value);
