...
{
   /** L(X_k, U_k) */
   double getCost(E state, DMatrixRMaj controlVector, DMatrixRMaj stateVector, DMatrixRMaj constants);

   /** L_x(X_k, U_k) */
   void getCostStateGradient(E state, DMatrixRMaj controlVector, DMatrixRMaj stateVector, DMatrixRMaj constants, DMatrixRMaj matrixToPack);
   /** L_u(X_k, U_k) */
   void getCostControlGradient(E state, DMatrixRMaj controlVector, DMatrixRMaj stateVector, DMatrixRMaj constants, DMatrixRMaj matrixToPack);
