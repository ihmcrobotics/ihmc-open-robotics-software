...
public class LIPMDynamicsTest
{
   ...
   public void testDynamicsStateGradient()
   {
      ...
      EjmlUnitTests.assertEquals(expectedDynamicsStateGradient, finiteDifferenceExpectedGradient, 1e-5);
   ...
   public void testDynamicsControlGradient()
   {
      ...
      EjmlUnitTests.assertEquals(expectedDynamicsControlGradient, finiteDifferenceExpectedGradient, 1e-5);
   ...
   public void testDynamicsStateHessian()
   {
      ...
      EjmlUnitTests.assertEquals(expectedDynamicsStateHessian, dynamicsStateHessian, 1e-10);
   ...
   public void testDynamicsControlHessian()
   {
      ...
      EjmlUnitTests.assertEquals(expectedDynamicsControlHessian, dynamicsControlHessian, 1e-10);
