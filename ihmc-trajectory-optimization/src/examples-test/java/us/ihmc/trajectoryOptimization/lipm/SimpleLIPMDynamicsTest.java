...
public class SimpleLIPMDynamicsTest
{
   ...
   public void testNextStateComputation()
   {
      ...
      EjmlUnitTests.assertEquals(expectedNextState, nextState, 1e-10);
   ...
   public void testDynamicsStateGradient()
   {
      ...
      EjmlUnitTests.assertEquals(expectedDynamicsStateGradient, dynamicsStateGradient, 1e-10);
   ...
   public void testDynamicsControlGradient()
   {
      ...
      EjmlUnitTests.assertEquals(expectedDynamicsControlGradient, dynamicsControlGradient, 1e-10);
