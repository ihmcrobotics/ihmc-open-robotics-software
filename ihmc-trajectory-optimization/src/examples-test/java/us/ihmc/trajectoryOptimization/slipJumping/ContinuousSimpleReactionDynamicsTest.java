...
public class ContinuousSimpleReactionDynamicsTest
{
   ...
   public void testDynamics()
   {
      ...
      EjmlUnitTests.assertEquals(functionExpected, function, 1e-7);
   ...
   public void testDynamicsStateGradient()
   {
      ...
      EjmlUnitTests.assertEquals(gradientExpected, gradient, 1e-7);
   ...
   public void testStateGradientNumericalDifferentiationStance()
   {
      ...
      EjmlUnitTests.assertEquals(expectedGradient, gradient, 1e-2);
   }
