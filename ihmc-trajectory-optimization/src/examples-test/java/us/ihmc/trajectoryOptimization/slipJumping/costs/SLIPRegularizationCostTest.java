...
import us.ihmc.trajectoryOptimization.CostFunctionTest;
...
public class SLIPRegularizationCostTest extends CostFunctionTest<SLIPState>
{
   ...
   public void testCostStateGradient()
   {
      ...
      DMatrixRMaj gradient = new DMatrixRMaj(stateVectorSize, 1);
      ...
      EjmlUnitTests.assertEquals(expectedGradient, gradient, 1e-7);
   }
   ...
   public void testCostControlGradient()
   {
      ...
      DMatrixRMaj gradient = new DMatrixRMaj(controlVectorSize, 1);
