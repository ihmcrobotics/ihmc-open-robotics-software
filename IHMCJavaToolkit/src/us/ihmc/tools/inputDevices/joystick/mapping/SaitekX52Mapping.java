...
public enum SaitekX52Mapping
{
   ...
   STICK_PITCH_AXIS(Identifier.Axis.Y, Identifier.Axis.Y, Identifier.Axis.Y),
   STICK_ROLL_AXIS(Identifier.Axis.X, Identifier.Axis.X, Identifier.Axis.X),
   STICK_YAW_AXIS(Identifier.Axis.RZ, Identifier.Axis.RZ, Identifier.Axis.RZ),
   THROTTLE_AXIS(Identifier.Axis.Z, Identifier.Axis.Z, Identifier.Axis.Z),
