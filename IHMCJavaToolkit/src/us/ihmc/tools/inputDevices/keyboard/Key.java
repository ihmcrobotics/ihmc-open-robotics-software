...
public enum Key
{
   ...
   public static Key fromKeyCode(int keyCode)
   {
      switch(keyCode)
      {
         case KeyEvent.VK_1: return ONE;
         case KeyEvent.VK_2: return TWO;
         case KeyEvent.VK_3: return THREE;
         case KeyEvent.VK_4: return FOUR;
         case KeyEvent.VK_5: return FIVE;
         case KeyEvent.VK_6: return SIX;
         case KeyEvent.VK_7: return SEVEN;
         case KeyEvent.VK_8: return EIGHT;
         case KeyEvent.VK_9: return NINE;
         case KeyEvent.VK_0: return ZERO;
         case KeyEvent.VK_ADD: return PLUS;
