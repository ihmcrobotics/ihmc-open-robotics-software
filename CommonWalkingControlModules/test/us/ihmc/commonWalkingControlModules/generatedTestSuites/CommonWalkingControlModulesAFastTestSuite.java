...
({
   ...
   us.ihmc.yoUtilities.math.trajectories.CirclePoseTrajectoryGeneratorTest.class,
   us.ihmc.yoUtilities.math.trajectories.CirclePositionTrajectoryGeneratorTest.class,
