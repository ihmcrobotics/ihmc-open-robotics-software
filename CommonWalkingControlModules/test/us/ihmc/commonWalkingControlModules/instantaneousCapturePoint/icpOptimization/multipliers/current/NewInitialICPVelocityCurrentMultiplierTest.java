...
public class NewInitialICPVelocityCurrentMultiplierTest
{
   ...
   public void testCalculationProjectForwardTwoCMPFirstSegment()
   {
      ...
      for (int iter = 0; iter < iters; iter++)
      {
         ...
         Assert.assertEquals(1.0 - projection, initialICPVelocityCurrentMultiplier.getPositionMultiplier(), epsilon);

         Assert.assertEquals(- omega * projection, initialICPVelocityCurrentMultiplier.getVelocityMultiplier(), epsilon);
      }
   }
   ...
   public void testCalculationRecurseBackwardTwoCMPFirstSegment()
   {
      ...
      for (int iter = 0; iter < iters; iter++)
      {
         ...
         Assert.assertEquals("iter = " + iter, 1.0 - projection, initialICPVelocityCurrentMultiplier.getPositionMultiplier(), epsilon);
         Assert.assertEquals("iter = " + iter, -omega * projection, initialICPVelocityCurrentMultiplier.getVelocityMultiplier(), epsilon);
      }
   }
