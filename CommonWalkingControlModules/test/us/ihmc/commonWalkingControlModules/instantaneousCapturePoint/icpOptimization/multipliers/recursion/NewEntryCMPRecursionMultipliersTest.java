...
public class NewEntryCMPRecursionMultipliersTest
{
   ...
   public void testConsiderOneStepOneRegisteredTwoCMPCalculation()
   {
      ...
      NewEntryCMPRecursionMultipliers entryCMPRecursionMultipliers = new NewEntryCMPRecursionMultipliers("", maxSteps, swingSplitFractions, transferSplitFractions,
            registry);
      NewRecursionMultipliers recursionMultipliers = new NewRecursionMultipliers("other", maxSteps, swingSplitFractions, transferSplitFractions, registry);
   ...
   public void testConsiderOneStepTwoRegisteredTwoCMPCalculation()
   {
      ...
      NewEntryCMPRecursionMultipliers entryCMPRecursionMultipliers = new NewEntryCMPRecursionMultipliers("", maxSteps, swingSplitFractions, transferSplitFractions, registry);
