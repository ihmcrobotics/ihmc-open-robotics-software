...
import us.ihmc.commonWalkingControlModules.instantaneousCapturePoint.icpOptimization.multipliers.stateMatrices.transfer.NewTransferExitCMPMatrix;
...
public class NewExitCMPCurrentMultiplierTest
{
   ...
   public void testCalculationTwoCMPTransfer()
   {
      ...
      NewExitCMPCurrentMultiplier exitCMPCurrentMultiplier = new NewExitCMPCurrentMultiplier(swingSplitFractions, transferSplitFractions, startOfSplineTime,
            endOfSplineTime, "", true, registry);

      NewTransferExitCMPMatrix exitCMPMatrix = new NewTransferExitCMPMatrix(swingSplitFractions, transferSplitFractions);
   ...
   public void testCalculationOneCMPTransfer()
   {
      ...
      NewExitCMPCurrentMultiplier exitCMPCurrentMultiplier = new NewExitCMPCurrentMultiplier(swingSplitFractions, transferSplitFractions, startOfSplineTime, endOfSplineTime, "",true,  registry);
   ...
   public void testCalculationTwoCMPFirstSegment()
   {
      ...
      NewExitCMPCurrentMultiplier exitCMPCurrentMultiplier = new NewExitCMPCurrentMultiplier(swingSplitFractions, doubleSupportDurations, startOfSplineTime, endOfSplineTime, "", true, registry);
   ...
   public void testCalculationTwoCMPSecondSegment()
   {
      ...
      NewSwingExitCMPMatrix exitCMPMatrix = new NewSwingExitCMPMatrix(swingSplitFractions, transferSplitFractions, endOfSplineTime);
      CubicMatrix cubicMatrix = new CubicMatrix();
      CubicDerivativeMatrix cubicDerivativeMatrix = new CubicDerivativeMatrix();
      DenseMatrix64F positionMatrixOut = new DenseMatrix64F(1, 1);
      DenseMatrix64F velocityMatrixOut = new DenseMatrix64F(1, 1);
