...
public class NewSwingStateEndMatrixTest
{
   ...
   public void testCreationSize()
   {
      ...
      NewSwingStateEndMatrix swingStateEndMatrix = new NewSwingStateEndMatrix(swingSplitFractions, transferSplitFractions, startOfSplineTime);
   ...
   public void testCalculation()
   {
      ...
      NewSwingStateEndMatrix swingStateEndMatrix = new NewSwingStateEndMatrix(swingSplitFractions, transferSplitFractions, endOfSplineTime);
