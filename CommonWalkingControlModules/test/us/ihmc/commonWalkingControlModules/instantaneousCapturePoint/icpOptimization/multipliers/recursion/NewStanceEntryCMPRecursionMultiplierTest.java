...
public class NewStanceEntryCMPRecursionMultiplierTest
{
   ...
   public void testOneStepCalculation()
   {
      ...
      NewStanceEntryCMPRecursionMultiplier entryCMPRecursionMultiplier = new NewStanceEntryCMPRecursionMultiplier("", exitCMPRatio, registry);
      ...
      for (int iter = 0; iter < iters; iter++)
      {
         ...
         Assert.assertEquals(exitCMPMultiplier, entryCMPRecursionMultiplier.getEntryMultiplier(), epsilon);

         // setup for in transfer
         isInTransfer = true;
         entryCMPRecursionMultiplier.compute(1, doubleSupportDurations, singleSupportDurations, useTwoCMPs, isInTransfer, omega);

         exitCMPMultiplier = (1.0 - Math.exp(-omega * currentTimeSpentOnEntryCMP));
         Assert.assertEquals(exitCMPMultiplier, entryCMPRecursionMultiplier.getEntryMultiplier(), epsilon);
      }
   }
