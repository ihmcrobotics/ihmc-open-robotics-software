...
public class NewSwingExitCMPMatrixTest
{
   ...
   public void testCreationSize()
   {
      ...
      NewSwingExitCMPMatrix swingExitCMPMatrix = new NewSwingExitCMPMatrix(swingSplitFractions, transferSplitFractions, startOfSplineTime);
   ...
   public void testCalculation()
   {
      ...
      NewSwingExitCMPMatrix swingExitCMPMatrix = new NewSwingExitCMPMatrix(swingSplitFractions, transferSplitFractions, endOfSplineTime);
