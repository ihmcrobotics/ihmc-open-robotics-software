...
public class NewStateEndCurrentMultiplierTest
{
   ...
   public void testCalculationTwoCMPTransfer()
   {
      ...
      NewStateEndCurrentMultiplier stateEndCurrentMultiplier = new NewStateEndCurrentMultiplier(swingSplitFractions, transferSplitFractions,
      ...
      for (int iter = 0; iter < iters; iter++)
      {
         ...
         stateEndCurrentMultiplier.compute(1, doubleSupportDurations, singleSupportDurations, timeInCurrentState, useTwoCMPs, isInTransfer, omega);
   ...
   public void testCalculationOneCMPTransfer()
   {
      ...
      NewStateEndCurrentMultiplier stateEndCurrentMultiplier = new NewStateEndCurrentMultiplier(swingSplitFractions, transferSplitFractions, startOfSplineTime,
   ...
   public void testCalculationTwoCMPSecondSegment()
   {
      ...
      NewSwingStateEndMatrix stateEndMatrix = new NewSwingStateEndMatrix(swingSplitFractions, transferSplitFractions, endOfSplineTime);
      CubicMatrix cubicMatrix = new CubicMatrix();
      CubicDerivativeMatrix cubicDerivativeMatrix = new CubicDerivativeMatrix();
      DenseMatrix64F positionMatrixOut = new DenseMatrix64F(1, 1);
      DenseMatrix64F velocityMatrixOut = new DenseMatrix64F(1, 1);
   ...
   public void testCalculationOneCMPSwing()
   {
      ...
      for (int iter = 0; iter < iters; iter++)
      {
         ...
         stateEndCurrentMultiplier.compute(1, doubleSupportDurations, singleSupportDurations, timeInCurrentState, false, isInTransfer, omega);
