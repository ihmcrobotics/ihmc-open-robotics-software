...
public class NewStateEndCurrentMultiplierTest
{
   ...
   public void testCalculationTwoCMPTransfer()
   {
      ...
      for (int iter = 0; iter < iters; iter++)
      {
         ...
         stateEndMatrix.compute(singleSupportDurations, doubleSupportDurations, useTwoCMPs, omega);
   ...
   public void testCalculationOneCMPTransfer()
   {
      ...
      for (int iter = 0; iter < iters; iter++)
      {
         ...
         stateEndMatrix.compute(singleSupportDurations, doubleSupportDurations, false, omega);
