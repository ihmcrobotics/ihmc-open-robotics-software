...
public class NewTransferStateEndMatrixTest
{
   ...
   public void testCreationSize()
   {
      ...
      NewTransferStateEndMatrix stateEndMatrix = new NewTransferStateEndMatrix(swingSplitFractions, transferSplitFractions);
   ...
   public void testCalculation()
   {
      ...
      for (int i = 0; i < iters; i++)
      {
         ...
         stateEndMatrix.compute(singleSupportDurations, doubleSupportDurations, useTwoCMPs, omega0);
