...
public class NewExitCMPRecursionMultipliersTest
{
   ...
   public void testConsiderOneStepOneRegisteredTwoCMPCalculation()
   {
      ...
      NewExitCMPRecursionMultipliers exitCMPRecursionMultipliers = new NewExitCMPRecursionMultipliers("", maxSteps, swingSplitFractions, transferSplitFractions, registry);
      NewRecursionMultipliers recursionMultipliers = new NewRecursionMultipliers("", maxSteps, swingSplitFractions, transferSplitFractions, registry);
