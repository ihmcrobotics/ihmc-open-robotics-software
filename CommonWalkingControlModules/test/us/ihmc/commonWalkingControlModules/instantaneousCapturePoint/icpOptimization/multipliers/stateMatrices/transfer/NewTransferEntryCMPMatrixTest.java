...
public class NewTransferEntryCMPMatrixTest
{
   ...
   public void testCreationSize()
   {
      ...
      NewTransferEntryCMPMatrix transferEntryCMPMatrix = new NewTransferEntryCMPMatrix(doubleYoVariable);
   ...
   public void testCalculation()
   {
      ...
      NewTransferEntryCMPMatrix transferEntryCMPMatrix = new NewTransferEntryCMPMatrix(doubleSupportSplitRatio);
