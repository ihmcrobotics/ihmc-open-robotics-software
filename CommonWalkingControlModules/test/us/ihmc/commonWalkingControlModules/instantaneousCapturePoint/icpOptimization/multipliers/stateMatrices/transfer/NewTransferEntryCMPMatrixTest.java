...
public class NewTransferEntryCMPMatrixTest
{
   ...
   public void testCreationSize()
   {
      ...
      NewTransferEntryCMPMatrix transferEntryCMPMatrix = new NewTransferEntryCMPMatrix(swingSplitFractions, transferSplitFractions);
