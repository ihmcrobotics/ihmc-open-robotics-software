...
public class NewEntryCMPCurrentMultiplierTest
{
   ...
   public void testCalculationTwoCMPTransfer()
   {
      ...
      NewEntryCMPCurrentMultiplier entryCMPCurrentMultiplier = new NewEntryCMPCurrentMultiplier(swingSplitFractions, transferSplitFractions, startOfSplineTime, endOfSplineTime,
            totalTrajectoryTime, "", true, registry);

      NewTransferEntryCMPMatrix entryCMPMatrix = new NewTransferEntryCMPMatrix(swingSplitFractions, transferSplitFractions);
