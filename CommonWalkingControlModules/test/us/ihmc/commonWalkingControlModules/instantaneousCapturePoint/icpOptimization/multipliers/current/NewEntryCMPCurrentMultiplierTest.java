...
import us.ihmc.commonWalkingControlModules.instantaneousCapturePoint.icpOptimization.multipliers.recursion.NewEntryCMPRecursionMultiplier;
...
public class NewEntryCMPCurrentMultiplierTest
{
   ...
   public void testCalculationTwoCMPTransfer()
   {
      ...
      NewEntryCMPCurrentMultiplier entryCMPCurrentMultiplier = new NewEntryCMPCurrentMultiplier(defaultSplitRatio, exitCMPRatio, startOfSplineTime, endOfSplineTime,
            totalTrajectoryTime, projectCMPForward, registry);

      NewTransferEntryCMPMatrix entryCMPMatrix = new NewTransferEntryCMPMatrix(defaultSplitRatio);
      ...
      for (int iter = 0; iter < iters; iter++)
      {
         ...
         entryCMPMatrix.compute(doubleSupportDurations, useTwoCMPs, omega);
