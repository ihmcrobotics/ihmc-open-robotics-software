...
public class ThreePointDoubleSplines1DTest
{
   ...
   public void testCompareOutOfOrderSplineWithNormalOne()
   {
      ...
      packSpline(spline2, xAtTwo, xAtThree, xAtOne, heightAtTwo, heightAtThree, heightAtOne, slopeAtTwo, slopeAtThree, slopeAtOne, secondDerivativeAtTwo,
            secondDerivativeAtThree, secondDerivativeAtOne);
