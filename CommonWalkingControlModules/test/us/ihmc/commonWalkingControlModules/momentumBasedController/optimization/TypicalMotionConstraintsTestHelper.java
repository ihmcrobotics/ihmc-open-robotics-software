...
public class TypicalMotionConstraintsTestHelper
{
   ...
   public TypicalMotionConstraintsTestHelper(double[][] JPrimaryMotionConstraintsData, double[][] pPrimaryMotionConstraintsData,
                                      double[][] centroidalMomentumAMatrixData, double[][] momentumDotEquationRightHandSideData,
                                      double[][] momentumSubspaceData)
   {
...
//      System.out.println("matrixW for centroidalMomentumAMatrix = " + matrixW);
      ...
      DenseMatrix64F momentumDotEquationRightHandSideSelected = new DenseMatrix64F(momentumSubspaceSelector.getNumRows(), momentumDotEquationRightHandSide.getNumCols());
      ...
      CommonOps.extract(JPrimaryMotionConstraints, 0, JPrimaryMotionConstraints.getNumRows(), 0, JPrimaryMotionConstraints.getNumCols(), combinedConstraintsAndDesiredMomentum, 0, 0);
