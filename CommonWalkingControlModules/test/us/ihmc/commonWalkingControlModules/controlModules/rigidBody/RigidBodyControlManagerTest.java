...
public class RigidBodyControlManagerTest
{
   ...
   private void setGainsAndWeights(RigidBodyControlManager manager)
   {
      ...
      YoPID3DGains taskspaceOrientationGains = new YoSymmetricSE3PIDGains("OrientationGains", testRegistry);
      YoPID3DGains taskspacePositionGains = new YoSymmetricSE3PIDGains("PositionGains", testRegistry);
