...
public class DynamicReachabilityCalculator
{
   ...
   public DynamicReachabilityCalculator(ICPPlanner icpPlanner, AbstractICPOptimizationController icpOptimizationController, FullHumanoidRobotModel fullRobotModel,
