...
public class TransferToAndNextFootstepsData
{
   ...
   public void getFootLocationList(ArrayList<FramePoint> footLocationListToPack, ArrayList<ReferenceFrame> soleFrameListToPack,
         double centimetersForwardFromCenter, double centimetersInFromCenter)
   {
      if (transferFromFootstep != null)
      {
         getFootLocationFromFootstepInWorldFramePlusSoleframe(footLocationListToPack, soleFrameListToPack, transferFromFootstep,
               transferToSide.getOppositeSide(), centimetersForwardFromCenter, centimetersInFromCenter);
      }
      else
         return;
      ...
      {
         getFootLocationFromFootstepInWorldFramePlusSoleframe(footLocationListToPack, soleFrameListToPack, transferToFootstep, transferToSide,
               centimetersForwardFromCenter, centimetersInFromCenter);
      }
      else
         return;
      ...
      {
         getFootLocationFromFootstepInWorldFramePlusSoleframe(footLocationListToPack, soleFrameListToPack, nextFootstep, transferToSide.getOppositeSide(),
               centimetersForwardFromCenter, centimetersInFromCenter);
      }
      else
         return;
      ...
      {
         getFootLocationFromFootstepInWorldFramePlusSoleframe(footLocationListToPack, soleFrameListToPack, nextNextFootstep, transferToSide,
               centimetersForwardFromCenter, centimetersInFromCenter);
      }
      else
         return;
   ...
   {
      FramePoint centerOfFootstep = FootstepUtils.getCenterOfPredictedContactPointsInFootstep(footstep, side, centimetersForwardFromCenter,
            centimetersInFromCenter);
