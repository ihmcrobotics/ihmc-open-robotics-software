...
public class BlindWalkingToDestinationDesiredFootstepCalculator extends AbstractAdjustableDesiredFootstepCalculator
{
   ...
   public void initializeDesiredFootstep(RobotSide supportLegSide)
   {
      ...
      FramePoint footstepPosition = getDesiredFootstepPositionCopy(supportAnkleZUpFrame, supportAnkleFrame, swingLegSide,
            desiredDestination.getFramePoint2dCopy(), footToWorldRotation);
   ...
   public Footstep predictFootstepAfterDesiredFootstep(RobotSide supportLegSide, Footstep desiredFootstep)
   {
      ...
      FramePoint footstepPosition = getDesiredFootstepPositionCopy(futureSupportAnkleZUpFrame, futureSupportAnkleFrame, futureSwingLegSide,
            desiredDestination.getFramePoint2dCopy(), footToWorldRotation);
   ...
   private FramePoint getDesiredFootstepPositionCopy(ReferenceFrame supportAnkleZUpFrame, ReferenceFrame supportAnkleFrame, RobotSide swingLegSide,
         FramePoint2d desiredDestination, Matrix3d footToWorldRotation)
   {
