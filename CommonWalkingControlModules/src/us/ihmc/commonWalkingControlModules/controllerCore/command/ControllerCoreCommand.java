...
public class ControllerCoreCommand implements ControllerCoreCommandInterface
{
   ...
   /**
    * Adds a feedback controller command.
    * Using this utilizes the controllers found in the inverse dynamics and virtual model control modules.
    * This command type is not considered by the inverse kinematics controller core.
   ...
   /**
    * Adds low level joint data to the existing low level joint data holder.
    * These inputs overwrite whatever comes out of the controller core.
    * That is, if you want to guarantee a certain joint output, bypassing the optimization process, submit that data here.
    ...
    * @param controllerCoreMode Desired controller core mode. Choose from Inverse Dynamics, Inverse Kinematics, and Virtual Model Control.
    */
   ...
   /**
    * @return the inverse dynamics command list to be considered by the inverse dynamics controller core.
    */
   @Override
   ...
   /**
    * @return the feedback control command list to be considered by the inverse dynamics controller core or the whole body controller core..
    */
   @Override
   ...
   /**
    * @return the inverse dynamics command list to be considered by the inverse kinematics controller core.
    */
   @Override
   ...
   /**
    * Contains the low level data that overwrites the whole body controller core output.
    * Guarantees certain joint data at the output.
