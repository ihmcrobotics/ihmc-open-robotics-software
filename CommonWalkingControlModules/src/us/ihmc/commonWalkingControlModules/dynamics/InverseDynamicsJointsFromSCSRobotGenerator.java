...
{   
   ...
   private RigidBody getParentIDBody(Joint polledJoint, RigidBody elevator)
   {
      ...
      {
         SixDoFJoint parentSixDoFJoint = floatingToSixDofToJointMap.get(parentJoint);
         return parentSixDoFJoint.getSuccessor();
      }
      else if (parentJoint instanceof PinJoint)
      {
         RevoluteJoint parentRevoluteJoint = pinToRevoluteJointMap.get(parentJoint);
   ...
   public void updateInverseDynamicsRobotModelFromRobot()
   {
