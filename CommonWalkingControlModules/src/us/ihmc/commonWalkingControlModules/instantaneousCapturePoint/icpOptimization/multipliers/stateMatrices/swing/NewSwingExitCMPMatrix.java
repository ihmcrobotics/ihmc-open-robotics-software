...
public class NewSwingExitCMPMatrix extends DenseMatrix64F
{
   ...
   public NewSwingExitCMPMatrix(DoubleYoVariable upcomingDoubleSupportSplitRatio, DoubleYoVariable exitCMPRatio, DoubleYoVariable endOfSplineTime)
   {
      super(4, 1);
