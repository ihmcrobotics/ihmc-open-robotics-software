...
public class NewEntryCMPRecursionMultipliers
{
   ...
   public NewEntryCMPRecursionMultipliers(String namePrefix, int maximumNumberOfFootstepsToConsider, List<DoubleYoVariable> swingSplitFractions,
