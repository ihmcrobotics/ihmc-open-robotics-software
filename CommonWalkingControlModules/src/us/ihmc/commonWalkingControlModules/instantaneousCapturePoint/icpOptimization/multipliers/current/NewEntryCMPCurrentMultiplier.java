...
public class NewEntryCMPCurrentMultiplier
{
   ...
   public NewEntryCMPCurrentMultiplier(List<DoubleYoVariable> swingSplitFractions, List<DoubleYoVariable> transferSplitFractions, DoubleYoVariable startOfSplineTime, DoubleYoVariable endOfSplineTime,
         ...
         YoVariableRegistry registry)
   {
      ...
      transferEntryCMPMatrix = new NewTransferEntryCMPMatrix(swingSplitFractions, transferSplitFractions);
   ...
   {
      transferEntryCMPMatrix.compute(singleSupportDurations, doubleSupportDurations, useTwoCMPs, omega0);
