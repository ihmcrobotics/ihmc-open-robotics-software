...
public class NewStateEndCurrentMultiplier
{
   ...
   public NewStateEndCurrentMultiplier(List<DoubleYoVariable> swingSplitFractions, List<DoubleYoVariable> transferSplitFractions,
         ...
         String yoNamePrefix, boolean clipTime, YoVariableRegistry registry)
   {
      ...
      transferStateEndMatrix = new NewTransferStateEndMatrix(swingSplitFractions, transferSplitFractions);
      swingStateEndMatrix = new NewSwingStateEndMatrix(swingSplitFractions, transferSplitFractions, endOfSplineTime);
   }
         ...
         boolean useTwoCMPs, boolean isInTransfer, double omega0)
   {
      ...
      if (isInTransfer)
      {
         positionMultiplier = computeInTransfer(singleSupportDurations, doubleSupportDurations, omega0, useTwoCMPs, timeInState);
      }
      else
      {
         if (useTwoCMPs)
   ...
   {
      transferStateEndMatrix.compute(singleSupportDurations, doubleSupportDurations, useTwoCMPs, omega0);
