...
public class NewRecursionMultipliers
{
   ...
   public NewRecursionMultipliers(String namePrefix, int maximumNumberOfFootstepsToConsider, List<DoubleYoVariable> swingSplitFractions,
         ...
         List<DoubleYoVariable> doubleSupportDurations, List<DoubleYoVariable> singleSupportDurations, double omega0)
   {
      ...
      for (int i = 1; i < numberOfStepsToConsider + 1; i++)
      {
         ...
         double entryRecursion = NewEntryCMPRecursionMultipliers.computeEntryRecursionMultiplierOneCMP(recursionTime, timeOnCMP, omega0);
         double exitRecursion = NewExitCMPRecursionMultipliers.computeExitRecursionMultiplierOneCMP();
      ...
      double finalICPRecursion = NewFinalICPRecursionMultiplier.computeFinalICPRecursionMultiplier(recursionTime, omega0);
         ...
         List<DoubleYoVariable> doubleSupportDurations, List<DoubleYoVariable> singleSupportDurations, double omega0)
   {
      ...
      for (int i = 1; i < numberOfStepsToConsider + 1; i++)
      {
         ...
         double entryRecursion = NewEntryCMPRecursionMultipliers.computeEntryRecursionMultiplierTwoCMPs(recursionTime, timeSpentOnEntryCMP, omega0);
         double exitRecursion = NewExitCMPRecursionMultipliers.computeExitRecursionMultiplierTwoCMPs(recursionTime, timeSpentOnEntryCMP, timeSpentOnExitCMP, omega0);
