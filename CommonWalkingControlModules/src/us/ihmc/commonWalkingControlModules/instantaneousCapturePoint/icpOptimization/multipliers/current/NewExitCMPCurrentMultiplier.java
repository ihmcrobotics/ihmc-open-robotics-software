...
public class NewExitCMPCurrentMultiplier
{
   ...
   private final NewTransferExitCMPMatrix transferExitCMPMatrix;
   ...
   public NewExitCMPCurrentMultiplier( List<DoubleYoVariable> swingSplitFractions, List<DoubleYoVariable> transferSplitFractions,
         ...
         CubicDerivativeMatrix cubicDerivativeMatrix, String yoNamePrefix, boolean clipTime, YoVariableRegistry registry)
   {
      ...
      transferExitCMPMatrix = new NewTransferExitCMPMatrix(swingSplitFractions, transferSplitFractions);
      swingExitCMPMatrix = new NewSwingExitCMPMatrix(swingSplitFractions, transferSplitFractions, endOfSplineTime);
   }
         ...
         double timeInState, boolean useTwoCMPs, boolean isInTransfer, double omega0)
   {
      ...
      if (isInTransfer)
      {
         positionMultiplier = computeInTransfer(singleSupportDurations, doubleSupportDurations, timeInState, useTwoCMPs, omega0);
      }
      else
      {
         if (useTwoCMPs)
   ...
   private double computeInTransfer(List<DoubleYoVariable> singleSupportDurations, List<DoubleYoVariable> doubleSupportDurations,
         double timeInState, boolean useTwoCMPs, double omega0)
   {
      transferExitCMPMatrix.compute(singleSupportDurations, doubleSupportDurations, useTwoCMPs, omega0);
