...
public class NewSwingStateEndMatrix extends DenseMatrix64F
{
   private final DoubleYoVariable upcomingDoubleSupportSplitRatio;
   private final DoubleYoVariable exitCMPRatio;
   private final DoubleYoVariable endOfSplineTime;

   public NewSwingStateEndMatrix(DoubleYoVariable upcomingDoubleSupportSplitRatio, DoubleYoVariable exitCMPRatio, DoubleYoVariable endOfSplineTime)
   {
      super(4, 1);
