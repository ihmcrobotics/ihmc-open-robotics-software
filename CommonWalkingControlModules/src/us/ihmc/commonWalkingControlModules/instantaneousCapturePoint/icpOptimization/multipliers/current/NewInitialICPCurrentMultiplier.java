...
public class NewInitialICPCurrentMultiplier
{
   ...
   public NewInitialICPCurrentMultiplier(DoubleYoVariable startOfSplineTime, DoubleYoVariable endOfSplineTime, String yoNamePrefix, YoVariableRegistry registry)
   {
      this(startOfSplineTime, endOfSplineTime, null, null, yoNamePrefix, registry);
   }

   public NewInitialICPCurrentMultiplier(DoubleYoVariable startOfSplineTime, DoubleYoVariable endOfSplineTime, CubicMatrix cubicMatrix,
