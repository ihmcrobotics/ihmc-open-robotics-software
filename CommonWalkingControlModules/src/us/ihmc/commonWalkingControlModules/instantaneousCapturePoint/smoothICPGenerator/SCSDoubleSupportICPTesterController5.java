...
public class SCSDoubleSupportICPTesterController5 implements RobotController
{
   ...
   private final YoFramePoint initialDoubleSupportICPposFramePoint = new YoFramePoint("initialDoubleSupportICPposFramePoint", "", ReferenceFrame.getWorldFrame(), registry);
   private final YoFramePoint finalDoubleSupportICPposFramePoint = new YoFramePoint("finalDoubleSupportICPposFramePoint", "", ReferenceFrame.getWorldFrame(), registry);
         ...
         double singleSupportTimeExt, double doubleSupportTimeExt, double initialTransferSupportTimeExt, Robot testRobot)
   {
      ...
      equivalentCoPAndICPPlotter.addPointListToDynamicGraphicsObjectsListRegistry(dynamicGraphicObjectsListRegistry, "currentFoot", consideredFootStepLocationsFramePoints, YoAppearance.Black(), 0.01);
      
      equivalentCoPAndICPPlotter.addPointListToDynamicGraphicsObjectsListRegistry(dynamicGraphicObjectsListRegistry, "equivalentConstCoP", equivalentConstantCoPsFramePoints, YoAppearance.Red(), 0.005);

      equivalentCoPAndICPPlotter.addPointListToDynamicGraphicsObjectsListRegistry(dynamicGraphicObjectsListRegistry, "initialICP", initialICPsFramePoints, YoAppearance.Green(), 0.01);
      
      
      equivalentCoPAndICPPlotter.addSinglePointToDynamicGraphicsObjectsListRegistry(dynamicGraphicObjectsListRegistry, "initialDoubleSupportICPpos", initialDoubleSupportICPposFramePoint, YoAppearance.Cyan(), 0.01); 

      equivalentCoPAndICPPlotter.addSinglePointToDynamicGraphicsObjectsListRegistry(dynamicGraphicObjectsListRegistry, "finalDoubleSupportICPpos", finalDoubleSupportICPposFramePoint, YoAppearance.Cyan(), 0.01); 
 
      equivalentCoPAndICPPlotter.addSinglePointToDynamicGraphicsObjectsListRegistry(dynamicGraphicObjectsListRegistry, "desiredDCMposOfTime", desiredDCMposOfTimeFramePoint, YoAppearance.OrangeRed(), 0.01); 


      
      equivalentCoPAndICPPlotter.addSinglePointToDynamicGraphicsObjectsListRegistry(dynamicGraphicObjectsListRegistry, "comPosition", comPositionFramePoint, YoAppearance.Blue(), 0.015); 
      
      equivalentCoPAndICPPlotter.addSinglePointToDynamicGraphicsObjectsListRegistry(dynamicGraphicObjectsListRegistry, "desiredECMPofTime", desiredECMPofTimeFramePoint, YoAppearance.Magenta(), 0.011); 
      
      equivalentCoPAndICPPlotter.addLineListToDynamicGraphicsObjectsListRegistry(dynamicGraphicObjectsListRegistry, "icpLines", listOfICPLineSegments, Color.orange); 
      
      equivalentCoPAndICPPlotter.addSingleLineToDynamicGraphicsObjectsListRegistry(dynamicGraphicObjectsListRegistry, "icpVelocityLine", icpVelocityLine, Color.gray); 
      
      equivalentCoPAndICPPlotter.addSingleLineToDynamicGraphicsObjectsListRegistry(dynamicGraphicObjectsListRegistry, "comVelocityLine", comVelocityLine, Color.blue); 
...
//      supportState
      ...
      { 
         dsICPcomputer.updateSubFootListForSmoothICPTrajectory(equivalentConstantCoPsVectors, footStepLocationsFramePoints, equivalentConstantCoPsFramePoints, consideredFootStepLocationsFramePoints, numberOfConsideredFootstepLocations, equivalentConstantCoPsVectors);
      ...
      {
      dsICPcomputer.computeDoubleSupportpolynomialParams(equivalentConstantCoPsVectors, dcmConst, steppingTime, doubleSupportFirstStepFraction, initialICPsVectors, 
            supportState.getIsFirstStep(), supportState.getInitialTransferSupportTime(), supportState.getDoubleSupportTime());
      }
      
      
      dsICPcomputer.calcDCMandECMPofTime(equivalentConstantCoPsVectors, doubleSupportFirstStepFraction, dcmConst, initialICPsVectors, supportState.getIsFirstStep(), supportState.getInitialTransferSupportTime(), 
            supportState.getDoubleSupportTime(), supportState.getIsSingleSupport(), supportState.getCurrentTime(), supportState.getSteppingTime()); 
      ...
      for (int i = 0; i < numberOfConsideredFootstepLocations; i++)
      {
         equivalentConstantCoPsFramePoints.get(i).set(equivalentConstantCoPsVectors.get(i).get(0), equivalentConstantCoPsVectors.get(i).get(1), equivalentConstantCoPsVectors.get(i).get(2));
      }
      ...
      initialDoubleSupportICPposFramePoint.set(dsICPcomputer.getInitialDoubleSupportICPpos().get(0), dsICPcomputer.getInitialDoubleSupportICPpos().get(1), dsICPcomputer.getInitialDoubleSupportICPpos().get(2));
      
      finalDoubleSupportICPposFramePoint.set(dsICPcomputer.getFinalDoubleSupportICPpos().get(0), dsICPcomputer.getFinalDoubleSupportICPpos().get(1), dsICPcomputer.getFinalDoubleSupportICPpos().get(2));
      

      desiredDCMposOfTimeFramePoint.set(dsICPcomputer.getDesiredDCMposOfTime().get(0), dsICPcomputer.getDesiredDCMposOfTime().get(1), dsICPcomputer.getDesiredDCMposOfTime().get(2));
      desiredDCMvelOfTimeFrameVector.set(dsICPcomputer.getDesiredDCMvelOfTime().get(0), dsICPcomputer.getDesiredDCMvelOfTime().get(1), dsICPcomputer.getDesiredDCMvelOfTime().get(2));
      desiredECMPofTimeFramePoint.set(dsICPcomputer.getDesiredECMPofTime().get(0), dsICPcomputer.getDesiredECMPofTime().get(1), dsICPcomputer.getDesiredECMPofTime().get(2));
      ...
      JojosICPutilities.discreteIntegrateCoMAndGetCoMVelocity(simDT.getDoubleValue(), dcmConst, dsICPcomputer.getDesiredDCMposOfTime(), comPositionVector, comVelocityVector); 
      ...
      FramePoint2d ls1p1 = new FramePoint2d(ReferenceFrame.getWorldFrame(), equivalentConstantCoPsFramePoints.get(0).getX(), equivalentConstantCoPsFramePoints.get(0).getY());
      ...
      FramePoint2d ls2p1 = new FramePoint2d(ReferenceFrame.getWorldFrame(), equivalentConstantCoPsFramePoints.get(1).getX(), equivalentConstantCoPsFramePoints.get(1).getY());
      ...
      FramePoint2d ls3p1 = new FramePoint2d(ReferenceFrame.getWorldFrame(), equivalentConstantCoPsFramePoints.get(2).getX(), equivalentConstantCoPsFramePoints.get(2).getY());
      FramePoint2d ls3p2 = new FramePoint2d(ReferenceFrame.getWorldFrame(), equivalentConstantCoPsFramePoints.get(3).getX(), equivalentConstantCoPsFramePoints.get(3).getY());  
      ...
      FramePoint2d velPointerStart = new FramePoint2d(ReferenceFrame.getWorldFrame(), desiredDCMposOfTimeFramePoint.getX(), desiredDCMposOfTimeFramePoint.getY());
      FramePoint2d velPointerEnd = new FramePoint2d(ReferenceFrame.getWorldFrame(), desiredDCMposOfTimeFramePoint.getX() + desiredDCMvelOfTimeFrameVector.getX(), desiredDCMposOfTimeFramePoint.getY()
            + desiredDCMvelOfTimeFrameVector.getY());
      ...
      FramePoint2d comVelPointerEnd = new FramePoint2d(ReferenceFrame.getWorldFrame(), comPositionFramePoint.getX() + comVelocityFrameVector.getX(), comPositionFramePoint.getY()
            + comVelocityFrameVector.getY());
