...
public class JojosICPutilities
{
   ...
   public static Point3d extrapolateDCMPosWithTransferRatio(Point3d constantCenterOfPressure, double time, double omega0, Point3d initialICP,
   ...
   public static void extrapolateDCMposAndVel(Point3d icpPositionToPack, Vector3d icpVelocityToPack, Point3d constantCenterOfPressure, double time,
         double omega0, Point3d initialICP)
   {
      double exponentialTerm = Math.exp(time * omega0);
      Vector3d tempVect = new Vector3d(initialICP);
      tempVect.sub(constantCenterOfPressure);
