...
public class NewDoubleSupportICPComputer
{
           ...
           boolean isInitialTransfer, double omega0, double toeToFootCenterShiftDuration, double footCenterToToeShiftDuration)
   {
      ...
      Point3d icpToeCornerPoint = JojosICPutilities.extrapolateDCMpos(constantToeCentersOfPressureToModify.get(numberOfCornerPoints - 1).getPoint3dCopy(),
                                     -toeToFootCenterShiftDuration, omega0,
                                     constantFootCenterCentersOfPressureToModify.get(numberOfCornerPoints).getPoint3dCopy());

      toeCornerPointsToModify.get(numberOfCornerPoints - 1).set(icpToeCornerPoint);

      Point3d icpFootCenterCornerPoint = JojosICPutilities.extrapolateDCMpos(constantFootCenterCentersOfPressureToModify.get(numberOfCornerPoints
                                            - 1).getPoint3dCopy(), -footCenterToToeShiftDuration, omega0, icpToeCornerPoint);
