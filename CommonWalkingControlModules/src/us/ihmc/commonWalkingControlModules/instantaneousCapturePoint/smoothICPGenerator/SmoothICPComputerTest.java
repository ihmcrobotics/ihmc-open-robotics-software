...
public class SmoothICPComputerTest
{
   ...
   public void testTypicalFourStepExample()
   {
      ...
      ArrayList<YoFramePoint> stepList = createABunchOfWalkingSteps(stepSide, startSquaredUp, numberOfStepsInStepList, stepLength, halfStepWidth);
   ...
   private ArrayList<YoFramePoint> createABunchOfWalkingSteps(RobotSide stepSide, boolean startSquaredUp, int numberOfStepsInStepList, double stepLength,
