...
public class PlaneContactStateToWrenchMatrixHelper
{
   ...
   private DenseMatrix64F computeSingleRhoJacobian(FramePoint basisVectorOrigin, FrameVector3D basisVector)
   {
   ...
   private DenseMatrix64F computeSingleRhoCoPJacobian(FramePoint basisVectorOrigin, FrameVector3D basisVector)
   {
