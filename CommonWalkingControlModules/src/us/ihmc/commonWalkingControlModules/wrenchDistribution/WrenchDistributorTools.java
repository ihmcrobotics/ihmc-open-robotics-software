...
public class WrenchDistributorTools
{
   ...
   public static FrameVector computeForce(FramePoint3D centerOfMass, FramePoint3D cmp, double fZ)
   {
   ...
   public static void computeForce(FrameVector forceToPack, FramePoint3D centerOfMass, FramePoint3D cmp, double fZ)
   {
