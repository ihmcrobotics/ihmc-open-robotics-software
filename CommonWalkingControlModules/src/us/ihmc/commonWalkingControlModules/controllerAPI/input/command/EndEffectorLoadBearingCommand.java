...
public class EndEffectorLoadBearingCommand implements CompilableCommand<EndEffectorLoadBearingCommand, EndEffectorLoadBearingMessage>
{
   ...
   public EndEffectorLoadBearingCommand()
   {
      clear();
   }
