...
public class ComponentBasedVariousWalkingProviderFactory implements VariousWalkingProviderFactory
{
   ...
   {
      return VariousWalkingProviders.createUsingComponentBasedDesiredFootstepCalculator(fullRobotModel, referenceFrames, feet, controlDT, updatables,
              useHeadingAndVelocityScript, heightMapForCheatingOnStepHeight, walkingControllerParameters, registry);
   }
