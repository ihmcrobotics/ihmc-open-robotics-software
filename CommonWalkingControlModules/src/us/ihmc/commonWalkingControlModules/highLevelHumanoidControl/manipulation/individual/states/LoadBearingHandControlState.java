...
public abstract class LoadBearingHandControlState extends TaskspaceHandControlState
{
   ...
   public LoadBearingHandControlState(IndividualHandControlState stateEnum, MomentumBasedController momentumBasedController, GeometricJacobian jacobian, YoVariableRegistry parentRegistry)
   {
      ...
      handAcceleration = new SpatialAccelerationVector(jacobian.getEndEffectorFrame(), jacobian.getBaseFrame(), jacobian.getEndEffectorFrame());
   }
