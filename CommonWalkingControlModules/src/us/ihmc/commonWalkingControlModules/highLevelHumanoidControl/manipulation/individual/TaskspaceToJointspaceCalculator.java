...
public class TaskspaceToJointspaceCalculator
{
   ...
   public void compute(FramePoint3D desiredPosition, FrameOrientation desiredOrientation, FrameVector desiredLinearVelocity, FrameVector desiredAngularVelocity)
   {
