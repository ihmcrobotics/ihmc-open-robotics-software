...
public class CutForceControlHelper
{
    ...
    */
   static void wristSensorUpdate(Wrench wristSensorWrench, ReferenceFrame worldFrame, DoubleYoVariable fxRaw, DoubleYoVariable fyRaw, DoubleYoVariable fzRaw,
         AlphaFilteredYoVariable fxFiltered, AlphaFilteredYoVariable fyFiltered, AlphaFilteredYoVariable fzFiltered, double massHandAndDrill, boolean adNoise,
         Random randomNumberGenerator, double driftTime)
   {
      ...
      fxRaw.set(wristSensorWrench
            .getLinearPartX()/* + generateDriftDisturbance(0.1, driftTime) */);
      fyRaw.set(wristSensorWrench
            .getLinearPartY()/* + generateDriftDisturbance(0.1, driftTime) */);
      fzRaw.set(wristSensorWrench
            .getLinearPartZ()/* + generateDriftDisturbance(0.1, driftTime) */);
    ...
    */
   static void getTangentForce(Vector3d forceVectorInWorld, DoubleYoVariable currentTangentialForce, Vector3d tangentTrajectoryVectorInWorld,
         Vector3d lastTangentTrajectoryVectorInWorld, Double fxFiltered, Double fyFiltered, Double fzFiltered, boolean addDisturbances,
         double timeForDisturbances)
   {
    ...
    * @param w22
    */
   static void adaptW(double x, double xStart, double xEnd, double w11Nom, double w22Nom, DoubleYoVariable w11, DoubleYoVariable w22)
   {
      /**
    ...
    * @param w2
    */
   static void modelParameterAdaption(double currentTangentialForce, double currentTangentialForceModel, double currentTangentialVelocity,
         DoubleYoVariable epsilon, DoubleYoVariable C1, DoubleYoVariable C2, double w1, double w2)
   {
      epsilon.set(Math.log(Math.abs(currentTangentialForce) + C1.getDoubleValue()) - Math.log(currentTangentialForceModel + C1.getDoubleValue()));
