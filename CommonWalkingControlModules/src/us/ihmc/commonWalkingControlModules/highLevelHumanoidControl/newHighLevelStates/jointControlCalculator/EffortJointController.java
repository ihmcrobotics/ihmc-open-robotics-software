...
public class EffortJointController
{
   ...
   public EffortJointController(String namePrefix, OneDoFJoint oneDoFJoint, Map<String, Double> gains, double torqueOffset, double standPrepAngle, double controlDT, YoVariableRegistry parentRegistry)
   {
