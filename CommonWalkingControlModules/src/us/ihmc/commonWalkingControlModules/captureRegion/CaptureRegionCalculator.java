...
////import YoboticsBiped.Visualizers.YoboticsBipedPlotter;
//
...
//                                      CapturePointCalculatorInterface yoboticsBipedCapturePointCalculator, YoVariableRegistry yoVariableRegistry,
...
//      
//      this.capturePointCalculator = yoboticsBipedCapturePointCalculator;
//
...
//
//         reachableRegionPoints[i][0] = x + midFootAnkleXOffset; //YoboticsBipedParameters.MID_FOOT_ANKLE_X_OFFSET;
...
//      reachableRegionPoints[numPoints][1] = -footWidth/2.0; // -YoboticsBipedParameters.FOOT_WIDTH / 2.0;
//
...
//      {
//         dynamicGraphicObjectsList = new DynamicGraphicObjectsList("captureRegionPoints");
...
//         if (DRAW_CAPTURE_REGION && (dynamicGraphicObjectsListRegistry != null))
//         {
//            DynamicGraphicPosition position = new DynamicGraphicPosition(captureRegionBestCaseVertices[i], DRAWN_POINT_BASE_SIZE * ((4 + i) / 4),
...
//         if (DRAW_CAPTURE_REGION && (dynamicGraphicObjectsListRegistry != null))
//         {
//            DynamicGraphicPosition position = new DynamicGraphicPosition(captureRegionKinematicLimitVertices[i], DRAWN_POINT_BASE_SIZE * ((4 + i) / 4),
...
//         if (DRAW_CAPTURE_REGION && (dynamicGraphicObjectsListRegistry != null))
//         {
//            DynamicGraphicPosition position = new DynamicGraphicPosition(estimatedCOPExtremes[i], DRAWN_POINT_BASE_SIZE * ((4 + i) / 4), YoAppearance.Black(),
...
//         if (DRAW_CAPTURE_REGION && (dynamicGraphicObjectsListRegistry != null))
//         {
//            DynamicGraphicPosition position = new DynamicGraphicPosition(additionalKinematicLimitPoints[i], DRAWN_POINT_BASE_SIZE * 0.5, YoAppearance.Aqua(),
//                                                 DynamicGraphicPosition.GraphicType.BALL);
//
//            dynamicGraphicObjectsList.add(position);
//            YoboticsBipedPlotter.registerDynamicGraphicPosition(pointName, position);
