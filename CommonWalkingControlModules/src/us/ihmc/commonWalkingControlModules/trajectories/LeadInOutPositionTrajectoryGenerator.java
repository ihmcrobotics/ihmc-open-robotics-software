...
public class LeadInOutPositionTrajectoryGenerator extends PositionTrajectoryGeneratorInMultipleFrames
{
   ...
   public void setInitialLeadOut(FramePoint3D initialPosition, FrameVector initialDirection, double leaveDistance)
   {
   ...
   public void setFinalLeadIn(FramePoint3D finalPosition, FrameVector finalDirection, double approachDistance)
   {
