...
public class ConstantCoPInstantaneousCapturePointTrajectory
{
   ...
   public ConstantCoPInstantaneousCapturePointTrajectory(RobotSide supportSide, BipedSupportPolygons bipedSupportPolygons, double gravity, double deltaT)
   {
      ...
      ReferenceFrame referenceFrame = bipedSupportPolygons.getFootPolygonInAnkleZUp(supportSide).getReferenceFrame();
   ...
   public void initialize(FramePoint2d initialDesiredICP, FramePoint2d finalDesiredICP, double moveTime, double comHeight)
   {
      ...
      if (!initialDesiredICP.epsilonEquals(finalDesiredICP, 0.0))
      {
         ...
         GeometryTools.movePointInsidePolygonAlongLine(equivalentConstantCoP, bipedSupportPolygons.getFootPolygonInAnkleZUp(supportSide), line);
