...
public class BodyFixedPointSpatialAccelerationControlModule
{
   ...
   public BodyFixedPointSpatialAccelerationControlModule(String namePrefix, TwistCalculator twistCalculator, RigidBody endEffector,
         ...
         double dt, YoSE3PIDGainsInterface taskspaceGains, YoVariableRegistry parentRegistry)
   {
      ...
      accelerationControlModule = new RigidBodySpatialAccelerationControlModule(namePrefix, twistCalculator,
            endEffector, bodyFixedPointFrame, dt, taskspaceGains, registry);
   ...
   {
      accelerationControlModule.doPositionControl(desiredPosition, desiredOrientation, desiredLinearVelocityOfOrigin, desiredAngularVelocity, desiredLinearAccelerationOfOrigin, desiredAngularAcceleration, base);
   }
