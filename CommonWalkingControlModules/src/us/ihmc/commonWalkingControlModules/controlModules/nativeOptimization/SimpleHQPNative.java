...
public class SimpleHQPNative {
	...
	public void initializeJava(int stages, int sizeA, int sizeb, int initA,
								int sizeC, int sized, int initC,
								int sizeE, int sizef, int initE,
								int sizeG, int sizeh, int initG, int sizex) {
		nStages = stages;
		ASize = sizeA;  
		bSize = sizeb;  
		AInit = initA;  
	...
	private void solve(double[] A, double[] b, double[] bType, double[] C, double[] d, double[] dType,
			double[] E, double[] f, double[] fType, double[] G, double[] h, double[] hType) {
