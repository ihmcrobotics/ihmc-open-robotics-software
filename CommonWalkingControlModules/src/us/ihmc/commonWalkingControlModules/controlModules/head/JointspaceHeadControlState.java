...
public class JointspaceHeadControlState extends HeadControlState
{
   ...
   public Boolean handleNeckTrajectoryCommand(NeckTrajectoryCommand command, double[] initialJointPositions)
   {
      ...
      {
         if(this.jointsOriginal.length!=command.getNumberOfJoints())
             System.err.println("Wrong number of neck joints: expected "+this.jointsOriginal.length+" got "+command.getNumberOfJoints());
         else
