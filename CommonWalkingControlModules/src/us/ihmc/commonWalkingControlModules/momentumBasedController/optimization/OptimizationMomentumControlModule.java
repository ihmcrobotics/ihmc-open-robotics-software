...
public class OptimizationMomentumControlModule
{
         ...
         YoVariableRegistry parentRegistry)
   {
      ...
      this.centroidalMomentumHandler = new CentroidalMomentumHandler(twistCalculator.getRootBody(), centerOfMassFrame, registry);
...

   {
      ...
      // Lambda
      DenseMatrix64F momentumDotWeight = momentumOptimizationSettings.getMomentumDotWeight(momentumRateCommand.getSelectionMatrix());
