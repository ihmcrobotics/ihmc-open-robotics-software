...
public class MomentumOptimizationSettings
{
   ...
   private Vector3d defaultLinearFootWeight = new Vector3d(30.0, 30.0, 30.0); // TODO This is too high, it prevents the privileged configuration to be achieved quickly when hitting singularity. Something closer to 10.0 would be better.
