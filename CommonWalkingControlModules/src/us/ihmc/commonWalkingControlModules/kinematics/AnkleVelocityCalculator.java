...
public class AnkleVelocityCalculator
{
   ...
   public AnkleVelocityCalculator(RobotSpecificJointNames robotJointNames, ProcessedSensorsInterface processedSensors, CommonWalkingReferenceFrames referenceFrames,
                                  RobotSide robotSide, SwingFullLegJacobian swingLegJacobian)
   {
   ...
   {
      FramePoint footOrigin = new FramePoint(referenceFrames.getFootFrame(robotSide));
      footOrigin.changeFrameCopy(referenceFrames.getPelvisFrame());
