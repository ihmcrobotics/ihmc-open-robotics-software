...
public class DesiredJointVelocityCalculator
{
   ...
   public void getDesiredJointVelocities(LegJointVelocities legJointVelocitiesToPack, Twist desiredTwistOfSwingFootWithRespectToWorld, double alpha)
   {
...
//    desiredTwistOfSwingFoot_World.changeFrame(bodyFrame);
      ...
      swingFullLegJacobian.getJointVelocitiesGivenTwist(legJointVelocitiesToPack, twistOfSwingFootWithRespectToBody, alpha);
   }
